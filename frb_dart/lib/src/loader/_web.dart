...
Future<ExternalLibrary> loadExternalLibraryRaw({required String moduleRoot}) async {
  return ExternalLibrary(wasmModule: await WasmModule.initialize(kind: Modules.noModules(root: moduleRoot)));
}
