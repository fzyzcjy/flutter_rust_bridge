...
* [rogurotus](https://github.com/rogurotus): Add opaque types, enabling arbitrary Rust structs to be used as opaque Dart objects, by generating wrappers and raw Arc pointers.
