...
* **Fast**: It is only a thin (though feature-rich) wrapper, thus performant (e.g. <500μs [when](https://github.com/fzyzcjy/flutter_rust_bridge/issues/318#issuecomment-1034451888) streaming multiple structs back).
