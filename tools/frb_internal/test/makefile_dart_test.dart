...
==3667== To see them, rerun with: --leak-check=full --show-leak-kinds=all
  ...
  group('release version config and validation', () {
    ...
    test('extracts old version from changelog for explicit new version', () {
      expect(
        extractVersionInfoFromChangelog('2.12.0').toString(),
        '_VersionInfo{oldVersion: 2.11.1, newVersion: 2.12.0}',
      );
    });
