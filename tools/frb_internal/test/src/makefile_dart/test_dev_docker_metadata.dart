...
void main() {
  test('parseDevDockerMetadataFromText parses the current Dockerfile', () {
    ...
    expect(metadata.flutterVersion, '3.47.0');
    expect(metadata.rustVersion, '1.93.1');
    expect(metadata.rustNightlyVersion, '2025-02-01');
    expect(
      metadata.versionTag,
      'flutter-3.47.0-rust-1.93.1-nightly-2025-02-01',
    );
    expect(
      metadata.imageRef(imageName: 'fzyzcjy/flutter_rust_bridge_dev'),
      'fzyzcjy/flutter_rust_bridge_dev:flutter-3.47.0-rust-1.93.1-nightly-2025-02-01',
    );
    expect(
      metadata.versionCodeTag(shortSha: 'abcdef0'),
      'flutter-3.47.0-rust-1.93.1-nightly-2025-02-01-code-abcdef0',
    );
    expect(
      ...
      'fzyzcjy/flutter_rust_bridge_dev:flutter-3.47.0-rust-1.93.1-nightly-2025-02-01-code-abcdef0',
    );
  });
  ...
  test('metadata imageRef respects custom image name', () {
    ...
    expect(
      ...
      'example/custom-dev-image:flutter-3.47.0-rust-1.93.1-nightly-2025-02-01',
    );
  });
}
