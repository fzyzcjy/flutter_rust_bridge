...
class ExampleApi extends DartRustBridgeBase<ExampleWire> {
  ...
  Future<Uint8List> drawMandelbrot(
      {required Size imageSize, required Point leftTop, required Point rightBottom, required int numThreads}) async {
    return execute(
        (port) => inner.wire_draw_mandelbrot(port, _api2wire_box_autoadd_size(imageSize),
            _api2wire_box_autoadd_point(leftTop), _api2wire_box_autoadd_point(rightBottom), _api2wire_i32(numThreads)),
