...
fn wire_test_method__method__SharedStructInBlock1And2_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        ...
        move || {
            ...
            move |task_callback| {
                Ok(SharedStructInBlock1And2::test_method(
                    &api_that,
                    api_message,
                ))
            }
...
fn wire_test_static_method__static_method__SharedStructInBlock1And2_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        ...
        move || {
            let api_message = message.wire2api();
            move |task_callback| Ok(SharedStructInBlock1And2::test_static_method(api_message))
        },
    )
}
fn wire_test_method__method__SharedStructInAllBlocks_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        ...
        move || {
            ...
            move |task_callback| {
                Ok(SharedStructInAllBlocks::test_method(
                    &api_that,
                    api_message,
                    api_num,
                ))
...
fn wire_test_static_method__static_method__SharedStructInAllBlocks_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        ...
        move || {
            let api_message = message.wire2api();
            move |task_callback| Ok(SharedStructInAllBlocks::test_static_method(api_message))
        },
    )
}
fn wire_test_method__method__CrossSharedStructInBlock1And2_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        ...
        move || {
            ...
            let api_message = message.wire2api();
            move |task_callback| {
                Ok(CrossSharedStructInBlock1And2::test_method(
                    &api_that,
                    api_message,
                ))
            }
...
fn wire_test_static_method__static_method__CrossSharedStructInBlock1And2_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        ...
        move || {
            let api_message = message.wire2api();
            move |task_callback| {
                Ok(CrossSharedStructInBlock1And2::test_static_method(
                    api_message,
                ))
            }
        },
...
fn wire_test_method__method__CrossSharedStructInBlock2And3_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        ...
        move || {
            ...
            let api_message = message.wire2api();
            move |task_callback| {
                Ok(CrossSharedStructInBlock2And3::test_method(
                    &api_that,
                    api_message,
                ))
            }
...
fn wire_test_static_method__static_method__CrossSharedStructInBlock2And3_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap(
        ...
        move || {
            let api_message = message.wire2api();
            move |task_callback| {
                Ok(CrossSharedStructInBlock2And3::test_static_method(
                    api_message,
                ))
            }
        },
