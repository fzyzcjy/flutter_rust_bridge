...
fn wire_test_shared_struct_only_for_sync_with_no_sync_return_in_block_3_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, SharedStructOnlyForSyncTest>(
        WrapInfo {
...
fn wire_test_all_shared_struct_in_block_3_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Option<SharedStructInAllBlocks>>(
        WrapInfo {
...
fn wire_test_cross_shared_struct_in_block_3_for_2_and_3_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, CrossSharedStructInBlock2And3>(
        WrapInfo {
...
fn wire_test_unique_struct_3_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, StructOnlyForBlock3>(
        WrapInfo {
