...
fn wire_test_cross_shared_struct_in_block_2_for_1_and_2_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, CrossSharedStructInBlock1And2>(
        WrapInfo {
...
fn wire_test_shared_struct_in_block_2_for_2_and_3_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, SharedStructInBlock2And3>(
        WrapInfo {
...
fn wire_test_unique_struct_2_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, StructOnlyForBlock2>(
        WrapInfo {
...
fn wire_test_enum_defined_in_block_2_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        ...
        move || {
            let api_custom = custom.wire2api();
            move |task_callback| Ok(test_enum_defined_in_block_2(api_custom))
        },
    )
}
...
fn wire_test_method__method__EnumDefinedInBlock2_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        ...
        move || {
            ...
            move |task_callback| Ok(EnumDefinedInBlock2::test_method(&api_that, api_message))
        },
    )
}
fn wire_test_static_method__static_method__EnumDefinedInBlock2_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        ...
        move || {
            let api_message = message.wire2api();
            move |task_callback| Ok(EnumDefinedInBlock2::test_static_method(api_message))
        },
    )
}
