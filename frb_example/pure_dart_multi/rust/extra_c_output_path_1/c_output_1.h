...
void wire_test_string_in_block_1(int64_t port_, wire_uint_8_list *s, uint64_t i);

WireSyncReturn wire_test_string_in_sync_in_block_1(wire_uint_8_list *s, uint64_t i);

void wire_test_optional_string_in_block_1(int64_t port_, wire_uint_8_list *s, int32_t i);

WireSyncReturn wire_test_optional_string_in_sync_in_block_1(wire_uint_8_list *s, int32_t i);

WireSyncReturn wire_test_shared_struct_only_for_sync_with_sync_return_in_block_1(wire_uint_8_list *name,
                                                                                 double score);
...
void wire_test_cross_shared_struct_in_block_1_for_1_and_2(int64_t port_,
                                                          wire_CrossSharedStructInBlock1And2 *custom);
