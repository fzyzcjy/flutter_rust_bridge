...
class ApiBlock1ClassPlatform extends FlutterRustBridgeBase<ApiBlock1ClassWire> {
  final BridgeGeneratedSharesPlatform _sharedPlatform;
  ApiBlock1ClassPlatform(ffi.DynamicLibrary dylib)
...
// Section: api2wire
  ...
  @protected
  ffi.Pointer<wire_StructOnlyForBlock1> api2wire_box_autoadd_struct_only_for_block_1(StructOnlyForBlock1 raw) {
...
// Section: api_fill_to_wire
  ...
  void _api_fill_to_wire_box_autoadd_enum_defined_in_block_1(
      EnumDefinedInBlock1 apiObj, ffi.Pointer<wire_EnumDefinedInBlock1> wireObj) {
    _api_fill_to_wire_enum_defined_in_block_1(apiObj, wireObj.ref);
  }

  void _api_fill_to_wire_box_autoadd_struct_defined_in_block_1(
      StructDefinedInBlock1 apiObj, ffi.Pointer<wire_StructDefinedInBlock1> wireObj) {
    _api_fill_to_wire_struct_defined_in_block_1(apiObj, wireObj.ref);
  }

  void _api_fill_to_wire_box_autoadd_struct_only_for_block_1(
      StructOnlyForBlock1 apiObj, ffi.Pointer<wire_StructOnlyForBlock1> wireObj) {
    _api_fill_to_wire_struct_only_for_block_1(apiObj, wireObj.ref);
  }

  void _api_fill_to_wire_enum_defined_in_block_1(EnumDefinedInBlock1 apiObj, wire_EnumDefinedInBlock1 wireObj) {
    if (apiObj is EnumDefinedInBlock1_Quit) {
      wireObj.tag = 0;
      return;
    }
    if (apiObj is EnumDefinedInBlock1_Move) {
      var pre_x = api2wire_i32(apiObj.x);
      var pre_y = api2wire_i32(apiObj.y);
      wireObj.tag = 1;
      wireObj.kind = inner.inflate_EnumDefinedInBlock1_Move();
      wireObj.kind.ref.Move.ref.x = pre_x;
      wireObj.kind.ref.Move.ref.y = pre_y;
      return;
    }
    if (apiObj is EnumDefinedInBlock1_Write) {
      var pre_field0 = _sharedPlatform.api2wire_String(apiObj.field0);
      wireObj.tag = 2;
      wireObj.kind = inner.inflate_EnumDefinedInBlock1_Write();
      wireObj.kind.ref.Write.ref.field0 = pre_field0;
      return;
    }
    if (apiObj is EnumDefinedInBlock1_ChangeColor) {
      ...
      wireObj.tag = 3;
      wireObj.kind = inner.inflate_EnumDefinedInBlock1_ChangeColor();
  ...
  void _api_fill_to_wire_struct_defined_in_block_1(StructDefinedInBlock1 apiObj, wire_StructDefinedInBlock1 wireObj) {
...
class ApiBlock1ClassWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  ApiBlock1ClassWire(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;
  ...
  ffi.Pointer<ffi.Int> new_box_autoadd_shared_struct_in_block_2_and_3() {
    return _new_box_autoadd_shared_struct_in_block_2_and_3();
  }

  late final _new_box_autoadd_shared_struct_in_block_2_and_3Ptr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Int> Function()>>('new_box_autoadd_shared_struct_in_block_2_and_3');
  late final _new_box_autoadd_shared_struct_in_block_2_and_3 =
      _new_box_autoadd_shared_struct_in_block_2_and_3Ptr.asFunction<ffi.Pointer<ffi.Int> Function()>();
  ...
  void wire_test_inbuilt_type_in_block_1(
    int port_,
    int a,
    double b,
  ) {
    return _wire_test_inbuilt_type_in_block_1(
      port_,
      a,
      b,
    );
  ...
  late final _wire_test_inbuilt_type_in_block_1Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Int32, ffi.Float)>>(
          'wire_test_inbuilt_type_in_block_1');
  late final _wire_test_inbuilt_type_in_block_1 =
      _wire_test_inbuilt_type_in_block_1Ptr.asFunction<void Function(int, int, double)>();

  void wire_test_string_in_block_1(
    int port_,
    ffi.Pointer<wire_uint_8_list> s,
    int i,
  ) {
    return _wire_test_string_in_block_1(
      port_,
      s,
      i,
    );
  ...
  void wire_test_all_shared_struct_in_block_1(
    ...
    return _wire_test_all_shared_struct_in_block_1(
      port_,
      custom,
      s,
      i,
  ...
  late final _wire_test_all_shared_struct_in_block_1Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Pointer<wire_SharedStructInAllBlocks>, ffi.Pointer<wire_uint_8_list>,
              ffi.Int32)>>('wire_test_all_shared_struct_in_block_1');
  late final _wire_test_all_shared_struct_in_block_1 = _wire_test_all_shared_struct_in_block_1Ptr
      .asFunction<void Function(int, ffi.Pointer<wire_SharedStructInAllBlocks>, ffi.Pointer<wire_uint_8_list>, int)>();

  void wire_test_shared_struct_in_block_1_for_1_and_2(
    int port_,
    ffi.Pointer<wire_SharedStructInBlock1And2> custom,
    ffi.Pointer<wire_uint_8_list> s,
    int i,
  ) {
    return _wire_test_shared_struct_in_block_1_for_1_and_2(
      port_,
      custom,
      s,
      i,
  ...
  late final _wire_test_shared_struct_in_block_1_for_1_and_2Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Pointer<wire_SharedStructInBlock1And2>, ffi.Pointer<wire_uint_8_list>,
              ffi.Int32)>>('wire_test_shared_struct_in_block_1_for_1_and_2');
  late final _wire_test_shared_struct_in_block_1_for_1_and_2 = _wire_test_shared_struct_in_block_1_for_1_and_2Ptr
      .asFunction<void Function(int, ffi.Pointer<wire_SharedStructInBlock1And2>, ffi.Pointer<wire_uint_8_list>, int)>();

  void wire_test_cross_shared_struct_in_block_1_for_1_and_2(
    int port_,
    ffi.Pointer<wire_CrossSharedStructInBlock1And2> custom,
  ) {
    return _wire_test_cross_shared_struct_in_block_1_for_1_and_2(
      port_,
      custom,
    );
  }

  late final _wire_test_cross_shared_struct_in_block_1_for_1_and_2Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Pointer<wire_CrossSharedStructInBlock1And2>)>>(
          'wire_test_cross_shared_struct_in_block_1_for_1_and_2');
  late final _wire_test_cross_shared_struct_in_block_1_for_1_and_2 =
      _wire_test_cross_shared_struct_in_block_1_for_1_and_2Ptr
          .asFunction<void Function(int, ffi.Pointer<wire_CrossSharedStructInBlock1And2>)>();

  void wire_test_unique_struct_1(
    int port_,
    ffi.Pointer<wire_StructOnlyForBlock1> custom,
    ffi.Pointer<wire_uint_8_list> s,
    int i,
  ) {
  ...
  late final _wire_test_unique_struct_1Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Pointer<wire_StructOnlyForBlock1>, ffi.Pointer<wire_uint_8_list>,
              ffi.Int8)>>('wire_test_unique_struct_1');
  ...
  void wire_test_struct_defined_in_block_1(
    int port_,
    ffi.Pointer<wire_StructDefinedInBlock1> custom,
  ) {
    return _wire_test_struct_defined_in_block_1(
      port_,
      custom,
    );
  }

  late final _wire_test_struct_defined_in_block_1Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Pointer<wire_StructDefinedInBlock1>)>>(
          'wire_test_struct_defined_in_block_1');
  ...
  void wire_test_method__method__EnumDefinedInBlock1(
    ...
    return _wire_test_method__method__EnumDefinedInBlock1(
      port_,
      that,
      message,
    );
  ...
  late final _wire_test_method__method__EnumDefinedInBlock1Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Pointer<wire_EnumDefinedInBlock1>,
              ffi.Pointer<wire_uint_8_list>)>>('wire_test_method__method__EnumDefinedInBlock1');
  late final _wire_test_method__method__EnumDefinedInBlock1 = _wire_test_method__method__EnumDefinedInBlock1Ptr
      .asFunction<void Function(int, ffi.Pointer<wire_EnumDefinedInBlock1>, ffi.Pointer<wire_uint_8_list>)>();

  void wire_test_static_method__static_method__EnumDefinedInBlock1(
    int port_,
    ffi.Pointer<wire_uint_8_list> message,
  ) {
    return _wire_test_static_method__static_method__EnumDefinedInBlock1(
      port_,
      message,
    );
  }

  late final _wire_test_static_method__static_method__EnumDefinedInBlock1Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>)>>(
          'wire_test_static_method__static_method__EnumDefinedInBlock1');
  late final _wire_test_static_method__static_method__EnumDefinedInBlock1 =
      _wire_test_static_method__static_method__EnumDefinedInBlock1Ptr
          .asFunction<void Function(int, ffi.Pointer<wire_uint_8_list>)>();

  void wire_test_method__method__StructDefinedInBlock1(
    int port_,
    ffi.Pointer<wire_StructDefinedInBlock1> that,
    ffi.Pointer<wire_uint_8_list> message,
  ) {
    return _wire_test_method__method__StructDefinedInBlock1(
      port_,
      that,
      message,
    );
  ...
  late final _wire_test_method__method__StructDefinedInBlock1Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Pointer<wire_StructDefinedInBlock1>,
              ffi.Pointer<wire_uint_8_list>)>>('wire_test_method__method__StructDefinedInBlock1');
  late final _wire_test_method__method__StructDefinedInBlock1 = _wire_test_method__method__StructDefinedInBlock1Ptr
      .asFunction<void Function(int, ffi.Pointer<wire_StructDefinedInBlock1>, ffi.Pointer<wire_uint_8_list>)>();

  void wire_test_static_method__static_method__StructDefinedInBlock1(
    int port_,
    ffi.Pointer<wire_uint_8_list> message,
  ) {
    return _wire_test_static_method__static_method__StructDefinedInBlock1(
      port_,
      message,
    );
  }

  late final _wire_test_static_method__static_method__StructDefinedInBlock1Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>)>>(
          'wire_test_static_method__static_method__StructDefinedInBlock1');
  late final _wire_test_static_method__static_method__StructDefinedInBlock1 =
  ...
  late final _new_box_autoadd_enum_defined_in_block_1Ptr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_EnumDefinedInBlock1> Function()>>(
          'new_box_autoadd_enum_defined_in_block_1');
  late final _new_box_autoadd_enum_defined_in_block_1 =
      _new_box_autoadd_enum_defined_in_block_1Ptr.asFunction<ffi.Pointer<wire_EnumDefinedInBlock1> Function()>();
  ...
  late final _new_box_autoadd_struct_defined_in_block_1Ptr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_StructDefinedInBlock1> Function()>>(
          'new_box_autoadd_struct_defined_in_block_1');
  late final _new_box_autoadd_struct_defined_in_block_1 =
      _new_box_autoadd_struct_defined_in_block_1Ptr.asFunction<ffi.Pointer<wire_StructDefinedInBlock1> Function()>();

  ffi.Pointer<wire_StructOnlyForBlock1> new_box_autoadd_struct_only_for_block_1() {
    return _new_box_autoadd_struct_only_for_block_1();
  }

  late final _new_box_autoadd_struct_only_for_block_1Ptr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_StructOnlyForBlock1> Function()>>(
  ...
  late final _inflate_EnumDefinedInBlock1_MovePtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<EnumDefinedInBlock1Kind> Function()>>('inflate_EnumDefinedInBlock1_Move');
  late final _inflate_EnumDefinedInBlock1_Move =
      _inflate_EnumDefinedInBlock1_MovePtr.asFunction<ffi.Pointer<EnumDefinedInBlock1Kind> Function()>();

  ffi.Pointer<EnumDefinedInBlock1Kind> inflate_EnumDefinedInBlock1_Write() {
    return _inflate_EnumDefinedInBlock1_Write();
  }

  late final _inflate_EnumDefinedInBlock1_WritePtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<EnumDefinedInBlock1Kind> Function()>>('inflate_EnumDefinedInBlock1_Write');
  late final _inflate_EnumDefinedInBlock1_Write =
      _inflate_EnumDefinedInBlock1_WritePtr.asFunction<ffi.Pointer<EnumDefinedInBlock1Kind> Function()>();

  ffi.Pointer<EnumDefinedInBlock1Kind> inflate_EnumDefinedInBlock1_ChangeColor() {
    return _inflate_EnumDefinedInBlock1_ChangeColor();
  }

  late final _inflate_EnumDefinedInBlock1_ChangeColorPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<EnumDefinedInBlock1Kind> Function()>>(
          'inflate_EnumDefinedInBlock1_ChangeColor');
  late final _inflate_EnumDefinedInBlock1_ChangeColor =
      _inflate_EnumDefinedInBlock1_ChangeColorPtr.asFunction<ffi.Pointer<EnumDefinedInBlock1Kind> Function()>();
}
...
final class wire_StructDefinedInBlock1 extends ffi.Struct {
  external ffi.Pointer<wire_uint_8_list> name;
}

final class wire_EnumDefinedInBlock1_Quit extends ffi.Opaque {}

final class wire_EnumDefinedInBlock1_Move extends ffi.Struct {
  @ffi.Int32()
  external int x;
...
final class wire_EnumDefinedInBlock1_Write extends ffi.Struct {
  external ffi.Pointer<wire_uint_8_list> field0;
}

final class wire_EnumDefinedInBlock1_ChangeColor extends ffi.Struct {
  @ffi.Int32()
  external int field0;
...
final class EnumDefinedInBlock1Kind extends ffi.Union {
  external ffi.Pointer<wire_EnumDefinedInBlock1_Quit> Quit;

  external ffi.Pointer<wire_EnumDefinedInBlock1_Move> Move;

  external ffi.Pointer<wire_EnumDefinedInBlock1_Write> Write;

  external ffi.Pointer<wire_EnumDefinedInBlock1_ChangeColor> ChangeColor;
}

final class wire_EnumDefinedInBlock1 extends ffi.Struct {
  @ffi.Int32()
  external int tag;
