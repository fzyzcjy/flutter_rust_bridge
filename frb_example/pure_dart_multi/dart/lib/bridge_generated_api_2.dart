...
class ApiClass2Wire implements FlutterRustBridgeWireBase {
  ...
  void wire_simple_adder_21(
    int port_,
    int a,
    int b,
  ) {
    return _wire_simple_adder_21(
      port_,
      a,
      b,
    );
  ...
  late final _wire_simple_adder_21Ptr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Int64, ffi.Int32, ffi.Int32)>>('wire_simple_adder_2');
  late final _wire_simple_adder_21 =
      _wire_simple_adder_21Ptr.asFunction<void Function(int, int, int)>();
