...
class ApiClass1Impl implements ApiClass1 {
  ...
  factory ApiClass1Impl(ExternalLibrary dylib) =>
      ApiClass1Impl.raw(ApiClass1Platform(dylib));

  /// Only valid on web/WASM platforms.
  factory ApiClass1Impl.wasm(FutureOr<WasmModule> module) =>
      ApiClass1Impl(module as ExternalLibrary);
  ...
  Future<int> simpleAdder1({required int a, required int b, dynamic hint}) {
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_simple_adder_1(port_, arg0, arg1),
