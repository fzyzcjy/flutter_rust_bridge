...
class ApiClass1Impl extends FlutterRustBridgeBase<ApiClass1Wire> implements ApiClass1 {
  factory ApiClass1Impl(ExternalLibrary dylib) => ApiClass1Impl.raw(ApiClass1Wire(dylib));
...
extension ApiClass1ImplIoExt on ApiClass1Impl {
// Section: api2wire
...
class ApiClass1Wire implements FlutterRustBridgeWireBase {
  ...
  ApiClass1Wire.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup) : _lookup = lookup;
