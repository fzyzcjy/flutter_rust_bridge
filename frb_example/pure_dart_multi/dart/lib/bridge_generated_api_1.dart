...
abstract class FlutterRustBridgeExampleMultiBlocksTest {
...
class FlutterRustBridgeExampleMultiBlocksTestImpl
    extends FlutterRustBridgeBase<FlutterRustBridgeExampleMultiBlocksTestWire>
    implements FlutterRustBridgeExampleMultiBlocksTest {
  factory FlutterRustBridgeExampleMultiBlocksTestImpl(ffi.DynamicLibrary dylib) =>
      FlutterRustBridgeExampleMultiBlocksTestImpl.raw(FlutterRustBridgeExampleMultiBlocksTestWire(dylib));

  FlutterRustBridgeExampleMultiBlocksTestImpl.raw(FlutterRustBridgeExampleMultiBlocksTestWire inner) : super(inner);
...
/// generated by flutter_rust_bridge
class FlutterRustBridgeExampleMultiBlocksTestWire implements FlutterRustBridgeWireBase {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  FlutterRustBridgeExampleMultiBlocksTestWire(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  FlutterRustBridgeExampleMultiBlocksTestWire.fromLookup(
  ...
  void wire_simple_adder_11(
    int port_,
    int a,
    int b,
  ) {
    return _wire_simple_adder_11(
      port_,
      a,
      b,
    );
  ...
  late final _wire_simple_adder_11Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Int32, ffi.Int32)>>('wire_simple_adder_1');
  late final _wire_simple_adder_11 = _wire_simple_adder_11Ptr.asFunction<void Function(int, int, int)>();
  ...
  late final _free_WireSyncReturnStruct1Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(WireSyncReturnStruct)>>('free_WireSyncReturnStruct');
  late final _free_WireSyncReturnStruct1 =
      _free_WireSyncReturnStruct1Ptr.asFunction<void Function(WireSyncReturnStruct)>();
