...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 508254727;
...
fn wire__crate__api__minimal__CONST_ARRAY_impl(
...
fn wire__crate__api__minimal__CONST_INT_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        1 => wire__crate__api__minimal__CONST_ARRAY_impl(ptr, rust_vec_len, data_len),
        2 => wire__crate__api__minimal__CONST_INT_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
