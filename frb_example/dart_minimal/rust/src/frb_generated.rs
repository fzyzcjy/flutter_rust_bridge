...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -34809232;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
                        3 => wire__crate__api__minimal__ItemContainerSolutionOneTwinNormal_create_twin_normal_impl(port, ptr, rust_vec_len, data_len),
4 => wire__crate__api__minimal__ItemContainerSolutionOneTwinNormal_get_item_contents_twin_normal_impl(port, ptr, rust_vec_len, data_len),
