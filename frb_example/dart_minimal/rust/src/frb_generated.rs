...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1492027392;
...
fn wire__crate__api__minimal__MyStruct_auto_accessor_get_a_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "MyStruct_auto_accessor_get_a",
            port: None,
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                ...
                let output_ok = Result::<_, ()>::Ok(api_that_guard.a.clone())?;
                Ok(output_ok)
            })())
        },
    )
}
fn wire__crate__api__minimal__MyStruct_auto_accessor_set_a_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "MyStruct_auto_accessor_set_a",
            port: None,
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Sync,
        },
        move || {
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        1 => wire__crate__api__minimal__MyStruct_auto_accessor_get_a_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        2 => wire__crate__api__minimal__MyStruct_auto_accessor_set_a_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
