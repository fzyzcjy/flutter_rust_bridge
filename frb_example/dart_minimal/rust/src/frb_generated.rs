        ...
        move || {
            ...
            move |context| {
                transform_result_sse((move || {
                    Result::<_, ()>::Ok(crate::api::minimal::gen_uuid())
                })())
            }
        },
    )
}
fn wire_get_now_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
        ...
        move || {
            ...
            move |context| {
                transform_result_sse(
                    (move || Result::<_, ()>::Ok(crate::api::minimal::get_now()))(),
                )
            }
        },
    )
...
impl SseDecode for chrono::DateTime<chrono::Utc> {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        return chrono::DateTime::<chrono::Utc>::from_naive_utc_and_offset(
            chrono::NaiveDateTime::from_timestamp_millis(inner)
...
impl SseDecode for uuid::Uuid {
    ...
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        ...
        return uuid::Uuid::from_slice(&inner);
    }
}
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        3 => wire_gen_uuid_impl(port, ptr, rust_vec_len, data_len),
        4 => wire_get_now_impl(port, ptr, rust_vec_len, data_len),
