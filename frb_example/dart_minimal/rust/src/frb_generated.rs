        ...
        move || {
            ...
            move |context| {
                transform_result_sse((move || {
                    ...
                    Result::<_, ()>::Ok(crate::api::minimal::MyStruct::f(&mut api_that))
                })())
            }
        },
    )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        3 => wire_MyStruct_f_impl(port, ptr, rust_vec_len, data_len),
...
impl SseEncode for MyStruct {
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <RustOpaqueMoi<flutter_rust_bridge::for_generated::rust_async::RwLock<MyStruct>>>::sse_encode(flutter_rust_bridge::for_generated::rust_auto_opaque_encode::<_, MoiArc<_>>(self), serializer);
    }
}
