...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 386221144;
...
fn wire__crate__api__minimal__immediate_stream_impl(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>({
                        crate::api::minimal::immediate_stream(api_sink);
                    })?;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__minimal__immediate_stream_impl(port, ptr, rust_vec_len, data_len),
