...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1172725631;
...
fn wire__crate__api__minimal__deserializer_my_type_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "deserializer_my_type",
            port: Some(port_),
        ...
        move || {
            ...
            move |context| {
                transform_result_sse((move || {
                    Result::<_, ()>::Ok(crate::api::minimal::deserializer_my_type(api_raw))
                })())
            }
        },
    )
...
fn wire__crate__api__minimal__serializer_my_type_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_raw = <MessageWithCustomSerializerTwinNormal>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse((move || {
                    Result::<_, ()>::Ok(crate::api::minimal::serializer_my_type(api_raw))
                })())
            }
        },
    )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => {
            wire__crate__api__minimal__deserializer_my_type_impl(port, ptr, rust_vec_len, data_len)
        }
        2 => wire__crate__api__minimal__function_using_type_with_custom_serializer_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        5 => wire__crate__api__minimal__serializer_my_type_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
