...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 576967428;
...
fn wire__crate__api__minimal__f_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let api_a = <Vec<u64>>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
...
fn wire__crate__api__minimal__func_type_fallible_panic_twin_normal_impl(
    port_: flutter_rust_bridge::for_generated::DartNativeSendPort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
        ...
        move || {
            ...
            move |context| {
                transform_result_sse((move || {
                    crate::api::minimal::func_type_fallible_panic_twin_normal()
                })())
            }
        },
    )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        2 => wire__crate__api__minimal__func_type_fallible_panic_twin_normal_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
