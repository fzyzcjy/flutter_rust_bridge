...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -910361693;
...
fn wire__crate__api__minimal__minimal_optional_callback_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_async::<flutter_rust_bridge::for_generated::SseCodec, _, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "minimal_optional_callback",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok = Result::<_, ()>::Ok({
                            crate::api::minimal::minimal_optional_callback(api_callback).await;
                        })?;
                        Ok(output_ok)
                    })()
                    .await,
...
fn decode_Optional_DartFn_Inputs_String_Output_unit_AnyhowException(
    ...
    raw.map(|dart_opaque| {
        Box::new(decode_DartFn_Inputs_String_Output_unit_AnyhowException(
            dart_opaque,
        )) as Box<dyn Fn(String) -> flutter_rust_bridge::DartFnFuture<()> + Send + Sync>
    })
}
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        3 => wire__crate__api__minimal__minimal_optional_callback_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
