...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1697006927;
...
fn wire__crate__api__minimal__example_basic_list_type_u64_twin_normal_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "example_basic_list_type_u64_twin_normal",
            port: Some(port_),
        ...
        move || {
            ...
            move |context| {
                transform_result_sse((move || {
                    Result::<_, ()>::Ok(
                        crate::api::minimal::example_basic_list_type_u64_twin_normal(api_arg),
                    )
                })())
            }
        },
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        3 => wire__crate__api__minimal__example_basic_list_type_u64_twin_normal_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
