...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 852417482;
...
fn wire__crate__api__minimal__CONST_ARRAY_TWIN_NORMAL_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok(crate::api::minimal::CONST_ARRAY_TWIN_NORMAL)?;
                Ok(output_ok)
            })())
        },
    )
}
fn wire__crate__api__minimal__CONST_INT_TWIN_NORMAL_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let output_ok = Result::<_, ()>::Ok(crate::api::minimal::CONST_INT_TWIN_NORMAL)?;
                Ok(output_ok)
            })())
        },
    )
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        1 => wire__crate__api__minimal__CONST_ARRAY_TWIN_NORMAL_impl(ptr, rust_vec_len, data_len),
        2 => wire__crate__api__minimal__CONST_INT_TWIN_NORMAL_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
