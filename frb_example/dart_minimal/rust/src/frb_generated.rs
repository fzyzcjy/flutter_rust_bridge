...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 2095221642;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__minimal__LtOwnedStructTwinNormal_create_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        2 => wire__crate__api__minimal__LtOwnedStructTwinNormal_create_with_logger_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        3 => {
            wire__crate__api__minimal__LtSubStructTwinNormal_greet_borrow_mut_self_twin_normal_impl(
                port,
                ptr,
                rust_vec_len,
                data_len,
        ...
        4 => wire__crate__api__minimal__LtSubStructTwinNormal_greet_borrow_self_twin_normal_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        5 => wire__crate__api__minimal__SimpleLogger_get_and_reset_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        6 => wire__crate__api__minimal__SimpleLogger_new_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
