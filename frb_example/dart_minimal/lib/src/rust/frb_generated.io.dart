...
class RustLibWire implements BaseWire {
  ...
  void wire__crate__api__minimal__func_for_struct_with_field_rename_twin_normal(
    int port_,
    ffi.Pointer<wire_cst_struct_with_field_rename_twin_normal> arg,
  ) {
    return _wire__crate__api__minimal__func_for_struct_with_field_rename_twin_normal(
      port_,
      arg,
    );
  }

  late final _wire__crate__api__minimal__func_for_struct_with_field_rename_twin_normalPtr =
      _lookup<
              ffi.NativeFunction<
                  ffi.Void Function(
                      ffi.Int64,
          ...
          'frbgen_frb_example_dart_minimal_wire__crate__api__minimal__func_for_struct_with_field_rename_twin_normal');
  ...
  late final _cst_new_box_autoadd_struct_with_field_rename_twin_normalPtr = _lookup<
          ffi.NativeFunction<
              ffi.Pointer<wire_cst_struct_with_field_rename_twin_normal>
                  Function()>>(
      'frbgen_frb_example_dart_minimal_cst_new_box_autoadd_struct_with_field_rename_twin_normal');
  late final _cst_new_box_autoadd_struct_with_field_rename_twin_normal =
      _cst_new_box_autoadd_struct_with_field_rename_twin_normalPtr.asFunction<
          ffi.Pointer<wire_cst_struct_with_field_rename_twin_normal>
              Function()>();
