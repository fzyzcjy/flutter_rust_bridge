...
abstract class RustLibApiImplPlatform extends BaseApiImpl<RustLibWire> {
  ...
  @protected
  HelloStruct sse_decode_box_autoadd_hello_struct(SseDeserializer deserializer);
  ...
  @protected
  ffi.Pointer<wire_cst_hello_struct> cst_encode_box_autoadd_hello_struct(
      HelloStruct raw) {
    // Codec=Cst (C-struct based), see doc to use other codecs
    final ptr = wire.cst_new_box_autoadd_hello_struct();
    cst_api_fill_to_wire_hello_struct(raw, ptr.ref);
    return ptr;
  }
  ...
  @protected
  void cst_api_fill_to_wire_box_autoadd_hello_struct(
      HelloStruct apiObj, ffi.Pointer<wire_cst_hello_struct> wireObj) {
    cst_api_fill_to_wire_hello_struct(apiObj, wireObj.ref);
  }

  @protected
  void cst_api_fill_to_wire_hello_struct(
      HelloStruct apiObj, wire_cst_hello_struct wireObj) {
    wireObj.a = cst_encode_i_32(apiObj.a);
    wireObj.b = cst_encode_String(apiObj.b);
  }
...
class RustLibWire implements BaseWire {
  ...
  void wire__crate__api__minimal__f(
    int port_,
    ffi.Pointer<wire_cst_hello_struct> a,
  ) {
  ...
  late final _wire__crate__api__minimal__fPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(
                  ffi.Int64, ffi.Pointer<wire_cst_hello_struct>)>>(
  ...
  late final _wire__crate__api__minimal__f = _wire__crate__api__minimal__fPtr
      .asFunction<void Function(int, ffi.Pointer<wire_cst_hello_struct>)>();
  ...
  ffi.Pointer<wire_cst_hello_struct> cst_new_box_autoadd_hello_struct() {
    return _cst_new_box_autoadd_hello_struct();
  }

  late final _cst_new_box_autoadd_hello_structPtr = _lookup<
          ffi.NativeFunction<ffi.Pointer<wire_cst_hello_struct> Function()>>(
      'frbgen_frb_example_dart_minimal_cst_new_box_autoadd_hello_struct');
  late final _cst_new_box_autoadd_hello_struct =
      _cst_new_box_autoadd_hello_structPtr
          .asFunction<ffi.Pointer<wire_cst_hello_struct> Function()>();
...
final class wire_cst_hello_struct extends ffi.Struct {
  @ffi.Int32()
  external int a;
