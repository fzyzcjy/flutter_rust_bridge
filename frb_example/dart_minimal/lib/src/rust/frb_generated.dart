...
import 'package:flutter_rust_bridge/flutter_rust_bridge_for_generated.dart';
                ...
                class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
                  ...
                  @override
                  int get rustContentHash => 208644647;
...
Future<void> crateApiMinimalR#for({required String type });
...
@override Future<void> crateApiMinimalR#for({required String type })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              
            final serializer = SseSerializer(generalizedFrbRustBinding);sse_encode_String(type, serializer);
        ...
        ,
            constMeta: kCrateApiMinimalR#forConstMeta,
            argValues: [type],
            apiImpl: this,
        )); }


        TaskConstMeta get kCrateApiMinimalR#forConstMeta => const TaskConstMeta(
            debugName: "r#for",
            argNames: ["type"],
        );
        

@override Future<StructWithRawNameField> crateApiMinimalStructWithRawNameFieldDefault()  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
        ...
        TaskConstMeta get kCrateApiMinimalStructWithRawNameFieldDefaultConstMeta => const TaskConstMeta(
...
@protected StructWithRawNameField dco_decode_struct_with_raw_name_field(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return StructWithRawNameField(type: dco_decode_String(arr[0]),); }
...
@protected StructWithRawNameField sse_decode_struct_with_raw_name_field(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
...
@protected void sse_encode_struct_with_raw_name_field(StructWithRawNameField self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
