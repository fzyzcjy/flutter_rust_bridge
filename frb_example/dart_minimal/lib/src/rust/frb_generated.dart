...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -357508777;
...
abstract class RustLibApi extends BaseApi {
  Future<MyStruct> crateApiMinimalMyStructDefault();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<MyStruct> crateApiMinimalMyStructDefault() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiMinimalMyStructDefaultConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMinimalMyStructDefaultConstMeta =>
      const TaskConstMeta(
