...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1697006927;
...
abstract class RustLibApi extends BaseApi {
  Future<Uint64List> crateApiMinimalExampleBasicListTypeU64TwinNormal(
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<Uint64List> crateApiMinimalExampleBasicListTypeU64TwinNormal(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiMinimalExampleBasicListTypeU64TwinNormalConstMeta,
      argValues: [arg],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta
      get kCrateApiMinimalExampleBasicListTypeU64TwinNormalConstMeta =>
          const TaskConstMeta(
