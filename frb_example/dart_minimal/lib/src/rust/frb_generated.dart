...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  SimpleTraitForDynTwinNormalImplementor
    ...
    switch (raw[0]) {
      case 0:
        return SimpleTraitForDynTwinNormalImplementor_StructOneWithTraitForDynTwinNormal(
          dco_decode_AutoExplicit_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerStructOneWithTraitForDynTwinNormal(
              raw[1]),
        );
      case 1:
        return SimpleTraitForDynTwinNormalImplementor_StructTwoWithTraitForDynTwinNormal(
          dco_decode_AutoExplicit_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerStructTwoWithTraitForDynTwinNormal(
              raw[1]),
        );
      default:
  ...
  void sse_encode_simple_trait_for_dyn_twin_normal_implementor(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    switch (self) {
      case SimpleTraitForDynTwinNormalImplementor_StructOneWithTraitForDynTwinNormal(
          field0: final field0
        ):
        sse_encode_i_32(0, serializer);
        sse_encode_AutoExplicit_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerStructOneWithTraitForDynTwinNormal(
            field0, serializer);
      case SimpleTraitForDynTwinNormalImplementor_StructTwoWithTraitForDynTwinNormal(
          field0: final field0
        ):
...
sealed class SimpleTraitForDynTwinNormalImplementor
  ...
  const factory SimpleTraitForDynTwinNormalImplementor.structOneWithTraitForDynTwinNormal(
    StructOneWithTraitForDynTwinNormal field0,
  ) = SimpleTraitForDynTwinNormalImplementor_StructOneWithTraitForDynTwinNormal;
  const factory SimpleTraitForDynTwinNormalImplementor.structTwoWithTraitForDynTwinNormal(
