...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 386221144;
...
abstract class RustLibApi extends BaseApi {
  Stream<int> crateApiMinimalImmediateStream();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
    ...
    unawaited(
      handler.executeNormal(
        NormalTask(
          ...
          constMeta: kCrateApiMinimalImmediateStreamConstMeta,
          argValues: [sink],
          apiImpl: this,
        ),
      ),
  ...
  TaskConstMeta get kCrateApiMinimalImmediateStreamConstMeta =>
      const TaskConstMeta(debugName: "immediate_stream", argNames: ["sink"]);
