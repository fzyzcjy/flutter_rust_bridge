...
// The type `SimpleEnumWithCommentsTwinNormal` is exported as `pub` but never used by any `pub` functions, thus it is ignored.
// The type `ComplexEnumWithCommentsTwinNormal` is exported as `pub` but never used by any `pub` functions, thus it is ignored.
