...
import 'package:flutter_rust_bridge/flutter_rust_bridge_for_generated.dart';
        ...
        Future<double?> handleOptionalReturnTwinRustAsyncSse({required double left , required double right , dynamic hint}) => RustLib.instance.api.handleOptionalReturnTwinRustAsyncSse(left: left, right: right, hint: hint);

Future<ElementTwinRustAsyncSse?> handleOptionalStructTwinRustAsyncSse({String? document , dynamic hint}) => RustLib.instance.api.handleOptionalStructTwinRustAsyncSse(document: document, hint: hint);

Future<ExoticOptionalsTwinRustAsyncSse?> handleOptionalIncrementTwinRustAsyncSse({ExoticOptionalsTwinRustAsyncSse? opt , dynamic hint}) => RustLib.instance.api.handleOptionalIncrementTwinRustAsyncSse(opt: opt, hint: hint);

Future<double> handleIncrementBoxedOptionalTwinRustAsyncSse({double? opt , dynamic hint}) => RustLib.instance.api.handleIncrementBoxedOptionalTwinRustAsyncSse(opt: opt, hint: hint);

Future<OptVecsTwinRustAsyncSse> handleVecOfOptsTwinRustAsyncSse({required OptVecsTwinRustAsyncSse opt , dynamic hint}) => RustLib.instance.api.handleVecOfOptsTwinRustAsyncSse(opt: opt, hint: hint);

Future<String> handleOptionBoxArgumentsTwinRustAsyncSse({int? i8Box , int? u8Box , int? i32Box , int? i64Box , double? f64Box , bool? boolbox , ExoticOptionalsTwinRustAsyncSse? structbox , dynamic hint}) => RustLib.instance.api.handleOptionBoxArgumentsTwinRustAsyncSse(i8Box: i8Box, u8Box: u8Box, i32Box: i32Box, i64Box: i64Box, f64Box: f64Box, boolbox: boolbox, structbox: structbox, hint: hint);
