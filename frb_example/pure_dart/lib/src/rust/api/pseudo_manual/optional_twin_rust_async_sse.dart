...
import 'package:flutter_rust_bridge/flutter_rust_bridge_for_generated.dart';
        ...
        Future<double?> handleOptionalReturnTwinRustAsyncSse({required double left , required double right , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualOptionalTwinRustAsyncSseHandleOptionalReturnTwinRustAsyncSse(left: left, right: right, hint: hint);

Future<ElementTwinRustAsyncSse?> handleOptionalStructTwinRustAsyncSse({String? document , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualOptionalTwinRustAsyncSseHandleOptionalStructTwinRustAsyncSse(document: document, hint: hint);

Future<ExoticOptionalsTwinRustAsyncSse?> handleOptionalIncrementTwinRustAsyncSse({ExoticOptionalsTwinRustAsyncSse? opt , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualOptionalTwinRustAsyncSseHandleOptionalIncrementTwinRustAsyncSse(opt: opt, hint: hint);

Future<double> handleIncrementBoxedOptionalTwinRustAsyncSse({double? opt , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualOptionalTwinRustAsyncSseHandleIncrementBoxedOptionalTwinRustAsyncSse(opt: opt, hint: hint);

Future<OptVecsTwinRustAsyncSse> handleVecOfOptsTwinRustAsyncSse({required OptVecsTwinRustAsyncSse opt , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualOptionalTwinRustAsyncSseHandleVecOfOptsTwinRustAsyncSse(opt: opt, hint: hint);

Future<String> handleOptionBoxArgumentsTwinRustAsyncSse({int? i8Box , int? u8Box , int? i32Box , PlatformInt64? i64Box , double? f64Box , bool? boolbox , ExoticOptionalsTwinRustAsyncSse? structbox , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualOptionalTwinRustAsyncSseHandleOptionBoxArgumentsTwinRustAsyncSse(i8Box: i8Box, u8Box: u8Box, i32Box: i32Box, i64Box: i64Box, f64Box: f64Box, boolbox: boolbox, structbox: structbox, hint: hint);
...
final List<ElementTwinRustAsyncSse>? children;
                ...
                const ElementTwinRustAsyncSse({this.tag ,this.text ,this.attributes ,this.children ,});
...
final NewTypeIntTwinRustAsyncSse? newtypeint;
                ...
                const ExoticOptionalsTwinRustAsyncSse({this.int32 ,this.int64 ,this.float64 ,this.boolean ,this.zerocopy ,this.int8List ,this.uint8List ,this.int32List ,this.float32List ,this.float64List ,this.attributes ,required this.attributesNullable ,this.nullableAttributes ,this.newtypeint ,});
...
final List<Int32List?> buffers;
                ...
                const OptVecsTwinRustAsyncSse({required this.i32 ,required this.enums ,required this.strings ,required this.buffers ,});
