...
Future<ZeroCopyVecOfPrimitivePackTwinRustAsync>
    handleZeroCopyVecOfPrimitiveTwinRustAsync({required int n, dynamic hint}) =>
        RustLib.instance.api
            .handleZeroCopyVecOfPrimitiveTwinRustAsync(n: n, hint: hint);
...
class ZeroCopyVecOfPrimitivePackTwinRustAsync {
  final Int8List int8List;
  final Uint8List uint8List;
  final Int16List int16List;
  final Uint16List uint16List;
  ...
  const ZeroCopyVecOfPrimitivePackTwinRustAsync({
    required this.int8List,
    required this.uint8List,
    required this.int16List,
    required this.uint16List,
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ZeroCopyVecOfPrimitivePackTwinRustAsync &&
          runtimeType == other.runtimeType &&
          int8List == other.int8List &&
          uint8List == other.uint8List &&
          int16List == other.int16List &&
