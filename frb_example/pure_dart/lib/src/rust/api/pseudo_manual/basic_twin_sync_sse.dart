...
bool exampleBasicTypeBoolTwinSyncSse({required bool arg}) => RustLib
    .instance
    .api
...
String exampleBasicTypeStringTwinSyncSse({required String arg}) => RustLib
    .instance
    .api
...
Uint8List exampleBasicTypeBytesTwinSyncSse({required List<int> arg}) => RustLib
    .instance
    .api
...
sealed class BasicGeneralEnumTwinSyncSse with _$BasicGeneralEnumTwinSyncSse {
  ...
  const factory BasicGeneralEnumTwinSyncSse.apple({required String field}) =
      BasicGeneralEnumTwinSyncSse_Apple;
  const factory BasicGeneralEnumTwinSyncSse.orange() =
      BasicGeneralEnumTwinSyncSse_Orange;
}

enum BasicPrimitiveEnumTwinSyncSse { apple, orange }
