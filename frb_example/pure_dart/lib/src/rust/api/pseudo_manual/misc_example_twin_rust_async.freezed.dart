...
/// @nodoc
mixin _$MySizeFreezedTwinRustAsync {
  int get width => throw _privateConstructorUsedError;
  int get height => throw _privateConstructorUsedError;

  @JsonKey(ignore: true)
  $MySizeFreezedTwinRustAsyncCopyWith<MySizeFreezedTwinRustAsync>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $MySizeFreezedTwinRustAsyncCopyWith<$Res> {
  factory $MySizeFreezedTwinRustAsyncCopyWith(MySizeFreezedTwinRustAsync value,
          $Res Function(MySizeFreezedTwinRustAsync) then) =
      _$MySizeFreezedTwinRustAsyncCopyWithImpl<$Res,
...
/// @nodoc
class _$MySizeFreezedTwinRustAsyncCopyWithImpl<$Res,
        $Val extends MySizeFreezedTwinRustAsync>
    implements $MySizeFreezedTwinRustAsyncCopyWith<$Res> {
  _$MySizeFreezedTwinRustAsyncCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$MySizeFreezedTwinRustAsyncImplCopyWith<$Res>
    implements $MySizeFreezedTwinRustAsyncCopyWith<$Res> {
  factory _$$MySizeFreezedTwinRustAsyncImplCopyWith(
          _$MySizeFreezedTwinRustAsyncImpl value,
          $Res Function(_$MySizeFreezedTwinRustAsyncImpl) then) =
      __$$MySizeFreezedTwinRustAsyncImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({int width, int height});
}
...
/// @nodoc
class __$$MySizeFreezedTwinRustAsyncImplCopyWithImpl<$Res>
    extends _$MySizeFreezedTwinRustAsyncCopyWithImpl<$Res,
        _$MySizeFreezedTwinRustAsyncImpl>
    implements _$$MySizeFreezedTwinRustAsyncImplCopyWith<$Res> {
  __$$MySizeFreezedTwinRustAsyncImplCopyWithImpl(
      _$MySizeFreezedTwinRustAsyncImpl _value,
      $Res Function(_$MySizeFreezedTwinRustAsyncImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$MySizeFreezedTwinRustAsyncImpl(
      width: null == width
          ? _value.width
          : width // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$MySizeFreezedTwinRustAsyncImpl implements _MySizeFreezedTwinRustAsync {
  const _$MySizeFreezedTwinRustAsyncImpl(
  ...
  @override
  String toString() {
    return 'MySizeFreezedTwinRustAsync(width: $width, height: $height)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$MySizeFreezedTwinRustAsyncImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$MySizeFreezedTwinRustAsyncImplCopyWith<_$MySizeFreezedTwinRustAsyncImpl>
      get copyWith => __$$MySizeFreezedTwinRustAsyncImplCopyWithImpl<
          _$MySizeFreezedTwinRustAsyncImpl>(this, _$identity);
}

abstract class _MySizeFreezedTwinRustAsync
    implements MySizeFreezedTwinRustAsync {
  const factory _MySizeFreezedTwinRustAsync(
      {required final int width,
      required final int height}) = _$MySizeFreezedTwinRustAsyncImpl;
