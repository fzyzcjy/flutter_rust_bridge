...
import 'package:flutter_rust_bridge/flutter_rust_bridge_for_generated.dart';
        ...
        Future<double?> handleOptionalReturnTwinRustAsync({required double left , required double right , dynamic hint}) => RustLib.instance.api.handleOptionalReturnTwinRustAsync(left: left, right: right, hint: hint);

Future<ElementTwinRustAsync?> handleOptionalStructTwinRustAsync({String? document , dynamic hint}) => RustLib.instance.api.handleOptionalStructTwinRustAsync(document: document, hint: hint);

Future<ExoticOptionalsTwinRustAsync?> handleOptionalIncrementTwinRustAsync({ExoticOptionalsTwinRustAsync? opt , dynamic hint}) => RustLib.instance.api.handleOptionalIncrementTwinRustAsync(opt: opt, hint: hint);

Future<double> handleIncrementBoxedOptionalTwinRustAsync({double? opt , dynamic hint}) => RustLib.instance.api.handleIncrementBoxedOptionalTwinRustAsync(opt: opt, hint: hint);

Future<OptVecsTwinRustAsync> handleVecOfOptsTwinRustAsync({required OptVecsTwinRustAsync opt , dynamic hint}) => RustLib.instance.api.handleVecOfOptsTwinRustAsync(opt: opt, hint: hint);

Future<String> handleOptionBoxArgumentsTwinRustAsync({int? i8Box , int? u8Box , int? i32Box , int? i64Box , double? f64Box , bool? boolbox , ExoticOptionalsTwinRustAsync? structbox , dynamic hint}) => RustLib.instance.api.handleOptionBoxArgumentsTwinRustAsync(i8Box: i8Box, u8Box: u8Box, i32Box: i32Box, i64Box: i64Box, f64Box: f64Box, boolbox: boolbox, structbox: structbox, hint: hint);
