...
Future<String> borrowStrTwinRustAsyncSse({required String arg}) => RustLib
    .instance
    .api
...
Future<int> borrowI32TwinRustAsyncSse({required int arg}) => RustLib
    .instance
    .api
...
Future<Uint8List> borrowSliceU8TwinRustAsyncSse({
