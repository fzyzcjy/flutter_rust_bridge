...
U8Array5 getArrayTwinSyncSse({dynamic hint}) => RustLib.instance.api
    .crateApiPseudoManualArrayTwinSyncSseGetArrayTwinSyncSse(hint: hint);

PointTwinSyncSseArray2 getComplexArrayTwinSyncSse({dynamic hint}) => RustLib
    .instance.api
    .crateApiPseudoManualArrayTwinSyncSseGetComplexArrayTwinSyncSse(hint: hint);

MessageIdTwinSyncSse newMsgidTwinSyncSse(
        {required U8Array32 id, dynamic hint}) =>
    RustLib.instance.api
        .crateApiPseudoManualArrayTwinSyncSseNewMsgidTwinSyncSse(
            id: id, hint: hint);

U8Array32 useMsgidTwinSyncSse(
        {required MessageIdTwinSyncSse id, dynamic hint}) =>
    RustLib.instance.api
        .crateApiPseudoManualArrayTwinSyncSseUseMsgidTwinSyncSse(
            id: id, hint: hint);

BlobTwinSyncSse boxedBlobTwinSyncSse(
        {required U8Array1600 blob, dynamic hint}) =>
    RustLib.instance.api
        .crateApiPseudoManualArrayTwinSyncSseBoxedBlobTwinSyncSse(
            blob: blob, hint: hint);

U8Array1600 useBoxedBlobTwinSyncSse(
        {required BlobTwinSyncSse blob, dynamic hint}) =>
    RustLib.instance.api
        .crateApiPseudoManualArrayTwinSyncSseUseBoxedBlobTwinSyncSse(
            blob: blob, hint: hint);
...
TestIdTwinSyncSse funcTestIdTwinSyncSse(
    ...
    RustLib.instance.api
        .crateApiPseudoManualArrayTwinSyncSseFuncTestIdTwinSyncSse(
            id: id, hint: hint);

double lastNumberTwinSyncSse({required F64Array16 array, dynamic hint}) =>
    RustLib.instance.api
        .crateApiPseudoManualArrayTwinSyncSseLastNumberTwinSyncSse(
