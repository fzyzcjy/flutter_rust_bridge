...
sealed class EnumOpaqueTwinRustAsyncSseMoi {
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    final self = this;
    if (self is EnumOpaqueTwinRustAsyncSseMoi_Struct) {
      return struct?.call(self.field0);
    }
    if (self is EnumOpaqueTwinRustAsyncSseMoi_Primitive) {
      return primitive?.call(self.field0);
    }
    if (self is EnumOpaqueTwinRustAsyncSseMoi_TraitObj) {
      return traitObj?.call(self.field0);
    }
    if (self is EnumOpaqueTwinRustAsyncSseMoi_Mutex) {
      return mutex?.call(self.field0);
    }
    if (self is EnumOpaqueTwinRustAsyncSseMoi_RwLock) {
      return rwLock?.call(self.field0);
    }
    if (self is EnumOpaqueTwinRustAsyncSseMoi_Nothing) {
      return nothing?.call();
    }
    return null;
  }
...
class EnumOpaqueTwinRustAsyncSseMoi_Struct
  ...
  const EnumOpaqueTwinRustAsyncSseMoi_Struct(
    this.field0,
  ) : super._();
...
class EnumOpaqueTwinRustAsyncSseMoi_Primitive
  ...
  const EnumOpaqueTwinRustAsyncSseMoi_Primitive(
    this.field0,
  ) : super._();
...
class EnumOpaqueTwinRustAsyncSseMoi_TraitObj
  ...
  const EnumOpaqueTwinRustAsyncSseMoi_TraitObj(
    this.field0,
  ) : super._();
...
class EnumOpaqueTwinRustAsyncSseMoi_Mutex
  ...
  const EnumOpaqueTwinRustAsyncSseMoi_Mutex(
    this.field0,
  ) : super._();
...
class EnumOpaqueTwinRustAsyncSseMoi_RwLock
  ...
  const EnumOpaqueTwinRustAsyncSseMoi_RwLock(
    this.field0,
  ) : super._();
