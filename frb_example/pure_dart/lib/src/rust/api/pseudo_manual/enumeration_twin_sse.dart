...
enum EnumSimpleTwinSse { a, b }

enum EnumWithDiscriminantTwinSse { oneHundred, fifty }
...
sealed class EnumWithItemMixedTwinSse with _$EnumWithItemMixedTwinSse {
  ...
  const factory EnumWithItemMixedTwinSse.b(Uint8List field0) =
      EnumWithItemMixedTwinSse_B;
  const factory EnumWithItemMixedTwinSse.c({required String cField}) =
...
sealed class EnumWithItemStructTwinSse with _$EnumWithItemStructTwinSse {
  ...
  const factory EnumWithItemStructTwinSse.a({required Uint8List aField}) =
      EnumWithItemStructTwinSse_A;
  const factory EnumWithItemStructTwinSse.b({required Int32List bField}) =
...
sealed class EnumWithItemTupleTwinSse with _$EnumWithItemTupleTwinSse {
  ...
  const factory EnumWithItemTupleTwinSse.a(Uint8List field0) =
      EnumWithItemTupleTwinSse_A;
  const factory EnumWithItemTupleTwinSse.b(int field0) =
...
sealed class KitchenSinkTwinSse with _$KitchenSinkTwinSse {
  ...
  const factory KitchenSinkTwinSse.buffer(Uint8List field0) =
...
sealed class MeasureTwinSse with _$MeasureTwinSse {
  ...
  const factory MeasureTwinSse.speed(SpeedTwinSse field0) =
      MeasureTwinSse_Speed;
  const factory MeasureTwinSse.distance(DistanceTwinSse field0) =
