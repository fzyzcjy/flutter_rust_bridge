...
sealed class DistanceTwinRustAsyncSse with _$DistanceTwinRustAsyncSse {
  ...
  const factory DistanceTwinRustAsyncSse.map(double field0) =
      DistanceTwinRustAsyncSse_Map;
}

enum EnumSimpleTwinRustAsyncSse { a, b }

enum EnumWithDiscriminantTwinRustAsyncSse { oneHundred, fifty }
...
sealed class EnumWithItemMixedTwinRustAsyncSse
  ...
  const factory EnumWithItemMixedTwinRustAsyncSse.b(Uint8List field0) =
      EnumWithItemMixedTwinRustAsyncSse_B;
  const factory EnumWithItemMixedTwinRustAsyncSse.c({required String cField}) =
...
sealed class EnumWithItemTupleTwinRustAsyncSse
  ...
  const factory EnumWithItemTupleTwinRustAsyncSse.a(Uint8List field0) =
      EnumWithItemTupleTwinRustAsyncSse_A;
  const factory EnumWithItemTupleTwinRustAsyncSse.b(int field0) =
...
sealed class KitchenSinkTwinRustAsyncSse with _$KitchenSinkTwinRustAsyncSse {
  ...
  const factory KitchenSinkTwinRustAsyncSse.buffer(Uint8List field0) =
...
sealed class MeasureTwinRustAsyncSse with _$MeasureTwinRustAsyncSse {
  ...
  const factory MeasureTwinRustAsyncSse.speed(SpeedTwinRustAsyncSse field0) =
...
sealed class SpeedTwinRustAsyncSse with _$SpeedTwinRustAsyncSse {
  ...
  const factory SpeedTwinRustAsyncSse.gps(double field0) =
