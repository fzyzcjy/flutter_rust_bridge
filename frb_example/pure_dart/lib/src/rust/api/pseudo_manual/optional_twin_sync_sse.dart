...
import 'package:flutter_rust_bridge/flutter_rust_bridge_for_generated.dart';
        ...
        double? handleOptionalReturnTwinSyncSse({required double left , required double right , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualOptionalTwinSyncSseHandleOptionalReturnTwinSyncSse(left: left, right: right, hint: hint);

ElementTwinSyncSse? handleOptionalStructTwinSyncSse({String? document , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualOptionalTwinSyncSseHandleOptionalStructTwinSyncSse(document: document, hint: hint);

ExoticOptionalsTwinSyncSse? handleOptionalIncrementTwinSyncSse({ExoticOptionalsTwinSyncSse? opt , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualOptionalTwinSyncSseHandleOptionalIncrementTwinSyncSse(opt: opt, hint: hint);

double handleIncrementBoxedOptionalTwinSyncSse({double? opt , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualOptionalTwinSyncSseHandleIncrementBoxedOptionalTwinSyncSse(opt: opt, hint: hint);

OptVecsTwinSyncSse handleVecOfOptsTwinSyncSse({required OptVecsTwinSyncSse opt , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualOptionalTwinSyncSseHandleVecOfOptsTwinSyncSse(opt: opt, hint: hint);

String handleOptionBoxArgumentsTwinSyncSse({int? i8Box , int? u8Box , int? i32Box , PlatformInt64? i64Box , double? f64Box , bool? boolbox , ExoticOptionalsTwinSyncSse? structbox , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualOptionalTwinSyncSseHandleOptionBoxArgumentsTwinSyncSse(i8Box: i8Box, u8Box: u8Box, i32Box: i32Box, i64Box: i64Box, f64Box: f64Box, boolbox: boolbox, structbox: structbox, hint: hint);
...
final List<ElementTwinSyncSse>? children;
                ...
                const ElementTwinSyncSse({this.tag ,this.text ,this.attributes ,this.children ,});
...
final NewTypeIntTwinSyncSse? newtypeint;
                ...
                const ExoticOptionalsTwinSyncSse({this.int32 ,this.int64 ,this.float64 ,this.boolean ,this.zerocopy ,this.int8List ,this.uint8List ,this.int32List ,this.float32List ,this.float64List ,this.attributes ,required this.attributesNullable ,this.nullableAttributes ,this.newtypeint ,});
...
final List<Int32List?> buffers;
                ...
                const OptVecsTwinSyncSse({required this.i32 ,required this.enums ,required this.strings ,required this.buffers ,});
