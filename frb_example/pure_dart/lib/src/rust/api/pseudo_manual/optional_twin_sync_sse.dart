...
import 'package:flutter_rust_bridge/flutter_rust_bridge_for_generated.dart';
        ...
        double? handleOptionalReturnTwinSyncSse({required double left , required double right , dynamic hint}) => RustLib.instance.api.handleOptionalReturnTwinSyncSse(left: left, right: right, hint: hint);

ElementTwinSyncSse? handleOptionalStructTwinSyncSse({String? document , dynamic hint}) => RustLib.instance.api.handleOptionalStructTwinSyncSse(document: document, hint: hint);

ExoticOptionalsTwinSyncSse? handleOptionalIncrementTwinSyncSse({ExoticOptionalsTwinSyncSse? opt , dynamic hint}) => RustLib.instance.api.handleOptionalIncrementTwinSyncSse(opt: opt, hint: hint);

double handleIncrementBoxedOptionalTwinSyncSse({double? opt , dynamic hint}) => RustLib.instance.api.handleIncrementBoxedOptionalTwinSyncSse(opt: opt, hint: hint);

OptVecsTwinSyncSse handleVecOfOptsTwinSyncSse({required OptVecsTwinSyncSse opt , dynamic hint}) => RustLib.instance.api.handleVecOfOptsTwinSyncSse(opt: opt, hint: hint);

String handleOptionBoxArgumentsTwinSyncSse({int? i8Box , int? u8Box , int? i32Box , int? i64Box , double? f64Box , bool? boolbox , ExoticOptionalsTwinSyncSse? structbox , dynamic hint}) => RustLib.instance.api.handleOptionBoxArgumentsTwinSyncSse(i8Box: i8Box, u8Box: u8Box, i32Box: i32Box, i64Box: i64Box, f64Box: f64Box, boolbox: boolbox, structbox: structbox, hint: hint);
