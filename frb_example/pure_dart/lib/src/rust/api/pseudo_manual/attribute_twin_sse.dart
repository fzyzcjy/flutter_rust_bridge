...
Future<UserIdTwinSse> nextUserIdTwinSse({UserIdTwinSse userId = const UserIdTwinSse(), dynamic hint}) => RustLib.instance.api.nextUserIdTwinSse(userId: userId, hint: hint);
