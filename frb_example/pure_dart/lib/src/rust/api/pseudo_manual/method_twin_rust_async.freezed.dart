...
/// Adds pattern-matching-related methods to [SimpleEnumTwinRustAsync].
extension SimpleEnumTwinRustAsyncPatterns on SimpleEnumTwinRustAsync {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    final _that = this;
    switch (_that) {
      case SimpleEnumTwinRustAsync_First() when first != null:
        return first(_that);
      case SimpleEnumTwinRustAsync_Second() when second != null:
        return second(_that);
      case _:
        return orElse();
    }
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case SimpleEnumTwinRustAsync_First():
        return first(_that);
      case SimpleEnumTwinRustAsync_Second():
        return second(_that);
    }
  }
