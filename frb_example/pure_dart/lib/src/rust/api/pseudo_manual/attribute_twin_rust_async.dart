...
Future<UserIdTwinRustAsync> nextUserIdTwinRustAsync({required UserIdTwinRustAsync userId , dynamic hint}) => RustLib.instance.api.nextUserIdTwinRustAsync(userId: userId, hint: hint);
