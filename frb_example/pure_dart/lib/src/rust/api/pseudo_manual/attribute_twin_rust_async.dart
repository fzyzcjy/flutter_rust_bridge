...
part 'attribute_twin_rust_async.freezed.dart';
        ...
        Future<void> handleCustomizedStructTwinRustAsync({required CustomizedTwinRustAsync val , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualAttributeTwinRustAsyncHandleCustomizedStructTwinRustAsync(val: val, hint: hint);

Future<UserIdTwinRustAsync> nextUserIdTwinRustAsync({UserIdTwinRustAsync userId = const UserIdTwinRustAsync(), dynamic hint}) => RustLib.instance.api.crateApiPseudoManualAttributeTwinRustAsyncNextUserIdTwinRustAsync(userId: userId, hint: hint);
