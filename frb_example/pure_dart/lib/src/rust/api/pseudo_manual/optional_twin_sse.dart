...
Future<String> handleOptionBoxArgumentsTwinSse(
        ...
        dynamic hint}) =>
    RustLib.instance.api.handleOptionBoxArgumentsTwinSse(
        i8Box: i8Box,
        u8Box: u8Box,
        i32Box: i32Box,
        i64Box: i64Box,
