...
import 'package:flutter_rust_bridge/flutter_rust_bridge_for_generated.dart';
        ...
        Future<double?> handleOptionalReturnTwinSse({required double left , required double right , dynamic hint}) => RustLib.instance.api.handleOptionalReturnTwinSse(left: left, right: right, hint: hint);

Future<ElementTwinSse?> handleOptionalStructTwinSse({String? document , dynamic hint}) => RustLib.instance.api.handleOptionalStructTwinSse(document: document, hint: hint);

Future<ExoticOptionalsTwinSse?> handleOptionalIncrementTwinSse({ExoticOptionalsTwinSse? opt , dynamic hint}) => RustLib.instance.api.handleOptionalIncrementTwinSse(opt: opt, hint: hint);

Future<double> handleIncrementBoxedOptionalTwinSse({double? opt , dynamic hint}) => RustLib.instance.api.handleIncrementBoxedOptionalTwinSse(opt: opt, hint: hint);

Future<OptVecsTwinSse> handleVecOfOptsTwinSse({required OptVecsTwinSse opt , dynamic hint}) => RustLib.instance.api.handleVecOfOptsTwinSse(opt: opt, hint: hint);

Future<String> handleOptionBoxArgumentsTwinSse({int? i8Box , int? u8Box , int? i32Box , int? i64Box , double? f64Box , bool? boolbox , ExoticOptionalsTwinSse? structbox , dynamic hint}) => RustLib.instance.api.handleOptionBoxArgumentsTwinSse(i8Box: i8Box, u8Box: u8Box, i32Box: i32Box, i64Box: i64Box, f64Box: f64Box, boolbox: boolbox, structbox: structbox, hint: hint);
