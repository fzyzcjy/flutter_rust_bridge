...
Int8List exampleBasicListTypeI8TwinSync({required List<int> arg}) => RustLib
    .instance
    .api
...
Int16List exampleBasicListTypeI16TwinSync({required List<int> arg}) => RustLib
    .instance
    .api
...
Int32List exampleBasicListTypeI32TwinSync({required List<int> arg}) => RustLib
    .instance
    .api
...
Int64List exampleBasicListTypeI64TwinSync({required Int64List arg}) => RustLib
    .instance
    .api
...
Uint8List exampleBasicListTypeU8TwinSync({required List<int> arg}) => RustLib
    .instance
    .api
...
Uint16List exampleBasicListTypeU16TwinSync({required List<int> arg}) => RustLib
    .instance
    .api
...
Uint32List exampleBasicListTypeU32TwinSync({required List<int> arg}) => RustLib
    .instance
    .api
...
Uint64List exampleBasicListTypeU64TwinSync({required Uint64List arg}) => RustLib
    .instance
    .api
