...
part 'misc_example_twin_sync_sse.freezed.dart';
        ...
        MyTreeNodeTwinSyncSse handleComplexStructTwinSyncSse({required MyTreeNodeTwinSyncSse s , dynamic hint}) => RustLib.instance.api.handleComplexStructTwinSyncSse(s: s, hint: hint);

List<WeekdaysTwinSyncSse> listOfPrimitiveEnumsTwinSyncSse({required List<WeekdaysTwinSyncSse> weekdays , dynamic hint}) => RustLib.instance.api.listOfPrimitiveEnumsTwinSyncSse(weekdays: weekdays, hint: hint);

MyNestedStructTwinSyncSse handleNestedStructTwinSyncSse({required MyNestedStructTwinSyncSse s , dynamic hint}) => RustLib.instance.api.handleNestedStructTwinSyncSse(s: s, hint: hint);

BigBuffersTwinSyncSse handleBigBuffersTwinSyncSse({dynamic hint}) => RustLib.instance.api.handleBigBuffersTwinSyncSse(hint: hint);

AbcTwinSyncSse testAbcEnumTwinSyncSse({required AbcTwinSyncSse abc , dynamic hint}) => RustLib.instance.api.testAbcEnumTwinSyncSse(abc: abc, hint: hint);

StructWithEnumTwinSyncSse testStructWithEnumTwinSyncSse({required StructWithEnumTwinSyncSse se , dynamic hint}) => RustLib.instance.api.testStructWithEnumTwinSyncSse(se: se, hint: hint);

String handleStringTwinSyncSse({required String s , dynamic hint}) => RustLib.instance.api.handleStringTwinSyncSse(s: s, hint: hint);

Uint8List handleVecU8TwinSyncSse({required Uint8List v , dynamic hint}) => RustLib.instance.api.handleVecU8TwinSyncSse(v: v, hint: hint);

MySize handleStructTwinSyncSse({required MySize arg , required MySize boxed , dynamic hint}) => RustLib.instance.api.handleStructTwinSyncSse(arg: arg, boxed: boxed, hint: hint);
