...
Future<MessageIdTwinSse> newMsgidTwinSse({required U8Array32 id}) => RustLib
    .instance
    .api
    .crateApiPseudoManualArrayTwinSseNewMsgidTwinSse(id: id);

Future<U8Array32> useMsgidTwinSse({required MessageIdTwinSse id}) => RustLib
    .instance
    .api
    .crateApiPseudoManualArrayTwinSseUseMsgidTwinSse(id: id);

Future<BlobTwinSse> boxedBlobTwinSse({required U8Array1600 blob}) => RustLib
    .instance
    .api
    .crateApiPseudoManualArrayTwinSseBoxedBlobTwinSse(blob: blob);

Future<U8Array1600> useBoxedBlobTwinSse({required BlobTwinSse blob}) => RustLib
    .instance
    .api
...
Future<TestIdTwinSse> funcTestIdTwinSse({required TestIdTwinSse id}) => RustLib
    .instance
    .api
    .crateApiPseudoManualArrayTwinSseFuncTestIdTwinSse(id: id);

Future<double> lastNumberTwinSse({required F64Array16 array}) => RustLib
    .instance
    .api
