...
part 'rust_auto_opaque_twin_sync.g.dart';
...
sealed class EnumWithGoodAndOpaqueTwinSync
  ...
  factory EnumWithGoodAndOpaqueTwinSync.fromJson(Map<String, dynamic> json) =>
      _$EnumWithGoodAndOpaqueTwinSyncFromJson(json);
}
