...
part 'misc_example_twin_rust_async.freezed.dart';
        ...
        Future<MyTreeNodeTwinRustAsync> handleComplexStructTwinRustAsync({required MyTreeNodeTwinRustAsync s , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualMiscExampleTwinRustAsyncHandleComplexStructTwinRustAsync(s: s, hint: hint);

Future<List<WeekdaysTwinRustAsync>> listOfPrimitiveEnumsTwinRustAsync({required List<WeekdaysTwinRustAsync> weekdays , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualMiscExampleTwinRustAsyncListOfPrimitiveEnumsTwinRustAsync(weekdays: weekdays, hint: hint);

Future<MyNestedStructTwinRustAsync> handleNestedStructTwinRustAsync({required MyNestedStructTwinRustAsync s , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualMiscExampleTwinRustAsyncHandleNestedStructTwinRustAsync(s: s, hint: hint);

Future<BigBuffersTwinRustAsync> handleBigBuffersTwinRustAsync({dynamic hint}) => RustLib.instance.api.crateApiPseudoManualMiscExampleTwinRustAsyncHandleBigBuffersTwinRustAsync(hint: hint);

Future<AbcTwinRustAsync> testAbcEnumTwinRustAsync({required AbcTwinRustAsync abc , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualMiscExampleTwinRustAsyncTestAbcEnumTwinRustAsync(abc: abc, hint: hint);

Future<StructWithEnumTwinRustAsync> testStructWithEnumTwinRustAsync({required StructWithEnumTwinRustAsync se , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualMiscExampleTwinRustAsyncTestStructWithEnumTwinRustAsync(se: se, hint: hint);

Future<String> handleStringTwinRustAsync({required String s , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualMiscExampleTwinRustAsyncHandleStringTwinRustAsync(s: s, hint: hint);

Future<String> handleCharTwinRustAsync({required String arg , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualMiscExampleTwinRustAsyncHandleCharTwinRustAsync(arg: arg, hint: hint);

Future<Uint8List> handleVecU8TwinRustAsync({required List<int> v , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualMiscExampleTwinRustAsyncHandleVecU8TwinRustAsync(v: v, hint: hint);

Future<MySize> handleStructTwinRustAsync({required MySize arg , required MySize boxed , dynamic hint}) => RustLib.instance.api.crateApiPseudoManualMiscExampleTwinRustAsyncHandleStructTwinRustAsync(arg: arg, boxed: boxed, hint: hint);
