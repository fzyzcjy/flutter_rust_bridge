...
Future<void> rustCallDartOptionalTwinRustAsync(
        {FutureOr<void> Function(String)? callback}) =>
    RustLib.instance.api
        .crateApiPseudoManualDartFnTwinRustAsyncRustCallDartOptionalTwinRustAsync(
            callback: callback);
...
Future<void> rustCallDartUsingIpv4AddrTwinRustAsync(
        {required FutureOr<InternetAddress> Function(InternetAddress)
            callback}) =>
    RustLib.instance.api
        .crateApiPseudoManualDartFnTwinRustAsyncRustCallDartUsingIpv4AddrTwinRustAsync(
            callback: callback);
