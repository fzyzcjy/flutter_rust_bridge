...
Future<int?> exampleBasicOptionalTypeI8TwinRustAsync({int? arg}) =>
    RustLib.instance.api
        .crateApiPseudoManualBasicOptionalTwinRustAsyncExampleBasicOptionalTypeI8TwinRustAsync(
      arg: arg,
    );

Future<int?> exampleBasicOptionalTypeI16TwinRustAsync({int? arg}) =>
    RustLib.instance.api
        .crateApiPseudoManualBasicOptionalTwinRustAsyncExampleBasicOptionalTypeI16TwinRustAsync(
      arg: arg,
    );

Future<int?> exampleBasicOptionalTypeI32TwinRustAsync({int? arg}) =>
    RustLib.instance.api
...
Future<int?> exampleBasicOptionalTypeU8TwinRustAsync({int? arg}) =>
    RustLib.instance.api
        .crateApiPseudoManualBasicOptionalTwinRustAsyncExampleBasicOptionalTypeU8TwinRustAsync(
      arg: arg,
    );

Future<int?> exampleBasicOptionalTypeU16TwinRustAsync({int? arg}) =>
    RustLib.instance.api
        .crateApiPseudoManualBasicOptionalTwinRustAsyncExampleBasicOptionalTypeU16TwinRustAsync(
      arg: arg,
    );

Future<int?> exampleBasicOptionalTypeU32TwinRustAsync({int? arg}) =>
    RustLib.instance.api
...
Future<bool?> exampleBasicOptionalTypeBoolTwinRustAsync({bool? arg}) =>
    RustLib.instance.api
