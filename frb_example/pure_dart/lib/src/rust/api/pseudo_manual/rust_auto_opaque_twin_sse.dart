...
Future<void> rustAutoOpaqueEnumWithGoodAndOpaqueArgOwnTwinSse({required EnumWithGoodAndOpaqueTwinSse arg , dynamic hint}) => RustLib.instance.api.rustAutoOpaqueEnumWithGoodAndOpaqueArgOwnTwinSse(arg: arg, hint: hint);

Future<EnumWithGoodAndOpaqueTwinSse> rustAutoOpaqueEnumWithGoodAndOpaqueReturnOwnGoodTwinSse({dynamic hint}) => RustLib.instance.api.rustAutoOpaqueEnumWithGoodAndOpaqueReturnOwnGoodTwinSse(hint: hint);

Future<EnumWithGoodAndOpaqueTwinSse> rustAutoOpaqueEnumWithGoodAndOpaqueReturnOwnOpaqueTwinSse({dynamic hint}) => RustLib.instance.api.rustAutoOpaqueEnumWithGoodAndOpaqueReturnOwnOpaqueTwinSse(hint: hint);

Future<void> rustAutoOpaqueDummyTwinSse({required StructWithGoodAndOpaqueFieldWithoutOptionTwinSse a , required EnumWithGoodAndOpaqueWithoutOptionTwinSse b , dynamic hint}) => RustLib.instance.api.rustAutoOpaqueDummyTwinSse(a: a, b: b, hint: hint);

Future<void> rustAutoOpaqueEnumArgBorrowTwinSse({required NonCloneSimpleEnumTwinSse arg , dynamic hint}) => RustLib.instance.api.rustAutoOpaqueEnumArgBorrowTwinSse(arg: arg, hint: hint);

Future<NonCloneSimpleEnumTwinSse> rustAutoOpaqueEnumReturnOwnTwinSse({dynamic hint}) => RustLib.instance.api.rustAutoOpaqueEnumReturnOwnTwinSse(hint: hint);

Stream<NonCloneSimpleTwinSse> rustAutoOpaqueStreamSinkTwinSse({dynamic hint}) => RustLib.instance.api.rustAutoOpaqueStreamSinkTwinSse(hint: hint);

Future<void> rustAutoOpaqueArgVecOwnTwinSse({required List<NonCloneSimpleTwinSse> arg , required List<int> expect , dynamic hint}) => RustLib.instance.api.rustAutoOpaqueArgVecOwnTwinSse(arg: arg, expect: expect, hint: hint);

Future<List<NonCloneSimpleTwinSse>> rustAutoOpaqueReturnVecOwnTwinSse({dynamic hint}) => RustLib.instance.api.rustAutoOpaqueReturnVecOwnTwinSse(hint: hint);

Future<void> rustAutoOpaqueExplicitArgTwinSse({required NonCloneSimpleTwinSse arg , required int expect , dynamic hint}) => RustLib.instance.api.rustAutoOpaqueExplicitArgTwinSse(arg: arg, expect: expect, hint: hint);

Future<void> rustAutoOpaqueExplicitStructTwinSse({required StructWithExplicitAutoOpaqueFieldTwinSse arg , dynamic hint}) => RustLib.instance.api.rustAutoOpaqueExplicitStructTwinSse(arg: arg, hint: hint);

Future<NonCloneSimpleTwinSse> rustAutoOpaqueExplicitReturnTwinSse({required int initial , dynamic hint}) => RustLib.instance.api.rustAutoOpaqueExplicitReturnTwinSse(initial: initial, hint: hint);

Future<int> rustAutoOpaqueSleepTwinSse({required NonCloneSimpleTwinSse apple , required NonCloneSimpleTwinSse orange , dynamic hint}) => RustLib.instance.api.rustAutoOpaqueSleepTwinSse(apple: apple, orange: orange, hint: hint);

Future<(OpaqueOneTwinSse,OpaqueTwoTwinSse)> rustAutoOpaqueReturnOpaqueOneAndTwoTwinSse({dynamic hint}) => RustLib.instance.api.rustAutoOpaqueReturnOpaqueOneAndTwoTwinSse(hint: hint);

Future<OpaqueTwoTwinSse> rustAutoOpaqueReturnOpaqueTwoTwinSse({dynamic hint}) => RustLib.instance.api.rustAutoOpaqueReturnOpaqueTwoTwinSse(hint: hint);

Future<int> rustAutoOpaqueBorrowAndMutBorrowTwinSse({required NonCloneSimpleTwinSse borrow , required NonCloneSimpleTwinSse mutBorrow , dynamic hint}) => RustLib.instance.api.rustAutoOpaqueBorrowAndMutBorrowTwinSse(borrow: borrow, mutBorrow: mutBorrow, hint: hint);

Future<int> rustAutoOpaqueBorrowAndBorrowTwinSse({required NonCloneSimpleTwinSse a , required NonCloneSimpleTwinSse b , dynamic hint}) => RustLib.instance.api.rustAutoOpaqueBorrowAndBorrowTwinSse(a: a, b: b, hint: hint);
            ...
            @sealed class EnumWithGoodAndOpaqueWithoutOptionTwinSse extends RustOpaque {
                ...
                EnumWithGoodAndOpaqueWithoutOptionTwinSse.sseDecode(int ptr, int externalSizeOnNative):
                    super.sseDecode(ptr, externalSizeOnNative, _kStaticData);
            ...
            @sealed class NonCloneSimpleTwinSse extends RustOpaque {
                ...
                static final _kStaticData = RustArcStaticData(
                 ...
                 Future<void>  instanceMethodArgBorrowTwinSse({ dynamic hint })=>RustLib.instance.api.nonCloneSimpleTwinSseInstanceMethodArgBorrowTwinSse(that: this, hint: hint);


 Future<void>  instanceMethodArgMutBorrowTwinSse({ dynamic hint })=>RustLib.instance.api.nonCloneSimpleTwinSseInstanceMethodArgMutBorrowTwinSse(that: this, hint: hint);


 Future<void>  instanceMethodArgOwnTwinSse({ dynamic hint })=>RustLib.instance.api.nonCloneSimpleTwinSseInstanceMethodArgOwnTwinSse(that: this, hint: hint);


 Future<int> get instanceMethodGetterTwinSse=>RustLib.instance.api.nonCloneSimpleTwinSseInstanceMethodGetterTwinSse(that: this, );


 Future<NonCloneSimpleTwinSse>  instanceMethodReturnOwnTwinSse({ dynamic hint })=>RustLib.instance.api.nonCloneSimpleTwinSseInstanceMethodReturnOwnTwinSse(that: this, hint: hint);
...
static Future<NonCloneSimpleTwinSse>  staticMethodReturnOwnTwinSse({ dynamic hint })=>RustLib.instance.api.nonCloneSimpleTwinSseStaticMethodReturnOwnTwinSse(hint: hint);
            ...
            @sealed class StructWithGoodAndOpaqueFieldWithoutOptionTwinSse extends RustOpaque {
                ...
                StructWithGoodAndOpaqueFieldWithoutOptionTwinSse.sseDecode(int ptr, int externalSizeOnNative):
                    super.sseDecode(ptr, externalSizeOnNative, _kStaticData);
