...
UserIdTwinSyncSse nextUserIdTwinSyncSse({required UserIdTwinSyncSse userId , dynamic hint}) => RustLib.instance.api.nextUserIdTwinSyncSse(userId: userId, hint: hint);
