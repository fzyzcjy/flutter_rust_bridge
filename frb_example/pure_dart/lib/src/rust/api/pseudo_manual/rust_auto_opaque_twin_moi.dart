...
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `PrivateOpaqueFieldInnerTwinMoi`, `RestrictedOpaqueFieldInnerTwinMoi`
...
// Rust type: RustOpaqueNom<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<OpaqueWithPrivateFieldTwinMoi>>
abstract class OpaqueWithPrivateFieldTwinMoi implements RustOpaqueInterface {
  static Future<OpaqueWithPrivateFieldTwinMoi> newTwinMoi(
          {required String value}) =>
      RustLib.instance.api
          .crateApiPseudoManualRustAutoOpaqueTwinMoiOpaqueWithPrivateFieldTwinMoiNewTwinMoi(
              value: value);

  Future<String> readTwinMoi();
}
