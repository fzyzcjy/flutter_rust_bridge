...
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `PrivateOpaqueFieldInnerTwinNormal`, `RestrictedOpaqueFieldInnerTwinNormal`
...
// Rust type: RustOpaqueNom<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<OpaqueWithPrivateFieldTwinNormal>>
abstract class OpaqueWithPrivateFieldTwinNormal implements RustOpaqueInterface {
  static Future<OpaqueWithPrivateFieldTwinNormal> newTwinNormal(
          {required String value}) =>
      RustLib.instance.api
          .crateApiRustAutoOpaqueOpaqueWithPrivateFieldTwinNormalNewTwinNormal(
              value: value);

  Future<String> readTwinNormal();
}
