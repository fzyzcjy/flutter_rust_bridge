...
extension ApplicationMessagePatterns on ApplicationMessage {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    final _that = this;
    switch (_that) {
      case ApplicationMessage_DisplayMessage() when displayMessage != null:
        return displayMessage(_that);
      case ApplicationMessage_RenderPixel() when renderPixel != null:
        return renderPixel(_that);
      case ApplicationMessage_Exit() when exit != null:
        return exit(_that);
      case _:
        return orElse();
    }
  ...
  TResult map<TResult extends Object?>({
    ...
    final _that = this;
    switch (_that) {
      case ApplicationMessage_DisplayMessage():
        return displayMessage(_that);
      case ApplicationMessage_RenderPixel():
        return renderPixel(_that);
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case ApplicationMessage_DisplayMessage() when displayMessage != null:
        return displayMessage(_that.field0);
      case ApplicationMessage_RenderPixel() when renderPixel != null:
        return renderPixel(_that.x, _that.y);
      case ApplicationMessage_Exit() when exit != null:
        return exit();
      case _:
        return orElse();
...
/// Adds pattern-matching-related methods to [RawStringEnumMirrored].
extension RawStringEnumMirroredPatterns on RawStringEnumMirrored {
  /// A variant of `map` that fallback to returning `orElse`.
  ///
  /// It is equivalent to doing:
  /// ```dart
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    final _that = this;
    switch (_that) {
      case RawStringEnumMirrored_Raw() when raw != null:
        return raw(_that);
      case RawStringEnumMirrored_Nested() when nested != null:
        return nested(_that);
      case RawStringEnumMirrored_ListOfNested() when listOfNested != null:
        return listOfNested(_that);
      case _:
        return orElse();
    }
  }
  ...
  TResult map<TResult extends Object?>({
    ...
    final _that = this;
    switch (_that) {
      case RawStringEnumMirrored_Raw():
        return raw(_that);
      case RawStringEnumMirrored_Nested():
        return nested(_that);
      case RawStringEnumMirrored_ListOfNested():
        return listOfNested(_that);
    }
  }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case RawStringEnumMirrored_Raw() when raw != null:
        return raw(_that.field0);
      case RawStringEnumMirrored_Nested() when nested != null:
        return nested(_that.field0);
      case RawStringEnumMirrored_ListOfNested() when listOfNested != null:
        return listOfNested(_that.field0);
      case _:
        return orElse();
    }
  }
