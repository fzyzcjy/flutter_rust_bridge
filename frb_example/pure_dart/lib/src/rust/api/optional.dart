...
import 'package:flutter_rust_bridge/flutter_rust_bridge_for_generated.dart';
        ...
        Future<double?> handleOptionalReturnTwinNormal({required double left , required double right , dynamic hint}) => RustLib.instance.api.crateApiOptionalHandleOptionalReturnTwinNormal(left: left, right: right, hint: hint);

Future<ElementTwinNormal?> handleOptionalStructTwinNormal({String? document , dynamic hint}) => RustLib.instance.api.crateApiOptionalHandleOptionalStructTwinNormal(document: document, hint: hint);

Future<ExoticOptionalsTwinNormal?> handleOptionalIncrementTwinNormal({ExoticOptionalsTwinNormal? opt , dynamic hint}) => RustLib.instance.api.crateApiOptionalHandleOptionalIncrementTwinNormal(opt: opt, hint: hint);

Future<double> handleIncrementBoxedOptionalTwinNormal({double? opt , dynamic hint}) => RustLib.instance.api.crateApiOptionalHandleIncrementBoxedOptionalTwinNormal(opt: opt, hint: hint);

Future<OptVecsTwinNormal> handleVecOfOptsTwinNormal({required OptVecsTwinNormal opt , dynamic hint}) => RustLib.instance.api.crateApiOptionalHandleVecOfOptsTwinNormal(opt: opt, hint: hint);

Future<String> handleOptionBoxArgumentsTwinNormal({int? i8Box , int? u8Box , int? i32Box , PlatformInt64? i64Box , double? f64Box , bool? boolbox , ExoticOptionalsTwinNormal? structbox , dynamic hint}) => RustLib.instance.api.crateApiOptionalHandleOptionBoxArgumentsTwinNormal(i8Box: i8Box, u8Box: u8Box, i32Box: i32Box, i64Box: i64Box, f64Box: f64Box, boolbox: boolbox, structbox: structbox, hint: hint);
