...
Future<SumWithTwinNormalArray3> getSumArrayTwinNormal({required int a , required int b , required int c , dynamic hint}) => RustLib.instance.api.getSumArrayTwinNormal(a: a, b: b, c: c, hint: hint);
 ...
 Future<String> concatenateTwinNormal({ required String b ,dynamic hint })=>RustLib.instance.api.concatenateWithTwinNormalConcatenateTwinNormal(that: this, b:b,);
...
static Stream<Log2TwinNormal> handleSomeStaticStreamSinkTwinNormal({ required int key ,required int max ,dynamic hint })=>RustLib.instance.api.concatenateWithTwinNormalHandleSomeStaticStreamSinkTwinNormal(key:key,max:max,hint: hint);
 ...
 Stream<int> handleSomeStreamSinkAt1TwinNormal({ dynamic hint })=>RustLib.instance.api.concatenateWithTwinNormalHandleSomeStreamSinkAt1TwinNormal(that: this, );


 Stream<Log2TwinNormal> handleSomeStreamSinkTwinNormal({ required int key ,required int max ,dynamic hint })=>RustLib.instance.api.concatenateWithTwinNormalHandleSomeStreamSinkTwinNormal(that: this, key:key,max:max,);
...
class SumWithTwinNormal  {
                ...
                const SumWithTwinNormal({required this.x ,});
                 ...
                 Future<int> sumTwinNormal({ required int y ,required int z ,dynamic hint })=>RustLib.instance.api.sumWithTwinNormalSumTwinNormal(that: this, y:y,z:z,);
