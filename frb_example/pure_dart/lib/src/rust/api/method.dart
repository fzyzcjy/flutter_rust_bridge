...
Future<SumWithTwinNormal> getSumStructTwinNormal({dynamic hint}) =>
    RustLib.instance.api.crateApiMethodGetSumStructTwinNormal(hint: hint);

Future<SumWithTwinNormalArray3> getSumArrayTwinNormal(
        {required int a, required int b, required int c, dynamic hint}) =>
    RustLib.instance.api
        .crateApiMethodGetSumArrayTwinNormal(a: a, b: b, c: c, hint: hint);
...
class ConcatenateWithTwinNormal {
  ...
  Stream<int> handleSomeStreamSinkAt1TwinNormal({dynamic hint}) => RustLib
      .instance.api
  ...
  static Future<ConcatenateWithTwinNormal> newTwinNormal(
      ...
      RustLib.instance.api.crateApiMethodConcatenateWithTwinNormalNewTwinNormal(
          a: a, hint: hint);
...
class MyCallableTwinNormal {
  ...
  Future<String> call({required String two, dynamic hint}) => RustLib
      .instance.api
      .crateApiMethodMyCallableTwinNormalCall(that: this, two: two, hint: hint);
...
enum SimplePrimitiveEnumTwinNormal {
  ...
  Future<int> simpleMethodTwinNormal({dynamic hint}) => RustLib.instance.api
...
class SimpleStructTwinNormal {
  ...
  static Future<String> argSelfTwinNormal(
          ...
          dynamic hint}) =>
      RustLib.instance.api
          .crateApiMethodSimpleStructTwinNormalArgSelfTwinNormal(
              a: a, b: b, hint: hint);

  Future<String> receiverBorrowTwinNormal({dynamic hint}) =>
      RustLib.instance.api
  ...
  static Future<List<String>> vecSelfTwinNormal(
      ...
      RustLib.instance.api
          .crateApiMethodSimpleStructTwinNormalVecSelfTwinNormal(
              arg: arg, hint: hint);
...
class StaticOnlyTwinNormal {
  ...
  static Future<int> staticMethodTwinNormal({required int a, dynamic hint}) =>
      RustLib.instance.api
          .crateApiMethodStaticOnlyTwinNormalStaticMethodTwinNormal(
              a: a, hint: hint);
...
class SumWithTwinNormal {
  ...
  Future<int> sumTwinNormal({required int y, required int z, dynamic hint}) =>
      RustLib.instance.api.crateApiMethodSumWithTwinNormalSumTwinNormal(
