...
part 'misc_example.freezed.dart';
        ...
        Future<MyTreeNodeTwinNormal> handleComplexStructTwinNormal({required MyTreeNodeTwinNormal s , dynamic hint}) => RustLib.instance.api.crateApiMiscExampleHandleComplexStructTwinNormal(s: s, hint: hint);

Future<List<WeekdaysTwinNormal>> listOfPrimitiveEnumsTwinNormal({required List<WeekdaysTwinNormal> weekdays , dynamic hint}) => RustLib.instance.api.crateApiMiscExampleListOfPrimitiveEnumsTwinNormal(weekdays: weekdays, hint: hint);

Future<MyNestedStructTwinNormal> handleNestedStructTwinNormal({required MyNestedStructTwinNormal s , dynamic hint}) => RustLib.instance.api.crateApiMiscExampleHandleNestedStructTwinNormal(s: s, hint: hint);

Future<BigBuffersTwinNormal> handleBigBuffersTwinNormal({dynamic hint}) => RustLib.instance.api.crateApiMiscExampleHandleBigBuffersTwinNormal(hint: hint);

Future<AbcTwinNormal> testAbcEnumTwinNormal({required AbcTwinNormal abc , dynamic hint}) => RustLib.instance.api.crateApiMiscExampleTestAbcEnumTwinNormal(abc: abc, hint: hint);

Future<StructWithEnumTwinNormal> testStructWithEnumTwinNormal({required StructWithEnumTwinNormal se , dynamic hint}) => RustLib.instance.api.crateApiMiscExampleTestStructWithEnumTwinNormal(se: se, hint: hint);

Future<String> handleStringTwinNormal({required String s , dynamic hint}) => RustLib.instance.api.crateApiMiscExampleHandleStringTwinNormal(s: s, hint: hint);

Future<String> handleCharTwinNormal({required String arg , dynamic hint}) => RustLib.instance.api.crateApiMiscExampleHandleCharTwinNormal(arg: arg, hint: hint);

Future<Uint8List> handleVecU8TwinNormal({required List<int> v , dynamic hint}) => RustLib.instance.api.crateApiMiscExampleHandleVecU8TwinNormal(v: v, hint: hint);

Future<MySize> handleStructTwinNormal({required MySize arg , required MySize boxed , dynamic hint}) => RustLib.instance.api.crateApiMiscExampleHandleStructTwinNormal(arg: arg, boxed: boxed, hint: hint);
