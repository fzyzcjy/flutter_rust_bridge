...
part 'misc_example.freezed.dart';
        ...
        Future<MyTreeNodeTwinNormal> handleComplexStructTwinNormal({required MyTreeNodeTwinNormal s , dynamic hint}) => RustLib.instance.api.handleComplexStructTwinNormal(s: s, hint: hint);

Future<List<WeekdaysTwinNormal>> listOfPrimitiveEnumsTwinNormal({required List<WeekdaysTwinNormal> weekdays , dynamic hint}) => RustLib.instance.api.listOfPrimitiveEnumsTwinNormal(weekdays: weekdays, hint: hint);

Future<MyNestedStructTwinNormal> handleNestedStructTwinNormal({required MyNestedStructTwinNormal s , dynamic hint}) => RustLib.instance.api.handleNestedStructTwinNormal(s: s, hint: hint);

Future<BigBuffersTwinNormal> handleBigBuffersTwinNormal({dynamic hint}) => RustLib.instance.api.handleBigBuffersTwinNormal(hint: hint);

Future<AbcTwinNormal> testAbcEnumTwinNormal({required AbcTwinNormal abc , dynamic hint}) => RustLib.instance.api.testAbcEnumTwinNormal(abc: abc, hint: hint);

Future<StructWithEnumTwinNormal> testStructWithEnumTwinNormal({required StructWithEnumTwinNormal se , dynamic hint}) => RustLib.instance.api.testStructWithEnumTwinNormal(se: se, hint: hint);

Future<String> handleStringTwinNormal({required String s , dynamic hint}) => RustLib.instance.api.handleStringTwinNormal(s: s, hint: hint);

Future<Uint8List> handleVecU8TwinNormal({required Uint8List v , dynamic hint}) => RustLib.instance.api.handleVecU8TwinNormal(v: v, hint: hint);

Future<MySize> handleStructTwinNormal({required MySize arg , required MySize boxed , dynamic hint}) => RustLib.instance.api.handleStructTwinNormal(arg: arg, boxed: boxed, hint: hint);
