...
Future<UserIdTwinNormal> nextUserIdTwinNormal({required UserIdTwinNormal userId , dynamic hint}) => RustLib.instance.api.nextUserIdTwinNormal(userId: userId, hint: hint);
