...
// The type `__external_impl__53696d706c655472616e736c617461626c6545787465726e616c537472756374576974684d6574686f64` is not used by any `pub` functions, thus it is ignored.
            ...
            @sealed class SimpleOpaqueExternalStructWithMethod extends RustOpaque {
                ...
                SimpleOpaqueExternalStructWithMethod.sseDecode(int ptr, int externalSizeOnNative):
                ...
                factory SimpleOpaqueExternalStructWithMethod({ required String a ,dynamic hint })=>RustLib.instance.api.simpleOpaqueExternalStructWithMethodNew(a: a, hint: hint);


 Future<String>  simpleExternalMethod({ dynamic hint })=>RustLib.instance.api.simpleOpaqueExternalStructWithMethodSimpleExternalMethod(that: this, hint: hint);
...
class SimpleTranslatableExternalStructWithMethod  {
                ...
                const SimpleTranslatableExternalStructWithMethod({required this.a ,});
                 ...
                 Future<String>  simpleExternalMethod({ dynamic hint })=>RustLib.instance.api.simpleTranslatableExternalStructWithMethodSimpleExternalMethod(that: this, hint: hint);
