...
part 'enumeration.freezed.dart';
        ...
        Future<EnumSimpleTwinNormal> funcEnumSimpleTwinNormal({required EnumSimpleTwinNormal arg , dynamic hint}) => RustLib.instance.api.crateApiEnumerationFuncEnumSimpleTwinNormal(arg: arg, hint: hint);

Future<EnumWithItemMixedTwinNormal> funcEnumWithItemMixedTwinNormal({required EnumWithItemMixedTwinNormal arg , dynamic hint}) => RustLib.instance.api.crateApiEnumerationFuncEnumWithItemMixedTwinNormal(arg: arg, hint: hint);

Future<EnumWithItemTupleTwinNormal> funcEnumWithItemTupleTwinNormal({required EnumWithItemTupleTwinNormal arg , dynamic hint}) => RustLib.instance.api.crateApiEnumerationFuncEnumWithItemTupleTwinNormal(arg: arg, hint: hint);

Future<EnumWithItemStructTwinNormal> funcEnumWithItemStructTwinNormal({required EnumWithItemStructTwinNormal arg , dynamic hint}) => RustLib.instance.api.crateApiEnumerationFuncEnumWithItemStructTwinNormal(arg: arg, hint: hint);

Future<EnumWithDiscriminantTwinNormal> funcEnumWithDiscriminantTwinNormal({required EnumWithDiscriminantTwinNormal arg , dynamic hint}) => RustLib.instance.api.crateApiEnumerationFuncEnumWithDiscriminantTwinNormal(arg: arg, hint: hint);

Future<Uint8List> printNoteTwinNormal({required NoteTwinNormal note , dynamic hint}) => RustLib.instance.api.crateApiEnumerationPrintNoteTwinNormal(note: note, hint: hint);

Future<WeekdaysTwinNormal?> handleReturnEnumTwinNormal({required String input , dynamic hint}) => RustLib.instance.api.crateApiEnumerationHandleReturnEnumTwinNormal(input: input, hint: hint);

Future<WeekdaysTwinNormal> handleEnumParameterTwinNormal({required WeekdaysTwinNormal weekday , dynamic hint}) => RustLib.instance.api.crateApiEnumerationHandleEnumParameterTwinNormal(weekday: weekday, hint: hint);

Future<MeasureTwinNormal?> multiplyByTenTwinNormal({required MeasureTwinNormal measure , dynamic hint}) => RustLib.instance.api.crateApiEnumerationMultiplyByTenTwinNormal(measure: measure, hint: hint);

Future<KitchenSinkTwinNormal> handleEnumStructTwinNormal({required KitchenSinkTwinNormal val , dynamic hint}) => RustLib.instance.api.crateApiEnumerationHandleEnumStructTwinNormal(val: val, hint: hint);
