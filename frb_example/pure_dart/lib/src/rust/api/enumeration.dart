...
part 'enumeration.freezed.dart';
        ...
        Future<EnumSimpleTwinNormal> funcEnumSimpleTwinNormal({required EnumSimpleTwinNormal arg , dynamic hint}) => RustLib.instance.api.funcEnumSimpleTwinNormal(arg: arg, hint: hint);

Future<EnumWithItemMixedTwinNormal> funcEnumWithItemMixedTwinNormal({required EnumWithItemMixedTwinNormal arg , dynamic hint}) => RustLib.instance.api.funcEnumWithItemMixedTwinNormal(arg: arg, hint: hint);

Future<EnumWithItemTupleTwinNormal> funcEnumWithItemTupleTwinNormal({required EnumWithItemTupleTwinNormal arg , dynamic hint}) => RustLib.instance.api.funcEnumWithItemTupleTwinNormal(arg: arg, hint: hint);

Future<EnumWithItemStructTwinNormal> funcEnumWithItemStructTwinNormal({required EnumWithItemStructTwinNormal arg , dynamic hint}) => RustLib.instance.api.funcEnumWithItemStructTwinNormal(arg: arg, hint: hint);

Future<EnumWithDiscriminantTwinNormal> funcEnumWithDiscriminantTwinNormal({required EnumWithDiscriminantTwinNormal arg , dynamic hint}) => RustLib.instance.api.funcEnumWithDiscriminantTwinNormal(arg: arg, hint: hint);

Future<Uint8List> printNoteTwinNormal({required NoteTwinNormal note , dynamic hint}) => RustLib.instance.api.printNoteTwinNormal(note: note, hint: hint);

Future<WeekdaysTwinNormal?> handleReturnEnumTwinNormal({required String input , dynamic hint}) => RustLib.instance.api.handleReturnEnumTwinNormal(input: input, hint: hint);

Future<WeekdaysTwinNormal> handleEnumParameterTwinNormal({required WeekdaysTwinNormal weekday , dynamic hint}) => RustLib.instance.api.handleEnumParameterTwinNormal(weekday: weekday, hint: hint);

Future<MeasureTwinNormal?> multiplyByTenTwinNormal({required MeasureTwinNormal measure , dynamic hint}) => RustLib.instance.api.multiplyByTenTwinNormal(measure: measure, hint: hint);

Future<KitchenSinkTwinNormal> handleEnumStructTwinNormal({required KitchenSinkTwinNormal val , dynamic hint}) => RustLib.instance.api.handleEnumStructTwinNormal(val: val, hint: hint);
