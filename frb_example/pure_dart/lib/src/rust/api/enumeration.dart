...
Future<EnumSimpleTwinNormal> funcEnumSimpleTwinNormal(
    ...
    RustLib.instance.api
        .crateApiEnumerationFuncEnumSimpleTwinNormal(arg: arg, hint: hint);
...
Future<EnumWithDiscriminantTwinNormal> funcEnumWithDiscriminantTwinNormal(
    ...
    RustLib.instance.api.crateApiEnumerationFuncEnumWithDiscriminantTwinNormal(
        arg: arg, hint: hint);

Future<Uint8List> printNoteTwinNormal(
        {required NoteTwinNormal note, dynamic hint}) =>
    RustLib.instance.api
        .crateApiEnumerationPrintNoteTwinNormal(note: note, hint: hint);
...
Future<KitchenSinkTwinNormal> handleEnumStructTwinNormal(
    ...
    RustLib.instance.api
        .crateApiEnumerationHandleEnumStructTwinNormal(val: val, hint: hint);
