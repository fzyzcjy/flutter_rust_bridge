...
class RustLibWire extends BaseWire {
  ...
  void wire_boxed_blob(UNKNOWN port_, UNKNOWN blob) =>
      wasmModule.wire_boxed_blob(port_, blob);

  void wire_func_test_id(UNKNOWN port_, UNKNOWN id) =>
      wasmModule.wire_func_test_id(port_, id);

  void wire_get_array(UNKNOWN port_) => wasmModule.wire_get_array(port_);

  void wire_get_complex_array(UNKNOWN port_) =>
      wasmModule.wire_get_complex_array(port_);

  void wire_last_number(UNKNOWN port_, UNKNOWN array) =>
      wasmModule.wire_last_number(port_, array);

  void wire_nested_id(UNKNOWN port_, UNKNOWN id) =>
      wasmModule.wire_nested_id(port_, id);

  void wire_new_msgid(UNKNOWN port_, UNKNOWN id) =>
      wasmModule.wire_new_msgid(port_, id);

  void wire_return_boxed_feed_id(UNKNOWN port_, UNKNOWN id) =>
      wasmModule.wire_return_boxed_feed_id(port_, id);

  void wire_return_boxed_raw_feed_id(UNKNOWN port_, UNKNOWN id) =>
      wasmModule.wire_return_boxed_raw_feed_id(port_, id);

  void wire_use_boxed_blob(UNKNOWN port_, UNKNOWN blob) =>
      wasmModule.wire_use_boxed_blob(port_, blob);

  void wire_use_msgid(UNKNOWN port_, UNKNOWN id) =>
  ...
  void wire_next_user_id(UNKNOWN port_, UNKNOWN user_id) =>
      wasmModule.wire_next_user_id(port_, user_id);

  void wire_datetime_local(UNKNOWN port_, UNKNOWN d) =>
      wasmModule.wire_datetime_local(port_, d);

  void wire_datetime_utc(UNKNOWN port_, UNKNOWN d) =>
      wasmModule.wire_datetime_utc(port_, d);

  void wire_duration(UNKNOWN port_, UNKNOWN d) =>
  ...
  void wire_handle_timestamps(
          UNKNOWN port_, UNKNOWN timestamps, UNKNOWN epoch) =>
      wasmModule.wire_handle_timestamps(port_, timestamps, epoch);

  void wire_how_long_does_it_take(UNKNOWN port_, UNKNOWN mine) =>
      wasmModule.wire_how_long_does_it_take(port_, mine);

  void wire_naivedatetime(UNKNOWN port_, UNKNOWN d) =>
  ...
  void wire_return_dart_dynamic(UNKNOWN port_) =>
  ...
  void wire_create_nested_dart_opaque(
          UNKNOWN port_, UNKNOWN opaque1, UNKNOWN opaque2) =>
      wasmModule.wire_create_nested_dart_opaque(port_, opaque1, opaque2);

  void wire_drop_static_dart_opaque(UNKNOWN port_) =>
      wasmModule.wire_drop_static_dart_opaque(port_);

  void wire_get_enum_dart_opaque(UNKNOWN port_, UNKNOWN opaque) =>
  ...
  void wire_loop_back(UNKNOWN port_, UNKNOWN opaque) =>
      wasmModule.wire_loop_back(port_, opaque);

  void wire_loop_back_array(UNKNOWN port_, UNKNOWN opaque) =>
      wasmModule.wire_loop_back_array(port_, opaque);

  void wire_loop_back_array_get(UNKNOWN port_, UNKNOWN opaque) =>
      wasmModule.wire_loop_back_array_get(port_, opaque);

  void wire_loop_back_option(UNKNOWN port_, UNKNOWN opaque) =>
      wasmModule.wire_loop_back_option(port_, opaque);

  void wire_loop_back_option_get(UNKNOWN port_, UNKNOWN opaque) =>
      wasmModule.wire_loop_back_option_get(port_, opaque);

  void wire_loop_back_vec(UNKNOWN port_, UNKNOWN opaque) =>
      wasmModule.wire_loop_back_vec(port_, opaque);

  void wire_loop_back_vec_get(UNKNOWN port_, UNKNOWN opaque) =>
  ...
  void wire_handle_return_enum(UNKNOWN port_, UNKNOWN input) =>
      wasmModule.wire_handle_return_enum(port_, input);

  void wire_multiply_by_ten(UNKNOWN port_, UNKNOWN measure) =>
      wasmModule.wire_multiply_by_ten(port_, measure);

  void wire_print_note(UNKNOWN port_, UNKNOWN note) =>
      wasmModule.wire_print_note(port_, note);

  void wire_Event_as_string(UNKNOWN port_, UNKNOWN that) =>
      wasmModule.wire_Event_as_string(port_, that);

  void wire_close_event_listener(UNKNOWN port_) =>
  ...
  void wire_register_event_listener(UNKNOWN port_) =>
  ...
  void wire_func_return_error_twin_normal(UNKNOWN port_) =>
  ...
  void wire_call_new_module_system(UNKNOWN port_) =>
      wasmModule.wire_call_new_module_system(port_);

  void wire_call_old_module_system(UNKNOWN port_) =>
      wasmModule.wire_call_old_module_system(port_);

  void wire_use_imported_enum(UNKNOWN port_, UNKNOWN my_enum) =>
  ...
  void wire_ConcatenateWith_handle_some_stream_sink(
          UNKNOWN port_, UNKNOWN that, UNKNOWN key, UNKNOWN max) =>
  ...
  void wire_ConcatenateWith_new(UNKNOWN port_, UNKNOWN a) =>
  ...
  void wire_get_sum_struct(UNKNOWN port_) =>
      wasmModule.wire_get_sum_struct(port_);

  void wire_app_settings_stream(UNKNOWN port_) =>
      wasmModule.wire_app_settings_stream(port_);

  void wire_app_settings_vec_stream(UNKNOWN port_) =>
      wasmModule.wire_app_settings_vec_stream(port_);

  void wire_first_number(UNKNOWN port_, UNKNOWN nums) =>
      wasmModule.wire_first_number(port_, nums);

  void wire_first_sequence(UNKNOWN port_, UNKNOWN seqs) =>
      wasmModule.wire_first_sequence(port_, seqs);

  void wire_get_app_settings(UNKNOWN port_) =>
      wasmModule.wire_get_app_settings(port_);

  void wire_get_fallible_app_settings(UNKNOWN port_) =>
  ...
  void wire_mirror_struct_stream(UNKNOWN port_) =>
      wasmModule.wire_mirror_struct_stream(port_);

  void wire_mirror_tuple_stream(UNKNOWN port_) =>
  ...
  void wire_test_nested_raw_string_mirrored(UNKNOWN port_) =>
  ...
  void wire_test_raw_string_mirrored(UNKNOWN port_) =>
      wasmModule.wire_test_raw_string_mirrored(port_);

  void wire_handle_big_buffers(UNKNOWN port_) =>
      wasmModule.wire_handle_big_buffers(port_);

  void wire_handle_complex_struct(UNKNOWN port_, UNKNOWN s) =>
      wasmModule.wire_handle_complex_struct(port_, s);

  void wire_handle_nested_struct(UNKNOWN port_, UNKNOWN s) =>
  ...
  void wire_test_abc_enum(UNKNOWN port_, UNKNOWN abc) =>
      wasmModule.wire_test_abc_enum(port_, abc);

  void wire_test_struct_with_enum(UNKNOWN port_, UNKNOWN se) =>
      wasmModule.wire_test_struct_with_enum(port_, se);

  void wire_func_return_unit_twin_normal(UNKNOWN port_) =>
      wasmModule.wire_func_return_unit_twin_normal(port_);

  void wire_func_string_twin_normal(UNKNOWN port_, UNKNOWN arg) =>
      wasmModule.wire_func_string_twin_normal(port_, arg);

  void wire_handle_list_of_struct(UNKNOWN port_, UNKNOWN l) =>
      wasmModule.wire_handle_list_of_struct(port_, l);

  void wire_handle_string_list(UNKNOWN port_, UNKNOWN names) =>
      wasmModule.wire_handle_string_list(port_, names);

  void wire_handle_newtype(UNKNOWN port_, UNKNOWN arg) =>
  ...
  void wire_handle_optional_return(
          UNKNOWN port_, UNKNOWN left, UNKNOWN right) =>
  ...
  void wire_handle_vec_of_opts(UNKNOWN port_, UNKNOWN opt) =>
  ...
  void wire_unwrap_rust_opaque(UNKNOWN port_, UNKNOWN opaque) =>
      wasmModule.wire_unwrap_rust_opaque(port_, opaque);

  void wire_frb_sync_generator_test(UNKNOWN port_) =>
  ...
  void wire_handle_stream_of_struct(UNKNOWN port_) =>
  ...
  void wire_test_tuple(UNKNOWN port_, UNKNOWN value) =>
      wasmModule.wire_test_tuple(port_, value);

  void wire_test_tuple_2(UNKNOWN port_, UNKNOWN value) =>
      wasmModule.wire_test_tuple_2(port_, value);

  void wire_handle_type_alias_id(UNKNOWN port_, UNKNOWN input) =>
  ...
  void wire_handle_nested_uuids(UNKNOWN port_, UNKNOWN ids) =>
      wasmModule.wire_handle_nested_uuids(port_, ids);

  void wire_handle_uuid(UNKNOWN port_, UNKNOWN id) =>
      wasmModule.wire_handle_uuid(port_, id);

  void wire_handle_uuids(UNKNOWN port_, UNKNOWN ids) =>
  ...
  void drop_opaque_RustOpaque_RwLockHideData(UNKNOWN ptr) =>
  ...
  void drop_opaque_RustOpaque_box_dynDartDebug(UNKNOWN ptr) =>
  ...
  void drop_opaque_RustOpaque_hide_data(UNKNOWN ptr) =>
  ...
  void drop_opaque_RustOpaque_i_32(UNKNOWN ptr) =>
  ...
  void drop_opaque_RustOpaque_non_clone_data(UNKNOWN ptr) =>
...
class RustLibWasmModule implements WasmModule {
  ...
  external void wire_handle_durations(
      UNKNOWN port_, UNKNOWN durations, UNKNOWN since);
  ...
  external void wire_create_event(
      UNKNOWN port_, UNKNOWN address, UNKNOWN payload);
  ...
  external void wire_SumWith_sum(
      UNKNOWN port_, UNKNOWN that, UNKNOWN y, UNKNOWN z);

  external void wire_get_sum_array(
      UNKNOWN port_, UNKNOWN a, UNKNOWN b, UNKNOWN c);
