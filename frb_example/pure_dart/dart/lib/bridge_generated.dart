...
abstract class FlutterRustBridgeExampleSingleBlockTest {
  ...
  Future<List<SumWith>> getSumArray({required int a, required int b, required int c, dynamic hint});
...
class FlutterRustBridgeExampleSingleBlockTestImpl
  ...
  Future<List<SumWith>> getSumArray({required int a, required int b, required int c, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_get_sum_array(port_, _api2wire_u32(a), _api2wire_u32(b), _api2wire_u32(c)),
        parseSuccessData: _wire2api_list_sum_with,
  ...
  Future<OldSimpleStruct> callOldModuleSystem({dynamic hint}) => executeNormal(FlutterRustBridgeTask(
  ...
  Future<NewSimpleStruct> callNewModuleSystem({dynamic hint}) => executeNormal(FlutterRustBridgeTask(
