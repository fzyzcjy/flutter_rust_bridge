...
class ApplicationEnv  {
                ...
                ApplicationEnv({required this.vars,});
...
final bool field1;
                ...
                ApplicationEnvVar({required this.field0,required this.field1,});
...
@freezed
                class ApplicationMessage with _$ApplicationMessage  {
                     const factory ApplicationMessage.displayMessage(String field0,) = DisplayMessage;
 const factory ApplicationMessage.renderPixel({ required int x,required int y, }) = RenderPixel;
...
final ApplicationEnv env;
                ...
                ApplicationSettings({required this.name,required this.version,required this.mode,required this.env,});
...
final String a;
                ...
                ConcatenateWith({required this.bridge,required this.a,});
 ...
 Future<String> concatenate({ required String b,dynamic hint })=>bridge.concatenateMethodConcatenateWith(that: this, b:b,);
...
static Future<String> concatenateStatic({ required FlutterRustBridgeExampleSingleBlockTest bridge,required String a,required String b,dynamic hint })=>bridge.concatenateStaticStaticMethodConcatenateWith(a:a,b:b,hint: hint);
 ...
 Stream<Log2> handleSomeStreamSink({ required int key,required int max,dynamic hint })=>bridge.handleSomeStreamSinkMethodConcatenateWith(that: this, key:key,max:max,);

 Stream<int> handleSomeStreamSinkAt1({ dynamic hint })=>bridge.handleSomeStreamSinkAt1MethodConcatenateWith(that: this, );
...
@freezed
                class CustomError with _$CustomError implements FrbException {
                    @Implements<FrbBacktracedException>() const factory CustomError.error0({ required String e,required String backtrace, }) = Error0;
@Implements<FrbBacktracedException>() const factory CustomError.error1({ required int e,required String backtrace, }) = Error1;
                }

@freezed
                class CustomNestedError1 with _$CustomNestedError1 implements FrbException {
                     const factory CustomNestedError1.customNested1(String field0,) = CustomNested1;
 const factory CustomNestedError1.errorNested(CustomNestedError2 field0,) = ErrorNested;
                }

@freezed
                class CustomNestedError2 with _$CustomNestedError2  {
                     const factory CustomNestedError2.customNested2(String field0,) = CustomNested2;
 const factory CustomNestedError2.customNested2Number(int field0,) = CustomNested2Number;
                }
...
final String message;
                ...
                CustomStruct({required this.bridge,required this.message,});

                static Future<CustomStruct> newCustomStruct({ required FlutterRustBridgeExampleSingleBlockTest bridge,required String message,dynamic hint })=>bridge.newStaticMethodCustomStruct(message:message,hint: hint);

static Future<void> staticReturnCustomStructError({ required FlutterRustBridgeExampleSingleBlockTest bridge,dynamic hint })=>bridge.staticReturnCustomStructErrorStaticMethodCustomStruct(hint: hint);

static Future<int> staticReturnCustomStructOk({ required FlutterRustBridgeExampleSingleBlockTest bridge,dynamic hint })=>bridge.staticReturnCustomStructOkStaticMethodCustomStruct(hint: hint);

 Future<void> nonstaticReturnCustomStructError({ dynamic hint })=>bridge.nonstaticReturnCustomStructErrorMethodCustomStruct(that: this, );

 Future<int> nonstaticReturnCustomStructOk({ dynamic hint })=>bridge.nonstaticReturnCustomStructOkMethodCustomStruct(that: this, );
...
class CustomStructError implements FrbException {
                ...
                CustomStructError({required this.message,});
...
class Customized  {
 ...
 String? nonFinalField;
                ...
                Customized({required this.finalField,this.nonFinalField,});
...
final String payload;
                ...
                Event({required this.address,required this.payload,});
...
final NewTypeInt? newtypeint;
                ...
                ExoticOptionals({this.int32,this.int64,this.float64,this.boolean,this.zerocopy,this.int8List,this.uint8List,this.int32List,this.int64List,this.float32List,this.float64List,this.attributes,required this.attributesNullable,this.nullableAttributes,this.newtypeint,});
...
const factory KitchenSink.empty() = Empty;
 const factory KitchenSink.primitives({ /// Dart field comment
required int int32,required double float64,required bool boolean, }) = Primitives;
 const factory KitchenSink.nested(KitchenSink field0,int field1,) = Nested;
 const factory KitchenSink.optional([/// Comment on anonymous field
int? field0,int? field1,]) = Optional;
...
final int value;
                ...
                Log({required this.key,required this.value,});
...
final String value;
                ...
                Log2({required this.key,required this.value,});
...
final int height;
                ...
                MySize({required this.width,required this.height,});
...
class MyStreamEntry  {
                ...
                MyStreamEntry({required this.hello,});
...
class MyStruct  {
                ...
                MyStruct({required this.content,});
...
final List<MyTreeNode> children;
                ...
                MyTreeNode({required this.valueI32,required this.valueVecU8,required this.valueBoolean,required this.children,});
...
class NewTypeInt  {
                ...
                NewTypeInt({required this.field0,});
...
final String body;
                ...
                Note({required this.day,required this.body,});
...
final int value;
                ...
                SomeStruct({required this.bridge,required this.value,});

                static Future<SomeStruct> newSomeStruct({ required FlutterRustBridgeExampleSingleBlockTest bridge,required int value,dynamic hint })=>bridge.newStaticMethodSomeStruct(value:value,hint: hint);

static Future<int> staticReturnErrCustomError({ required FlutterRustBridgeExampleSingleBlockTest bridge,dynamic hint })=>bridge.staticReturnErrCustomErrorStaticMethodSomeStruct(hint: hint);

static Future<int> staticReturnOkCustomError({ required FlutterRustBridgeExampleSingleBlockTest bridge,dynamic hint })=>bridge.staticReturnOkCustomErrorStaticMethodSomeStruct(hint: hint);

 Future<int> nonStaticReturnErrCustomError({ dynamic hint })=>bridge.nonStaticReturnErrCustomErrorMethodSomeStruct(that: this, );

 Future<int> nonStaticReturnOkCustomError({ dynamic hint })=>bridge.nonStaticReturnOkCustomErrorMethodSomeStruct(that: this, );
...
final int x;
                ...
                SumWith({required this.bridge,required this.x,});

                 Future<int> sum({ required int y,required int z,dynamic hint })=>bridge.sumMethodSumWith(that: this, y:y,z:z,);
...
final Float64List float64List;
                ...
                VecOfPrimitivePack({required this.int8List,required this.uint8List,required this.int16List,required this.uint16List,required this.uint32List,required this.int32List,required this.uint64List,required this.int64List,required this.float32List,required this.float64List,});
...
final Float64List float64List;
                ...
                ZeroCopyVecOfPrimitivePack({required this.int8List,required this.uint8List,required this.int16List,required this.uint16List,required this.uint32List,required this.int32List,required this.uint64List,required this.int64List,required this.float32List,required this.float64List,});
...
Future<int> returnErrCustomError({ dynamic hint }) => executeNormal(FlutterRustBridgeTask(
...
Future<int> returnOkCustomError({ dynamic hint }) => executeNormal(FlutterRustBridgeTask(
...
Future<int> returnCustomStructOk({ dynamic hint }) => executeNormal(FlutterRustBridgeTask(
...
Future<SomeStruct> newStaticMethodSomeStruct({ required int value,dynamic hint }) => executeNormal(FlutterRustBridgeTask(
...
Future<int> staticReturnErrCustomErrorStaticMethodSomeStruct({ dynamic hint }) => executeNormal(FlutterRustBridgeTask(
        ...
        FlutterRustBridgeTaskConstMeta get kStaticReturnErrCustomErrorStaticMethodSomeStructConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "static_return_err_custom_error__static_method__SomeStruct",
            argNames: [],
        );
        

Future<int> staticReturnOkCustomErrorStaticMethodSomeStruct({ dynamic hint }) => executeNormal(FlutterRustBridgeTask(
        ...
        FlutterRustBridgeTaskConstMeta get kStaticReturnOkCustomErrorStaticMethodSomeStructConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "static_return_ok_custom_error__static_method__SomeStruct",
            argNames: [],
        );
        

Future<int> nonStaticReturnErrCustomErrorMethodSomeStruct({ required SomeStruct that,dynamic hint }) => executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => inner.wire_non_static_return_err_custom_error__method__SomeStruct(port_, _api2wire_box_autoadd_some_struct(that)),
            parseSuccessData: _wire2api_u32,
            parseErrorData: _wire2api_custom_error,
        ...
        FlutterRustBridgeTaskConstMeta get kNonStaticReturnErrCustomErrorMethodSomeStructConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "non_static_return_err_custom_error__method__SomeStruct",
            argNames: ["that"],
        );
        

Future<int> nonStaticReturnOkCustomErrorMethodSomeStruct({ required SomeStruct that,dynamic hint }) => executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => inner.wire_non_static_return_ok_custom_error__method__SomeStruct(port_, _api2wire_box_autoadd_some_struct(that)),
            parseSuccessData: _wire2api_u32,
            parseErrorData: _wire2api_custom_error,
        ...
        FlutterRustBridgeTaskConstMeta get kNonStaticReturnOkCustomErrorMethodSomeStructConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "non_static_return_ok_custom_error__method__SomeStruct",
            argNames: ["that"],
        );
        

Future<CustomStruct> newStaticMethodCustomStruct({ required String message,dynamic hint }) => executeNormal(FlutterRustBridgeTask(
...
Future<void> staticReturnCustomStructErrorStaticMethodCustomStruct({ dynamic hint }) => executeNormal(FlutterRustBridgeTask(
        ...
        FlutterRustBridgeTaskConstMeta get kStaticReturnCustomStructErrorStaticMethodCustomStructConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "static_return_custom_struct_error__static_method__CustomStruct",
            argNames: [],
        );
        

Future<int> staticReturnCustomStructOkStaticMethodCustomStruct({ dynamic hint }) => executeNormal(FlutterRustBridgeTask(
        ...
        FlutterRustBridgeTaskConstMeta get kStaticReturnCustomStructOkStaticMethodCustomStructConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "static_return_custom_struct_ok__static_method__CustomStruct",
            argNames: [],
        );
        

Future<void> nonstaticReturnCustomStructErrorMethodCustomStruct({ required CustomStruct that,dynamic hint }) => executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => inner.wire_nonstatic_return_custom_struct_error__method__CustomStruct(port_, _api2wire_box_autoadd_custom_struct(that)),
            parseSuccessData: _wire2api_unit,
            parseErrorData: _wire2api_custom_struct_error,
        ...
        FlutterRustBridgeTaskConstMeta get kNonstaticReturnCustomStructErrorMethodCustomStructConstMeta => const FlutterRustBridgeTaskConstMeta(
            debugName: "nonstatic_return_custom_struct_error__method__CustomStruct",
            argNames: ["that"],
        );
        

Future<int> nonstaticReturnCustomStructOkMethodCustomStruct({ required CustomStruct that,dynamic hint }) => executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => inner.wire_nonstatic_return_custom_struct_ok__method__CustomStruct(port_, _api2wire_box_autoadd_custom_struct(that)),
            parseSuccessData: _wire2api_u32,
            parseErrorData: _wire2api_custom_struct_error,
        ...
        FlutterRustBridgeTaskConstMeta get kNonstaticReturnCustomStructOkMethodCustomStructConstMeta => const FlutterRustBridgeTaskConstMeta(
...
ffi.Pointer<wire_CustomStruct> _api2wire_box_autoadd_custom_struct(CustomStruct raw) {
...
ffi.Pointer<wire_SomeStruct> _api2wire_box_autoadd_some_struct(SomeStruct raw) {
...
void _api_fill_to_wire_kitchen_sink(KitchenSink apiObj, wire_KitchenSink wireObj) {
            if (apiObj is Empty) { wireObj.tag = 0; return; }
...
ApplicationEnv _wire2api_application_env(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return ApplicationEnv(vars: _wire2api_list_application_env_var(arr[0]),);
        }
...
ApplicationEnvVar _wire2api_application_env_var(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return ApplicationEnvVar(field0: _wire2api_String(arr[0]),
...
ApplicationMessage _wire2api_application_message(dynamic raw) {
            switch (raw[0]) {
                case 0: return DisplayMessage(_wire2api_String(raw[1]),);
case 1: return RenderPixel(x: _wire2api_i32(raw[1]),y: _wire2api_i32(raw[2]),);
case 2: return Exit();
...
ApplicationSettings _wire2api_application_settings(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return ApplicationSettings(name: _wire2api_String(arr[0]),
...
Attribute _wire2api_attribute(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return Attribute(key: _wire2api_String(arr[0]),
...
ConcatenateWith _wire2api_concatenate_with(FlutterRustBridgeExampleSingleBlockTest bridge,dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return ConcatenateWith(bridge: bridge,
...
CustomError _wire2api_custom_error(dynamic raw) {
            switch (raw[0]) {
                case 0: return Error0(e: _wire2api_String(raw[1]),backtrace: _wire2api_String(raw[2]),);
case 1: return Error1(e: _wire2api_u32(raw[1]),backtrace: _wire2api_String(raw[2]),);
                default: throw Exception("unreachable");
            }
        }
...
CustomNestedError1 _wire2api_custom_nested_error_1(dynamic raw) {
            switch (raw[0]) {
                case 0: return CustomNested1(_wire2api_String(raw[1]),);
case 1: return ErrorNested(_wire2api_box_autoadd_custom_nested_error_2(raw[1]),);
                default: throw Exception("unreachable");
            }
        }
...
CustomNestedError2 _wire2api_custom_nested_error_2(dynamic raw) {
            switch (raw[0]) {
                case 0: return CustomNested2(_wire2api_String(raw[1]),);
case 1: return CustomNested2Number(_wire2api_u32(raw[1]),);
                default: throw Exception("unreachable");
            }
        }
        

CustomStruct _wire2api_custom_struct(FlutterRustBridgeExampleSingleBlockTest bridge,dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return CustomStruct(bridge: bridge,
...
CustomStructError _wire2api_custom_struct_error(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return CustomStructError(message: _wire2api_String(arr[0]),);
        }
...
Element _wire2api_element(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 4) throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
                return Element(tag: _wire2api_opt_String(arr[0]),
...
Event _wire2api_event(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return Event(address: _wire2api_String(arr[0]),
...
ExoticOptionals _wire2api_exotic_optionals(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return ExoticOptionals(int32: _wire2api_opt_box_autoadd_i32(arr[0]),
...
KitchenSink _wire2api_kitchen_sink(dynamic raw) {
            switch (raw[0]) {
                case 0: return Empty();
case 1: return Primitives(int32: _wire2api_i32(raw[1]),float64: _wire2api_f64(raw[2]),boolean: _wire2api_bool(raw[3]),);
case 2: return Nested(_wire2api_box_kitchen_sink(raw[1]),_wire2api_i32(raw[2]),);
case 3: return Optional(_wire2api_opt_box_autoadd_i32(raw[1]),_wire2api_opt_box_autoadd_i32(raw[2]),);
case 4: return Buffer(_wire2api_ZeroCopyBuffer_Uint8List(raw[1]),);
case 5: return Enums(_wire2api_weekdays(raw[1]),);
                default: throw Exception("unreachable");
            }
        }
...
Log _wire2api_log(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return Log(key: _wire2api_u32(arr[0]),
...
Log2 _wire2api_log_2(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return Log2(key: _wire2api_u32(arr[0]),
value: _wire2api_String(arr[1]),);
        }
...
MySize _wire2api_my_size(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return MySize(width: _wire2api_i32(arr[0]),
...
MyStreamEntry _wire2api_my_stream_entry(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return MyStreamEntry(hello: _wire2api_String(arr[0]),);
        }
...
MyTreeNode _wire2api_my_tree_node(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 4) throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
                return MyTreeNode(valueI32: _wire2api_i32(arr[0]),
...
NewTypeInt _wire2api_new_type_int(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return NewTypeInt(field0: _wire2api_i64(arr[0]),);
        }
...
Point _wire2api_point(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return Point(x: _wire2api_f32(arr[0]),
y: _wire2api_f32(arr[1]),);
        }
        

SomeStruct _wire2api_some_struct(FlutterRustBridgeExampleSingleBlockTest bridge,dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return SomeStruct(bridge: bridge,
...
UserId _wire2api_user_id(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return UserId(value: _wire2api_u32(arr[0]),);
        }
...
VecOfPrimitivePack _wire2api_vec_of_primitive_pack(dynamic raw) {
            final arr = raw as List<dynamic>;
                ...
                return VecOfPrimitivePack(int8List: _wire2api_int_8_list(arr[0]),
...
ZeroCopyVecOfPrimitivePack _wire2api_zero_copy_vec_of_primitive_pack(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 10) throw Exception('unexpected arr length: expect 10 but see ${arr.length}');
                return ZeroCopyVecOfPrimitivePack(int8List: _wire2api_ZeroCopyBuffer_Int8List(arr[0]),
...
class FlutterRustBridgeExampleSingleBlockTestWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_new__static_method__SomeStructPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Uint32)>>(
          'wire_new__static_method__SomeStruct');
  late final _wire_new__static_method__SomeStruct =
      _wire_new__static_method__SomeStructPtr
          .asFunction<void Function(int, int)>();
  ...
  late final _wire_static_return_err_custom_error__static_method__SomeStruct =
      _wire_static_return_err_custom_error__static_method__SomeStructPtr
          .asFunction<void Function(int)>();
  ...
  late final _wire_static_return_ok_custom_error__static_method__SomeStruct =
      _wire_static_return_ok_custom_error__static_method__SomeStructPtr
          .asFunction<void Function(int)>();
  ...
  late final _wire_non_static_return_err_custom_error__method__SomeStructPtr =
      _lookup<
              ffi.NativeFunction<
                  ffi.Void Function(ffi.Int64, ffi.Pointer<wire_SomeStruct>)>>(
  ...
  late final _wire_new__static_method__CustomStructPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>)>>(
      'wire_new__static_method__CustomStruct');
  late final _wire_new__static_method__CustomStruct =
      _wire_new__static_method__CustomStructPtr
          .asFunction<void Function(int, ffi.Pointer<wire_uint_8_list>)>();
  ...
  late final _wire_static_return_custom_struct_error__static_method__CustomStruct =
      _wire_static_return_custom_struct_error__static_method__CustomStructPtr
          .asFunction<void Function(int)>();
  ...
  late final _wire_static_return_custom_struct_ok__static_method__CustomStruct =
      _wire_static_return_custom_struct_ok__static_method__CustomStructPtr
          .asFunction<void Function(int)>();
  ...
  late final _wire_nonstatic_return_custom_struct_error__method__CustomStructPtr =
      _lookup<
              ffi.NativeFunction<
                  ffi.Void Function(
                      ffi.Int64, ffi.Pointer<wire_CustomStruct>)>>(
  ...
  late final _new_box_autoadd_custom_struct_0Ptr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_CustomStruct> Function()>>(
          'new_box_autoadd_custom_struct_0');
  late final _new_box_autoadd_custom_struct_0 =
      _new_box_autoadd_custom_struct_0Ptr
          .asFunction<ffi.Pointer<wire_CustomStruct> Function()>();
  ...
  late final _new_box_autoadd_some_struct_0Ptr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_SomeStruct> Function()>>(
          'new_box_autoadd_some_struct_0');
  late final _new_box_autoadd_some_struct_0 = _new_box_autoadd_some_struct_0Ptr
      .asFunction<ffi.Pointer<wire_SomeStruct> Function()>();
...
class wire_SomeStruct extends ffi.Struct {
  @ffi.Uint32()
  external int value;
}

class wire_CustomStruct extends ffi.Struct {
