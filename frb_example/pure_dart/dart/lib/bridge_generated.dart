...
class FlutterRustBridgeExampleImpl extends FlutterRustBridgeExample {
  ...
  Future<Uint8List> handleVecU8({required Uint8List v, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port) =>
            inner.wire_handle_vec_u8(port, _api2wire_uint_8_list(v)),
  ...
  Future<VecOfPrimitivePack> handleVecOfPrimitive(
      ...
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port) =>
            inner.wire_handle_vec_of_primitive(port, _api2wire_i32(n)),
  ...
  Future<ZeroCopyVecOfPrimitivePack> handleZeroCopyVecOfPrimitive(
          {required int n, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port) => inner.wire_handle_zero_copy_vec_of_primitive(
            port, _api2wire_i32(n)),
  ...
  Future<MySize> handleStruct(
          {required MySize arg, required MySize boxed, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port) => inner.wire_handle_struct(port,
  ...
  Future<NewTypeInt> handleNewtype({required NewTypeInt arg, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port) => inner.wire_handle_newtype(
  ...
  Future<List<String>> handleStringList(
      ...
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port) =>
            inner.wire_handle_string_list(port, _api2wire_StringList(names)),
  ...
  Future<MyTreeNode> handleComplexStruct(
      ...
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port) => inner.wire_handle_complex_struct(
  ...
  Stream<String> handleStream({required String arg, dynamic hint}) =>
      executeStream(FlutterRustBridgeTask(
        callFfi: (port) =>
            inner.wire_handle_stream(port, _api2wire_String(arg)),
        parseSuccessData: _wire2api_String,
        constMeta: const FlutterRustBridgeTaskConstMeta(
  ...
  Future<double?> handleOptionalReturn(
          {required double left, required double right, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port) => inner.wire_handle_optional_return(
            port, _api2wire_f64(left), _api2wire_f64(right)),
  ...
  Future<Element?> handleOptionalStruct({String? document, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port) => inner.wire_handle_optional_struct(
            port, _api2wire_opt_String(document)),
  ...
  Future<ExoticOptionals?> handleOptionalIncrement(
          {ExoticOptionals? opt, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port) => inner.wire_handle_optional_increment(
            port, _api2wire_opt_box_autoadd_exotic_optionals(opt)),
  ...
  Future<double> handleIncrementBoxedOptional({double? opt, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port) => inner.wire_handle_increment_boxed_optional(
            port, _api2wire_opt_box_f64(opt)),
  ...
  Future<Weekdays?> handleReturnEnum({required String input, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port) =>
            inner.wire_handle_return_enum(port, _api2wire_String(input)),
  ...
  Future<Weekdays> handleEnumParameter(
      ...
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port) =>
            inner.wire_handle_enum_parameter(port, _api2wire_weekdays(weekday)),
  ...
  Future<void> handleCustomizedStruct(
      ...
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port) => inner.wire_handle_customized_struct(
            port, _api2wire_box_autoadd_customized(val)),
        parseSuccessData: _wire2api_unit,
        constMeta: const FlutterRustBridgeTaskConstMeta(
  ...
  Future<KitchenSink> handleEnumStruct(
          {required KitchenSink val, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port) => inner.wire_handle_enum_struct(
            port, _api2wire_box_autoadd_kitchen_sink(val)),
  ...
  Future<bool> useImportedStruct({required MyStruct myStruct, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port) => inner.wire_use_imported_struct(
            port, _api2wire_box_autoadd_my_struct(myStruct)),
  ...
  Future<bool> useImportedEnum({required MyEnum myEnum, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port) =>
            inner.wire_use_imported_enum(port, _api2wire_my_enum(myEnum)),
        parseSuccessData: _wire2api_bool,
        constMeta: const FlutterRustBridgeTaskConstMeta(
...
class FlutterRustBridgeExampleWire implements FlutterRustBridgeWireBase {
  ...
  late final _new_box_bool =
      _new_box_boolPtr.asFunction<ffi.Pointer<ffi.Uint8> Function(int)>();
