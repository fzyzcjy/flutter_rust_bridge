...
class FlutterRustBridgeExampleImpl extends FlutterRustBridgeBase<FlutterRustBridgeExampleWire>
  ...
  Future<Uint64List> handleU64Vec({Uint64List? vec, dynamic hint}) => executeNormal(FlutterRustBridgeTask(
        callFfi: (port) => inner.wire_handle_u64_vec(port, _api2wire_opt_uint_64_list(vec)),
...
class FlutterRustBridgeExampleWire implements FlutterRustBridgeWireBase {
  ...
  late final _newtypeintPtr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<ffi.Int32>)>>('newtypeint');
  late final _newtypeint = _newtypeintPtr.asFunction<int Function(ffi.Pointer<ffi.Int32>)>();
  ...
  late final _kindPtr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<ffi.Int32>)>>('kind');
  late final _kind = _kindPtr.asFunction<int Function(ffi.Pointer<ffi.Int32>)>();
  ...
  late final _tagPtr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<ffi.Int32>)>>('tag');
  late final _tag = _tagPtr.asFunction<int Function(ffi.Pointer<ffi.Int32>)>();
  ...
  late final _int32Ptr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<ffi.Int32>)>>('int32');
  late final _int32 = _int32Ptr.asFunction<int Function(ffi.Pointer<ffi.Int32>)>();
  ...
  late final _float64Ptr = _lookup<ffi.NativeFunction<ffi.Double Function(ffi.Pointer<ffi.Int32>)>>('float64');
  late final _float64 = _float64Ptr.asFunction<double Function(ffi.Pointer<ffi.Int32>)>();
  ...
  late final _booleanPtr = _lookup<ffi.NativeFunction<ffi.Uint8 Function(ffi.Pointer<ffi.Int32>)>>('boolean');
  late final _boolean = _booleanPtr.asFunction<int Function(ffi.Pointer<ffi.Int32>)>();
  ...
  late final _field0Ptr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<ffi.Int32>)>>('field0');
  late final _field0 = _field0Ptr.asFunction<int Function(ffi.Pointer<ffi.Int32>)>();
  ...
  late final _value_i32Ptr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<ffi.Int32>)>>('value_i32');
  late final _value_i32 = _value_i32Ptr.asFunction<int Function(ffi.Pointer<ffi.Int32>)>();
  ...
  late final _value_booleanPtr =
      _lookup<ffi.NativeFunction<ffi.Uint8 Function(ffi.Pointer<ffi.Int32>)>>('value_boolean');
  late final _value_boolean = _value_booleanPtr.asFunction<int Function(ffi.Pointer<ffi.Int32>)>();
...
class Option_String extends ffi.Opaque {}

class Option_bool extends ffi.Opaque {}

class Option_f64 extends ffi.Opaque {}

class Option_i32 extends ffi.Opaque {}

class Option_i64 extends ffi.Opaque {}
