...
class FlutterRustBridgeExampleWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_sumPtr = _lookup<
          ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Pointer<wire_StructWithMethod>, ffi.Uint32, ffi.Uint32)>>(
      'wire_sum');
  late final _wire_sum = _wire_sumPtr.asFunction<void Function(int, ffi.Pointer<wire_StructWithMethod>, int, int)>();
  ...
  late final _new_box_autoadd_struct_with_methodPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<wire_StructWithMethod> Function()>>('new_box_autoadd_struct_with_method');
  late final _new_box_autoadd_struct_with_method =
      _new_box_autoadd_struct_with_methodPtr.asFunction<ffi.Pointer<wire_StructWithMethod> Function()>();
