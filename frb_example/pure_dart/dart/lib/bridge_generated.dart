...
var arg6 = _platform.api2wire_opt_box_exotic_optionals(structbox);
            return _platform.executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_handle_option_box_arguments(port_, arg0, arg1, arg2, arg3, arg4, arg5, arg6),
            parseSuccessData: _wire2api_String,
...
var arg2 = api2wire_u32(max);
            return _platform.executeStream(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_handle_some_stream_sink__method__ConcatenateWith(port_, arg0, arg1, arg2),
...
var arg1 = api2wire_u32(max);
            return _platform.executeStream(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_handle_some_static_stream_sink__static_method__ConcatenateWith(port_, arg0, arg1),
            parseSuccessData: _wire2api_log_2,
...
Stream<int> handleSomeStaticStreamSinkSingleArgStaticMethodConcatenateWith({ dynamic hint }) {
            ...
            return _platform.executeStream(FlutterRustBridgeTask(
            callFfi: (port_) => _platform.inner.wire_handle_some_static_stream_sink_single_arg__static_method__ConcatenateWith(port_),
            parseSuccessData: _wire2api_u32,
...
ApplicationMessage _wire2api_application_message(dynamic raw) {
            switch (raw[0]) {
                case 0: return ApplicationMessage_DisplayMessage(_wire2api_String(raw[1]),);
case 1: return ApplicationMessage_RenderPixel(x: _wire2api_i32(raw[1]),y: _wire2api_i32(raw[2]),);
case 2: return ApplicationMessage_Exit();
...
BigBuffers _wire2api_big_buffers(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return BigBuffers(int64: _wire2api_int_64_list(arr[0]),
...
Blob _wire2api_blob(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return Blob(field0: _wire2api_u8_array_1600(arr[0]),);
        }
...
ConcatenateWith _wire2api_concatenate_with(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return ConcatenateWith(bridge: this,
...
Distance _wire2api_distance(dynamic raw) {
            switch (raw[0]) {
                case 0: return Distance_Unknown();
case 1: return Distance_Map(_wire2api_f64(raw[1]),);
                default: throw Exception("unreachable");
            }
        }
...
EnumOpaque _wire2api_enum_opaque(dynamic raw) {
            switch (raw[0]) {
                case 0: return EnumOpaque_Struct(_wire2api_HideData(raw[1]),);
case 1: return EnumOpaque_Primitive(_wire2api_I32(raw[1]),);
case 2: return EnumOpaque_TraitObj(_wire2api_BoxDartDebug(raw[1]),);
case 3: return EnumOpaque_Mutex(_wire2api_MutexHideData(raw[1]),);
case 4: return EnumOpaque_RwLock(_wire2api_RwLockHideData(raw[1]),);
                default: throw Exception("unreachable");
            }
        }
...
FeatureUuid _wire2api_feature_uuid(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return FeatureUuid(one: _wire2api_Uuid(arr[0]),
...
FeedId _wire2api_feed_id(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return FeedId(field0: _wire2api_u8_array_8(arr[0]),);
        }
...
KitchenSink _wire2api_kitchen_sink(dynamic raw) {
            switch (raw[0]) {
                case 0: return KitchenSink_Empty();
case 1: return KitchenSink_Primitives(int32: _wire2api_i32(raw[1]),float64: _wire2api_f64(raw[2]),boolean: _wire2api_bool(raw[3]),);
case 2: return KitchenSink_Nested(_wire2api_box_kitchen_sink(raw[1]),_wire2api_i32(raw[2]),);
case 3: return KitchenSink_Optional(_wire2api_opt_box_autoadd_i32(raw[1]),_wire2api_opt_box_autoadd_i32(raw[2]),);
case 4: return KitchenSink_Buffer(_wire2api_ZeroCopyBuffer_Uint8List(raw[1]),);
case 5: return KitchenSink_Enums(_wire2api_weekdays(raw[1]),);
                default: throw Exception("unreachable");
            }
        }
...
Measure _wire2api_measure(dynamic raw) {
            switch (raw[0]) {
                case 0: return Measure_Speed(_wire2api_box_speed(raw[1]),);
case 1: return Measure_Distance(_wire2api_box_distance(raw[1]),);
                default: throw Exception("unreachable");
            }
        }
...
MessageId _wire2api_message_id(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return MessageId(field0: _wire2api_u8_array_32(arr[0]),);
        }
...
NewSimpleStruct _wire2api_new_simple_struct(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return NewSimpleStruct(field: _wire2api_i32(arr[0]),);
        }
...
Numbers _wire2api_numbers(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return Numbers(field0: _wire2api_int_32_list(arr[0]),);
        }
...
OldSimpleStruct _wire2api_old_simple_struct(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return OldSimpleStruct(field: _wire2api_i32(arr[0]),);
        }
...
OpaqueNested _wire2api_opaque_nested(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 2) throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
                return OpaqueNested(first: _wire2api_HideData(arr[0]),
...
Sequences _wire2api_sequences(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return Sequences(field0: _wire2api_int_32_list(arr[0]),);
        }
        

Speed _wire2api_speed(dynamic raw) {
            switch (raw[0]) {
                case 0: return Speed_Unknown();
case 1: return Speed_GPS(_wire2api_f64(raw[1]),);
                default: throw Exception("unreachable");
            }
        }
...
TestId _wire2api_test_id(dynamic raw) {
            final arr = raw as List<dynamic>;
                if (arr.length != 1) throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
                return TestId(field0: _wire2api_i32_array_2(arr[0]),);
        }
