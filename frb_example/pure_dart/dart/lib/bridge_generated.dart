...
CustomError _wire2api_custom_error(dynamic raw) {
  ...
  switch (access[0]) {
    case 0:
      final e = Error0(_wire2api_String(access[1]), raw[3]);
      if (raw[1] != null) {
        {
      ...
      return e;
    case 1:
      final e = Error1(_wire2api_u32(access[1]), raw[3]);
      if (raw[1] != null) {
        {
          //Backtrace backtrace = Backtrace(raw[1] as String);
          //e.setBacktrace(backtrace);
...
CustomNestedError1 _wire2api_custom_nested_error_1(dynamic raw) {
  ...
  switch (access[0]) {
    case 0:
      final e = CustomNested1(_wire2api_String(access[1]), raw[3]);
      if (raw[1] != null) {
        {
          //Backtrace backtrace = Backtrace(raw[1] as String);
          //e.setBacktrace(backtrace);
    ...
    case 1:
      final e = ErrorNested(
          _wire2api_box_autoadd_custom_nested_error_2(access[1]), raw[3]);
      if (raw[1] != null) {
        {
          //Backtrace backtrace = Backtrace(raw[1] as String);
          //e.setBacktrace(backtrace);
