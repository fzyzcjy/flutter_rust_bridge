...
class FlutterRustBridgeExampleSingleBlockTestImpl
  ...
  Future<Numbers> repeatNumber(
          {required int num, required int times, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_repeat_number(
            port_, _api2wire_i32(num), _api2wire_usize(times)),
  ...
  Future<Sequences> repeatSequence(
          {required int seq, required int times, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_repeat_sequence(
            port_, _api2wire_i32(seq), _api2wire_usize(times)),
  ...
  Future<int?> firstNumber({required Numbers nums, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) =>
            inner.wire_first_number(port_, _api2wire_box_autoadd_numbers(nums)),
  ...
  Future<int?> firstSequence({required Sequences seqs, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_first_sequence(
            port_, _api2wire_box_autoadd_sequences(seqs)),
        parseSuccessData: _wire2api_opt_box_autoadd_i32,
  ...
  Future<Measure?> multiplyByTen({required Measure measure, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_multiply_by_ten(
            port_, _api2wire_box_autoadd_measure(measure)),
  ...
  void _api_fill_to_wire_measure(Measure apiObj, wire_Measure wireObj) {
    ...
    if (apiObj is Measure_Distance) {
      ...
      wireObj.kind.ref.Distance.ref.field0 =
          _api2wire_box_distance(apiObj.field0);
    }
  }
