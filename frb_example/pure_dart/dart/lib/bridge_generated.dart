...
class ConcatenateWith {
  ...
  Future<ConcatenateWith> newConcatenateWith({required String a, dynamic hint}) =>
  ...
  Future<String> concatenateStatic({required String a, required String b, dynamic hint}) =>
