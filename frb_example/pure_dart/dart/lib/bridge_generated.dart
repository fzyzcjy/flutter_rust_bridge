...
abstract class FlutterRustBridgeExampleSingleBlockTest {
  ...
  Future<int> sumMethod(
      {required SumWith sumWith, required int y, required int z, dynamic hint});
  ...
  Future<String> concatenateMethod(
      {required ConcatenateWith concatenateWith,
      required String b,
      dynamic hint});
...
class StructWithMethod {
  ...
  Future<void> doNothing({required String b, dynamic hint}) =>
      bridge.doNothingMethod(
...
class FlutterRustBridgeExampleSingleBlockTestImpl
  ...
  Future<int> sumMethod(
          {required SumWith sumWith,
          required int y,
          required int z,
          dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_sum__method(
            port_,
            _api2wire_box_autoadd_sum_with(sumWith),
            _api2wire_u32(y),
            _api2wire_u32(z)),
        parseSuccessData: _wire2api_u32,
  ...
  Future<ConcatenateWith> newStaticMethodConcatenateWith(
          {required String a, dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_new___static_methodConcatenateWith(
  ...
  Future<String> concatenateMethod(
          ...
          dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_concatenate__method(
            port_,
            _api2wire_box_autoadd_concatenate_with(concatenateWith),
            _api2wire_String(b)),
        parseSuccessData: _wire2api_String,
  ...
  Future<String> concatenateStaticStaticMethodConcatenateWith(
      ...
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) =>
            inner.wire_concatenate_static___static_methodConcatenateWith(
  ...
  Future<void> doNothingMethod(
          ...
          dynamic hint}) =>
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_do_nothing__method(
            port_,
