...
@freezed
class CustomError with _$CustomError implements Exception {
...
@freezed
class CustomNestedError1 with _$CustomNestedError1 implements Exception {
...
class CustomStructError implements Exception {
  final String message;
