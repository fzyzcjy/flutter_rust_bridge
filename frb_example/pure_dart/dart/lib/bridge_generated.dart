...
Future<int> sumMethod({ required StructWithMethod structWithMethod,required int y,required int z,dynamic hint });

FlutterRustBridgeTaskConstMeta get kSumMethodConstMeta;

Future<String> concatenateMethod({ required StructWithMethod structWithMethod,required String b,dynamic hint });
...
final int x;
                ...
                StructWithMethod({required this.bridge,required this.x,});
                Future<int> sum({ required int y,required int z,dynamic hint })=>bridge.sumMethod(structWithMethod: this, y:y,z:z,);Future<String> concatenate({ required String b,dynamic hint })=>bridge.concatenateMethod(structWithMethod: this, b:b,);
            }
...
Future<int> sumMethod({ required StructWithMethod structWithMethod,required int y,required int z,dynamic hint }) => executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => inner.wire_sum__method(port_, _api2wire_box_autoadd_struct_with_method(structWithMethod), _api2wire_u32(y), _api2wire_u32(z)),
            parseSuccessData: _wire2api_u32,
            
        constMeta: kSumMethodConstMeta,
        argValues: [structWithMethod, y, z],
        hint: hint,
        ...
        FlutterRustBridgeTaskConstMeta get kSumMethodConstMeta => const FlutterRustBridgeTaskConstMeta(
            ...
            argNames: ["structWithMethod", "y", "z"],
        );
        

Future<String> concatenateMethod({ required StructWithMethod structWithMethod,required String b,dynamic hint }) => executeNormal(FlutterRustBridgeTask(
            callFfi: (port_) => inner.wire_concatenate__method(port_, _api2wire_box_autoadd_struct_with_method(structWithMethod), _api2wire_String(b)),
            parseSuccessData: _wire2api_String,
  ...
  late final _wire_sum__methodPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Pointer<wire_StructWithMethod>,
              ffi.Uint32, ffi.Uint32)>>('wire_sum__method');
  late final _wire_sum__method = _wire_sum__methodPtr.asFunction<
      void Function(int, ffi.Pointer<wire_StructWithMethod>, int, int)>();
