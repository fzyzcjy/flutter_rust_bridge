...
class FlutterRustBridgeExampleImpl extends FlutterRustBridgeBase<FlutterRustBridgeExampleWire>
  ...
  Stream<Log> handleStream1({required int key, required int max, dynamic hint}) => executeStream(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_handle_stream_1(port_, _api2wire_u32(key), _api2wire_u32(max)),
  ...
  FlutterRustBridgeTaskConstMeta get kHandleStream1ConstMeta => const FlutterRustBridgeTaskConstMeta(
        debugName: "handle_stream_1",
        argNames: ["key", "max"],
      );

  Stream<Log> handleStream2({required int key, required int max, dynamic hint}) => executeStream(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_handle_stream_2(port_, _api2wire_u32(key), _api2wire_u32(max)),
        parseSuccessData: _wire2api_log,
  ...
  FlutterRustBridgeTaskConstMeta get kHandleStream2ConstMeta => const FlutterRustBridgeTaskConstMeta(
        debugName: "handle_stream_2",
        argNames: ["key", "max"],
      );

  Stream<Log> handleStream3({required int key, required int max, dynamic hint}) => executeStream(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_handle_stream_3(port_, _api2wire_u32(key), _api2wire_u32(max)),
        parseSuccessData: _wire2api_log,
  ...
  FlutterRustBridgeTaskConstMeta get kHandleStream3ConstMeta => const FlutterRustBridgeTaskConstMeta(
...
class FlutterRustBridgeExampleWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_handle_stream_1Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Uint32, ffi.Uint32)>>('wire_handle_stream_1');
  late final _wire_handle_stream_1 = _wire_handle_stream_1Ptr.asFunction<void Function(int, int, int)>();
  ...
  late final _wire_handle_stream_2Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Uint32, ffi.Uint32)>>('wire_handle_stream_2');
  late final _wire_handle_stream_2 = _wire_handle_stream_2Ptr.asFunction<void Function(int, int, int)>();
  ...
  late final _wire_handle_stream_3Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64, ffi.Uint32, ffi.Uint32)>>('wire_handle_stream_3');
  late final _wire_handle_stream_3 = _wire_handle_stream_3Ptr.asFunction<void Function(int, int, int)>();
