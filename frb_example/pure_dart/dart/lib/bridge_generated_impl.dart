...
class FlutterRustBridgeExampleWire implements FlutterRustBridgeWireBase {
  ...
  int newtypeint(
    ffi.Pointer<wire_ExoticOptionals> this_,
  ) {
    return _newtypeint(
      this_,
    );
  ...
  late final _newtypeintPtr =
      _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<wire_ExoticOptionals>)>>('newtypeint');
  late final _newtypeint = _newtypeintPtr.asFunction<int Function(ffi.Pointer<wire_ExoticOptionals>)>();

  int kind(
    ffi.Pointer<wire_KitchenSink> this_,
  ) {
    return _kind(
      this_,
    );
  ...
  late final _kindPtr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<wire_KitchenSink>)>>('kind');
  late final _kind = _kindPtr.asFunction<int Function(ffi.Pointer<wire_KitchenSink>)>();
  ...
  late final _tagPtr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<wire_KitchenSink>)>>('tag');
  late final _tag = _tagPtr.asFunction<int Function(ffi.Pointer<wire_KitchenSink>)>();

  int int32(
    ffi.Pointer<KitchenSink_Primitives> this_,
  ) {
    return _int32(
      this_,
    );
  ...
  late final _int32Ptr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<KitchenSink_Primitives>)>>('int32');
  late final _int32 = _int32Ptr.asFunction<int Function(ffi.Pointer<KitchenSink_Primitives>)>();
  ...
  late final _float64Ptr =
      _lookup<ffi.NativeFunction<ffi.Double Function(ffi.Pointer<KitchenSink_Primitives>)>>('float64');
  late final _float64 = _float64Ptr.asFunction<double Function(ffi.Pointer<KitchenSink_Primitives>)>();
  ...
  late final _booleanPtr =
      _lookup<ffi.NativeFunction<ffi.Uint8 Function(ffi.Pointer<KitchenSink_Primitives>)>>('boolean');
  late final _boolean = _booleanPtr.asFunction<int Function(ffi.Pointer<KitchenSink_Primitives>)>();

  wire_KitchenSink field0(
    ffi.Pointer<KitchenSink_Nested> this_,
  ) {
    return _field0(
      this_,
    );
  ...
  late final _field0Ptr =
      _lookup<ffi.NativeFunction<wire_KitchenSink Function(ffi.Pointer<KitchenSink_Nested>)>>('field0');
  late final _field0 = _field0Ptr.asFunction<wire_KitchenSink Function(ffi.Pointer<KitchenSink_Nested>)>();

  int width(
    ffi.Pointer<wire_MySize> this_,
  ) {
    return _width(
      this_,
    );
  ...
  late final _widthPtr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<wire_MySize>)>>('width');
  late final _width = _widthPtr.asFunction<int Function(ffi.Pointer<wire_MySize>)>();
  ...
  late final _heightPtr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<wire_MySize>)>>('height');
  late final _height = _heightPtr.asFunction<int Function(ffi.Pointer<wire_MySize>)>();

  int value_i32(
    ffi.Pointer<wire_MyTreeNode> this_,
  ) {
    return _value_i32(
      this_,
    );
  ...
  late final _value_i32Ptr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<wire_MyTreeNode>)>>('value_i32');
  late final _value_i32 = _value_i32Ptr.asFunction<int Function(ffi.Pointer<wire_MyTreeNode>)>();
  ...
  late final _value_booleanPtr =
      _lookup<ffi.NativeFunction<ffi.Uint8 Function(ffi.Pointer<wire_MyTreeNode>)>>('value_boolean');
  late final _value_boolean = _value_booleanPtr.asFunction<int Function(ffi.Pointer<wire_MyTreeNode>)>();
}
