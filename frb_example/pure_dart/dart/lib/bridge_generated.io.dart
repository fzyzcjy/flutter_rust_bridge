...
import 'bridge_generated.dart'; export 'bridge_generated.dart'; import 'package:meta/meta.dart';
...
class FlutterRustBridgeExampleSingleBlockTestPlatform extends FlutterRustBridgeBase<FlutterRustBridgeExampleSingleBlockTestWire> {
                FlutterRustBridgeExampleSingleBlockTestPlatform(ffi.DynamicLibrary dylib) : super(FlutterRustBridgeExampleSingleBlockTestWire(dylib));
// Section: api2wire
...
void _api_fill_to_wire_distance(Distance apiObj, wire_Distance wireObj) {
                if (apiObj is Distance_Unknown) { wireObj.tag = 0; return; }
...
void _api_fill_to_wire_kitchen_sink(KitchenSink apiObj, wire_KitchenSink wireObj) {
                if (apiObj is KitchenSink_Empty) { wireObj.tag = 0; return; }
...
void _api_fill_to_wire_speed(Speed apiObj, wire_Speed wireObj) {
                if (apiObj is Speed_Unknown) { wireObj.tag = 0; return; }
