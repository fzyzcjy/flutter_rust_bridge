...
import 'package:meta/meta.dart' as meta;import 'package:collection/collection.dart';
...
FlutterRustBridgeTaskConstMeta get kHandleSomeStaticStreamSinkSingleArgStaticMethodConcatenateWithConstMeta;
    ...
    OpaqueTypeFinalizer get RwLockHideDataFinalizer;
        ...
        @sealed class BoxDartDebug extends FrbOpaque {
                ...
                class EnumOpaqueArray5 extends NonGrowableListView<EnumOpaque> {
                    ...
                    EnumOpaqueArray5(List<EnumOpaque> inner)
                        : assert(inner.length == arraySize),
                          super(inner);
                    EnumOpaqueArray5.unchecked(List<EnumOpaque> inner)
                        : super(inner);
                    EnumOpaqueArray5.init(EnumOpaque fill): super(List<EnumOpaque>.filled(arraySize,fill));
                  }
                

@sealed class FrbOpaqueReturn extends FrbOpaque {
                final FlutterRustBridgeExampleSingleBlockTest bridge;
...
@sealed class HideData extends FrbOpaque {
                final FlutterRustBridgeExampleSingleBlockTest bridge;
                ...
                class HideDataArray2 extends NonGrowableListView<HideData> {
                    ...
                    HideDataArray2(List<HideData> inner)
                        : assert(inner.length == arraySize),
                          super(inner);
                    HideDataArray2.unchecked(List<HideData> inner)
                        : super(inner);
                    HideDataArray2.init(HideData fill): super(List<HideData>.filled(arraySize,fill));
                  }
                

@sealed class I32 extends FrbOpaque {
                final FlutterRustBridgeExampleSingleBlockTest bridge;
...
@sealed class MutexHideData extends FrbOpaque {
                final FlutterRustBridgeExampleSingleBlockTest bridge;
                ...
                class PointArray2 extends NonGrowableListView<Point> {
                    ...
                    PointArray2(List<Point> inner)
                        : assert(inner.length == arraySize),
                          super(inner);
                    PointArray2.unchecked(List<Point> inner)
                        : super(inner);
                    PointArray2.init(Point fill): super(List<Point>.filled(arraySize,fill));
                  }
                

@sealed class RwLockHideData extends FrbOpaque {
                final FlutterRustBridgeExampleSingleBlockTest bridge;
                ...
                class SumWithArray3 extends NonGrowableListView<SumWith> {
                    ...
                    SumWithArray3(List<SumWith> inner)
                        : assert(inner.length == arraySize),
                          super(inner);
                    SumWithArray3.unchecked(List<SumWith> inner)
                        : super(inner);
                ...
                class TestIdArray2 extends NonGrowableListView<TestId> {
                    ...
                    TestIdArray2(List<TestId> inner)
                        : assert(inner.length == arraySize),
                          super(inner);
                    TestIdArray2.unchecked(List<TestId> inner)
                        : super(inner);
                ...
                class TestIdArray4 extends NonGrowableListView<TestId> {
                    ...
                    TestIdArray4(List<TestId> inner)
                        : assert(inner.length == arraySize),
                          super(inner);
                    TestIdArray4.unchecked(List<TestId> inner)
                        : super(inner);
...
final Uint64List uint64;
                ...
                BigBuffers({required this.int64,required this.uint64,});
...
const factory Distance.map(double field0,) = Distance_Map;
                }
...
@freezed
                class EnumOpaque with _$EnumOpaque {
                    const factory EnumOpaque.struct(HideData field0,) = EnumOpaque_Struct;
const factory EnumOpaque.primitive(I32 field0,) = EnumOpaque_Primitive;
const factory EnumOpaque.traitObj(BoxDartDebug field0,) = EnumOpaque_TraitObj;
const factory EnumOpaque.mutex(MutexHideData field0,) = EnumOpaque_Mutex;
const factory EnumOpaque.rwLock(RwLockHideData field0,) = EnumOpaque_RwLock;
                }

@freezed
class Event with _$Event {
                const factory Event({required  String address,required  String payload,}) = _Event;
...
final NewTypeInt? newtypeint;
                ...
                ExoticOptionals({this.int32,this.int64,this.float64,this.boolean,this.zerocopy,this.int8List,this.uint8List,this.int32List,this.float32List,this.float64List,this.attributes,required this.attributesNullable,this.nullableAttributes,this.newtypeint,});
                ...
                class F64Array16 extends NonGrowableListView<double> {
                    ...
                    F64Array16(Float64List inner)
                        : assert(inner.length == arraySize),
                          super(inner);
                    F64Array16.unchecked(Float64List inner)
                        : super(inner);
...
final DateTime naive;
                ...
                FeatureChrono({required this.utc,required this.local,required this.duration,required this.naive,});
...
final List<UuidValue> many;
                ...
                FeatureUuid({required this.one,required this.many,});
...
class FeedId {
                ...
                class I32Array2 extends NonGrowableListView<int> {
                    ...
                    I32Array2(Int32List inner)
                        : assert(inner.length == arraySize),
                          super(inner);
                    I32Array2.unchecked(Int32List inner)
                        : super(inner);
...
required int int32,required double float64,required bool boolean, }) = KitchenSink_Primitives;
const factory KitchenSink.nested(KitchenSink field0,int field1,) = KitchenSink_Nested;
const factory KitchenSink.optional([/// Comment on anonymous field
int? field0,int? field1,]) = KitchenSink_Optional;
const factory KitchenSink.buffer(Uint8List field0,) = KitchenSink_Buffer;
const factory KitchenSink.enums(Weekdays field0,) = KitchenSink_Enums;
                }
...
@freezed
                class Measure with _$Measure {
                    const factory Measure.speed(Speed field0,) = Measure_Speed;
const factory Measure.distance(Distance field0,) = Measure_Distance;
                }

class MessageId {
                final U8Array32 field0;

                MessageId({required this.field0,});
...
class NewSimpleStruct {
                ...
                NewSimpleStruct({required this.field,});
...
class OldSimpleStruct {
                ...
                OldSimpleStruct({required this.field,});
...
final HideData second;
                ...
                OpaqueNested({required this.first,required this.second,});
...
class Sequences {
                ...
                Sequences({required this.field0,});
...
const factory Speed.gps(double field0,) = Speed_GPS;
                }
...
class TestId {
                ...
                class U8Array1600 extends NonGrowableListView<int> {
                    ...
                    U8Array1600(Uint8List inner)
                        : assert(inner.length == arraySize),
                          super(inner);
                    U8Array1600.unchecked(Uint8List inner)
                        : super(inner);
                ...
                class U8Array5 extends NonGrowableListView<int> {
                    ...
                    U8Array5(Uint8List inner)
                        : assert(inner.length == arraySize),
                          super(inner);
                    U8Array5.unchecked(Uint8List inner)
                        : super(inner);
                ...
                class U8Array8 extends NonGrowableListView<int> {
                    ...
                    U8Array8(Uint8List inner)
                        : assert(inner.length == arraySize),
                          super(inner);
                    U8Array8.unchecked(Uint8List inner)
                        : super(inner);
