...
class BoxDartDebug extends FrbOpaque {
  ...
  BoxDartDebug.fromRaw(int ptr, int size, this.bridge)
...
class FrbOpaqueReturn extends FrbOpaque {
  final FlutterRustBridgeExampleSingleBlockTest bridge;
  FrbOpaqueReturn.fromRaw(int ptr, int size, this.bridge)
      : super.unsafe(ptr, size);
  @override
...
class FrbOpaqueSyncReturn extends FrbOpaque {
  final FlutterRustBridgeExampleSingleBlockTest bridge;
  FrbOpaqueSyncReturn.fromRaw(int ptr, int size, this.bridge)
      : super.unsafe(ptr, size);
  @override
  ...
  OpaqueTypeFinalizer get staticFinalizer =>
      bridge.FrbOpaqueSyncReturnFinalizer;
}
...
class MutexHideData extends FrbOpaque {
  final FlutterRustBridgeExampleSingleBlockTest bridge;
  MutexHideData.fromRaw(int ptr, int size, this.bridge)
      : super.unsafe(ptr, size);
  @override
...
class NonSendHideData extends FrbOpaque {
  final FlutterRustBridgeExampleSingleBlockTest bridge;
  NonSendHideData.fromRaw(int ptr, int size, this.bridge)
      : super.unsafe(ptr, size);
  @override
...
class RwLockHideData extends FrbOpaque {
  final FlutterRustBridgeExampleSingleBlockTest bridge;
  RwLockHideData.fromRaw(int ptr, int size, this.bridge)
      : super.unsafe(ptr, size);
  @override
