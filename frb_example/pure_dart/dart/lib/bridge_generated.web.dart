...
class FlutterRustBridgeExampleSingleBlockTestWasmModule implements WasmModule {
  ...
  external dynamic /*  */ P7C55DD6B_wire_simple_adder(port_, a, b);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_simple_adder_sync(a, b);

  external dynamic /*  */ P7C55DD6B_wire_primitive_types(port_, my_i32, my_i64, my_f64, my_bool);

  external dynamic /*  */ P7C55DD6B_wire_primitive_optional_types(port_, my_i32, my_i64, my_f64, my_bool);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_primitive_types_sync(my_i32, my_i64, my_f64, my_bool);

  external dynamic /*  */ P7C55DD6B_wire_primitive_u32(port_, my_u32);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_primitive_u32_sync(my_u32);

  external dynamic /*  */ P7C55DD6B_wire_handle_string(port_, s);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_string_sync(s);

  external dynamic /*  */ P7C55DD6B_wire_handle_return_unit(port_);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_return_unit_sync();

  external dynamic /*  */ P7C55DD6B_wire_handle_vec_u8(port_, v);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_vec_u8_sync(v);

  external dynamic /*  */ P7C55DD6B_wire_handle_vec_of_primitive(port_, n);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_vec_of_primitive_sync(n);

  external dynamic /*  */ P7C55DD6B_wire_handle_zero_copy_vec_of_primitive(port_, n);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_zero_copy_vec_of_primitive_sync(n);

  external dynamic /*  */ P7C55DD6B_wire_handle_struct(port_, arg, boxed);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_struct_sync(arg, boxed);

  external dynamic /*  */ P7C55DD6B_wire_handle_newtype(port_, arg);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_newtype_sync(arg);

  external dynamic /*  */ P7C55DD6B_wire_handle_list_of_struct(port_, l);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_list_of_struct_sync(l);

  external dynamic /*  */ P7C55DD6B_wire_handle_string_list(port_, names);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_string_list_sync(names);

  external dynamic /*  */ P7C55DD6B_wire_handle_complex_struct(port_, s);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_complex_struct_sync(s);

  external dynamic /*  */ P7C55DD6B_wire_handle_nested_struct(port_, s);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_sync_return(mode);

  external dynamic /*  */ P7C55DD6B_wire_handle_stream(port_, arg);

  external dynamic /*  */ P7C55DD6B_wire_handle_stream_of_struct(port_);

  external dynamic /*  */ P7C55DD6B_wire_return_err(port_);

  external dynamic /*  */ P7C55DD6B_wire_return_panic(port_);

  external dynamic /*  */ P7C55DD6B_wire_handle_optional_return(port_, left, right);

  external dynamic /*  */ P7C55DD6B_wire_handle_optional_struct(port_, document);

  external dynamic /*  */ P7C55DD6B_wire_handle_optional_increment(port_, opt);

  external dynamic /*  */ P7C55DD6B_wire_handle_increment_boxed_optional(port_, opt);

  external dynamic /*  */ P7C55DD6B_wire_handle_option_box_arguments(
      port_, i8box, u8box, i32box, i64box, f64box, boolbox, structbox);

  external dynamic /*  */ P7C55DD6B_wire_print_note(port_, note);

  external dynamic /*  */ P7C55DD6B_wire_handle_return_enum(port_, input);

  external dynamic /*  */ P7C55DD6B_wire_handle_enum_parameter(port_, weekday);

  external dynamic /*  */ P7C55DD6B_wire_handle_customized_struct(port_, val);

  external dynamic /*  */ P7C55DD6B_wire_handle_enum_struct(port_, val);

  external dynamic /*  */ P7C55DD6B_wire_use_imported_struct(port_, my_struct);

  external dynamic /*  */ P7C55DD6B_wire_use_imported_enum(port_, my_enum);

  external dynamic /*  */ P7C55DD6B_wire_get_app_settings(port_);

  external dynamic /*  */ P7C55DD6B_wire_get_fallible_app_settings(port_);

  external dynamic /*  */ P7C55DD6B_wire_is_app_embedded(port_, app_settings);

  external dynamic /*  */ P7C55DD6B_wire_get_message(port_);

  external dynamic /*  */ P7C55DD6B_wire_repeat_number(port_, number, times);

  external dynamic /*  */ P7C55DD6B_wire_repeat_sequence(port_, seq, times);

  external dynamic /*  */ P7C55DD6B_wire_first_number(port_, nums);

  external dynamic /*  */ P7C55DD6B_wire_first_sequence(port_, seqs);

  external dynamic /*  */ P7C55DD6B_wire_get_array(port_);

  external dynamic /*  */ P7C55DD6B_wire_get_complex_array(port_);

  external dynamic /*  */ P7C55DD6B_wire_get_usize(port_, u);

  external dynamic /*  */ P7C55DD6B_wire_next_user_id(port_, user_id);

  external dynamic /*  */ P7C55DD6B_wire_register_event_listener(port_);

  external dynamic /*  */ P7C55DD6B_wire_close_event_listener(port_);

  external dynamic /*  */ P7C55DD6B_wire_create_event(port_, address, payload);

  external dynamic /*  */ P7C55DD6B_wire_handle_stream_sink_at_1(port_, key, max);

  external dynamic /*  */ P7C55DD6B_wire_handle_stream_sink_at_2(port_, key, max);

  external dynamic /*  */ P7C55DD6B_wire_handle_stream_sink_at_3(port_, key, max);

  external dynamic /*  */ P7C55DD6B_wire_get_sum_struct(port_);

  external dynamic /*  */ P7C55DD6B_wire_get_sum_array(port_, a, b, c);

  external dynamic /*  */ P7C55DD6B_wire_multiply_by_ten(port_, measure);

  external dynamic /*  */ P7C55DD6B_wire_call_old_module_system(port_);

  external dynamic /*  */ P7C55DD6B_wire_call_new_module_system(port_);

  external dynamic /*  */ P7C55DD6B_wire_handle_big_buffers(port_);

  external dynamic /*  */ P7C55DD6B_wire_datetime_utc(port_, d);

  external dynamic /*  */ P7C55DD6B_wire_datetime_local(port_, d);

  external dynamic /*  */ P7C55DD6B_wire_naivedatetime(port_, d);

  external dynamic /*  */ P7C55DD6B_wire_optional_empty_datetime_utc(port_, d);

  external dynamic /*  */ P7C55DD6B_wire_duration(port_, d);

  external dynamic /*  */ P7C55DD6B_wire_handle_timestamps(port_, timestamps, epoch);

  external dynamic /*  */ P7C55DD6B_wire_handle_durations(port_, durations, since);

  external dynamic /*  */ P7C55DD6B_wire_test_chrono(port_);

  external dynamic /*  */ P7C55DD6B_wire_test_precise_chrono(port_);

  external dynamic /*  */ P7C55DD6B_wire_how_long_does_it_take(port_, mine);

  external dynamic /*  */ P7C55DD6B_wire_handle_uuid(port_, id);

  external dynamic /*  */ P7C55DD6B_wire_handle_uuids(port_, ids);

  external dynamic /*  */ P7C55DD6B_wire_handle_nested_uuids(port_, ids);

  external dynamic /*  */ P7C55DD6B_wire_new_msgid(port_, id);

  external dynamic /*  */ P7C55DD6B_wire_use_msgid(port_, id);

  external dynamic /*  */ P7C55DD6B_wire_boxed_blob(port_, blob);

  external dynamic /*  */ P7C55DD6B_wire_use_boxed_blob(port_, blob);

  external dynamic /*  */ P7C55DD6B_wire_return_boxed_feed_id(port_, id);

  external dynamic /*  */ P7C55DD6B_wire_return_boxed_raw_feed_id(port_, id);

  external dynamic /*  */ P7C55DD6B_wire_test_id(port_, id);

  external dynamic /*  */ P7C55DD6B_wire_last_number(port_, array);

  external dynamic /*  */ P7C55DD6B_wire_nested_id(port_, id);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_accept_dart_opaque(opaque);

  external dynamic /*  */ P7C55DD6B_wire_async_accept_dart_opaque(port_, opaque);

  external dynamic /*  */ P7C55DD6B_wire_loop_back(port_, opaque);

  external dynamic /*  */ P7C55DD6B_wire_loop_back_option(port_, opaque);

  external dynamic /*  */ P7C55DD6B_wire_loop_back_array(port_, opaque);

  external dynamic /*  */ P7C55DD6B_wire_loop_back_vec(port_, opaque);

  external dynamic /*  */ P7C55DD6B_wire_loop_back_option_get(port_, opaque);

  external dynamic /*  */ P7C55DD6B_wire_loop_back_array_get(port_, opaque);

  external dynamic /*  */ P7C55DD6B_wire_loop_back_vec_get(port_, opaque);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_unwrap_dart_opaque(opaque);

  external dynamic /*  */ P7C55DD6B_wire_panic_unwrap_dart_opaque(port_, opaque);

  external dynamic /*  */ P7C55DD6B_wire_create_opaque(port_);

  external dynamic /*  */ P7C55DD6B_wire_create_option_opaque(port_, opaque);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_create_opaque();

  external dynamic /*  */ P7C55DD6B_wire_create_array_opaque_enum(port_);

  external dynamic /*  */ P7C55DD6B_wire_run_enum_opaque(port_, opaque);

  external dynamic /*  */ P7C55DD6B_wire_run_opaque(port_, opaque);

  external dynamic /*  */ P7C55DD6B_wire_run_opaque_with_delay(port_, opaque);

  external dynamic /*  */ P7C55DD6B_wire_opaque_array(port_);

  external dynamic /*  */ P7C55DD6B_wire_create_sync_opaque(port_);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_create_sync_opaque();

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_run_opaque(opaque);

  external dynamic /*  */ P7C55DD6B_wire_opaque_array_run(port_, data);

  external dynamic /*  */ P7C55DD6B_wire_opaque_vec(port_);

  external dynamic /*  */ P7C55DD6B_wire_opaque_vec_run(port_, data);

  external dynamic /*  */ P7C55DD6B_wire_create_nested_opaque(port_);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_loopback(opaque);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_option_loopback(opaque);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_option();

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_option_null();

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_option_rust_opaque();

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_option_dart_opaque(opaque);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_void();

  external dynamic /*  */ P7C55DD6B_wire_run_nested_opaque(port_, opaque);

  external dynamic /*  */ P7C55DD6B_wire_create_nested_dart_opaque(port_, opaque1, opaque2);

  external dynamic /*  */ P7C55DD6B_wire_get_nested_dart_opaque(port_, opaque);

  external dynamic /*  */ P7C55DD6B_wire_create_enum_dart_opaque(port_, opaque);

  external dynamic /*  */ P7C55DD6B_wire_get_enum_dart_opaque(port_, opaque);

  external dynamic /*  */ P7C55DD6B_wire_set_static_dart_opaque(port_, opaque);

  external dynamic /*  */ P7C55DD6B_wire_drop_static_dart_opaque(port_);

  external dynamic /*  */ P7C55DD6B_wire_unwrap_rust_opaque(port_, opaque);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_return_non_droppable_dart_opaque(opaque);

  external dynamic /*  */ P7C55DD6B_wire_frb_generator_test(port_);

  external dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_frb_sync_generator_test();

  external dynamic /*  */ P7C55DD6B_wire_handle_type_alias_id(port_, input);

  external dynamic /*  */ P7C55DD6B_wire_handle_type_nest_alias_id(port_, input);

  external dynamic /*  */ P7C55DD6B_wire_handle_type_alias_model(port_, input);

  external dynamic /*  */ P7C55DD6B_wire_empty_struct(port_, empty);

  external dynamic /*  */ P7C55DD6B_wire_return_dart_dynamic(port_);

  external dynamic /*  */ P7C55DD6B_wire_test_raw_string_item_struct(port_);

  external dynamic /*  */ P7C55DD6B_wire_test_more_than_just_one_raw_string_struct(port_);

  external dynamic /*  */ P7C55DD6B_wire_test_raw_string_mirrored(port_);

  external dynamic /*  */ P7C55DD6B_wire_test_nested_raw_string_mirrored(port_);

  external dynamic /*  */ P7C55DD6B_wire_test_raw_string_enum_mirrored(port_, nested);

  external dynamic /*  */ P7C55DD6B_wire_test_list_of_raw_nested_string_mirrored(port_);

  external dynamic /*  */ P7C55DD6B_wire_test_fallible_of_raw_string_mirrored(port_);

  external dynamic /*  */ P7C55DD6B_wire_list_of_primitive_enums(port_, weekdays);

  external dynamic /*  */ P7C55DD6B_wire_test_abc_enum(port_, abc);

  external dynamic /*  */ P7C55DD6B_wire_test_contains_mirrored_sub_struct(port_);

  external dynamic /*  */ P7C55DD6B_wire_sum__method__SumWith(port_, that, y, z);

  external dynamic /*  */ P7C55DD6B_wire_new__static_method__ConcatenateWith(port_, a);

  external dynamic /*  */ P7C55DD6B_wire_concatenate__method__ConcatenateWith(port_, that, b);

  external dynamic /*  */ P7C55DD6B_wire_concatenate_static__static_method__ConcatenateWith(port_, a, b);

  external dynamic /*  */ P7C55DD6B_wire_handle_some_stream_sink__method__ConcatenateWith(port_, that, key, max);

  external dynamic /*  */ P7C55DD6B_wire_handle_some_stream_sink_at_1__method__ConcatenateWith(port_, that);

  external dynamic /*  */ P7C55DD6B_wire_handle_some_static_stream_sink__static_method__ConcatenateWith(
      port_, key, max);

  external dynamic /*  */ P7C55DD6B_wire_handle_some_static_stream_sink_single_arg__static_method__ConcatenateWith(
      port_);
...
class FlutterRustBridgeExampleSingleBlockTestWire
  ...
  dynamic /*  */ P7C55DD6B_wire_simple_adder(port_, a, b) => wasmModule.P7C55DD6B_wire_simple_adder(port_, a, b);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_simple_adder_sync(a, b) =>
      wasmModule.P7C55DD6B_wire_simple_adder_sync(a, b);

  dynamic /*  */ P7C55DD6B_wire_primitive_types(port_, my_i32, my_i64, my_f64, my_bool) =>
      wasmModule.P7C55DD6B_wire_primitive_types(port_, my_i32, my_i64, my_f64, my_bool);

  dynamic /*  */ P7C55DD6B_wire_primitive_optional_types(port_, my_i32, my_i64, my_f64, my_bool) =>
      wasmModule.P7C55DD6B_wire_primitive_optional_types(port_, my_i32, my_i64, my_f64, my_bool);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_primitive_types_sync(my_i32, my_i64, my_f64, my_bool) =>
      wasmModule.P7C55DD6B_wire_primitive_types_sync(my_i32, my_i64, my_f64, my_bool);

  dynamic /*  */ P7C55DD6B_wire_primitive_u32(port_, my_u32) => wasmModule.P7C55DD6B_wire_primitive_u32(port_, my_u32);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_primitive_u32_sync(my_u32) =>
      wasmModule.P7C55DD6B_wire_primitive_u32_sync(my_u32);

  dynamic /*  */ P7C55DD6B_wire_handle_string(port_, s) => wasmModule.P7C55DD6B_wire_handle_string(port_, s);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_string_sync(s) =>
      wasmModule.P7C55DD6B_wire_handle_string_sync(s);

  dynamic /*  */ P7C55DD6B_wire_handle_return_unit(port_) => wasmModule.P7C55DD6B_wire_handle_return_unit(port_);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_return_unit_sync() =>
      wasmModule.P7C55DD6B_wire_handle_return_unit_sync();

  dynamic /*  */ P7C55DD6B_wire_handle_vec_u8(port_, v) => wasmModule.P7C55DD6B_wire_handle_vec_u8(port_, v);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_vec_u8_sync(v) =>
      wasmModule.P7C55DD6B_wire_handle_vec_u8_sync(v);

  dynamic /*  */ P7C55DD6B_wire_handle_vec_of_primitive(port_, n) =>
      wasmModule.P7C55DD6B_wire_handle_vec_of_primitive(port_, n);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_vec_of_primitive_sync(n) =>
      wasmModule.P7C55DD6B_wire_handle_vec_of_primitive_sync(n);

  dynamic /*  */ P7C55DD6B_wire_handle_zero_copy_vec_of_primitive(port_, n) =>
      wasmModule.P7C55DD6B_wire_handle_zero_copy_vec_of_primitive(port_, n);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_zero_copy_vec_of_primitive_sync(n) =>
      wasmModule.P7C55DD6B_wire_handle_zero_copy_vec_of_primitive_sync(n);

  dynamic /*  */ P7C55DD6B_wire_handle_struct(port_, arg, boxed) =>
      wasmModule.P7C55DD6B_wire_handle_struct(port_, arg, boxed);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_struct_sync(arg, boxed) =>
      wasmModule.P7C55DD6B_wire_handle_struct_sync(arg, boxed);

  dynamic /*  */ P7C55DD6B_wire_handle_newtype(port_, arg) => wasmModule.P7C55DD6B_wire_handle_newtype(port_, arg);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_newtype_sync(arg) =>
      wasmModule.P7C55DD6B_wire_handle_newtype_sync(arg);

  dynamic /*  */ P7C55DD6B_wire_handle_list_of_struct(port_, l) =>
      wasmModule.P7C55DD6B_wire_handle_list_of_struct(port_, l);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_list_of_struct_sync(l) =>
      wasmModule.P7C55DD6B_wire_handle_list_of_struct_sync(l);

  dynamic /*  */ P7C55DD6B_wire_handle_string_list(port_, names) =>
      wasmModule.P7C55DD6B_wire_handle_string_list(port_, names);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_string_list_sync(names) =>
      wasmModule.P7C55DD6B_wire_handle_string_list_sync(names);

  dynamic /*  */ P7C55DD6B_wire_handle_complex_struct(port_, s) =>
      wasmModule.P7C55DD6B_wire_handle_complex_struct(port_, s);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_complex_struct_sync(s) =>
      wasmModule.P7C55DD6B_wire_handle_complex_struct_sync(s);

  dynamic /*  */ P7C55DD6B_wire_handle_nested_struct(port_, s) =>
      wasmModule.P7C55DD6B_wire_handle_nested_struct(port_, s);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_handle_sync_return(mode) =>
      wasmModule.P7C55DD6B_wire_handle_sync_return(mode);

  dynamic /*  */ P7C55DD6B_wire_handle_stream(port_, arg) => wasmModule.P7C55DD6B_wire_handle_stream(port_, arg);

  dynamic /*  */ P7C55DD6B_wire_handle_stream_of_struct(port_) =>
      wasmModule.P7C55DD6B_wire_handle_stream_of_struct(port_);

  dynamic /*  */ P7C55DD6B_wire_return_err(port_) => wasmModule.P7C55DD6B_wire_return_err(port_);

  dynamic /*  */ P7C55DD6B_wire_return_panic(port_) => wasmModule.P7C55DD6B_wire_return_panic(port_);

  dynamic /*  */ P7C55DD6B_wire_handle_optional_return(port_, left, right) =>
      wasmModule.P7C55DD6B_wire_handle_optional_return(port_, left, right);

  dynamic /*  */ P7C55DD6B_wire_handle_optional_struct(port_, document) =>
      wasmModule.P7C55DD6B_wire_handle_optional_struct(port_, document);

  dynamic /*  */ P7C55DD6B_wire_handle_optional_increment(port_, opt) =>
      wasmModule.P7C55DD6B_wire_handle_optional_increment(port_, opt);

  dynamic /*  */ P7C55DD6B_wire_handle_increment_boxed_optional(port_, opt) =>
      wasmModule.P7C55DD6B_wire_handle_increment_boxed_optional(port_, opt);

  dynamic /*  */ P7C55DD6B_wire_handle_option_box_arguments(
          port_, i8box, u8box, i32box, i64box, f64box, boolbox, structbox) =>
      wasmModule.P7C55DD6B_wire_handle_option_box_arguments(
          port_, i8box, u8box, i32box, i64box, f64box, boolbox, structbox);

  dynamic /*  */ P7C55DD6B_wire_print_note(port_, note) => wasmModule.P7C55DD6B_wire_print_note(port_, note);

  dynamic /*  */ P7C55DD6B_wire_handle_return_enum(port_, input) =>
      wasmModule.P7C55DD6B_wire_handle_return_enum(port_, input);

  dynamic /*  */ P7C55DD6B_wire_handle_enum_parameter(port_, weekday) =>
      wasmModule.P7C55DD6B_wire_handle_enum_parameter(port_, weekday);

  dynamic /*  */ P7C55DD6B_wire_handle_customized_struct(port_, val) =>
      wasmModule.P7C55DD6B_wire_handle_customized_struct(port_, val);

  dynamic /*  */ P7C55DD6B_wire_handle_enum_struct(port_, val) =>
      wasmModule.P7C55DD6B_wire_handle_enum_struct(port_, val);

  dynamic /*  */ P7C55DD6B_wire_use_imported_struct(port_, my_struct) =>
      wasmModule.P7C55DD6B_wire_use_imported_struct(port_, my_struct);

  dynamic /*  */ P7C55DD6B_wire_use_imported_enum(port_, my_enum) =>
      wasmModule.P7C55DD6B_wire_use_imported_enum(port_, my_enum);

  dynamic /*  */ P7C55DD6B_wire_get_app_settings(port_) => wasmModule.P7C55DD6B_wire_get_app_settings(port_);

  dynamic /*  */ P7C55DD6B_wire_get_fallible_app_settings(port_) =>
      wasmModule.P7C55DD6B_wire_get_fallible_app_settings(port_);

  dynamic /*  */ P7C55DD6B_wire_is_app_embedded(port_, app_settings) =>
      wasmModule.P7C55DD6B_wire_is_app_embedded(port_, app_settings);

  dynamic /*  */ P7C55DD6B_wire_get_message(port_) => wasmModule.P7C55DD6B_wire_get_message(port_);

  dynamic /*  */ P7C55DD6B_wire_repeat_number(port_, number, times) =>
      wasmModule.P7C55DD6B_wire_repeat_number(port_, number, times);

  dynamic /*  */ P7C55DD6B_wire_repeat_sequence(port_, seq, times) =>
      wasmModule.P7C55DD6B_wire_repeat_sequence(port_, seq, times);

  dynamic /*  */ P7C55DD6B_wire_first_number(port_, nums) => wasmModule.P7C55DD6B_wire_first_number(port_, nums);

  dynamic /*  */ P7C55DD6B_wire_first_sequence(port_, seqs) => wasmModule.P7C55DD6B_wire_first_sequence(port_, seqs);

  dynamic /*  */ P7C55DD6B_wire_get_array(port_) => wasmModule.P7C55DD6B_wire_get_array(port_);

  dynamic /*  */ P7C55DD6B_wire_get_complex_array(port_) => wasmModule.P7C55DD6B_wire_get_complex_array(port_);

  dynamic /*  */ P7C55DD6B_wire_get_usize(port_, u) => wasmModule.P7C55DD6B_wire_get_usize(port_, u);

  dynamic /*  */ P7C55DD6B_wire_next_user_id(port_, user_id) => wasmModule.P7C55DD6B_wire_next_user_id(port_, user_id);

  dynamic /*  */ P7C55DD6B_wire_register_event_listener(port_) =>
      wasmModule.P7C55DD6B_wire_register_event_listener(port_);

  dynamic /*  */ P7C55DD6B_wire_close_event_listener(port_) => wasmModule.P7C55DD6B_wire_close_event_listener(port_);

  dynamic /*  */ P7C55DD6B_wire_create_event(port_, address, payload) =>
      wasmModule.P7C55DD6B_wire_create_event(port_, address, payload);

  dynamic /*  */ P7C55DD6B_wire_handle_stream_sink_at_1(port_, key, max) =>
      wasmModule.P7C55DD6B_wire_handle_stream_sink_at_1(port_, key, max);

  dynamic /*  */ P7C55DD6B_wire_handle_stream_sink_at_2(port_, key, max) =>
      wasmModule.P7C55DD6B_wire_handle_stream_sink_at_2(port_, key, max);

  dynamic /*  */ P7C55DD6B_wire_handle_stream_sink_at_3(port_, key, max) =>
      wasmModule.P7C55DD6B_wire_handle_stream_sink_at_3(port_, key, max);

  dynamic /*  */ P7C55DD6B_wire_get_sum_struct(port_) => wasmModule.P7C55DD6B_wire_get_sum_struct(port_);

  dynamic /*  */ P7C55DD6B_wire_get_sum_array(port_, a, b, c) =>
      wasmModule.P7C55DD6B_wire_get_sum_array(port_, a, b, c);

  dynamic /*  */ P7C55DD6B_wire_multiply_by_ten(port_, measure) =>
      wasmModule.P7C55DD6B_wire_multiply_by_ten(port_, measure);

  dynamic /*  */ P7C55DD6B_wire_call_old_module_system(port_) =>
      wasmModule.P7C55DD6B_wire_call_old_module_system(port_);

  dynamic /*  */ P7C55DD6B_wire_call_new_module_system(port_) =>
      wasmModule.P7C55DD6B_wire_call_new_module_system(port_);

  dynamic /*  */ P7C55DD6B_wire_handle_big_buffers(port_) => wasmModule.P7C55DD6B_wire_handle_big_buffers(port_);

  dynamic /*  */ P7C55DD6B_wire_datetime_utc(port_, d) => wasmModule.P7C55DD6B_wire_datetime_utc(port_, d);

  dynamic /*  */ P7C55DD6B_wire_datetime_local(port_, d) => wasmModule.P7C55DD6B_wire_datetime_local(port_, d);

  dynamic /*  */ P7C55DD6B_wire_naivedatetime(port_, d) => wasmModule.P7C55DD6B_wire_naivedatetime(port_, d);

  dynamic /*  */ P7C55DD6B_wire_optional_empty_datetime_utc(port_, d) =>
      wasmModule.P7C55DD6B_wire_optional_empty_datetime_utc(port_, d);

  dynamic /*  */ P7C55DD6B_wire_duration(port_, d) => wasmModule.P7C55DD6B_wire_duration(port_, d);

  dynamic /*  */ P7C55DD6B_wire_handle_timestamps(port_, timestamps, epoch) =>
      wasmModule.P7C55DD6B_wire_handle_timestamps(port_, timestamps, epoch);

  dynamic /*  */ P7C55DD6B_wire_handle_durations(port_, durations, since) =>
      wasmModule.P7C55DD6B_wire_handle_durations(port_, durations, since);

  dynamic /*  */ P7C55DD6B_wire_test_chrono(port_) => wasmModule.P7C55DD6B_wire_test_chrono(port_);

  dynamic /*  */ P7C55DD6B_wire_test_precise_chrono(port_) => wasmModule.P7C55DD6B_wire_test_precise_chrono(port_);

  dynamic /*  */ P7C55DD6B_wire_how_long_does_it_take(port_, mine) =>
      wasmModule.P7C55DD6B_wire_how_long_does_it_take(port_, mine);

  dynamic /*  */ P7C55DD6B_wire_handle_uuid(port_, id) => wasmModule.P7C55DD6B_wire_handle_uuid(port_, id);

  dynamic /*  */ P7C55DD6B_wire_handle_uuids(port_, ids) => wasmModule.P7C55DD6B_wire_handle_uuids(port_, ids);

  dynamic /*  */ P7C55DD6B_wire_handle_nested_uuids(port_, ids) =>
      wasmModule.P7C55DD6B_wire_handle_nested_uuids(port_, ids);

  dynamic /*  */ P7C55DD6B_wire_new_msgid(port_, id) => wasmModule.P7C55DD6B_wire_new_msgid(port_, id);

  dynamic /*  */ P7C55DD6B_wire_use_msgid(port_, id) => wasmModule.P7C55DD6B_wire_use_msgid(port_, id);

  dynamic /*  */ P7C55DD6B_wire_boxed_blob(port_, blob) => wasmModule.P7C55DD6B_wire_boxed_blob(port_, blob);

  dynamic /*  */ P7C55DD6B_wire_use_boxed_blob(port_, blob) => wasmModule.P7C55DD6B_wire_use_boxed_blob(port_, blob);

  dynamic /*  */ P7C55DD6B_wire_return_boxed_feed_id(port_, id) =>
      wasmModule.P7C55DD6B_wire_return_boxed_feed_id(port_, id);

  dynamic /*  */ P7C55DD6B_wire_return_boxed_raw_feed_id(port_, id) =>
      wasmModule.P7C55DD6B_wire_return_boxed_raw_feed_id(port_, id);

  dynamic /*  */ P7C55DD6B_wire_test_id(port_, id) => wasmModule.P7C55DD6B_wire_test_id(port_, id);

  dynamic /*  */ P7C55DD6B_wire_last_number(port_, array) => wasmModule.P7C55DD6B_wire_last_number(port_, array);

  dynamic /*  */ P7C55DD6B_wire_nested_id(port_, id) => wasmModule.P7C55DD6B_wire_nested_id(port_, id);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_accept_dart_opaque(opaque) =>
      wasmModule.P7C55DD6B_wire_sync_accept_dart_opaque(opaque);

  dynamic /*  */ P7C55DD6B_wire_async_accept_dart_opaque(port_, opaque) =>
      wasmModule.P7C55DD6B_wire_async_accept_dart_opaque(port_, opaque);

  dynamic /*  */ P7C55DD6B_wire_loop_back(port_, opaque) => wasmModule.P7C55DD6B_wire_loop_back(port_, opaque);

  dynamic /*  */ P7C55DD6B_wire_loop_back_option(port_, opaque) =>
      wasmModule.P7C55DD6B_wire_loop_back_option(port_, opaque);

  dynamic /*  */ P7C55DD6B_wire_loop_back_array(port_, opaque) =>
      wasmModule.P7C55DD6B_wire_loop_back_array(port_, opaque);

  dynamic /*  */ P7C55DD6B_wire_loop_back_vec(port_, opaque) => wasmModule.P7C55DD6B_wire_loop_back_vec(port_, opaque);

  dynamic /*  */ P7C55DD6B_wire_loop_back_option_get(port_, opaque) =>
      wasmModule.P7C55DD6B_wire_loop_back_option_get(port_, opaque);

  dynamic /*  */ P7C55DD6B_wire_loop_back_array_get(port_, opaque) =>
      wasmModule.P7C55DD6B_wire_loop_back_array_get(port_, opaque);

  dynamic /*  */ P7C55DD6B_wire_loop_back_vec_get(port_, opaque) =>
      wasmModule.P7C55DD6B_wire_loop_back_vec_get(port_, opaque);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_unwrap_dart_opaque(opaque) =>
      wasmModule.P7C55DD6B_wire_unwrap_dart_opaque(opaque);

  dynamic /*  */ P7C55DD6B_wire_panic_unwrap_dart_opaque(port_, opaque) =>
      wasmModule.P7C55DD6B_wire_panic_unwrap_dart_opaque(port_, opaque);

  dynamic /*  */ P7C55DD6B_wire_create_opaque(port_) => wasmModule.P7C55DD6B_wire_create_opaque(port_);

  dynamic /*  */ P7C55DD6B_wire_create_option_opaque(port_, opaque) =>
      wasmModule.P7C55DD6B_wire_create_option_opaque(port_, opaque);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_create_opaque() =>
      wasmModule.P7C55DD6B_wire_sync_create_opaque();

  dynamic /*  */ P7C55DD6B_wire_create_array_opaque_enum(port_) =>
      wasmModule.P7C55DD6B_wire_create_array_opaque_enum(port_);

  dynamic /*  */ P7C55DD6B_wire_run_enum_opaque(port_, opaque) =>
      wasmModule.P7C55DD6B_wire_run_enum_opaque(port_, opaque);

  dynamic /*  */ P7C55DD6B_wire_run_opaque(port_, opaque) => wasmModule.P7C55DD6B_wire_run_opaque(port_, opaque);

  dynamic /*  */ P7C55DD6B_wire_run_opaque_with_delay(port_, opaque) =>
      wasmModule.P7C55DD6B_wire_run_opaque_with_delay(port_, opaque);

  dynamic /*  */ P7C55DD6B_wire_opaque_array(port_) => wasmModule.P7C55DD6B_wire_opaque_array(port_);

  dynamic /*  */ P7C55DD6B_wire_create_sync_opaque(port_) => wasmModule.P7C55DD6B_wire_create_sync_opaque(port_);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_create_sync_opaque() =>
      wasmModule.P7C55DD6B_wire_sync_create_sync_opaque();

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_run_opaque(opaque) =>
      wasmModule.P7C55DD6B_wire_sync_run_opaque(opaque);

  dynamic /*  */ P7C55DD6B_wire_opaque_array_run(port_, data) =>
      wasmModule.P7C55DD6B_wire_opaque_array_run(port_, data);

  dynamic /*  */ P7C55DD6B_wire_opaque_vec(port_) => wasmModule.P7C55DD6B_wire_opaque_vec(port_);

  dynamic /*  */ P7C55DD6B_wire_opaque_vec_run(port_, data) => wasmModule.P7C55DD6B_wire_opaque_vec_run(port_, data);

  dynamic /*  */ P7C55DD6B_wire_create_nested_opaque(port_) => wasmModule.P7C55DD6B_wire_create_nested_opaque(port_);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_loopback(opaque) =>
      wasmModule.P7C55DD6B_wire_sync_loopback(opaque);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_option_loopback(opaque) =>
      wasmModule.P7C55DD6B_wire_sync_option_loopback(opaque);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_option() => wasmModule.P7C55DD6B_wire_sync_option();

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_option_null() =>
      wasmModule.P7C55DD6B_wire_sync_option_null();

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_option_rust_opaque() =>
      wasmModule.P7C55DD6B_wire_sync_option_rust_opaque();

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_option_dart_opaque(opaque) =>
      wasmModule.P7C55DD6B_wire_sync_option_dart_opaque(opaque);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_sync_void() => wasmModule.P7C55DD6B_wire_sync_void();

  dynamic /*  */ P7C55DD6B_wire_run_nested_opaque(port_, opaque) =>
      wasmModule.P7C55DD6B_wire_run_nested_opaque(port_, opaque);

  dynamic /*  */ P7C55DD6B_wire_create_nested_dart_opaque(port_, opaque1, opaque2) =>
      wasmModule.P7C55DD6B_wire_create_nested_dart_opaque(port_, opaque1, opaque2);

  dynamic /*  */ P7C55DD6B_wire_get_nested_dart_opaque(port_, opaque) =>
      wasmModule.P7C55DD6B_wire_get_nested_dart_opaque(port_, opaque);

  dynamic /*  */ P7C55DD6B_wire_create_enum_dart_opaque(port_, opaque) =>
      wasmModule.P7C55DD6B_wire_create_enum_dart_opaque(port_, opaque);

  dynamic /*  */ P7C55DD6B_wire_get_enum_dart_opaque(port_, opaque) =>
      wasmModule.P7C55DD6B_wire_get_enum_dart_opaque(port_, opaque);

  dynamic /*  */ P7C55DD6B_wire_set_static_dart_opaque(port_, opaque) =>
      wasmModule.P7C55DD6B_wire_set_static_dart_opaque(port_, opaque);

  dynamic /*  */ P7C55DD6B_wire_drop_static_dart_opaque(port_) =>
      wasmModule.P7C55DD6B_wire_drop_static_dart_opaque(port_);

  dynamic /*  */ P7C55DD6B_wire_unwrap_rust_opaque(port_, opaque) =>
      wasmModule.P7C55DD6B_wire_unwrap_rust_opaque(port_, opaque);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_return_non_droppable_dart_opaque(opaque) =>
      wasmModule.P7C55DD6B_wire_return_non_droppable_dart_opaque(opaque);

  dynamic /*  */ P7C55DD6B_wire_frb_generator_test(port_) => wasmModule.P7C55DD6B_wire_frb_generator_test(port_);

  dynamic /* support::WireSyncReturn */ P7C55DD6B_wire_frb_sync_generator_test() =>
      wasmModule.P7C55DD6B_wire_frb_sync_generator_test();

  dynamic /*  */ P7C55DD6B_wire_handle_type_alias_id(port_, input) =>
      wasmModule.P7C55DD6B_wire_handle_type_alias_id(port_, input);

  dynamic /*  */ P7C55DD6B_wire_handle_type_nest_alias_id(port_, input) =>
      wasmModule.P7C55DD6B_wire_handle_type_nest_alias_id(port_, input);

  dynamic /*  */ P7C55DD6B_wire_handle_type_alias_model(port_, input) =>
      wasmModule.P7C55DD6B_wire_handle_type_alias_model(port_, input);

  dynamic /*  */ P7C55DD6B_wire_empty_struct(port_, empty) => wasmModule.P7C55DD6B_wire_empty_struct(port_, empty);

  dynamic /*  */ P7C55DD6B_wire_return_dart_dynamic(port_) => wasmModule.P7C55DD6B_wire_return_dart_dynamic(port_);

  dynamic /*  */ P7C55DD6B_wire_test_raw_string_item_struct(port_) =>
      wasmModule.P7C55DD6B_wire_test_raw_string_item_struct(port_);

  dynamic /*  */ P7C55DD6B_wire_test_more_than_just_one_raw_string_struct(port_) =>
      wasmModule.P7C55DD6B_wire_test_more_than_just_one_raw_string_struct(port_);

  dynamic /*  */ P7C55DD6B_wire_test_raw_string_mirrored(port_) =>
      wasmModule.P7C55DD6B_wire_test_raw_string_mirrored(port_);

  dynamic /*  */ P7C55DD6B_wire_test_nested_raw_string_mirrored(port_) =>
      wasmModule.P7C55DD6B_wire_test_nested_raw_string_mirrored(port_);

  dynamic /*  */ P7C55DD6B_wire_test_raw_string_enum_mirrored(port_, nested) =>
      wasmModule.P7C55DD6B_wire_test_raw_string_enum_mirrored(port_, nested);

  dynamic /*  */ P7C55DD6B_wire_test_list_of_raw_nested_string_mirrored(port_) =>
      wasmModule.P7C55DD6B_wire_test_list_of_raw_nested_string_mirrored(port_);

  dynamic /*  */ P7C55DD6B_wire_test_fallible_of_raw_string_mirrored(port_) =>
      wasmModule.P7C55DD6B_wire_test_fallible_of_raw_string_mirrored(port_);

  dynamic /*  */ P7C55DD6B_wire_list_of_primitive_enums(port_, weekdays) =>
      wasmModule.P7C55DD6B_wire_list_of_primitive_enums(port_, weekdays);

  dynamic /*  */ P7C55DD6B_wire_test_abc_enum(port_, abc) => wasmModule.P7C55DD6B_wire_test_abc_enum(port_, abc);

  dynamic /*  */ P7C55DD6B_wire_test_contains_mirrored_sub_struct(port_) =>
      wasmModule.P7C55DD6B_wire_test_contains_mirrored_sub_struct(port_);

  dynamic /*  */ P7C55DD6B_wire_sum__method__SumWith(port_, that, y, z) =>
      wasmModule.P7C55DD6B_wire_sum__method__SumWith(port_, that, y, z);

  dynamic /*  */ P7C55DD6B_wire_new__static_method__ConcatenateWith(port_, a) =>
      wasmModule.P7C55DD6B_wire_new__static_method__ConcatenateWith(port_, a);

  dynamic /*  */ P7C55DD6B_wire_concatenate__method__ConcatenateWith(port_, that, b) =>
      wasmModule.P7C55DD6B_wire_concatenate__method__ConcatenateWith(port_, that, b);

  dynamic /*  */ P7C55DD6B_wire_concatenate_static__static_method__ConcatenateWith(port_, a, b) =>
      wasmModule.P7C55DD6B_wire_concatenate_static__static_method__ConcatenateWith(port_, a, b);

  dynamic /*  */ P7C55DD6B_wire_handle_some_stream_sink__method__ConcatenateWith(port_, that, key, max) =>
      wasmModule.P7C55DD6B_wire_handle_some_stream_sink__method__ConcatenateWith(port_, that, key, max);

  dynamic /*  */ P7C55DD6B_wire_handle_some_stream_sink_at_1__method__ConcatenateWith(port_, that) =>
      wasmModule.P7C55DD6B_wire_handle_some_stream_sink_at_1__method__ConcatenateWith(port_, that);

  dynamic /*  */ P7C55DD6B_wire_handle_some_static_stream_sink__static_method__ConcatenateWith(port_, key, max) =>
      wasmModule.P7C55DD6B_wire_handle_some_static_stream_sink__static_method__ConcatenateWith(port_, key, max);

  dynamic /*  */ P7C55DD6B_wire_handle_some_static_stream_sink_single_arg__static_method__ConcatenateWith(port_) =>
