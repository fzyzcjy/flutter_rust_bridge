...
class FlutterRustBridgeExampleSingleBlockTestPlatform extends FlutterRustBridgeBase<FlutterRustBridgeExampleSingleBlockTestWire> with FlutterRustBridgeSetupMixin {
                FlutterRustBridgeExampleSingleBlockTestPlatform(FutureOr<WasmModule> dylib) : super(FlutterRustBridgeExampleSingleBlockTestWire(dylib)) {
...
@protected
                    List<dynamic> api2wire_application_settings(ApplicationSettings raw) {
                        return [api2wire_String(raw.name),api2wire_String(raw.version),api2wire_application_mode(raw.mode),api2wire_box_application_env(raw.env)];
                    }
@protected
...
@protected
                    List<dynamic> api2wire_exotic_optionals(ExoticOptionals raw) {
                        return [api2wire_opt_box_autoadd_i32(raw.int32),api2wire_opt_box_autoadd_i64(raw.int64),api2wire_opt_box_autoadd_f64(raw.float64),api2wire_opt_box_autoadd_bool(raw.boolean),api2wire_opt_ZeroCopyBuffer_Uint8List(raw.zerocopy),api2wire_opt_int_8_list(raw.int8List),api2wire_opt_uint_8_list(raw.uint8List),api2wire_opt_int_32_list(raw.int32List),api2wire_opt_float_32_list(raw.float32List),api2wire_opt_float_64_list(raw.float64List),api2wire_opt_list_attribute(raw.attributes),api2wire_list_opt_box_autoadd_attribute(raw.attributesNullable),api2wire_opt_list_opt_box_autoadd_attribute(raw.nullableAttributes),api2wire_opt_box_autoadd_new_type_int(raw.newtypeint)];
                    }
...
@protected
                    List<dynamic> api2wire_my_tree_node(MyTreeNode raw) {
                        return [api2wire_i32(raw.valueI32),api2wire_uint_8_list(raw.valueVecU8),api2wire_bool(raw.valueBoolean),api2wire_list_my_tree_node(raw.children)];
                    }
@protected
...
late final Finalizer<PlatformPointer> _BoxDartDebugFinalizer = Finalizer<PlatformPointer>(inner.drop_opaque_BoxDartDebug);
            Finalizer<PlatformPointer> get BoxDartDebugFinalizer => _BoxDartDebugFinalizer;
late final Finalizer<PlatformPointer> _FrbOpaqueReturnFinalizer = Finalizer<PlatformPointer>(inner.drop_opaque_FrbOpaqueReturn);
...
late final Finalizer<PlatformPointer> _MutexHideDataFinalizer = Finalizer<PlatformPointer>(inner.drop_opaque_MutexHideData);
            Finalizer<PlatformPointer> get MutexHideDataFinalizer => _MutexHideDataFinalizer;
late final Finalizer<PlatformPointer> _RwLockHideDataFinalizer = Finalizer<PlatformPointer>(inner.drop_opaque_RwLockHideData);
            Finalizer<PlatformPointer> get RwLockHideDataFinalizer => _RwLockHideDataFinalizer;
}

// Section: WASM wire module

@JS('wasm_bindgen') external FlutterRustBridgeExampleSingleBlockTestWasmModule get wasmModule;
@JS() @anonymous class FlutterRustBridgeExampleSingleBlockTestWasmModule implements WasmModule {
...
external void wire_handle_option_box_arguments(NativePortType port_,int /* *i8 */? i8box,int /* *u8 */? u8box,int /* *i32 */? i32box,int /* *i64 */? i64box,int /* *f64 */? f64box,int /* *bool */? boolbox,List<dynamic>? structbox);
...
external void wire_handle_some_stream_sink__method__ConcatenateWith(NativePortType port_,List<dynamic> that,int key,int max);

external void wire_handle_some_stream_sink_at_1__method__ConcatenateWith(NativePortType port_,List<dynamic> that);

external void wire_handle_some_static_stream_sink__static_method__ConcatenateWith(NativePortType port_,int key,int max);
...
class FlutterRustBridgeExampleSingleBlockTestWire extends FlutterRustBridgeWasmWireBase<FlutterRustBridgeExampleSingleBlockTestWasmModule> {
            FlutterRustBridgeExampleSingleBlockTestWire(FutureOr<WasmModule> module) : super(WasmModule.cast<FlutterRustBridgeExampleSingleBlockTestWasmModule>(module));
            
            void wire_simple_adder(NativePortType port_,int a,int b) => wasmModule.wire_simple_adder(port_,a,b);

void wire_primitive_types(NativePortType port_,int my_i32,Object my_i64,double my_f64,bool my_bool) => wasmModule.wire_primitive_types(port_,my_i32,my_i64,my_f64,my_bool);
...
void wire_handle_zero_copy_vec_of_primitive(NativePortType port_,int n) => wasmModule.wire_handle_zero_copy_vec_of_primitive(port_,n);

void wire_handle_struct(NativePortType port_,List<dynamic> arg,List<dynamic> boxed) => wasmModule.wire_handle_struct(port_,arg,boxed);

void wire_handle_newtype(NativePortType port_,List<dynamic> arg) => wasmModule.wire_handle_newtype(port_,arg);

void wire_handle_list_of_struct(NativePortType port_,List<dynamic> l) => wasmModule.wire_handle_list_of_struct(port_,l);

void wire_handle_string_list(NativePortType port_,List<String> names) => wasmModule.wire_handle_string_list(port_,names);

void wire_handle_complex_struct(NativePortType port_,List<dynamic> s) => wasmModule.wire_handle_complex_struct(port_,s);
...
void wire_handle_optional_return(NativePortType port_,double left,double right) => wasmModule.wire_handle_optional_return(port_,left,right);

void wire_handle_optional_struct(NativePortType port_,String? document) => wasmModule.wire_handle_optional_struct(port_,document);

void wire_handle_optional_increment(NativePortType port_,List<dynamic>? opt) => wasmModule.wire_handle_optional_increment(port_,opt);

void wire_handle_increment_boxed_optional(NativePortType port_,int /* *f64 */? opt) => wasmModule.wire_handle_increment_boxed_optional(port_,opt);

void wire_handle_option_box_arguments(NativePortType port_,int /* *i8 */? i8box,int /* *u8 */? u8box,int /* *i32 */? i32box,int /* *i64 */? i64box,int /* *f64 */? f64box,int /* *bool */? boolbox,List<dynamic>? structbox) => wasmModule.wire_handle_option_box_arguments(port_,i8box,u8box,i32box,i64box,f64box,boolbox,structbox);
...
void wire_handle_enum_parameter(NativePortType port_,int weekday) => wasmModule.wire_handle_enum_parameter(port_,weekday);

void wire_handle_customized_struct(NativePortType port_,List<dynamic> val) => wasmModule.wire_handle_customized_struct(port_,val);

void wire_handle_enum_struct(NativePortType port_,List<dynamic> val) => wasmModule.wire_handle_enum_struct(port_,val);

void wire_use_imported_struct(NativePortType port_,List<dynamic> my_struct) => wasmModule.wire_use_imported_struct(port_,my_struct);
...
void wire_is_app_embedded(NativePortType port_,List<dynamic> app_settings) => wasmModule.wire_is_app_embedded(port_,app_settings);
...
void wire_repeat_sequence(NativePortType port_,int seq,int times) => wasmModule.wire_repeat_sequence(port_,seq,times);
...
void wire_create_event(NativePortType port_,String address,String payload) => wasmModule.wire_create_event(port_,address,payload);

void wire_handle_stream_sink_at_1(NativePortType port_,int key,int max) => wasmModule.wire_handle_stream_sink_at_1(port_,key,max);

void wire_handle_stream_sink_at_2(NativePortType port_,int key,int max) => wasmModule.wire_handle_stream_sink_at_2(port_,key,max);

void wire_handle_stream_sink_at_3(NativePortType port_,int key,int max) => wasmModule.wire_handle_stream_sink_at_3(port_,key,max);
...
void wire_multiply_by_ten(NativePortType port_,List<dynamic> measure) => wasmModule.wire_multiply_by_ten(port_,measure);
...
void wire_how_long_does_it_take(NativePortType port_,List<dynamic> mine) => wasmModule.wire_how_long_does_it_take(port_,mine);
...
void wire_handle_nested_uuids(NativePortType port_,List<dynamic> ids) => wasmModule.wire_handle_nested_uuids(port_,ids);
...
void wire_return_boxed_raw_feed_id(NativePortType port_,List<dynamic> id) => wasmModule.wire_return_boxed_raw_feed_id(port_,id);
...
void wire_run_enum_opaque(NativePortType port_,List<dynamic> opaque) => wasmModule.wire_run_enum_opaque(port_,opaque);

void wire_run_opaque(NativePortType port_,dynamic opaque) => wasmModule.wire_run_opaque(port_,opaque);

void wire_run_opaque_with_delay(NativePortType port_,dynamic opaque) => wasmModule.wire_run_opaque_with_delay(port_,opaque);
...
void wire_run_nested_opaque(NativePortType port_,List<dynamic> opaque) => wasmModule.wire_run_nested_opaque(port_,opaque);

void wire_unwrap_rust_opaque(NativePortType port_,dynamic opaque) => wasmModule.wire_unwrap_rust_opaque(port_,opaque);

void wire_frb_generator_test(NativePortType port_) => wasmModule.wire_frb_generator_test(port_);

void wire_sum__method__SumWith(NativePortType port_,List<dynamic> that,int y,int z) => wasmModule.wire_sum__method__SumWith(port_,that,y,z);

void wire_new__static_method__ConcatenateWith(NativePortType port_,String a) => wasmModule.wire_new__static_method__ConcatenateWith(port_,a);

void wire_concatenate__method__ConcatenateWith(NativePortType port_,List<dynamic> that,String b) => wasmModule.wire_concatenate__method__ConcatenateWith(port_,that,b);

void wire_concatenate_static__static_method__ConcatenateWith(NativePortType port_,String a,String b) => wasmModule.wire_concatenate_static__static_method__ConcatenateWith(port_,a,b);

void wire_handle_some_stream_sink__method__ConcatenateWith(NativePortType port_,List<dynamic> that,int key,int max) => wasmModule.wire_handle_some_stream_sink__method__ConcatenateWith(port_,that,key,max);

void wire_handle_some_stream_sink_at_1__method__ConcatenateWith(NativePortType port_,List<dynamic> that) => wasmModule.wire_handle_some_stream_sink_at_1__method__ConcatenateWith(port_,that);

void wire_handle_some_static_stream_sink__static_method__ConcatenateWith(NativePortType port_,int key,int max) => wasmModule.wire_handle_some_static_stream_sink__static_method__ConcatenateWith(port_,key,max);

void wire_handle_some_static_stream_sink_single_arg__static_method__ConcatenateWith(NativePortType port_) => wasmModule.wire_handle_some_static_stream_sink_single_arg__static_method__ConcatenateWith(port_);
