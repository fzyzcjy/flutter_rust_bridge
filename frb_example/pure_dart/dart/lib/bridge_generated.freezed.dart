...
abstract class Error0 implements CustomError, FrbBacktracedException {
  const factory Error0(
      {required final String e, required final String backtrace}) = _$Error0;
...
abstract class Error1 implements CustomError, FrbBacktracedException {
  const factory Error1(
      {required final int e, required final String backtrace}) = _$Error1;
