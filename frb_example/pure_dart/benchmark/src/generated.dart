...
class PrimeNumber_Na_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      PrimeNumber_Na_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"PrimeNumber","approach":"Na","direction":null,"asynchronous":false,"arg":"$number","platform":"$currentPlatformName"}');
      
      @override
      void setup() {  }

      @override
      void run() {         final ans = isPrime(number);
...
class IntParse_Na_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      IntParse_Na_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"IntParse","approach":"Na","direction":null,"asynchronous":false,"arg":"$number","platform":"$currentPlatformName"}');
      
      @override
      void setup() {  }

      @override
      void run() {         final ans = int.parse(number);
        dummyValue ^= ans;
       }
...
class Base64Encode_Na_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      Base64Encode_Na_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"Base64Encode","approach":"Na","direction":null,"asynchronous":false,"arg":"$len","platform":"$currentPlatformName"}');
      
      @override
      void setup() { setupData = 'HelloWorld' * (len ~/ 10); }

      @override
      void run() {         final ans = base64Encode(utf8.encode(setupData));
...
class VoidFunction_Frb_Async_Benchmark extends EnhancedAsyncBenchmarkBase {
      ...
      VoidFunction_Frb_Async_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"VoidFunction","approach":"Frb","direction":null,"asynchronous":true,"platform":"$currentPlatformName"}');
      
      @override
      Future<void> setup() async {  }

      @override
      Future<void> run() async { await benchmarkVoidTwinNormal(); }
...
class VoidFunction_Frb_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      VoidFunction_Frb_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"VoidFunction","approach":"Frb","direction":null,"asynchronous":false,"platform":"$currentPlatformName"}');
...
class VoidFunction_FrbSse_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      VoidFunction_FrbSse_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"VoidFunction","approach":"FrbSse","direction":null,"asynchronous":false,"platform":"$currentPlatformName"}');
      
      @override
      void setup() {  }

      @override
      void run() { benchmarkVoidTwinSyncSse(); }
...
class VoidFunction_FrbCstSse_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      VoidFunction_FrbCstSse_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"VoidFunction","approach":"FrbCstSse","direction":null,"asynchronous":false,"platform":"$currentPlatformName"}');
      
      @override
      void setup() {  }

      @override
      void run() { benchmarkVoidSemiSerialize(); }
...
class VoidFunction_Raw_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      VoidFunction_Raw_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"VoidFunction","approach":"Raw","direction":null,"asynchronous":false,"platform":"$currentPlatformName"}');
...
class VoidFunction_Raw_Async_Benchmark extends EnhancedAsyncBenchmarkBase {
      ...
      VoidFunction_Raw_Async_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"VoidFunction","approach":"Raw","direction":null,"asynchronous":true,"platform":"$currentPlatformName"}');
...
class Bytes_Frb_Input_Async_Benchmark extends EnhancedAsyncBenchmarkBase {
      ...
      Bytes_Frb_Input_Async_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"Bytes","approach":"Frb","direction":"Input","asynchronous":true,"arg":"$len","platform":"$currentPlatformName"}');
      
      @override
      Future<void> setup() async { setupData = Uint8List(len); }

      @override
      Future<void> run() async { await benchmarkInputBytesTwinNormal(bytes: setupData); }
...
class Bytes_Frb_Input_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      Bytes_Frb_Input_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"Bytes","approach":"Frb","direction":"Input","asynchronous":false,"arg":"$len","platform":"$currentPlatformName"}');
      
      @override
      void setup() { setupData = Uint8List(len); }

      @override
      void run() {  benchmarkInputBytesTwinSync(bytes: setupData); }
...
class Bytes_Raw_Input_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      Bytes_Raw_Input_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"Bytes","approach":"Raw","direction":"Input","asynchronous":false,"arg":"$len","platform":"$currentPlatformName"}');
      
      @override
      void setup() { setupData = Uint8List(len); }

      @override
      void run() {         final raw = rawWire.benchmark_raw_new_list_prim_u_8(setupData.length);
...
class Bytes_Frb_Output_Async_Benchmark extends EnhancedAsyncBenchmarkBase {
      ...
      Bytes_Frb_Output_Async_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"Bytes","approach":"Frb","direction":"Output","asynchronous":true,"arg":"$len","platform":"$currentPlatformName"}');
      
      @override
      Future<void> setup() async {  }

      @override
      Future<void> run() async { await benchmarkOutputBytesTwinNormal(size: len); }
...
class Bytes_Frb_Output_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      Bytes_Frb_Output_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"Bytes","approach":"Frb","direction":"Output","asynchronous":false,"arg":"$len","platform":"$currentPlatformName"}');
...
class Bytes_Raw_Output_Async_Benchmark extends EnhancedAsyncBenchmarkBase {
        ...
        Bytes_Raw_Output_Async_Benchmark({required this.len, super.emitter})
            : super('{"area":"PureDart","task":"Bytes","approach":"Raw","direction":"Output","asynchronous":true,"arg":"$len","platform":"$currentPlatformName"}') {
...
class BinaryTree_Frb_Input_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      BinaryTree_Frb_Input_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"BinaryTree","approach":"Frb","direction":"Input","asynchronous":false,"arg":"$depth","platform":"$currentPlatformName"}');
      
      @override
      void setup() { setupData = _createTree(depth); }

      @override
      void run() { benchmarkBinaryTreeInputTwinSync(tree: setupData); }
...
class BinaryTree_Frb_Output_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      BinaryTree_Frb_Output_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"BinaryTree","approach":"Frb","direction":"Output","asynchronous":false,"arg":"$depth","platform":"$currentPlatformName"}');
...
class BinaryTree_FrbSse_Input_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      BinaryTree_FrbSse_Input_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"BinaryTree","approach":"FrbSse","direction":"Input","asynchronous":false,"arg":"$depth","platform":"$currentPlatformName"}');
      
      @override
      void setup() { setupData = _createTree(depth); }

      @override
      void run() { benchmarkBinaryTreeInputTwinSyncSse(tree: setupData); }
...
class BinaryTree_FrbSse_Output_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      BinaryTree_FrbSse_Output_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"BinaryTree","approach":"FrbSse","direction":"Output","asynchronous":false,"arg":"$depth","platform":"$currentPlatformName"}');
...
class BinaryTree_Protobuf_Input_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      BinaryTree_Protobuf_Input_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"BinaryTree","approach":"Protobuf","direction":"Input","asynchronous":false,"arg":"$depth","platform":"$currentPlatformName"}');
      
      @override
      void setup() { setupData = _createTreeProtobuf(depth); }

      @override
      void run() { benchmarkBinaryTreeInputProtobufTwinSync(raw: setupData.writeToBuffer()); }
...
class BinaryTree_Protobuf_Output_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      BinaryTree_Protobuf_Output_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"BinaryTree","approach":"Protobuf","direction":"Output","asynchronous":false,"arg":"$depth","platform":"$currentPlatformName"}');
      
      @override
      void setup() {  }

      @override
      void run() {         final raw = benchmarkBinaryTreeOutputProtobufTwinSync(depth: depth);
...
class BinaryTree_Json_Input_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      BinaryTree_Json_Input_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"BinaryTree","approach":"Json","direction":"Input","asynchronous":false,"arg":"$depth","platform":"$currentPlatformName"}');
      
      @override
      void setup() { setupData = BinaryTree_Frb_Input_Sync_Benchmark._createTree(depth); }

      @override
      void run() { benchmarkBinaryTreeInputJsonTwinSync(raw: jsonEncode(setupData, toEncodable: _toJson)); }
...
class BinaryTree_Json_Output_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      BinaryTree_Json_Output_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"BinaryTree","approach":"Json","direction":"Output","asynchronous":false,"arg":"$depth","platform":"$currentPlatformName"}');
      
      @override
      void setup() {  }

      @override
      void run() {     final raw = benchmarkBinaryTreeOutputJsonTwinSync(depth: depth);
...
class Blob_Frb_Input_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      Blob_Frb_Input_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"Blob","approach":"Frb","direction":"Input","asynchronous":false,"arg":"$len","platform":"$currentPlatformName"}');
      
      @override
      void setup() {         setupData = BenchmarkBlobTwinSync(
          first: Uint8List(len),
      ...
      @override
      void run() { benchmarkBlobInputTwinSync(blob: setupData); }
...
class Blob_Frb_Output_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      Blob_Frb_Output_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"Blob","approach":"Frb","direction":"Output","asynchronous":false,"arg":"$len","platform":"$currentPlatformName"}');
...
class Blob_FrbSse_Input_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      Blob_FrbSse_Input_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"Blob","approach":"FrbSse","direction":"Input","asynchronous":false,"arg":"$len","platform":"$currentPlatformName"}');
      
      @override
      void setup() {         setupData = BenchmarkBlobTwinSyncSse(
          first: Uint8List(len),
          second: Uint8List(len),
          third: Uint8List(len),
        );
      ...
      @override
      void run() { benchmarkBlobInputTwinSyncSse(blob: setupData); }
...
class Blob_FrbSse_Output_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      Blob_FrbSse_Output_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"Blob","approach":"FrbSse","direction":"Output","asynchronous":false,"arg":"$len","platform":"$currentPlatformName"}');
...
class Blob_Protobuf_Input_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      Blob_Protobuf_Input_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"Blob","approach":"Protobuf","direction":"Input","asynchronous":false,"arg":"$len","platform":"$currentPlatformName"}');
      
      @override
      void setup() {         setupData = BlobProtobuf(
          first: Uint8List(len),
          second: Uint8List(len),
          third: Uint8List(len),
        );
      ...
      @override
      void run() { benchmarkBlobInputProtobufTwinSync(raw: setupData.writeToBuffer()); }
...
class Blob_Protobuf_Output_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      Blob_Protobuf_Output_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"Blob","approach":"Protobuf","direction":"Output","asynchronous":false,"arg":"$len","platform":"$currentPlatformName"}');
      
      @override
      void setup() {  }

      @override
      void run() {         final raw = benchmarkBlobOutputProtobufTwinSync(size: len);
...
class Blob_Json_Input_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      Blob_Json_Input_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"Blob","approach":"Json","direction":"Input","asynchronous":false,"arg":"$len","platform":"$currentPlatformName"}');
      ...
      @override
      void run() { benchmarkBlobInputJsonTwinSync(raw: jsonEncode(setupData, toEncodable: _toJson)); }
...
class Blob_Json_Output_Sync_Benchmark extends EnhancedBenchmarkBase {
      ...
      Blob_Json_Output_Sync_Benchmark({
        ...
        super.emitter,
      }) : super('{"area":"PureDart","task":"Blob","approach":"Json","direction":"Output","asynchronous":false,"arg":"$len","platform":"$currentPlatformName"}');
      
      @override
      void setup() {  }

      @override
      void run() {         final raw = benchmarkBlobOutputJsonTwinSync(size: len);
        // TODO: Should use json_serialize to further generate Dart objects
        // Otherwise this comparison is unfair (JSON does fewer amount of work)
        final json = jsonDecode(raw);
        dummyValue ^= json.hashCode;
