...
fn P7C55DD6B_wire_sync_create_non_clone_impl() -> support::WireSyncReturn {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(
        WrapInfo {
...
fn P7C55DD6B_wire_run_non_clone_impl(
    port_: MessagePort,
...
fn P7C55DD6B_wire_as_string__method__Event_impl(
    port_: MessagePort,
