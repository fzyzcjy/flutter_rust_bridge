...
// Section: wire functions
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "primitive_types", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    ...
                    move |task_callback| Ok(primitive_types(api_my_i32, api_my_i64, api_my_f64, api_my_bool))
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_option_box_arguments", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    ...
                    move |task_callback| Ok(handle_option_box_arguments(api_i8box, api_u8box, api_i32box, api_i64box, api_f64box, api_boolbox, api_structbox))
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "get_complex_array", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    ...
                    move |task_callback| Ok(get_complex_array())
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "close_event_listener", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    ...
                    move |task_callback| Ok(close_event_listener())
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "create_event", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    ...
                    move |task_callback| Ok(create_event())
                ...
                #[no_mangle]
                pub extern "C" fn wire_r#sum__method(port_: i64, StructWithMethod__method: *mut wire_StructWithMethod, a: u32, b: u32)  {
                    
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "r#sum__method", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    let api_StructWithMethod__method = StructWithMethod__method.wire2api();let api_a = a.wire2api();let api_b = b.wire2api();
                    move |task_callback| Ok(StructWithMethod::r#sum__method(&api_StructWithMethod__method, api_a, api_b))
...
// Section: allocate functions
                ...
                #[no_mangle]
                pub extern "C" fn new_list_opt_box_autoadd_attribute(len: i32) -> *mut wire_list_opt_box_autoadd_attribute {
...
impl Wire2Api<StructWithMethod> for wire_StructWithMethod {
            fn wire2api(self) -> StructWithMethod {
                StructWithMethod{something:  self.something.wire2api()}
            }
        }
...
impl NewWithNullPtr for wire_StructWithMethod {
                    fn new_with_null_ptr() -> Self {
                        Self { something: core::ptr::null_mut(), }
                    }
                }
