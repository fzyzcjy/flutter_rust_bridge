#![allow(non_camel_case_types, unused, clippy::redundant_closure, clippy::useless_conversion, clippy::unit_arg, clippy::double_parens, non_snake_case)]
...
// Section: wire functions
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "simple_adder", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "primitive_types", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    ...
                    move |task_callback| Result::<_,()>::Ok(primitive_types(api_my_i32, api_my_i64, api_my_f64, api_my_bool))
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "primitive_u32", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_string", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_return_unit", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| Result::<_,()>::Ok(handle_return_unit())
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_vec_u8", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_vec_of_primitive", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_zero_copy_vec_of_primitive", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    let api_n = n.wire2api();
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_struct", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_newtype", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_list_of_struct", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_string_list", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_complex_struct", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    let api_s = s.wire2api();
                ...
                #[no_mangle]
                pub extern "C" fn wire_handle_sync_return(mode: *mut wire_uint_8_list) -> support::WireSyncReturnStruct {
                    
                FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync(WrapInfo{ debug_name: "handle_sync_return", port: None, mode: FfiCallMode::Sync }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_stream", port: Some(port_), mode: FfiCallMode::Stream }, move || {
                    let api_arg = arg.wire2api();
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_stream_of_struct", port: Some(port_), mode: FfiCallMode::Stream }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "return_err", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "return_panic", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| Result::<_,()>::Ok(return_panic())
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_optional_return", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_optional_struct", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_optional_increment", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_increment_boxed_optional", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    let api_opt = opt.wire2api();
                ...
                #[no_mangle]
                pub extern "C" fn wire_handle_option_box_arguments(port_: i64, i8box: *mut i8, u8box: *mut u8, i32box: *mut i32, i64box: *mut i64, f64box: *mut f64, boolbox: *mut bool, structbox: *mut wire_ExoticOptionals)  {
                    
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_option_box_arguments", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    ...
                    move |task_callback| Result::<_,()>::Ok(handle_option_box_arguments(api_i8box, api_u8box, api_i32box, api_i64box, api_f64box, api_boolbox, api_structbox))
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "print_note", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_return_enum", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_enum_parameter", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_customized_struct", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_enum_struct", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    let api_val = val.wire2api();
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "use_imported_struct", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "use_imported_enum", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "get_app_settings", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "is_app_embedded", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "get_message", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| Result::<_,()>::Ok(mirror_ApplicationMessage(get_message()))
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "get_array", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| Result::<_,()>::Ok(get_array())
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "get_complex_array", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| Result::<_,()>::Ok(get_complex_array())
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "get_usize", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "next_user_id", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "register_event_listener", port: Some(port_), mode: FfiCallMode::Stream }, move || {
                    
                    move |task_callback| register_event_listener(task_callback.stream_sink())
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "close_event_listener", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| Result::<_,()>::Ok(close_event_listener())
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "create_event", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| Result::<_,()>::Ok(create_event())
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_stream_sink_at_1", port: Some(port_), mode: FfiCallMode::Stream }, move || {
                    let api_key = key.wire2api();let api_max = max.wire2api();
                    move |task_callback| handle_stream_sink_at_1(api_key, api_max, task_callback.stream_sink())
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_stream_sink_at_2", port: Some(port_), mode: FfiCallMode::Stream }, move || {
                    let api_key = key.wire2api();let api_max = max.wire2api();
                    move |task_callback| handle_stream_sink_at_2(api_key, task_callback.stream_sink(), api_max)
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_stream_sink_at_3", port: Some(port_), mode: FfiCallMode::Stream }, move || {
                    let api_key = key.wire2api();let api_max = max.wire2api();
                    move |task_callback| handle_stream_sink_at_3(task_callback.stream_sink(), api_key, api_max)
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "return_err_custom_error", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| return_err_custom_error()
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "return_ok_custom_error", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| return_ok_custom_error()
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "return_error_variant", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "return_custom_nested_error_1", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| return_custom_nested_error_1()
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "return_custom_struct_error", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| return_custom_struct_error()
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "return_custom_struct_ok", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| return_custom_struct_ok()
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "sum__method__SumWith", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    let api_that = that.wire2api();let api_y = y.wire2api();let api_z = z.wire2api();
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "new__static_method__ConcatenateWith", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                #[no_mangle]
                pub extern "C" fn wire_concatenate__method__ConcatenateWith(port_: i64, that: *mut wire_ConcatenateWith, b: *mut wire_uint_8_list)  {
                    
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "concatenate__method__ConcatenateWith", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    let api_that = that.wire2api();let api_b = b.wire2api();
                ...
                #[no_mangle]
                pub extern "C" fn wire_concatenate_static__static_method__ConcatenateWith(port_: i64, a: *mut wire_uint_8_list, b: *mut wire_uint_8_list)  {
                    
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "concatenate_static__static_method__ConcatenateWith", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    let api_a = a.wire2api();let api_b = b.wire2api();
                    move |task_callback| Result::<_,()>::Ok(ConcatenateWith::concatenate_static(api_a, api_b))
                ...
                #[no_mangle]
                pub extern "C" fn wire_handle_some_stream_sink__method__ConcatenateWith(port_: i64, that: *mut wire_ConcatenateWith, key: u32, max: u32)  {
                    
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_some_stream_sink__method__ConcatenateWith", port: Some(port_), mode: FfiCallMode::Stream }, move || {
                    let api_that = that.wire2api();let api_key = key.wire2api();let api_max = max.wire2api();
                    move |task_callback| ConcatenateWith::handle_some_stream_sink(&api_that, api_key, api_max, task_callback.stream_sink())
                ...
                #[no_mangle]
                pub extern "C" fn wire_handle_some_stream_sink_at_1__method__ConcatenateWith(port_: i64, that: *mut wire_ConcatenateWith)  {
                    
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_some_stream_sink_at_1__method__ConcatenateWith", port: Some(port_), mode: FfiCallMode::Stream }, move || {
                    let api_that = that.wire2api();
                    move |task_callback| ConcatenateWith::handle_some_stream_sink_at_1(&api_that, task_callback.stream_sink())
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_some_static_stream_sink__static_method__ConcatenateWith", port: Some(port_), mode: FfiCallMode::Stream }, move || {
                    let api_key = key.wire2api();let api_max = max.wire2api();
                    move |task_callback| ConcatenateWith::handle_some_static_stream_sink(api_key, api_max, task_callback.stream_sink())
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "handle_some_static_stream_sink_single_arg__static_method__ConcatenateWith", port: Some(port_), mode: FfiCallMode::Stream }, move || {
                    
                    move |task_callback| ConcatenateWith::handle_some_static_stream_sink_single_arg(task_callback.stream_sink())
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "new__static_method__SomeStruct", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "static_return_err_custom_error__static_method__SomeStruct", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| SomeStruct::static_return_err_custom_error()
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "static_return_ok_custom_error__static_method__SomeStruct", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| SomeStruct::static_return_ok_custom_error()
                ...
                #[no_mangle]
                pub extern "C" fn wire_non_static_return_err_custom_error__method__SomeStruct(port_: i64, that: *mut wire_SomeStruct)  {
                    
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "non_static_return_err_custom_error__method__SomeStruct", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    let api_that = that.wire2api();
                ...
                #[no_mangle]
                pub extern "C" fn wire_non_static_return_ok_custom_error__method__SomeStruct(port_: i64, that: *mut wire_SomeStruct)  {
                    
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "non_static_return_ok_custom_error__method__SomeStruct", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    let api_that = that.wire2api();
                ...
                #[no_mangle]
                pub extern "C" fn wire_new__static_method__CustomStruct(port_: i64, message: *mut wire_uint_8_list)  {
                    
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "new__static_method__CustomStruct", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "static_return_custom_struct_error__static_method__CustomStruct", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| CustomStruct::static_return_custom_struct_error()
                ...
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "static_return_custom_struct_ok__static_method__CustomStruct", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    
                    move |task_callback| CustomStruct::static_return_custom_struct_ok()
                ...
                #[no_mangle]
                pub extern "C" fn wire_nonstatic_return_custom_struct_error__method__CustomStruct(port_: i64, that: *mut wire_CustomStruct)  {
                    
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "nonstatic_return_custom_struct_error__method__CustomStruct", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    let api_that = that.wire2api();
                ...
                #[no_mangle]
                pub extern "C" fn wire_nonstatic_return_custom_struct_ok__method__CustomStruct(port_: i64, that: *mut wire_CustomStruct)  {
                    
                FLUTTER_RUST_BRIDGE_HANDLER.wrap(WrapInfo{ debug_name: "nonstatic_return_custom_struct_ok__method__CustomStruct", port: Some(port_), mode: FfiCallMode::Normal }, move || {
                    let api_that = that.wire2api();
...
#[repr(C)]
            #[derive(Clone)]
            pub struct wire_KitchenSink { tag: i32, kind: *mut KitchenSinkKind }
...
#[repr(C)]
                    #[derive(Clone)]
                    pub struct KitchenSink_Primitives { int32: i32,
float64: f64,
boolean: bool, }

#[repr(C)]
                    #[derive(Clone)]
                    pub struct KitchenSink_Nested { field0: *mut wire_KitchenSink,
field1: i32, }

#[repr(C)]
                    #[derive(Clone)]
                    pub struct KitchenSink_Optional { field0: *mut i32,
field1: *mut i32, }

#[repr(C)]
                    #[derive(Clone)]
                    pub struct KitchenSink_Buffer { field0: *mut wire_uint_8_list, }

#[repr(C)]
                    #[derive(Clone)]
                    pub struct KitchenSink_Enums { field0: i32, }
...
const _: fn() = || {
{ let ApplicationEnv = None::<ApplicationEnv>.unwrap(); let _: Vec<ApplicationEnvVar> = ApplicationEnv.vars;
 } 
{ let ApplicationEnvVar_ = None::<ApplicationEnvVar>.unwrap(); let _: String = ApplicationEnvVar_.0;
let _: bool = ApplicationEnvVar_.1;
 } 
match None::<ApplicationMessage>.unwrap() { ApplicationMessage::DisplayMessage(field0) => { let _: String = field0;
 },ApplicationMessage::RenderPixel { x,y } => { let _: i32 = x;
let _: i32 = y;
 },ApplicationMessage::Exit => {} }
match None::<ApplicationMode>.unwrap() { ApplicationMode::Standalone => {},ApplicationMode::Embedded => {} }
{ let ApplicationSettings = None::<ApplicationSettings>.unwrap(); let _: String = ApplicationSettings.name;
...
// Section: allocate functions
                ...
                pub extern "C" fn new_float_32_list_0(len: i32) -> *mut wire_float_32_list {
                    let ans = wire_float_32_list { ptr: support::new_leak_vec_ptr(Default::default(), len), len };
                ...
                pub extern "C" fn new_float_64_list_0(len: i32) -> *mut wire_float_64_list {
                    let ans = wire_float_64_list { ptr: support::new_leak_vec_ptr(Default::default(), len), len };
                support::new_leak_box_ptr(ans)
                }
                ...
                pub extern "C" fn new_int_32_list_0(len: i32) -> *mut wire_int_32_list {
                    let ans = wire_int_32_list { ptr: support::new_leak_vec_ptr(Default::default(), len), len };
                support::new_leak_box_ptr(ans)
                }
                ...
                pub extern "C" fn new_int_64_list_0(len: i32) -> *mut wire_int_64_list {
                    let ans = wire_int_64_list { ptr: support::new_leak_vec_ptr(Default::default(), len), len };
                support::new_leak_box_ptr(ans)
                }
                ...
                pub extern "C" fn new_int_8_list_0(len: i32) -> *mut wire_int_8_list {
                    let ans = wire_int_8_list { ptr: support::new_leak_vec_ptr(Default::default(), len), len };
                support::new_leak_box_ptr(ans)
                }
                ...
                pub extern "C" fn new_list_application_env_var_0(len: i32) -> *mut wire_list_application_env_var {
                    let wrap = wire_list_application_env_var { ptr: support::new_leak_vec_ptr(<wire_ApplicationEnvVar>::new_with_null_ptr(), len), len };
                support::new_leak_box_ptr(wrap)
                }
                ...
                pub extern "C" fn new_list_attribute_0(len: i32) -> *mut wire_list_attribute {
                    let wrap = wire_list_attribute { ptr: support::new_leak_vec_ptr(<wire_Attribute>::new_with_null_ptr(), len), len };
                support::new_leak_box_ptr(wrap)
                }
                ...
                pub extern "C" fn new_list_my_size_0(len: i32) -> *mut wire_list_my_size {
                    let wrap = wire_list_my_size { ptr: support::new_leak_vec_ptr(<wire_MySize>::new_with_null_ptr(), len), len };
                support::new_leak_box_ptr(wrap)
                }
                ...
                pub extern "C" fn new_list_my_tree_node_0(len: i32) -> *mut wire_list_my_tree_node {
                    let wrap = wire_list_my_tree_node { ptr: support::new_leak_vec_ptr(<wire_MyTreeNode>::new_with_null_ptr(), len), len };
                support::new_leak_box_ptr(wrap)
                }
                ...
                pub extern "C" fn new_list_opt_box_autoadd_attribute_0(len: i32) -> *mut wire_list_opt_box_autoadd_attribute {
                    let wrap = wire_list_opt_box_autoadd_attribute { ptr: support::new_leak_vec_ptr(<*mut wire_Attribute>::new_with_null_ptr(), len), len };
                support::new_leak_box_ptr(wrap)
                }
...
impl Wire2Api<ApplicationEnv> for wire_ApplicationEnv {
            fn wire2api(self) -> ApplicationEnv {
                ApplicationEnv{vars:  self.vars.wire2api()}
            }
        }
...
impl Wire2Api<ApplicationSettings> for wire_ApplicationSettings {
            fn wire2api(self) -> ApplicationSettings {
                ApplicationSettings{name:  self.name.wire2api(),version:  self.version.wire2api(),mode:  self.mode.wire2api(),env:  self.env.wire2api()}
            }
        }
        
impl Wire2Api<Attribute> for wire_Attribute {
            fn wire2api(self) -> Attribute {
                Attribute{key:  self.key.wire2api(),value:  self.value.wire2api()}
            }
        }
...
impl Wire2Api<CustomStruct> for wire_CustomStruct {
            fn wire2api(self) -> CustomStruct {
                CustomStruct{message:  self.message.wire2api()}
            }
        }
        
impl Wire2Api<Customized> for wire_Customized {
            fn wire2api(self) -> Customized {
                Customized{final_field:  self.final_field.wire2api(),non_final_field:  self.non_final_field.wire2api()}
            }
        }
        
impl Wire2Api<ExoticOptionals> for wire_ExoticOptionals {
            fn wire2api(self) -> ExoticOptionals {
                ExoticOptionals{int32:  self.int32.wire2api(),int64:  self.int64.wire2api(),float64:  self.float64.wire2api(),boolean:  self.boolean.wire2api(),zerocopy:  self.zerocopy.wire2api(),int8list:  self.int8list.wire2api(),uint8list:  self.uint8list.wire2api(),int32list:  self.int32list.wire2api(),int64list:  self.int64list.wire2api(),float32list:  self.float32list.wire2api(),float64list:  self.float64list.wire2api(),attributes:  self.attributes.wire2api(),attributes_nullable:  self.attributes_nullable.wire2api(),nullable_attributes:  self.nullable_attributes.wire2api(),newtypeint:  self.newtypeint.wire2api()}
            }
        }
...
1 => unsafe {
                            ...
                            KitchenSink::Primitives{int32: ans.int32.wire2api(),float64: ans.float64.wire2api(),boolean: ans.boolean.wire2api()}
                        }
2 => unsafe {
                            let ans = support::box_from_leak_ptr(self.kind);
...
impl Wire2Api<MySize> for wire_MySize {
            fn wire2api(self) -> MySize {
                MySize{width:  self.width.wire2api(),height:  self.height.wire2api()}
            }
        }
        
impl Wire2Api<MyStruct> for wire_MyStruct {
            fn wire2api(self) -> MyStruct {
                MyStruct{content:  self.content.wire2api()}
            }
        }
        
impl Wire2Api<MyTreeNode> for wire_MyTreeNode {
            fn wire2api(self) -> MyTreeNode {
                MyTreeNode{value_i32:  self.value_i32.wire2api(),value_vec_u8:  self.value_vec_u8.wire2api(),value_boolean:  self.value_boolean.wire2api(),children:  self.children.wire2api()}
            }
        }
...
impl Wire2Api<Note> for wire_Note {
            fn wire2api(self) -> Note {
                Note{day:  self.day.wire2api(),body:  self.body.wire2api()}
            }
        }
...
impl Wire2Api<SomeStruct> for wire_SomeStruct {
            fn wire2api(self) -> SomeStruct {
                SomeStruct{value:  self.value.wire2api()}
            }
        }
...
impl Wire2Api<UserId> for wire_UserId {
            fn wire2api(self) -> UserId {
                UserId{value:  self.value.wire2api()}
            }
        }
                ...
                pub extern "C" fn inflate_KitchenSink_Nested() -> *mut KitchenSinkKind {
                    support::new_leak_box_ptr(KitchenSinkKind {
                            Nested: support::new_leak_box_ptr(KitchenSink_Nested {
                                field0: core::ptr::null_mut(),field1: Default::default()
                            })
                        })
                }
...
impl support::IntoDart for mirror_ApplicationEnv {
                fn into_dart(self) -> support::DartCObject {
                    vec![
                        self.0.vars.into_iter().map(|v| mirror_ApplicationEnvVar(v)).collect::<Vec<_>>().into_dart()
                    ].into_dart()
                }
            }
...
ApplicationMessage::RenderPixel{x,y} => vec![1.into_dart(),x.into_dart(),y.into_dart()],
...
Self::Nested(field0,field1) => vec![2.into_dart(),field0.into_dart(),field1.into_dart()],
