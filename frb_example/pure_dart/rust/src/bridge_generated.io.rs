...
#[no_mangle]
pub extern "C" fn wire_primitive_types(port_: i64, my_i32: i32, my_i64: i64, my_f64: f64, my_bool: bool) {
	wire_primitive_types_impl(port_, my_i32, my_i64, my_f64, my_bool)
}

#[no_mangle]
pub extern "C" fn wire_primitive_optional_types(
	port_: i64, my_i32: *mut i32, my_i64: *mut i64, my_f64: *mut f64, my_bool: *mut bool,
) {
...
pub extern "C" fn wire_primitive_types_sync(
	my_i32: i32, my_i64: i64, my_f64: f64, my_bool: bool,
...
#[no_mangle]
pub extern "C" fn wire_handle_struct_sync(arg: *mut wire_MySize, boxed: *mut wire_MySize) -> support::WireSyncReturn {
...
#[no_mangle]
pub extern "C" fn wire_handle_list_of_struct_sync(l: *mut wire_list_my_size) -> support::WireSyncReturn {
...
#[no_mangle]
pub extern "C" fn wire_handle_string_list_sync(names: *mut wire_StringList) -> support::WireSyncReturn {
...
#[no_mangle]
pub extern "C" fn wire_handle_complex_struct_sync(s: *mut wire_MyTreeNode) -> support::WireSyncReturn {
...
pub extern "C" fn wire_handle_option_box_arguments(
	port_: i64, i8box: *mut i8, u8box: *mut u8, i32box: *mut i32, i64box: *mut i64, f64box: *mut f64,
	boolbox: *mut bool, structbox: *mut wire_ExoticOptionals,
) {
	wire_handle_option_box_arguments_impl(port_, i8box, u8box, i32box, i64box, f64box, boolbox, structbox)
}
...
#[no_mangle]
pub extern "C" fn wire_create_event(port_: i64, address: *mut wire_uint_8_list, payload: *mut wire_uint_8_list) {
...
#[no_mangle]
pub extern "C" fn wire_handle_timestamps(port_: i64, timestamps: *mut wire_int_64_list, epoch: i64) {
...
#[no_mangle]
pub extern "C" fn wire_sync_option_loopback(opaque: *mut wire_DartOpaque) -> support::WireSyncReturn {
...
#[no_mangle]
pub extern "C" fn wire_create_nested_dart_opaque(port_: i64, opaque1: wire_DartOpaque, opaque2: wire_DartOpaque) {
...
#[no_mangle]
pub extern "C" fn wire_return_non_droppable_dart_opaque(opaque: wire_DartOpaque) -> support::WireSyncReturn {
...
pub extern "C" fn wire_concatenate__method__ConcatenateWith(
	port_: i64, that: *mut wire_ConcatenateWith, b: *mut wire_uint_8_list,
) {
...
pub extern "C" fn wire_concatenate_static__static_method__ConcatenateWith(
	port_: i64, a: *mut wire_uint_8_list, b: *mut wire_uint_8_list,
) {
...
pub extern "C" fn wire_handle_some_stream_sink__method__ConcatenateWith(
	port_: i64, that: *mut wire_ConcatenateWith, key: u32, max: u32,
) {
...
pub extern "C" fn wire_handle_some_stream_sink_at_1__method__ConcatenateWith(
	port_: i64, that: *mut wire_ConcatenateWith,
) {
	wire_handle_some_stream_sink_at_1__method__ConcatenateWith_impl(port_, that)
}

#[no_mangle]
pub extern "C" fn wire_handle_some_static_stream_sink__static_method__ConcatenateWith(port_: i64, key: u32, max: u32) {
	wire_handle_some_static_stream_sink__static_method__ConcatenateWith_impl(port_, key, max)
}

#[no_mangle]
pub extern "C" fn wire_handle_some_static_stream_sink_single_arg__static_method__ConcatenateWith(port_: i64) {
...
#[no_mangle]
pub extern "C" fn new_list_opt_box_autoadd_attribute_0(len: i32) -> *mut wire_list_opt_box_autoadd_attribute {
...
impl Wire2Api<ConcatenateWith> for wire_ConcatenateWith {
	fn wire2api(self) -> ConcatenateWith {
		ConcatenateWith { a: self.a.wire2api() }
	}
}
