...
#[wasm_bindgen]
pub fn P343B03A6_wire_simple_adder(port_: MessagePort, a: i32, b: i32) {
    P343B03A6_wire_simple_adder_impl(port_, a, b)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_simple_adder_sync(a: i32, b: i32) -> support::WireSyncReturn {
    P343B03A6_wire_simple_adder_sync_impl(a, b)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_primitive_types(
    port_: MessagePort,
    my_i32: i32,
    my_i64: i64,
    my_f64: f64,
...
#[wasm_bindgen]
pub fn P343B03A6_wire_primitive_optional_types(
    port_: MessagePort,
    my_i32: JsValue,
    my_i64: JsValue,
    my_f64: JsValue,
...
#[wasm_bindgen]
pub fn P343B03A6_wire_primitive_types_sync(
    my_i32: i32,
    my_i64: i64,
    my_f64: f64,
    my_bool: bool,
...
#[wasm_bindgen]
pub fn P343B03A6_wire_primitive_u32(port_: MessagePort, my_u32: u32) {
    P343B03A6_wire_primitive_u32_impl(port_, my_u32)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_primitive_u32_sync(my_u32: u32) -> support::WireSyncReturn {
    P343B03A6_wire_primitive_u32_sync_impl(my_u32)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_string(port_: MessagePort, s: String) {
    P343B03A6_wire_handle_string_impl(port_, s)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_string_sync(s: String) -> support::WireSyncReturn {
    P343B03A6_wire_handle_string_sync_impl(s)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_return_unit(port_: MessagePort) {
    P343B03A6_wire_handle_return_unit_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_return_unit_sync() -> support::WireSyncReturn {
    P343B03A6_wire_handle_return_unit_sync_impl()
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_vec_u8(port_: MessagePort, v: Box<[u8]>) {
    P343B03A6_wire_handle_vec_u8_impl(port_, v)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_vec_u8_sync(v: Box<[u8]>) -> support::WireSyncReturn {
    P343B03A6_wire_handle_vec_u8_sync_impl(v)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_vec_of_primitive(port_: MessagePort, n: i32) {
    P343B03A6_wire_handle_vec_of_primitive_impl(port_, n)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_vec_of_primitive_sync(n: i32) -> support::WireSyncReturn {
    P343B03A6_wire_handle_vec_of_primitive_sync_impl(n)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_zero_copy_vec_of_primitive(port_: MessagePort, n: i32) {
    P343B03A6_wire_handle_zero_copy_vec_of_primitive_impl(port_, n)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_zero_copy_vec_of_primitive_sync(n: i32) -> support::WireSyncReturn {
    P343B03A6_wire_handle_zero_copy_vec_of_primitive_sync_impl(n)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_struct(port_: MessagePort, arg: JsValue, boxed: JsValue) {
    P343B03A6_wire_handle_struct_impl(port_, arg, boxed)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_struct_sync(arg: JsValue, boxed: JsValue) -> support::WireSyncReturn {
    P343B03A6_wire_handle_struct_sync_impl(arg, boxed)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_newtype(port_: MessagePort, arg: JsValue) {
    P343B03A6_wire_handle_newtype_impl(port_, arg)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_newtype_sync(arg: JsValue) -> support::WireSyncReturn {
    P343B03A6_wire_handle_newtype_sync_impl(arg)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_list_of_struct(port_: MessagePort, l: JsValue) {
    P343B03A6_wire_handle_list_of_struct_impl(port_, l)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_list_of_struct_sync(l: JsValue) -> support::WireSyncReturn {
    P343B03A6_wire_handle_list_of_struct_sync_impl(l)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_string_list(port_: MessagePort, names: JsValue) {
    P343B03A6_wire_handle_string_list_impl(port_, names)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_string_list_sync(names: JsValue) -> support::WireSyncReturn {
    P343B03A6_wire_handle_string_list_sync_impl(names)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_complex_struct(port_: MessagePort, s: JsValue) {
    P343B03A6_wire_handle_complex_struct_impl(port_, s)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_complex_struct_sync(s: JsValue) -> support::WireSyncReturn {
    P343B03A6_wire_handle_complex_struct_sync_impl(s)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_nested_struct(port_: MessagePort, s: JsValue) {
    P343B03A6_wire_handle_nested_struct_impl(port_, s)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_sync_return(mode: String) -> support::WireSyncReturn {
    P343B03A6_wire_handle_sync_return_impl(mode)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_stream(port_: MessagePort, arg: String) {
    P343B03A6_wire_handle_stream_impl(port_, arg)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_stream_of_struct(port_: MessagePort) {
    P343B03A6_wire_handle_stream_of_struct_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_return_err(port_: MessagePort) {
    P343B03A6_wire_return_err_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_return_panic(port_: MessagePort) {
    P343B03A6_wire_return_panic_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_optional_return(port_: MessagePort, left: f64, right: f64) {
    P343B03A6_wire_handle_optional_return_impl(port_, left, right)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_optional_struct(port_: MessagePort, document: Option<String>) {
    P343B03A6_wire_handle_optional_struct_impl(port_, document)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_optional_increment(port_: MessagePort, opt: JsValue) {
    P343B03A6_wire_handle_optional_increment_impl(port_, opt)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_increment_boxed_optional(port_: MessagePort, opt: JsValue) {
    P343B03A6_wire_handle_increment_boxed_optional_impl(port_, opt)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_option_box_arguments(
    port_: MessagePort,
    i8box: JsValue,
    u8box: JsValue,
    i32box: JsValue,
...
#[wasm_bindgen]
pub fn P343B03A6_wire_print_note(port_: MessagePort, note: JsValue) {
    P343B03A6_wire_print_note_impl(port_, note)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_return_enum(port_: MessagePort, input: String) {
    P343B03A6_wire_handle_return_enum_impl(port_, input)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_enum_parameter(port_: MessagePort, weekday: i32) {
    P343B03A6_wire_handle_enum_parameter_impl(port_, weekday)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_customized_struct(port_: MessagePort, val: JsValue) {
    P343B03A6_wire_handle_customized_struct_impl(port_, val)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_enum_struct(port_: MessagePort, val: JsValue) {
    P343B03A6_wire_handle_enum_struct_impl(port_, val)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_use_imported_struct(port_: MessagePort, my_struct: JsValue) {
    P343B03A6_wire_use_imported_struct_impl(port_, my_struct)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_use_imported_enum(port_: MessagePort, my_enum: i32) {
    P343B03A6_wire_use_imported_enum_impl(port_, my_enum)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_get_app_settings(port_: MessagePort) {
    P343B03A6_wire_get_app_settings_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_get_fallible_app_settings(port_: MessagePort) {
    P343B03A6_wire_get_fallible_app_settings_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_is_app_embedded(port_: MessagePort, app_settings: JsValue) {
    P343B03A6_wire_is_app_embedded_impl(port_, app_settings)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_get_message(port_: MessagePort) {
    P343B03A6_wire_get_message_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_repeat_number(port_: MessagePort, number: i32, times: usize) {
    P343B03A6_wire_repeat_number_impl(port_, number, times)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_repeat_sequence(port_: MessagePort, seq: i32, times: usize) {
    P343B03A6_wire_repeat_sequence_impl(port_, seq, times)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_first_number(port_: MessagePort, nums: JsValue) {
    P343B03A6_wire_first_number_impl(port_, nums)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_first_sequence(port_: MessagePort, seqs: JsValue) {
    P343B03A6_wire_first_sequence_impl(port_, seqs)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_get_array(port_: MessagePort) {
    P343B03A6_wire_get_array_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_get_complex_array(port_: MessagePort) {
    P343B03A6_wire_get_complex_array_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_get_usize(port_: MessagePort, u: usize) {
    P343B03A6_wire_get_usize_impl(port_, u)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_next_user_id(port_: MessagePort, user_id: JsValue) {
    P343B03A6_wire_next_user_id_impl(port_, user_id)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_register_event_listener(port_: MessagePort) {
    P343B03A6_wire_register_event_listener_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_close_event_listener(port_: MessagePort) {
    P343B03A6_wire_close_event_listener_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_create_event(port_: MessagePort, address: String, payload: String) {
    P343B03A6_wire_create_event_impl(port_, address, payload)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_stream_sink_at_1(port_: MessagePort, key: u32, max: u32) {
    P343B03A6_wire_handle_stream_sink_at_1_impl(port_, key, max)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_stream_sink_at_2(port_: MessagePort, key: u32, max: u32) {
    P343B03A6_wire_handle_stream_sink_at_2_impl(port_, key, max)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_stream_sink_at_3(port_: MessagePort, key: u32, max: u32) {
    P343B03A6_wire_handle_stream_sink_at_3_impl(port_, key, max)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_get_sum_struct(port_: MessagePort) {
    P343B03A6_wire_get_sum_struct_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_get_sum_array(port_: MessagePort, a: u32, b: u32, c: u32) {
    P343B03A6_wire_get_sum_array_impl(port_, a, b, c)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_multiply_by_ten(port_: MessagePort, measure: JsValue) {
    P343B03A6_wire_multiply_by_ten_impl(port_, measure)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_call_old_module_system(port_: MessagePort) {
    P343B03A6_wire_call_old_module_system_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_call_new_module_system(port_: MessagePort) {
    P343B03A6_wire_call_new_module_system_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_big_buffers(port_: MessagePort) {
    P343B03A6_wire_handle_big_buffers_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_datetime_utc(port_: MessagePort, d: i64) {
    P343B03A6_wire_datetime_utc_impl(port_, d)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_datetime_local(port_: MessagePort, d: i64) {
    P343B03A6_wire_datetime_local_impl(port_, d)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_naivedatetime(port_: MessagePort, d: i64) {
    P343B03A6_wire_naivedatetime_impl(port_, d)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_optional_empty_datetime_utc(port_: MessagePort, d: JsValue) {
    P343B03A6_wire_optional_empty_datetime_utc_impl(port_, d)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_duration(port_: MessagePort, d: i64) {
    P343B03A6_wire_duration_impl(port_, d)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_timestamps(port_: MessagePort, timestamps: Box<[i64]>, epoch: i64) {
    P343B03A6_wire_handle_timestamps_impl(port_, timestamps, epoch)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_durations(port_: MessagePort, durations: Box<[i64]>, since: i64) {
    P343B03A6_wire_handle_durations_impl(port_, durations, since)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_test_chrono(port_: MessagePort) {
    P343B03A6_wire_test_chrono_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_test_precise_chrono(port_: MessagePort) {
    P343B03A6_wire_test_precise_chrono_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_how_long_does_it_take(port_: MessagePort, mine: JsValue) {
    P343B03A6_wire_how_long_does_it_take_impl(port_, mine)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_uuid(port_: MessagePort, id: Box<[u8]>) {
    P343B03A6_wire_handle_uuid_impl(port_, id)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_uuids(port_: MessagePort, ids: Box<[u8]>) {
    P343B03A6_wire_handle_uuids_impl(port_, ids)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_nested_uuids(port_: MessagePort, ids: JsValue) {
    P343B03A6_wire_handle_nested_uuids_impl(port_, ids)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_new_msgid(port_: MessagePort, id: Box<[u8]>) {
    P343B03A6_wire_new_msgid_impl(port_, id)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_use_msgid(port_: MessagePort, id: JsValue) {
    P343B03A6_wire_use_msgid_impl(port_, id)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_boxed_blob(port_: MessagePort, blob: Box<[u8]>) {
    P343B03A6_wire_boxed_blob_impl(port_, blob)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_use_boxed_blob(port_: MessagePort, blob: JsValue) {
    P343B03A6_wire_use_boxed_blob_impl(port_, blob)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_return_boxed_feed_id(port_: MessagePort, id: Box<[u8]>) {
    P343B03A6_wire_return_boxed_feed_id_impl(port_, id)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_return_boxed_raw_feed_id(port_: MessagePort, id: JsValue) {
    P343B03A6_wire_return_boxed_raw_feed_id_impl(port_, id)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_test_id(port_: MessagePort, id: JsValue) {
    P343B03A6_wire_test_id_impl(port_, id)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_last_number(port_: MessagePort, array: Box<[f64]>) {
    P343B03A6_wire_last_number_impl(port_, array)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_nested_id(port_: MessagePort, id: JsValue) {
    P343B03A6_wire_nested_id_impl(port_, id)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_sync_accept_dart_opaque(opaque: JsValue) -> support::WireSyncReturn {
    P343B03A6_wire_sync_accept_dart_opaque_impl(opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_async_accept_dart_opaque(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_async_accept_dart_opaque_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_loop_back(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_loop_back_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_loop_back_option(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_loop_back_option_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_loop_back_array(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_loop_back_array_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_loop_back_vec(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_loop_back_vec_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_loop_back_option_get(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_loop_back_option_get_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_loop_back_array_get(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_loop_back_array_get_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_loop_back_vec_get(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_loop_back_vec_get_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_unwrap_dart_opaque(opaque: JsValue) -> support::WireSyncReturn {
    P343B03A6_wire_unwrap_dart_opaque_impl(opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_panic_unwrap_dart_opaque(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_panic_unwrap_dart_opaque_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_create_opaque(port_: MessagePort) {
    P343B03A6_wire_create_opaque_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_create_option_opaque(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_create_option_opaque_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_sync_create_opaque() -> support::WireSyncReturn {
    P343B03A6_wire_sync_create_opaque_impl()
}

#[wasm_bindgen]
pub fn P343B03A6_wire_create_array_opaque_enum(port_: MessagePort) {
    P343B03A6_wire_create_array_opaque_enum_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_run_enum_opaque(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_run_enum_opaque_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_run_opaque(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_run_opaque_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_run_opaque_with_delay(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_run_opaque_with_delay_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_opaque_array(port_: MessagePort) {
    P343B03A6_wire_opaque_array_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_sync_create_non_clone() -> support::WireSyncReturn {
    P343B03A6_wire_sync_create_non_clone_impl()
}

#[wasm_bindgen]
pub fn P343B03A6_wire_run_non_clone(port_: MessagePort, clone: JsValue) {
    P343B03A6_wire_run_non_clone_impl(port_, clone)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_create_sync_opaque(port_: MessagePort) {
    P343B03A6_wire_create_sync_opaque_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_sync_create_sync_opaque() -> support::WireSyncReturn {
    P343B03A6_wire_sync_create_sync_opaque_impl()
}

#[wasm_bindgen]
pub fn P343B03A6_wire_sync_run_opaque(opaque: JsValue) -> support::WireSyncReturn {
    P343B03A6_wire_sync_run_opaque_impl(opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_opaque_array_run(port_: MessagePort, data: JsValue) {
    P343B03A6_wire_opaque_array_run_impl(port_, data)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_opaque_vec(port_: MessagePort) {
    P343B03A6_wire_opaque_vec_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_opaque_vec_run(port_: MessagePort, data: JsValue) {
    P343B03A6_wire_opaque_vec_run_impl(port_, data)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_create_nested_opaque(port_: MessagePort) {
    P343B03A6_wire_create_nested_opaque_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_sync_loopback(opaque: JsValue) -> support::WireSyncReturn {
    P343B03A6_wire_sync_loopback_impl(opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_sync_option_loopback(opaque: JsValue) -> support::WireSyncReturn {
    P343B03A6_wire_sync_option_loopback_impl(opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_sync_option() -> support::WireSyncReturn {
    P343B03A6_wire_sync_option_impl()
}

#[wasm_bindgen]
pub fn P343B03A6_wire_sync_option_null() -> support::WireSyncReturn {
    P343B03A6_wire_sync_option_null_impl()
}

#[wasm_bindgen]
pub fn P343B03A6_wire_sync_option_rust_opaque() -> support::WireSyncReturn {
    P343B03A6_wire_sync_option_rust_opaque_impl()
}

#[wasm_bindgen]
pub fn P343B03A6_wire_sync_option_dart_opaque(opaque: JsValue) -> support::WireSyncReturn {
    P343B03A6_wire_sync_option_dart_opaque_impl(opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_sync_void() -> support::WireSyncReturn {
    P343B03A6_wire_sync_void_impl()
}

#[wasm_bindgen]
pub fn P343B03A6_wire_run_nested_opaque(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_run_nested_opaque_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_create_nested_dart_opaque(
    port_: MessagePort,
    opaque1: JsValue,
    opaque2: JsValue,
) {
...
#[wasm_bindgen]
pub fn P343B03A6_wire_get_nested_dart_opaque(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_get_nested_dart_opaque_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_create_enum_dart_opaque(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_create_enum_dart_opaque_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_get_enum_dart_opaque(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_get_enum_dart_opaque_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_set_static_dart_opaque(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_set_static_dart_opaque_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_drop_static_dart_opaque(port_: MessagePort) {
    P343B03A6_wire_drop_static_dart_opaque_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_unwrap_rust_opaque(port_: MessagePort, opaque: JsValue) {
    P343B03A6_wire_unwrap_rust_opaque_impl(port_, opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_return_non_droppable_dart_opaque(opaque: JsValue) -> support::WireSyncReturn {
    P343B03A6_wire_return_non_droppable_dart_opaque_impl(opaque)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_frb_generator_test(port_: MessagePort) {
    P343B03A6_wire_frb_generator_test_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_frb_sync_generator_test() -> support::WireSyncReturn {
    P343B03A6_wire_frb_sync_generator_test_impl()
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_type_alias_id(port_: MessagePort, input: u64) {
    P343B03A6_wire_handle_type_alias_id_impl(port_, input)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_type_nest_alias_id(port_: MessagePort, input: u64) {
    P343B03A6_wire_handle_type_nest_alias_id_impl(port_, input)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_handle_type_alias_model(port_: MessagePort, input: u64) {
    P343B03A6_wire_handle_type_alias_model_impl(port_, input)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_empty_struct(port_: MessagePort, empty: JsValue) {
    P343B03A6_wire_empty_struct_impl(port_, empty)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_return_dart_dynamic(port_: MessagePort) {
    P343B03A6_wire_return_dart_dynamic_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_test_raw_string_item_struct(port_: MessagePort) {
    P343B03A6_wire_test_raw_string_item_struct_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_test_more_than_just_one_raw_string_struct(port_: MessagePort) {
    P343B03A6_wire_test_more_than_just_one_raw_string_struct_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_test_raw_string_mirrored(port_: MessagePort) {
    P343B03A6_wire_test_raw_string_mirrored_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_test_nested_raw_string_mirrored(port_: MessagePort) {
    P343B03A6_wire_test_nested_raw_string_mirrored_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_test_raw_string_enum_mirrored(port_: MessagePort, nested: bool) {
    P343B03A6_wire_test_raw_string_enum_mirrored_impl(port_, nested)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_test_list_of_raw_nested_string_mirrored(port_: MessagePort) {
    P343B03A6_wire_test_list_of_raw_nested_string_mirrored_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_test_fallible_of_raw_string_mirrored(port_: MessagePort) {
    P343B03A6_wire_test_fallible_of_raw_string_mirrored_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_list_of_primitive_enums(port_: MessagePort, weekdays: JsValue) {
    P343B03A6_wire_list_of_primitive_enums_impl(port_, weekdays)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_test_abc_enum(port_: MessagePort, abc: JsValue) {
    P343B03A6_wire_test_abc_enum_impl(port_, abc)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_test_contains_mirrored_sub_struct(port_: MessagePort) {
    P343B03A6_wire_test_contains_mirrored_sub_struct_impl(port_)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_as_string__method__Event(port_: MessagePort, that: JsValue) {
    P343B03A6_wire_as_string__method__Event_impl(port_, that)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_sum__method__SumWith(port_: MessagePort, that: JsValue, y: u32, z: u32) {
    P343B03A6_wire_sum__method__SumWith_impl(port_, that, y, z)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_new__static_method__ConcatenateWith(port_: MessagePort, a: String) {
    P343B03A6_wire_new__static_method__ConcatenateWith_impl(port_, a)
}

#[wasm_bindgen]
pub fn P343B03A6_wire_concatenate__method__ConcatenateWith(
    port_: MessagePort,
    that: JsValue,
    b: String,
) {
...
#[wasm_bindgen]
pub fn P343B03A6_wire_concatenate_static__static_method__ConcatenateWith(
    port_: MessagePort,
    a: String,
    b: String,
) {
...
#[wasm_bindgen]
pub fn P343B03A6_wire_handle_some_stream_sink__method__ConcatenateWith(
    port_: MessagePort,
    that: JsValue,
    key: u32,
    max: u32,
...
#[wasm_bindgen]
pub fn P343B03A6_wire_handle_some_stream_sink_at_1__method__ConcatenateWith(
    port_: MessagePort,
    that: JsValue,
) {
...
#[wasm_bindgen]
pub fn P343B03A6_wire_handle_some_static_stream_sink__static_method__ConcatenateWith(
    port_: MessagePort,
    key: u32,
    max: u32,
) {
...
#[wasm_bindgen]
pub fn P343B03A6_wire_handle_some_static_stream_sink_single_arg__static_method__ConcatenateWith(
    port_: MessagePort,
) {
