...
#[no_mangle]
pub unsafe extern "C" fn benchmark_raw_input_bytes_sync(bytes: benchmark_raw_list_prim_u_8) -> i32 {
    let vec = vec_from_leak_ptr(bytes.ptr, bytes.len);
    benchmark_input_bytes_twin_normal(vec)
}

#[no_mangle]
pub extern "C" fn benchmark_raw_output_bytes_sync(size: i32) -> benchmark_raw_list_prim_u_8 {
