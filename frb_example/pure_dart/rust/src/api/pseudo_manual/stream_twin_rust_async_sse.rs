...
#[flutter_rust_bridge::frb(serialize)]
pub async fn stream_sink_emit_range_twin_rust_async_sse(
    sink: StreamSink<i32, flutter_rust_bridge::SseCodec>,
    count: u32,
) {
    for i in 0..count {
...
#[flutter_rust_bridge::frb(serialize)]
pub async fn stream_sink_emit_range_then_hold_twin_rust_async_sse(
    sink: StreamSink<i32, flutter_rust_bridge::SseCodec>,
    count: u32,
    hold_millis: u64,
) {
...
#[flutter_rust_bridge::frb(serialize)]
pub async fn stream_sink_emit_many_twin_rust_async_sse(
    sink: StreamSink<i32, flutter_rust_bridge::SseCodec>,
    count: u32,
) {
    (FLUTTER_RUST_BRIDGE_HANDLER.thread_pool()).execute(transfer!(|| {
...
#[flutter_rust_bridge::frb(serialize)]
pub async fn store_stream_sink_twin_rust_async_sse(
    sink: StreamSink<i32, flutter_rust_bridge::SseCodec>,
) {
...
#[flutter_rust_bridge::frb(serialize)]
pub async fn clear_stored_stream_sink_twin_rust_async_sse() {
...
#[flutter_rust_bridge::frb(serialize)]
pub async fn stored_stream_sink_emit_many_twin_rust_async_sse(count: u32) {
    if let Ok(mut guard) = STORED_STREAM_SINK_TWIN_NORMAL.lock() {
...
#[flutter_rust_bridge::frb(serialize)]
pub async fn stored_stream_sink_start_spam_twin_rust_async_sse(total: u32, interval_millis: u64) {
...
#[flutter_rust_bridge::frb(serialize)]
pub async fn stored_stream_sink_emit_error_twin_rust_async_sse(message: String) {
    if let Ok(mut guard) = STORED_STREAM_SINK_TWIN_NORMAL.lock() {
        if let Some(sink) = guard.as_mut() {
