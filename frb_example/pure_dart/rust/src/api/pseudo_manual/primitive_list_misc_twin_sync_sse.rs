...
pub struct VecOfPrimitivePackTwinSyncSse {
    pub int8list: Vec<i8>,
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn handle_vec_of_primitive_twin_sync_sse(n: i32) -> VecOfPrimitivePackTwinSyncSse {
...
// pub struct ZeroCopyVecOfPrimitivePackTwinSyncSse {
...
// }
//
// #[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn handle_zero_copy_vec_of_primitive_twin_sync_sse(
//     n: i32,
// ) -> ZeroCopyVecOfPrimitivePackTwinSyncSse {
//     ZeroCopyVecOfPrimitivePackTwinSyncSse {
