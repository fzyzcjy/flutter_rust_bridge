...
pub struct VecOfPrimitivePackTwinRustAsync {
    pub int8list: Vec<i8>,
...
pub async fn handle_vec_of_primitive_twin_rust_async(n: i32) -> VecOfPrimitivePackTwinRustAsync {
...
// pub struct ZeroCopyVecOfPrimitivePackTwinRustAsync {
...
// }
//
// pub async fn handle_zero_copy_vec_of_primitive_twin_rust_async(
//     n: i32,
