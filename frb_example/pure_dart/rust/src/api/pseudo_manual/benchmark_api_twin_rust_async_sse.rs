...
#[flutter_rust_bridge::frb(serialize)] pub async fn benchmark_void_twin_rust_async_sse() {}
  
#[flutter_rust_bridge::frb(serialize)] pub async fn benchmark_input_bytes_twin_rust_async_sse(bytes: Vec<u8>) -> i32 {
    bytes.into_iter().map(|x| x as i32).sum()
}

#[flutter_rust_bridge::frb(serialize)] pub async fn benchmark_output_bytes_twin_rust_async_sse(size: i32) -> Vec<u8> {
    vec![0; size as usize]
}
...
#[flutter_rust_bridge::frb(serialize)] pub async fn benchmark_binary_tree_input_twin_rust_async_sse(tree: BenchmarkBinaryTreeTwinRustAsyncSse) {
    black_box(tree);
}

#[flutter_rust_bridge::frb(serialize)] pub async fn benchmark_binary_tree_output_twin_rust_async_sse(depth: i32) -> BenchmarkBinaryTreeTwinRustAsyncSse {
    BINARY_TREES.get(&depth).unwrap().to_owned()
}

#[flutter_rust_bridge::frb(serialize)] pub async fn benchmark_binary_tree_input_protobuf_twin_rust_async_sse(raw: Vec<u8>) {
    let data = BinaryTreeProtobuf::parse_from_bytes(&raw).unwrap();
    black_box(data);
}

#[flutter_rust_bridge::frb(serialize)] pub async fn benchmark_binary_tree_output_protobuf_twin_rust_async_sse(depth: i32) -> Vec<u8> {
...
#[flutter_rust_bridge::frb(serialize)] pub async fn benchmark_binary_tree_input_json_twin_rust_async_sse(raw: String) {
    let obj: BenchmarkBinaryTreeTwinRustAsyncSse = serde_json::from_str(&raw).unwrap();
    black_box(obj);
}

#[flutter_rust_bridge::frb(serialize)] pub async fn benchmark_binary_tree_output_json_twin_rust_async_sse(depth: i32) -> String {
...
#[flutter_rust_bridge::frb(serialize)] pub async fn benchmark_blob_input_twin_rust_async_sse(blob: BenchmarkBlobTwinRustAsyncSse) {
    black_box(blob);
}

#[flutter_rust_bridge::frb(serialize)] pub async fn benchmark_blob_output_twin_rust_async_sse(size: i32) -> BenchmarkBlobTwinRustAsyncSse {
    create_blob(size)
}

#[flutter_rust_bridge::frb(serialize)] pub async fn benchmark_blob_input_protobuf_twin_rust_async_sse(raw: Vec<u8>) {
    let data = BlobProtobuf::parse_from_bytes(&raw).unwrap();
    black_box(data);
}

#[flutter_rust_bridge::frb(serialize)] pub async fn benchmark_blob_output_protobuf_twin_rust_async_sse(size: i32) -> Vec<u8> {
    let data = vec![0; size as _];
...
#[flutter_rust_bridge::frb(serialize)] pub async fn benchmark_blob_input_json_twin_rust_async_sse(raw: String) {
    let obj: BenchmarkBlobTwinRustAsyncSse = serde_json::from_str(&raw).unwrap();
    black_box(obj);
}

#[flutter_rust_bridge::frb(serialize)] pub async fn benchmark_blob_output_json_twin_rust_async_sse(size: i32) -> String {
