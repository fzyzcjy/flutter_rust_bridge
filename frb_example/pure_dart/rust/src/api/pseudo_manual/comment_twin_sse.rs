...
#[flutter_rust_bridge::frb(serialize)] pub fn function_with_comments_triple_slash_single_line_twin_sse() {}

/// This is first line
/// This is second line
#[flutter_rust_bridge::frb(serialize)] pub fn function_with_comments_triple_slash_multi_line_twin_sse() {}
...
*/
#[flutter_rust_bridge::frb(serialize)] pub fn function_with_comments_slash_star_star_twin_sse() {}
...
impl StructWithCommentsTwinSse {
    ...
    #[flutter_rust_bridge::frb(serialize)] pub fn static_method_twin_sse() {}

    /// Documentation on an instance method
    #[flutter_rust_bridge::frb(serialize)] pub fn instance_method_twin_sse(&self) {}
}
