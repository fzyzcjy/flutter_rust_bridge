...
#[derive(Debug)]
pub(super) struct RestrictedOpaqueFieldInnerTwinSyncMoi {
    value: String,
}

mod private_opaque_field_module_twin_sync_moi {
    #[derive(Debug)]
...
mod private_opaque_field_base_alias_module_twin_sync_moi {
    use super::private_opaque_field_module_twin_sync_moi::PrivateModuleOpaqueFieldInnerTwinSyncMoi;

    pub type BaseAliasTwinSyncMoi = PrivateModuleOpaqueFieldInnerTwinSyncMoi;
}

mod private_opaque_field_chained_alias_module_twin_sync_moi {
    use super::private_opaque_field_base_alias_module_twin_sync_moi::BaseAliasTwinSyncMoi;

    pub type ChainedAliasTwinSyncMoi = BaseAliasTwinSyncMoi;
}

use private_opaque_field_chained_alias_module_twin_sync_moi::ChainedAliasTwinSyncMoi;
...
pub struct OpaqueWithPrivateFieldTwinSyncMoi {
    ...
    pub restricted_field: Arc<RwLock<RestrictedOpaqueFieldInnerTwinSyncMoi>>,
    ...
    pub chained_alias_field: Arc<RwLock<ChainedAliasTwinSyncMoi>>,
...
impl OpaqueWithPrivateFieldTwinSyncMoi {
    ...
    pub fn new_twin_sync_moi(value: String) -> Self {
        Self {
            field: Arc::new(RwLock::new(PrivateOpaqueFieldInnerTwinSyncMoi {
                value: value.clone(),
            })),
            restricted_field: Arc::new(RwLock::new(RestrictedOpaqueFieldInnerTwinSyncMoi {
                value: value.clone(),
            })),
            private_module_field: Arc::new(RwLock::new(
                private_opaque_field_module_twin_sync_moi::PrivateModuleOpaqueFieldInnerTwinSyncMoi {
                    value: value.clone(),
                },
            )),
            ...
            chained_alias_field: Arc::new(RwLock::new(PrivateModuleOpaqueFieldInnerTwinSyncMoi {
                value: value.clone(),
            })),
