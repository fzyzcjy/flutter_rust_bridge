...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] pub async fn rust_auto_opaque_enum_with_good_and_opaque_arg_own_twin_rust_async_moi(
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] pub async fn rust_auto_opaque_enum_with_good_and_opaque_return_own_good_twin_rust_async_moi(
) -> EnumWithGoodAndOpaqueTwinRustAsyncMoi {
    EnumWithGoodAndOpaqueTwinRustAsyncMoi::Good("hello".to_owned())
}

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] pub async fn rust_auto_opaque_enum_with_good_and_opaque_return_own_opaque_twin_rust_async_moi(
) -> EnumWithGoodAndOpaqueTwinRustAsyncMoi {
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] pub async fn rust_auto_opaque_dummy_twin_rust_async_moi(
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] pub async fn rust_auto_opaque_enum_arg_borrow_twin_rust_async_moi(arg: &NonCloneSimpleEnumTwinRustAsyncMoi) {
    assert!(matches!(arg, NonCloneSimpleEnumTwinRustAsyncMoi::Orange));
}

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] pub async fn rust_auto_opaque_enum_return_own_twin_rust_async_moi() -> NonCloneSimpleEnumTwinRustAsyncMoi {
    NonCloneSimpleEnumTwinRustAsyncMoi::Orange
}

// ================ stream sink ===================

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] pub async fn rust_auto_opaque_stream_sink_twin_rust_async_moi(sink: StreamSink<NonCloneSimpleTwinRustAsyncMoi>) {
    sink.add(NonCloneSimpleTwinRustAsyncMoi { inner: 42 }).unwrap();
}

// ================ vec of opaque ===================

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] pub async fn rust_auto_opaque_arg_vec_own_twin_rust_async_moi(
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] pub async fn rust_auto_opaque_return_vec_own_twin_rust_async_moi() -> Vec<NonCloneSimpleTwinRustAsyncMoi> {
    vec![
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] pub async fn rust_auto_opaque_explicit_arg_twin_rust_async_moi(
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] pub async fn rust_auto_opaque_explicit_struct_twin_rust_async_moi(
    arg: StructWithExplicitAutoOpaqueFieldTwinRustAsyncMoi,
) {
    assert_eq!(arg.auto_opaque.try_read().unwrap().inner, arg.normal);
}

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] pub async fn rust_auto_opaque_explicit_return_struct_twin_rust_async_moi(
) -> StructWithExplicitAutoOpaqueFieldTwinRustAsyncMoi {
    StructWithExplicitAutoOpaqueFieldTwinRustAsyncMoi {
        normal: 100,
        auto_opaque: crate::frb_generated::RustAutoOpaqueMoi::new(NonCloneSimpleTwinRustAsyncMoi { inner: 100 }),
    }
}

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] pub async fn rust_auto_opaque_explicit_return_twin_rust_async_moi(
    initial: i32,
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] pub async fn rust_auto_opaque_sleep_twin_rust_async_moi(
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] pub async fn rust_auto_opaque_borrow_and_mut_borrow_twin_rust_async_moi(
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] pub async fn rust_auto_opaque_borrow_and_borrow_twin_rust_async_moi(
    a: &NonCloneSimpleTwinRustAsyncMoi,
    b: &NonCloneSimpleTwinRustAsyncMoi,
) -> i32 {
    a.inner + b.inner
