...
#[derive(Debug)]
struct PrivateOpaqueFieldInnerTwinRustAsyncMoi {
    value: String,
}

#[derive(Debug)]
pub(super) struct RestrictedOpaqueFieldInnerTwinRustAsyncMoi {
    value: String,
}

mod private_opaque_field_module_twin_rust_async_moi {
    #[derive(Debug)]
...
use private_opaque_field_module_twin_rust_async_moi as private_module_alias_twin_rust_async_moi;
...
mod private_opaque_field_alias_module_twin_rust_async_moi {
    use super::private_opaque_field_module_twin_rust_async_moi::PrivateModuleOpaqueFieldInnerTwinRustAsyncMoi;

    pub type ImportedTargetAliasTwinRustAsyncMoi = PrivateModuleOpaqueFieldInnerTwinRustAsyncMoi;
}
...
#[derive(Clone, Debug)]
#[frb(opaque)]
pub struct OpaqueWithPrivateFieldTwinRustAsyncMoi {
    pub field: Arc<RwLock<PrivateOpaqueFieldInnerTwinRustAsyncMoi>>,
    pub restricted_field: Arc<RwLock<RestrictedOpaqueFieldInnerTwinRustAsyncMoi>>,
...
impl OpaqueWithPrivateFieldTwinRustAsyncMoi {
    #[flutter_rust_bridge::frb(rust_opaque_codec_moi)]
    pub async fn new_twin_rust_async_moi(value: String) -> Self {
        Self {
            field: Arc::new(RwLock::new(PrivateOpaqueFieldInnerTwinRustAsyncMoi {
                value: value.clone(),
            })),
            restricted_field: Arc::new(RwLock::new(RestrictedOpaqueFieldInnerTwinRustAsyncMoi {
                value: value.clone(),
            })),
            private_module_field: Arc::new(RwLock::new(
                private_opaque_field_module_twin_rust_async_moi::PrivateModuleOpaqueFieldInnerTwinRustAsyncMoi {
                    value: value.clone(),
                },
            )),
            ...
            module_alias_field: Arc::new(RwLock::new(
                private_module_alias_twin_rust_async_moi::PrivateModuleOpaqueFieldInnerTwinRustAsyncMoi {
                    value: value.clone(),
                },
            )),
