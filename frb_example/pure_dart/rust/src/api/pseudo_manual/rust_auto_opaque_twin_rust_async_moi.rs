...
type PrivateOpaqueFieldAliasTwinRustAsyncMoi = Arc<RwLock<PrivateOpaqueFieldInnerTwinRustAsyncMoi>>;
...
pub struct OpaqueWithPrivateFieldTwinRustAsyncMoi {
    ...
    >,
    pub alias_field: PrivateOpaqueFieldAliasTwinRustAsyncMoi,
}
