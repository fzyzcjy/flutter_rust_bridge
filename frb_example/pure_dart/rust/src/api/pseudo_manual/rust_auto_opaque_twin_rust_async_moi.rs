...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)]
pub async fn rust_auto_opaque_trait_object_arg_borrow_twin_rust_async_moi(
    arg: &Box<dyn HelloTraitTwinRustAsyncMoi>,
    expect: String,
) {
    assert_eq!(arg.func_hello(), expect);
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)]
pub async fn rust_auto_opaque_trait_object_return_own_two_twin_rust_async_moi(
) -> Box<dyn HelloTraitTwinRustAsyncMoi> {
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)]
pub async fn rust_auto_opaque_struct_with_good_and_opaque_field_arg_borrow_twin_rust_async_moi(
    arg: &StructWithGoodAndOpaqueFieldTwinRustAsyncMoi,
) {
    assert_eq!(&arg.good, "hello");
    assert_eq!(arg.opaque.inner, 42);
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)]
pub async fn rust_auto_opaque_struct_with_good_and_opaque_field_arg_mut_borrow_twin_rust_async_moi(
...
pub async fn rust_auto_opaque_explicit_return_twin_rust_async_moi(
    ...
    NonCloneSimpleTwinRustAsyncMoi { inner: initial }.into()
}
