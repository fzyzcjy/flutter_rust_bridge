...
pub fn example_basic_list_type_i8_twin_sse(arg: Vec<i8>) -> Vec<i8> {
    arg
}

#[flutter_rust_bridge::frb(serialize)]
pub fn example_basic_list_type_i16_twin_sse(arg: Vec<i16>) -> Vec<i16> {
    arg
}

#[flutter_rust_bridge::frb(serialize)]
pub fn example_basic_list_type_i32_twin_sse(arg: Vec<i32>) -> Vec<i32> {
    arg
}

#[flutter_rust_bridge::frb(serialize)]
pub fn example_basic_list_type_i64_twin_sse(arg: Vec<i64>) -> Vec<i64> {
    arg
}
...
#[flutter_rust_bridge::frb(serialize)]
pub fn example_basic_list_type_u16_twin_sse(arg: Vec<u16>) -> Vec<u16> {
    arg
}

#[flutter_rust_bridge::frb(serialize)]
pub fn example_basic_list_type_u32_twin_sse(arg: Vec<u32>) -> Vec<u32> {
    arg
}
...
#[flutter_rust_bridge::frb(serialize)]
pub fn example_basic_list_type_f64_twin_sse(arg: Vec<f64>) -> Vec<f64> {
    arg
}
