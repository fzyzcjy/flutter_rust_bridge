...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn get_app_settings_twin_sync_sse() -> ApplicationSettings {
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn get_fallible_app_settings_twin_sync_sse() -> anyhow::Result<ApplicationSettings> {
    Ok(frb_example_pure_dart_example_external_lib::get_app_settings())
}

// Similarly, receiving an object from Dart works. Please note that the mirror definition must match entirely and the original struct must have all its fields public.
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn is_app_embedded_twin_sync_sse(app_settings: ApplicationSettings) -> bool {
    // info!("env: {:?}", app_settings.env.vars);
    matches!(app_settings.mode, ApplicationMode::Embedded)
}

// use a stream of a mirrored type
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn app_settings_stream_twin_sync_sse(sink: StreamSink<ApplicationSettings, flutter_rust_bridge::SseCodec>) {
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn app_settings_vec_stream_twin_sync_sse(sink: StreamSink<Vec<ApplicationSettings>, flutter_rust_bridge::SseCodec>) {
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn mirror_struct_stream_twin_sync_sse(sink: StreamSink<MirrorStructTwinSyncSse, flutter_rust_bridge::SseCodec>) {
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn mirror_tuple_stream_twin_sync_sse(
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn get_message_twin_sync_sse() -> ApplicationMessage {
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn repeat_number_twin_sync_sse(num: i32, times: usize) -> Numbers {
    frb_example_pure_dart_example_external_lib::repeat_number(num, times)
}

#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn repeat_sequence_twin_sync_sse(seq: i32, times: usize) -> Sequences {
    frb_example_pure_dart_example_external_lib::repeat_sequences(seq, times)
}

#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn first_number_twin_sync_sse(nums: Numbers) -> Option<i32> {
    nums.0.first().copied()
}

#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn first_sequence_twin_sync_sse(seqs: Sequences) -> Option<i32> {
    seqs.0.first().copied()
}
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn test_raw_string_mirrored_twin_sync_sse() -> RawStringMirrored {
    RawStringMirrored {
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn test_nested_raw_string_mirrored_twin_sync_sse() -> NestedRawStringMirrored {
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn test_raw_string_enum_mirrored_twin_sync_sse(nested: bool) -> RawStringEnumMirrored {
    if nested {
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn test_list_of_raw_nested_string_mirrored_twin_sync_sse() -> ListOfNestedRawStringMirrored {
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn test_fallible_of_raw_string_mirrored_twin_sync_sse() -> anyhow::Result<Vec<RawStringMirrored>>
{
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn test_list_of_nested_enums_mirrored_twin_sync_sse() -> Vec<RawStringEnumMirrored> {
    vec![
        RawStringEnumMirrored::Nested(NestedRawStringMirrored {
            raw: RawStringMirrored {
                r#value: "test".to_owned(),
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn test_contains_mirrored_sub_struct_twin_sync_sse() -> ContainsMirroredSubStructTwinSyncSse {
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn test_hashmap_with_mirrored_value_twin_sync_sse() -> StructWithHashMap {
    StructWithHashMap {
        map: {
            [(
                "key".to_owned(),
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn mirror_enum_stream_twin_sync_sse(sink: StreamSink<ApplicationMode, flutter_rust_bridge::SseCodec>) {
    sink.add(ApplicationMode::Embedded).unwrap();
    sink.add(ApplicationMode::Standalone).unwrap();
}

#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn mirror_option_enum_stream_twin_sync_sse(sink: StreamSink<Option<ApplicationMode>, flutter_rust_bridge::SseCodec>) {
    sink.add(Some(ApplicationMode::Embedded)).unwrap();
    sink.add(None).unwrap();
    sink.add(Some(ApplicationMode::Standalone)).unwrap();
}

#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn mirror_vec_enum_stream_twin_sync_sse(sink: StreamSink<Vec<ApplicationMode>, flutter_rust_bridge::SseCodec>) {
    sink.add(vec![ApplicationMode::Embedded]).unwrap();
    sink.add(vec![ApplicationMode::Standalone]).unwrap();
}

#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn mirror_map_enum_stream_twin_sync_sse(sink: StreamSink<HashMap<u8, ApplicationMode>, flutter_rust_bridge::SseCodec>) {
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn mirror_set_enum_stream_twin_sync_sse(sink: StreamSink<HashSet<ApplicationMode>, flutter_rust_bridge::SseCodec>) {
...
#[flutter_rust_bridge::frb(serialize)] #[flutter_rust_bridge::frb(sync)] pub fn mirror_array_enum_stream_twin_sync_sse(sink: StreamSink<[ApplicationMode; 2], flutter_rust_bridge::SseCodec>) {
