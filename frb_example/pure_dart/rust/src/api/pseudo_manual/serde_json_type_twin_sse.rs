...
#[derive(Debug, Clone)]
pub struct FeatureSerdeJsonTwinSse {
    pub data: serde_json::Value,
}

#[flutter_rust_bridge::frb(serialize)]
pub fn handle_serde_json_value_twin_sse(
...
#[flutter_rust_bridge::frb(serialize)]
pub fn handle_option_serde_json_value_twin_sse(
...
#[flutter_rust_bridge::frb(serialize)]
pub fn handle_vec_serde_json_value_twin_sse(
...
#[flutter_rust_bridge::frb(serialize)]
pub fn handle_map_serde_json_value_twin_sse(
...
#[flutter_rust_bridge::frb(serialize)]
pub fn handle_nested_serde_json_value_twin_sse(
    wrapper: FeatureSerdeJsonTwinSse,
) -> anyhow::Result<FeatureSerdeJsonTwinSse> {
    Ok(wrapper)
}

#[derive(Debug, Clone)]
pub struct FeatureBigNumberTwinSse {
...
#[flutter_rust_bridge::frb(serialize)]
pub fn handle_big_number_types_twin_sse(
    input: FeatureBigNumberTwinSse,
) -> anyhow::Result<FeatureBigNumberTwinSse> {
    assert_eq!(
