...
pub async fn example_basic_list_type_i8_twin_rust_async(arg: Vec<i8>) -> Vec<i8> {
    arg
}

pub async fn example_basic_list_type_i16_twin_rust_async(arg: Vec<i16>) -> Vec<i16> {
    arg
}

pub async fn example_basic_list_type_i32_twin_rust_async(arg: Vec<i32>) -> Vec<i32> {
    arg
}

pub async fn example_basic_list_type_i64_twin_rust_async(arg: Vec<i64>) -> Vec<i64> {
    arg
}

pub async fn example_basic_list_type_i128_twin_rust_async(arg: Vec<i128>) -> Vec<i128> {
    arg
}

pub async fn example_basic_list_type_u8_twin_rust_async(arg: Vec<u8>) -> Vec<u8> {
    arg
}

pub async fn example_basic_list_type_u16_twin_rust_async(arg: Vec<u16>) -> Vec<u16> {
    arg
}

pub async fn example_basic_list_type_u32_twin_rust_async(arg: Vec<u32>) -> Vec<u32> {
    arg
}
...
pub async fn example_basic_list_type_u128_twin_rust_async(arg: Vec<u128>) -> Vec<u128> {
    arg
}
...
pub async fn example_basic_list_type_f64_twin_rust_async(arg: Vec<f64>) -> Vec<f64> {
    arg
}
