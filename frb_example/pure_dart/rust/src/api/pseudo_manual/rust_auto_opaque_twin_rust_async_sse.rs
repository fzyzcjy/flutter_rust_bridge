...
type PrivateOpaqueFieldAliasTwinRustAsyncSse = Arc<RwLock<PrivateOpaqueFieldInnerTwinRustAsyncSse>>;
...
pub struct OpaqueWithPrivateFieldTwinRustAsyncSse {
    ...
    >,
    pub alias_field: PrivateOpaqueFieldAliasTwinRustAsyncSse,
}
