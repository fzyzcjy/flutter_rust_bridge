...
#[derive(Debug)]
struct PrivateOpaqueFieldInnerTwinRustAsyncSse {
    value: String,
}

#[derive(Debug)]
pub(super) struct RestrictedOpaqueFieldInnerTwinRustAsyncSse {
    value: String,
}

mod private_opaque_field_module_twin_rust_async_sse {
    #[derive(Debug)]
    pub struct PrivateModuleOpaqueFieldInnerTwinRustAsyncSse {
        pub value: String,
    }

    pub type PrivateModuleOpaqueFieldAliasTwinRustAsyncSse =
        PrivateModuleOpaqueFieldInnerTwinRustAsyncSse;
}

use private_opaque_field_module_twin_rust_async_sse as private_module_alias_twin_rust_async_sse;
use private_opaque_field_module_twin_rust_async_sse::{
    PrivateModuleOpaqueFieldAliasTwinRustAsyncSse, PrivateModuleOpaqueFieldInnerTwinRustAsyncSse,
    PrivateModuleOpaqueFieldInnerTwinRustAsyncSse as RenamedPrivateModuleOpaqueFieldInnerTwinRustAsyncSse,
};

mod private_opaque_field_alias_module_twin_rust_async_sse {
    use super::private_opaque_field_module_twin_rust_async_sse::PrivateModuleOpaqueFieldInnerTwinRustAsyncSse;

    pub type ImportedTargetAliasTwinRustAsyncSse = PrivateModuleOpaqueFieldInnerTwinRustAsyncSse;
}
...
#[derive(Clone, Debug)]
#[frb(opaque)]
pub struct OpaqueWithPrivateFieldTwinRustAsyncSse {
    pub field: Arc<RwLock<PrivateOpaqueFieldInnerTwinRustAsyncSse>>,
    pub restricted_field: Arc<RwLock<RestrictedOpaqueFieldInnerTwinRustAsyncSse>>,
    pub private_module_field: Arc<
        RwLock<private_opaque_field_module_twin_rust_async_sse::PrivateModuleOpaqueFieldInnerTwinRustAsyncSse>,
    >,
    pub imported_private_module_field: Arc<RwLock<PrivateModuleOpaqueFieldInnerTwinRustAsyncSse>>,
    pub renamed_private_module_field: Arc<RwLock<RenamedPrivateModuleOpaqueFieldInnerTwinRustAsyncSse>>,
    pub imported_alias_field: Arc<RwLock<PrivateModuleOpaqueFieldAliasTwinRustAsyncSse>>,
...
impl OpaqueWithPrivateFieldTwinRustAsyncSse {
    #[flutter_rust_bridge::frb(serialize)]
    pub async fn new_twin_rust_async_sse(value: String) -> Self {
        Self {
            field: Arc::new(RwLock::new(PrivateOpaqueFieldInnerTwinRustAsyncSse {
                value: value.clone(),
            })),
            restricted_field: Arc::new(RwLock::new(RestrictedOpaqueFieldInnerTwinRustAsyncSse {
                value: value.clone(),
            })),
            private_module_field: Arc::new(RwLock::new(
                private_opaque_field_module_twin_rust_async_sse::PrivateModuleOpaqueFieldInnerTwinRustAsyncSse {
                    value: value.clone(),
                },
            )),
            ...
            renamed_private_module_field: Arc::new(RwLock::new(
                RenamedPrivateModuleOpaqueFieldInnerTwinRustAsyncSse {
                    value: value.clone(),
                },
            )),
            imported_alias_field: Arc::new(RwLock::new(PrivateModuleOpaqueFieldInnerTwinRustAsyncSse {
                value: value.clone(),
            })),
            module_alias_field: Arc::new(RwLock::new(
                private_module_alias_twin_rust_async_sse::PrivateModuleOpaqueFieldInnerTwinRustAsyncSse {
                    value: value.clone(),
                },
            )),
