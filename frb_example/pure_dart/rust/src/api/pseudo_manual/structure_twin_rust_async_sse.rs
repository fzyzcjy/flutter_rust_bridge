...
#[flutter_rust_bridge::frb(serialize)] pub async fn func_struct_with_zero_field_twin_rust_async_sse(
...
#[flutter_rust_bridge::frb(serialize)] pub async fn func_struct_with_one_field_twin_rust_async_sse(
...
#[flutter_rust_bridge::frb(serialize)] pub async fn func_struct_with_two_field_twin_rust_async_sse(
...
#[flutter_rust_bridge::frb(serialize)] pub async fn func_tuple_struct_with_one_field_twin_rust_async_sse(
...
#[flutter_rust_bridge::frb(serialize)] pub async fn func_tuple_struct_with_two_field_twin_rust_async_sse(
...
#[flutter_rust_bridge::frb(serialize)] pub async fn func_for_struct_with_field_rename_twin_rust_async_sse(
...
#[flutter_rust_bridge::frb(serialize)] pub async fn func_for_struct_with_dart_keyword_field_twin_rust_async_sse(
