...
#[flutter_rust_bridge::frb(serialize)]
pub async fn reproduce_moi_arc_release_contention_twin_rust_async_sse() {
    contention_repro_twin_rust_async_sse::release_while_pool_is_read_locked();
}

#[flutter_rust_bridge::frb(serialize)]
pub async fn moi_arc_contention_value_drop_count_twin_rust_async_sse() -> u32 {
    contention_repro_twin_rust_async_sse::drop_count()
}

#[flutter_rust_bridge::frb(ignore)]
mod contention_repro_twin_rust_async_sse {
