...
#[flutter_rust_bridge::frb(serialize)]
#[flutter_rust_bridge::frb(sync)]
pub fn create_any_opaque_twin_sync_sse_moi() -> Box<dyn Any + Send + Sync + 'static> {
...
#[flutter_rust_bridge::frb(serialize)]
#[flutter_rust_bridge::frb(sync)]
pub fn run_any_opaque_twin_sync_sse_moi(opaque: Box<dyn Any + Send + Sync + 'static>) -> bool {
    opaque.is::<String>()
}
