...
#[flutter_rust_bridge::frb(serialize)]
#[flutter_rust_bridge::frb(sync)]
pub fn reproduce_moi_arc_release_contention_twin_sync_sse_moi() {
    contention_repro_twin_sync_sse_moi::release_while_pool_is_read_locked();
}

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)]
#[flutter_rust_bridge::frb(serialize)]
#[flutter_rust_bridge::frb(sync)]
pub fn moi_arc_contention_value_drop_count_twin_sync_sse_moi() -> u32 {
    contention_repro_twin_sync_sse_moi::drop_count()
}

#[flutter_rust_bridge::frb(ignore)]
mod contention_repro_twin_sync_sse_moi {
