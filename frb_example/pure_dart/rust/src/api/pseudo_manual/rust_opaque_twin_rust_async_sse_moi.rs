...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)]
#[flutter_rust_bridge::frb(serialize)]
pub async fn create_any_opaque_twin_rust_async_sse_moi() -> Box<dyn Any + Send + Sync + 'static> {
    Box::new("content".to_owned())
}

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)]
#[flutter_rust_bridge::frb(serialize)]
pub async fn run_any_opaque_twin_rust_async_sse_moi(
    opaque: Box<dyn Any + Send + Sync + 'static>,
) -> bool {
    opaque.is::<String>()
}
