...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn create_opaque_twin_rust_async_sse_moi() -> crate::frb_generated::RustOpaqueMoi<HideDataTwinRustAsyncSseMoi> {
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn create_array_opaque_enum_twin_rust_async_sse_moi() -> [EnumOpaqueTwinRustAsyncSseMoi; 5] {
    [
        EnumOpaqueTwinRustAsyncSseMoi::Struct(crate::frb_generated::RustOpaqueMoi::new(HideDataTwinRustAsyncSseMoi(HideDataRaw::new()))),
        ...
        EnumOpaqueTwinRustAsyncSseMoi::Mutex(crate::frb_generated::RustOpaqueMoi::new(Mutex::new(HideDataTwinRustAsyncSseMoi(
            HideDataRaw::new(),
        )))),
        EnumOpaqueTwinRustAsyncSseMoi::RwLock(crate::frb_generated::RustOpaqueMoi::new(RwLock::new(HideDataTwinRustAsyncSseMoi(
            HideDataRaw::new(),
        )))),
    ]
}
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn run_opaque_twin_rust_async_sse_moi(opaque: crate::frb_generated::RustOpaqueMoi<HideDataTwinRustAsyncSseMoi>) -> String {
    opaque.0.hide_data()
}

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn run_opaque_with_delay_twin_rust_async_sse_moi(opaque: crate::frb_generated::RustOpaqueMoi<HideDataTwinRustAsyncSseMoi>) -> String {
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn opaque_array_twin_rust_async_sse_moi() -> [crate::frb_generated::RustOpaqueMoi<HideDataTwinRustAsyncSseMoi>; 2] {
    [
        crate::frb_generated::RustOpaqueMoi::new(HideDataTwinRustAsyncSseMoi(HideDataRaw::new())),
        crate::frb_generated::RustOpaqueMoi::new(HideDataTwinRustAsyncSseMoi(HideDataRaw::new())),
    ]
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn run_non_clone_twin_rust_async_sse_moi(clone: crate::frb_generated::RustOpaqueMoi<NonCloneDataTwinRustAsyncSseMoi>) -> String {
    // Tests whether `.clone()` works even without the generic type wrapped by it
    // implementing Clone.
    clone.clone().0.hide_data()
}

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn opaque_array_run_twin_rust_async_sse_moi(data: [crate::frb_generated::RustOpaqueMoi<HideDataTwinRustAsyncSseMoi>; 2]) {
    for i in data {
        i.0.hide_data();
    }
}

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn opaque_vec_twin_rust_async_sse_moi() -> Vec<crate::frb_generated::RustOpaqueMoi<HideDataTwinRustAsyncSseMoi>> {
    vec![
        crate::frb_generated::RustOpaqueMoi::new(HideDataTwinRustAsyncSseMoi(HideDataRaw::new())),
        crate::frb_generated::RustOpaqueMoi::new(HideDataTwinRustAsyncSseMoi(HideDataRaw::new())),
    ]
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn opaque_vec_run_twin_rust_async_sse_moi(data: Vec<crate::frb_generated::RustOpaqueMoi<HideDataTwinRustAsyncSseMoi>>) {
    for i in data {
        i.0.hide_data();
    }
}
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn create_nested_opaque_twin_rust_async_sse_moi() -> OpaqueNestedTwinRustAsyncSseMoi {
    OpaqueNestedTwinRustAsyncSseMoi {
        first: crate::frb_generated::RustOpaqueMoi::new(HideDataTwinRustAsyncSseMoi(HideDataRaw::new())),
        second: crate::frb_generated::RustOpaqueMoi::new(HideDataTwinRustAsyncSseMoi(HideDataRaw::new())),
    }
}
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn unwrap_rust_opaque_twin_rust_async_sse_moi(opaque: crate::frb_generated::RustOpaqueMoi<HideDataTwinRustAsyncSseMoi>) -> Result<String> {
...
/// FrbOpaqueReturn must be only return type.
/// FrbOpaqueReturn must not be used as an argument.
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn frb_generator_test_twin_rust_async_sse_moi() -> crate::frb_generated::RustOpaqueMoi<FrbOpaqueReturnTwinRustAsyncSseMoi> {
    panic!("dummy code");
}
