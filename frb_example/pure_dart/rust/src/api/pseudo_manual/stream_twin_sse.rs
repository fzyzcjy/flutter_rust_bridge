...
#[flutter_rust_bridge::frb(serialize)]
pub fn immediate_stream_twin_sse(sink: StreamSink<i32, flutter_rust_bridge::SseCodec>) {
    sink.add(0).unwrap();
    sink.add(1).unwrap();
}

#[flutter_rust_bridge::frb(serialize)]
pub fn stream_worker_transfer_twin_sse(sink: StreamSink<i32, flutter_rust_bridge::SseCodec>) {
    #[cfg(target_family = "wasm")]
    {
