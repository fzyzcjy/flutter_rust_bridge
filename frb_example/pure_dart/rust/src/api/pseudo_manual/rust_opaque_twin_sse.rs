...
pub fn create_opaque_twin_sse() -> crate::frb_generated::RustOpaqueMoi<HideData> {
...
// TODO about sync
// #[flutter_rust_bridge::frb(serialize)] pub fn sync_create_opaque_twin_sse() -> SyncReturn<crate::frb_generated::RustOpaqueMoi<HideData>> {
...
#[flutter_rust_bridge::frb(serialize)]
pub fn run_opaque_twin_sse(opaque: crate::frb_generated::RustOpaqueMoi<HideData>) -> String {
    opaque.hide_data()
}
...
#[flutter_rust_bridge::frb(serialize)]
pub fn opaque_array_twin_sse() -> [crate::frb_generated::RustOpaqueMoi<HideData>; 2] {
    [
        RustOpaque::new(HideData::new()),
        RustOpaque::new(HideData::new()),
    ]
...
// TODO about sync
// #[flutter_rust_bridge::frb(serialize)] pub fn sync_create_non_clone_twin_sse() -> SyncReturn<crate::frb_generated::RustOpaqueMoi<NonCloneData>> {
//     SyncReturn(RustOpaque::new(NonCloneData::new()))
// }

#[allow(clippy::redundant_clone)]
#[flutter_rust_bridge::frb(serialize)]
pub fn run_non_clone_twin_sse(clone: crate::frb_generated::RustOpaqueMoi<NonCloneData>) -> String {
...
#[flutter_rust_bridge::frb(serialize)]
pub fn create_sync_opaque_twin_sse() -> crate::frb_generated::RustOpaqueMoi<NonSendHideData> {
    RustOpaque::new(NonSendHideData::new())
}

// TODO about sync
// #[flutter_rust_bridge::frb(serialize)] pub fn sync_create_sync_opaque_twin_sse() -> SyncReturn<crate::frb_generated::RustOpaqueMoi<NonSendHideData>> {
//     SyncReturn(RustOpaque::new(NonSendHideData::new()))
// }

#[flutter_rust_bridge::frb(serialize)]
pub fn opaque_array_run_twin_sse(data: [crate::frb_generated::RustOpaqueMoi<HideData>; 2]) {
    for i in data {
        i.hide_data();
    }
}
...
#[flutter_rust_bridge::frb(serialize)]
pub fn opaque_vec_twin_sse() -> Vec<crate::frb_generated::RustOpaqueMoi<HideData>> {
    vec![
        RustOpaque::new(HideData::new()),
        RustOpaque::new(HideData::new()),
    ]
...
#[flutter_rust_bridge::frb(serialize)]
pub fn opaque_vec_run_twin_sse(data: Vec<crate::frb_generated::RustOpaqueMoi<HideData>>) {
    for i in data {
        i.hide_data();
    }
}
...
#[flutter_rust_bridge::frb(serialize)]
pub fn frb_generator_test_twin_sse() -> crate::frb_generated::RustOpaqueMoi<FrbOpaqueReturn> {
    panic!("dummy code");
}
