...
#[flutter_rust_bridge::frb(sync)] pub fn handle_type_alias_id_twin_sync(input: Id) -> Id {
    input
}

#[flutter_rust_bridge::frb(sync)] pub fn handle_type_nest_alias_id_twin_sync(input: UserIdAlias) -> Id {
    input
}
...
#[flutter_rust_bridge::frb(sync)] pub fn handle_type_alias_model_twin_sync(input: Id) -> TestModelTwinSync {
    TestModelTwinSync {
        id: input,
