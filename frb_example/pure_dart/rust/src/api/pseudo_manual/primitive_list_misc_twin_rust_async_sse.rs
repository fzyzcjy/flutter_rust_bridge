...
pub struct VecOfPrimitivePackTwinRustAsyncSse {
    pub int8list: Vec<i8>,
...
#[flutter_rust_bridge::frb(serialize)] pub async fn handle_vec_of_primitive_twin_rust_async_sse(n: i32) -> VecOfPrimitivePackTwinRustAsyncSse {
...
// pub struct ZeroCopyVecOfPrimitivePackTwinRustAsyncSse {
...
// }
//
// #[flutter_rust_bridge::frb(serialize)] pub async fn handle_zero_copy_vec_of_primitive_twin_rust_async_sse(
//     n: i32,
// ) -> ZeroCopyVecOfPrimitivePackTwinRustAsyncSse {
//     ZeroCopyVecOfPrimitivePackTwinRustAsyncSse {
