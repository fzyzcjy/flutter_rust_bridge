...
#[flutter_rust_bridge::frb(serialize)] pub async fn handle_uuid_twin_rust_async_sse(id: uuid::Uuid) -> anyhow::Result<uuid::Uuid> {
    Ok(id)
}
...
#[flutter_rust_bridge::frb(serialize)] pub async fn handle_nested_uuids_twin_rust_async_sse(
