...
#[frb(sync)]
#[flutter_rust_bridge::frb(serialize)] pub fn sync_loopback_twin_sse(opaque: DartOpaque) -> DartOpaque {
    opaque
}

#[frb(sync)]
#[flutter_rust_bridge::frb(serialize)] pub fn sync_option_loopback_twin_sse(opaque: Option<DartOpaque>) -> Option<DartOpaque> {
    opaque
}

#[frb(sync)]
#[flutter_rust_bridge::frb(serialize)] pub fn sync_accept_dart_opaque_twin_sse(opaque: DartOpaque) -> String {
    drop(opaque);
    "test".to_owned()
}
...
#[frb(sync)]
#[flutter_rust_bridge::frb(serialize)] pub fn unwrap_dart_opaque_twin_sse(opaque: DartOpaque) -> String {
...
#[frb(sync)]
#[flutter_rust_bridge::frb(serialize)] pub fn sync_option_dart_opaque_twin_sse(
    opaque: DartOpaque,
