...
#[flutter_rust_bridge::frb(sync)] pub fn benchmark_void_twin_sync() {}
  
#[flutter_rust_bridge::frb(sync)] pub fn benchmark_input_bytes_twin_sync(bytes: Vec<u8>) -> i32 {
    bytes.into_iter().map(|x| x as i32).sum()
}

#[flutter_rust_bridge::frb(sync)] pub fn benchmark_output_bytes_twin_sync(size: i32) -> Vec<u8> {
    vec![0; size as usize]
}
...
#[flutter_rust_bridge::frb(sync)] pub fn benchmark_binary_tree_input_twin_sync(tree: BenchmarkBinaryTreeTwinSync) {
    black_box(tree);
}

#[flutter_rust_bridge::frb(sync)] pub fn benchmark_binary_tree_output_twin_sync(depth: i32) -> BenchmarkBinaryTreeTwinSync {
    BINARY_TREES.get(&depth).unwrap().to_owned()
}

#[flutter_rust_bridge::frb(sync)] pub fn benchmark_binary_tree_input_protobuf_twin_sync(raw: Vec<u8>) {
    let data = BinaryTreeProtobuf::parse_from_bytes(&raw).unwrap();
    black_box(data);
}

#[flutter_rust_bridge::frb(sync)] pub fn benchmark_binary_tree_output_protobuf_twin_sync(depth: i32) -> Vec<u8> {
...
#[flutter_rust_bridge::frb(sync)] pub fn benchmark_binary_tree_input_json_twin_sync(raw: String) {
    let obj: BenchmarkBinaryTreeTwinSync = serde_json::from_str(&raw).unwrap();
    black_box(obj);
}

#[flutter_rust_bridge::frb(sync)] pub fn benchmark_binary_tree_output_json_twin_sync(depth: i32) -> String {
...
#[flutter_rust_bridge::frb(sync)] pub fn benchmark_blob_input_twin_sync(blob: BenchmarkBlobTwinSync) {
    black_box(blob);
}

#[flutter_rust_bridge::frb(sync)] pub fn benchmark_blob_output_twin_sync(size: i32) -> BenchmarkBlobTwinSync {
    create_blob(size)
}

#[flutter_rust_bridge::frb(sync)] pub fn benchmark_blob_input_protobuf_twin_sync(raw: Vec<u8>) {
    let data = BlobProtobuf::parse_from_bytes(&raw).unwrap();
    black_box(data);
}

#[flutter_rust_bridge::frb(sync)] pub fn benchmark_blob_output_protobuf_twin_sync(size: i32) -> Vec<u8> {
    let data = vec![0; size as _];
...
#[flutter_rust_bridge::frb(sync)] pub fn benchmark_blob_input_json_twin_sync(raw: String) {
    let obj: BenchmarkBlobTwinSync = serde_json::from_str(&raw).unwrap();
    black_box(obj);
}

#[flutter_rust_bridge::frb(sync)] pub fn benchmark_blob_output_json_twin_sync(size: i32) -> String {
