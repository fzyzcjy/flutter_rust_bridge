...
#[derive(Debug)]
struct PrivateOpaqueFieldInnerTwinSseMoi {
    value: String,
}

#[derive(Debug)]
pub(super) struct RestrictedOpaqueFieldInnerTwinSseMoi {
    value: String,
}

mod private_opaque_field_module_twin_sse_moi {
    #[derive(Debug)]
...
use private_opaque_field_module_twin_sse_moi as private_module_alias_twin_sse_moi;
...
mod private_opaque_field_alias_module_twin_sse_moi {
    use super::private_opaque_field_module_twin_sse_moi::PrivateModuleOpaqueFieldInnerTwinSseMoi;

    pub type ImportedTargetAliasTwinSseMoi = PrivateModuleOpaqueFieldInnerTwinSseMoi;
}

use private_opaque_field_alias_module_twin_sse_moi::ImportedTargetAliasTwinSseMoi;

mod private_opaque_field_base_alias_module_twin_sse_moi {
    use super::private_opaque_field_module_twin_sse_moi::PrivateModuleOpaqueFieldInnerTwinSseMoi;

    pub type BaseAliasTwinSseMoi = PrivateModuleOpaqueFieldInnerTwinSseMoi;
}

mod private_opaque_field_chained_alias_module_twin_sse_moi {
    use super::private_opaque_field_base_alias_module_twin_sse_moi::BaseAliasTwinSseMoi;

    pub type ChainedAliasTwinSseMoi = BaseAliasTwinSseMoi;
}

use private_opaque_field_chained_alias_module_twin_sse_moi::ChainedAliasTwinSseMoi;
...
#[derive(Clone, Debug)]
#[frb(opaque)]
pub struct OpaqueWithPrivateFieldTwinSseMoi {
    pub field: Arc<RwLock<PrivateOpaqueFieldInnerTwinSseMoi>>,
    pub restricted_field: Arc<RwLock<RestrictedOpaqueFieldInnerTwinSseMoi>>,
    ...
    pub module_alias_field:
        Arc<RwLock<private_module_alias_twin_sse_moi::PrivateModuleOpaqueFieldInnerTwinSseMoi>>,
    pub imported_target_alias_field: Arc<RwLock<ImportedTargetAliasTwinSseMoi>>,
    pub chained_alias_field: Arc<RwLock<ChainedAliasTwinSseMoi>>,
    pub alias_field: Arc<RwLock<PrivateOpaqueFieldAliasTwinSseMoi>>,
}

impl OpaqueWithPrivateFieldTwinSseMoi {
    #[flutter_rust_bridge::frb(rust_opaque_codec_moi)]
    #[flutter_rust_bridge::frb(serialize)]
    pub fn new_twin_sse_moi(value: String) -> Self {
        Self {
            field: Arc::new(RwLock::new(PrivateOpaqueFieldInnerTwinSseMoi {
                value: value.clone(),
            })),
            restricted_field: Arc::new(RwLock::new(RestrictedOpaqueFieldInnerTwinSseMoi {
                value: value.clone(),
            })),
            private_module_field: Arc::new(RwLock::new(
                private_opaque_field_module_twin_sse_moi::PrivateModuleOpaqueFieldInnerTwinSseMoi {
                    value: value.clone(),
                },
            )),
            imported_private_module_field: Arc::new(RwLock::new(
                PrivateModuleOpaqueFieldInnerTwinSseMoi {
                    value: value.clone(),
                },
            )),
            ...
            module_alias_field: Arc::new(RwLock::new(
                private_module_alias_twin_sse_moi::PrivateModuleOpaqueFieldInnerTwinSseMoi {
                    value: value.clone(),
                },
            )),
            ...
            chained_alias_field: Arc::new(RwLock::new(PrivateModuleOpaqueFieldInnerTwinSseMoi {
                value: value.clone(),
            })),
