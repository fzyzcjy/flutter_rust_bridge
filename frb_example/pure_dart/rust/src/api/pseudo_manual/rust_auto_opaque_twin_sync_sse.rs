...
#[derive(Debug)]
struct PrivateOpaqueFieldInnerTwinSyncSse {
    value: String,
}

#[derive(Debug)]
pub(super) struct RestrictedOpaqueFieldInnerTwinSyncSse {
    value: String,
}

mod private_opaque_field_module_twin_sync_sse {
    #[derive(Debug)]
    pub struct PrivateModuleOpaqueFieldInnerTwinSyncSse {
        pub value: String,
    }

    pub type PrivateModuleOpaqueFieldAliasTwinSyncSse = PrivateModuleOpaqueFieldInnerTwinSyncSse;
}

use private_opaque_field_module_twin_sync_sse as private_module_alias_twin_sync_sse;
use private_opaque_field_module_twin_sync_sse::{
    PrivateModuleOpaqueFieldAliasTwinSyncSse, PrivateModuleOpaqueFieldInnerTwinSyncSse,
    PrivateModuleOpaqueFieldInnerTwinSyncSse as RenamedPrivateModuleOpaqueFieldInnerTwinSyncSse,
};

mod private_opaque_field_alias_module_twin_sync_sse {
    use super::private_opaque_field_module_twin_sync_sse::PrivateModuleOpaqueFieldInnerTwinSyncSse;

    pub type ImportedTargetAliasTwinSyncSse = PrivateModuleOpaqueFieldInnerTwinSyncSse;
}
...
#[derive(Clone, Debug)]
#[frb(opaque)]
pub struct OpaqueWithPrivateFieldTwinSyncSse {
    pub field: Arc<RwLock<PrivateOpaqueFieldInnerTwinSyncSse>>,
    pub restricted_field: Arc<RwLock<RestrictedOpaqueFieldInnerTwinSyncSse>>,
    pub private_module_field: Arc<
        RwLock<private_opaque_field_module_twin_sync_sse::PrivateModuleOpaqueFieldInnerTwinSyncSse>,
    >,
    pub imported_private_module_field: Arc<RwLock<PrivateModuleOpaqueFieldInnerTwinSyncSse>>,
    pub renamed_private_module_field: Arc<RwLock<RenamedPrivateModuleOpaqueFieldInnerTwinSyncSse>>,
    pub imported_alias_field: Arc<RwLock<PrivateModuleOpaqueFieldAliasTwinSyncSse>>,
...
impl OpaqueWithPrivateFieldTwinSyncSse {
    #[flutter_rust_bridge::frb(serialize)]
    #[flutter_rust_bridge::frb(sync)]
    pub fn new_twin_sync_sse(value: String) -> Self {
        Self {
            field: Arc::new(RwLock::new(PrivateOpaqueFieldInnerTwinSyncSse {
                value: value.clone(),
            })),
            restricted_field: Arc::new(RwLock::new(RestrictedOpaqueFieldInnerTwinSyncSse {
                value: value.clone(),
            })),
            private_module_field: Arc::new(RwLock::new(
                private_opaque_field_module_twin_sync_sse::PrivateModuleOpaqueFieldInnerTwinSyncSse {
                    value: value.clone(),
                },
            )),
            imported_private_module_field: Arc::new(RwLock::new(
                PrivateModuleOpaqueFieldInnerTwinSyncSse {
                    value: value.clone(),
                },
            )),
            renamed_private_module_field: Arc::new(RwLock::new(
                RenamedPrivateModuleOpaqueFieldInnerTwinSyncSse {
                    value: value.clone(),
                },
            )),
            imported_alias_field: Arc::new(RwLock::new(PrivateModuleOpaqueFieldInnerTwinSyncSse {
                value: value.clone(),
            })),
            module_alias_field: Arc::new(RwLock::new(
                private_module_alias_twin_sync_sse::PrivateModuleOpaqueFieldInnerTwinSyncSse {
                    value: value.clone(),
                },
            )),
