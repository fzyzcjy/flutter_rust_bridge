...
pub fn use_imported_struct_twin_sse(my_struct: MyStruct) -> bool {
    my_struct.content
}

// Function that uses imported enum (from within this crate)
#[flutter_rust_bridge::frb(serialize)]
pub fn use_imported_enum_twin_sse(my_enum: MyEnum) -> bool {
    match my_enum {
        MyEnum::False => false,
        MyEnum::True => true,
    }
...
#[flutter_rust_bridge::frb(serialize)]
pub fn call_old_module_system_twin_sse() -> OldSimpleStruct {
    use_old_module_system(2)
}

#[flutter_rust_bridge::frb(serialize)]
pub fn call_new_module_system_twin_sse() -> NewSimpleStruct {
