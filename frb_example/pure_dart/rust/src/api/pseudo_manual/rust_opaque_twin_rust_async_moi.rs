...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)]
pub async fn reproduce_moi_arc_release_contention_twin_rust_async_moi() {
    contention_repro_twin_rust_async_moi::release_while_pool_is_read_locked();
}

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)]
pub async fn moi_arc_contention_value_drop_count_twin_rust_async_moi() -> u32 {
    contention_repro_twin_rust_async_moi::drop_count()
}

#[flutter_rust_bridge::frb(ignore)]
mod contention_repro_twin_rust_async_moi {
