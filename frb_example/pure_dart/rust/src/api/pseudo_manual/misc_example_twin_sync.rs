...
#[flutter_rust_bridge::frb(sync)] pub fn handle_char_twin_sync(arg: char) -> char {
    arg
}
...
#[frb(positional)]
#[flutter_rust_bridge::frb(sync)] pub fn positional_arguments_twin_sync(a: i32, b: i32) -> i32 {
    a + b
}
