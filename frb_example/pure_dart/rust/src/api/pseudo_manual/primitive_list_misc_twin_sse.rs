...
pub struct VecOfPrimitivePackTwinSse {
    pub int8list: Vec<i8>,
...
#[flutter_rust_bridge::frb(serialize)] pub fn handle_vec_of_primitive_twin_sse(n: i32) -> VecOfPrimitivePackTwinSse {
    VecOfPrimitivePackTwinSse {
...
// pub struct ZeroCopyVecOfPrimitivePackTwinSse {
...
// }
//
// #[flutter_rust_bridge::frb(serialize)] pub fn handle_zero_copy_vec_of_primitive_twin_sse(
//     n: i32,
// ) -> ZeroCopyVecOfPrimitivePackTwinSse {
//     ZeroCopyVecOfPrimitivePackTwinSse {
