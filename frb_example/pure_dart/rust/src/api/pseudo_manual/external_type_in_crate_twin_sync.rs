...
#[flutter_rust_bridge::frb(sync)] pub fn use_imported_struct_twin_sync(my_struct: MyStruct) -> bool {
    my_struct.content
}

// Function that uses imported enum (from within this crate)
#[flutter_rust_bridge::frb(sync)] pub fn use_imported_enum_twin_sync(my_enum: MyEnum) -> bool {
    match my_enum {
        MyEnum::False => false,
        MyEnum::True => true,
    }
...
#[flutter_rust_bridge::frb(sync)] pub fn call_old_module_system_twin_sync() -> OldSimpleStruct {
    use_old_module_system(2)
}

#[flutter_rust_bridge::frb(sync)] pub fn call_new_module_system_twin_sync() -> NewSimpleStruct {
