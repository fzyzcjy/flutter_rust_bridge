...
#[flutter_rust_bridge::frb(serialize)] pub async fn handle_complex_struct_twin_rust_async_sse(s: MyTreeNodeTwinRustAsyncSse) -> MyTreeNodeTwinRustAsyncSse {
...
#[flutter_rust_bridge::frb(serialize)] pub async fn list_of_primitive_enums_twin_rust_async_sse(
...
#[flutter_rust_bridge::frb(serialize)] pub async fn handle_nested_struct_twin_rust_async_sse(s: MyNestedStructTwinRustAsyncSse) -> MyNestedStructTwinRustAsyncSse {
...
#[flutter_rust_bridge::frb(serialize)] pub async fn handle_big_buffers_twin_rust_async_sse() -> BigBuffersTwinRustAsyncSse {
...
#[flutter_rust_bridge::frb(serialize)] pub async fn test_abc_enum_twin_rust_async_sse(abc: AbcTwinRustAsyncSse) -> AbcTwinRustAsyncSse {
    abc
}
...
#[flutter_rust_bridge::frb(serialize)] pub async fn test_struct_with_enum_twin_rust_async_sse(se: StructWithEnumTwinRustAsyncSse) -> StructWithEnumTwinRustAsyncSse {
...
#[flutter_rust_bridge::frb(serialize)] pub async fn handle_string_twin_rust_async_sse(s: String) -> String {
    info!("handle_string({})", &s);
    let s2 = s.clone();
    s + &s2
}

#[flutter_rust_bridge::frb(serialize)] pub async fn handle_char_twin_rust_async_sse(arg: char) -> char {
    arg
}

// to check that `Vec<u8>` can be used as return type
#[flutter_rust_bridge::frb(serialize)] pub async fn handle_vec_u8_twin_rust_async_sse(v: Vec<u8>) -> Vec<u8> {
    info!("handle_vec_u8(first few elements: {:?})", &v[..5]);
    v.repeat(2)
}

#[flutter_rust_bridge::frb(serialize)] pub async fn handle_struct_twin_rust_async_sse(arg: MySize, boxed: Box<MySize>) -> MySize {
...
#[frb(positional)]
#[flutter_rust_bridge::frb(serialize)] pub async fn positional_arguments_twin_rust_async_sse(a: i32, b: i32) -> i32 {
    a + b
}
