...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn rust_auto_opaque_enum_with_good_and_opaque_arg_own_twin_rust_async_sse_moi(
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn rust_auto_opaque_enum_with_good_and_opaque_return_own_good_twin_rust_async_sse_moi(
) -> EnumWithGoodAndOpaqueTwinRustAsyncSseMoi {
    EnumWithGoodAndOpaqueTwinRustAsyncSseMoi::Good("hello".to_owned())
}

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn rust_auto_opaque_enum_with_good_and_opaque_return_own_opaque_twin_rust_async_sse_moi(
) -> EnumWithGoodAndOpaqueTwinRustAsyncSseMoi {
    EnumWithGoodAndOpaqueTwinRustAsyncSseMoi::Opaque(NonCloneSimpleTwinRustAsyncSseMoi { inner: 42 })
}
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn rust_auto_opaque_dummy_twin_rust_async_sse_moi(
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn rust_auto_opaque_enum_arg_borrow_twin_rust_async_sse_moi(arg: &NonCloneSimpleEnumTwinRustAsyncSseMoi) {
    assert!(matches!(arg, NonCloneSimpleEnumTwinRustAsyncSseMoi::Orange));
}

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn rust_auto_opaque_enum_return_own_twin_rust_async_sse_moi() -> NonCloneSimpleEnumTwinRustAsyncSseMoi {
    NonCloneSimpleEnumTwinRustAsyncSseMoi::Orange
}

// ================ stream sink ===================

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn rust_auto_opaque_stream_sink_twin_rust_async_sse_moi(sink: StreamSink<NonCloneSimpleTwinRustAsyncSseMoi, flutter_rust_bridge::SseCodec>) {
    sink.add(NonCloneSimpleTwinRustAsyncSseMoi { inner: 42 }).unwrap();
}

// ================ vec of opaque ===================

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn rust_auto_opaque_arg_vec_own_twin_rust_async_sse_moi(
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn rust_auto_opaque_return_vec_own_twin_rust_async_sse_moi() -> Vec<NonCloneSimpleTwinRustAsyncSseMoi> {
    vec![
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn rust_auto_opaque_explicit_arg_twin_rust_async_sse_moi(
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn rust_auto_opaque_explicit_struct_twin_rust_async_sse_moi(
    arg: StructWithExplicitAutoOpaqueFieldTwinRustAsyncSseMoi,
) {
    assert_eq!(arg.auto_opaque.try_read().unwrap().inner, arg.normal);
}

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn rust_auto_opaque_explicit_return_struct_twin_rust_async_sse_moi(
) -> StructWithExplicitAutoOpaqueFieldTwinRustAsyncSseMoi {
    StructWithExplicitAutoOpaqueFieldTwinRustAsyncSseMoi {
        normal: 100,
        auto_opaque: crate::frb_generated::RustAutoOpaqueMoi::new(NonCloneSimpleTwinRustAsyncSseMoi { inner: 100 }),
    }
}

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn rust_auto_opaque_explicit_return_twin_rust_async_sse_moi(
    initial: i32,
) -> crate::frb_generated::RustAutoOpaqueMoi<NonCloneSimpleTwinRustAsyncSseMoi> {
    crate::frb_generated::RustAutoOpaqueMoi::new(NonCloneSimpleTwinRustAsyncSseMoi { inner: initial })
}

// ================ deadlock detection ===================

#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn rust_auto_opaque_sleep_twin_rust_async_sse_moi(
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn rust_auto_opaque_borrow_and_mut_borrow_twin_rust_async_sse_moi(
...
#[flutter_rust_bridge::frb(rust_opaque_codec_moi)] #[flutter_rust_bridge::frb(serialize)] pub async fn rust_auto_opaque_borrow_and_borrow_twin_rust_async_sse_moi(
    a: &NonCloneSimpleTwinRustAsyncSseMoi,
    b: &NonCloneSimpleTwinRustAsyncSseMoi,
) -> i32 {
    a.inner + b.inner
