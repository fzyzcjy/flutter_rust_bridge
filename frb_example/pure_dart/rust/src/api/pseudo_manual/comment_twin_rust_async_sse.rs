...
#[flutter_rust_bridge::frb(serialize)] pub async fn function_with_comments_triple_slash_single_line_twin_rust_async_sse() {}

/// This is first line
/// This is second line
#[flutter_rust_bridge::frb(serialize)] pub async fn function_with_comments_triple_slash_multi_line_twin_rust_async_sse() {}
...
*/
#[flutter_rust_bridge::frb(serialize)] pub async fn function_with_comments_slash_star_star_twin_rust_async_sse() {}
...
impl StructWithCommentsTwinRustAsyncSse {
    ...
    #[flutter_rust_bridge::frb(serialize)] pub async fn static_method_twin_rust_async_sse() {}

    /// Documentation on an instance method
    #[flutter_rust_bridge::frb(serialize)] pub async fn instance_method_twin_rust_async_sse(&self) {}
}
