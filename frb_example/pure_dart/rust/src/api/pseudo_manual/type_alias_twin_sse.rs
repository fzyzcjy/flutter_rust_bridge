...
#[flutter_rust_bridge::frb(serialize)] pub fn handle_type_alias_id_twin_sse(input: Id) -> Id {
    input
}

#[flutter_rust_bridge::frb(serialize)] pub fn handle_type_nest_alias_id_twin_sse(input: UserIdAlias) -> Id {
    input
}
...
#[flutter_rust_bridge::frb(serialize)] pub fn handle_type_alias_model_twin_sse(input: Id) -> TestModelTwinSse {
    TestModelTwinSse {
        id: input,
