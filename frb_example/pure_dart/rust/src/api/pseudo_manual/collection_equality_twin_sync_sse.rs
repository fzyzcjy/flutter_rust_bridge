...
pub struct StructWithDeepCollectionEqualityTwinSyncSse {
    pub list: Vec<String>,
...
pub fn echo_struct_with_deep_collection_equality_twin_sync_sse(
    value: StructWithDeepCollectionEqualityTwinSyncSse,
...
#[flutter_rust_bridge::frb(serialize)]
#[flutter_rust_bridge::frb(sync)]
pub fn echo_struct_with_shallow_collection_equality_twin_sync_sse(
    value: StructWithShallowCollectionEqualityTwinSyncSse,
