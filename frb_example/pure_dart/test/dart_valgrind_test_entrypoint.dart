...
Future<void> callFileEntrypoints() async {
  ...
  await serde_json_type_twin_rust_async_sse_test.main(skipRustLibInit: true);
  await serde_json_type_twin_rust_async_test.main(skipRustLibInit: true);
  await serde_json_type_twin_sse_test.main(skipRustLibInit: true);
  await serde_json_type_twin_sync_sse_test.main(skipRustLibInit: true);
