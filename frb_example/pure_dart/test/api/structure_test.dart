...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  addTestsIdentityFunctionCall(funcStructWithZeroFieldTwinNormal, [
    StructWithZeroFieldTwinNormal(),
  ]);
  addTestsIdentityFunctionCall(funcStructWithOneFieldTwinNormal, [
    StructWithOneFieldTwinNormal(a: 42),
  ]);
