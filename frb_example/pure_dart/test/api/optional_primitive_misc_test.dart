...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  test('dart call optional primitiveTypes', () async {
    ...
    expect(await primitiveOptionalTypes(myI32: 0, myI64: BigInt.from(0), myF64: 0, myBool: false), 4);
    expect(await primitiveOptionalTypes(myI32: 123, myI64: BigInt.from(123), myF64: 123, myBool: true), 4);
  });
}
