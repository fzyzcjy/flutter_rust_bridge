...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  group('basic_list', () {
    addTestsIdentityFunctionCall(
      exampleBasicListTypeI8TwinRustAsyncSse,
      <Int8List>[
        Int8List(0),
        Int8List(1)..[0] = 0,
        Int8List(1)..[0] = -128,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeI16TwinRustAsyncSse,
      <Int16List>[
        Int16List(0),
        Int16List(1)..[0] = 0,
        Int16List(1)..[0] = -32768,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeI32TwinRustAsyncSse,
      <Int32List>[
        Int32List(0),
        Int32List(1)..[0] = 0,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeI64TwinRustAsyncSse,
      <Int64List>[
        Int64List(0),
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeU8TwinRustAsyncSse,
      <Uint8List>[
        Uint8List(0),
        Uint8List(1)..[0] = 0,
        Uint8List(1)..[0] = 255,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeU16TwinRustAsyncSse,
      <Uint16List>[
        Uint16List(0),
        Uint16List(1)..[0] = 0,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeU32TwinRustAsyncSse,
      <Uint32List>[
        Uint32List(0),
        Uint32List(1)..[0] = 0,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeF32TwinRustAsyncSse,
      <Float32List>[
        Float32List(0),
        Float32List(1)..[0] = 0,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeF64TwinRustAsyncSse,
      <Float64List>[
        Float64List(0),
        Float64List(1)..[0] = 0,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeStringTwinRustAsyncSse,
      <List<String>>[
        [],
        [""],
        ["hello"],
