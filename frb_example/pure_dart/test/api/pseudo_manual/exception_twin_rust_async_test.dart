...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  group('systematic test', () {
    ...
    test('call funcTypeFalliblePanicTwinRustAsync', skip: kIsWeb, () async {
      await expectRustPanic(
        () async => funcTypeFalliblePanicTwinRustAsync(),
        'TwinRustAsync',
        messageOnNative: 'deliberate panic',
      );
    });
    test('call funcTypeInfalliblePanicTwinRustAsync', skip: kIsWeb, () async {
      await expectRustPanic(
        () async => funcTypeInfalliblePanicTwinRustAsync(),
        'TwinRustAsync',
        messageOnNative: 'deliberate panic',
      );
    });
    ...
    test('call customEnumErrorPanicTwinRustAsync', skip: kIsWeb, () async {
      await expectRustPanic(
        () async => customEnumErrorPanicTwinRustAsync(),
        'TwinRustAsync',
        messageOnNative: 'deliberate panic',
      );
    });
    ...
    test('call funcReturnErrorTwinRustAsync', () async {
      var matcher = isA<CustomEnumErrorTwinRustAsync>().having(
        (x) => x.message,
        'message',
        startsWith('deliberate error'),
      );
      ...
      await expectLater(
        () async => customEnumErrorReturnErrorTwinRustAsync(),
        throwsA(matcher),
      );
    });
  ...
  group('example-based tests', () {
    group('custom errors', () {
      ...
      test('Throw CustomError', timeout: Timeout.factor(5), () {
        expect(
          () async => returnErrCustomErrorTwinRustAsync(),
      ...
      test('Throw CustomStructError', () async {
        await expectLater(
          () async => returnCustomStructErrorTwinRustAsync(),
      ...
      test('Throw CustomNestedError1', () async {
        await expectLater(
          ...
          throwsA(
            CustomNestedError1TwinRustAsync.errorNested(
      ...
      test('Throw CustomNestedError2', () async {
        await expectLater(
          () async => returnCustomNestedError2TwinRustAsync(),
      ...
      test('Throw anyhow error', () async {
        await expectLater(
          () async => throwAnyhowTwinRustAsync(),
          throwsA(isA<FrbException>()),
        );
      });
