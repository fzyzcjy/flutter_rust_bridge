...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  group('systematic test', () {
    ...
    test('call funcTypeFalliblePanicTwinSyncSse', skip: kIsWeb, () async {
      await expectRustPanic(
        () async => funcTypeFalliblePanicTwinSyncSse(),
        'TwinSyncSse',
        messageOnNative: 'deliberate panic',
      );
    });
    test('call funcTypeInfalliblePanicTwinSyncSse', skip: kIsWeb, () async {
      await expectRustPanic(
        () async => funcTypeInfalliblePanicTwinSyncSse(),
        'TwinSyncSse',
        messageOnNative: 'deliberate panic',
      );
    });
    ...
    test('call customEnumErrorPanicTwinSyncSse', skip: kIsWeb, () async {
      await expectRustPanic(
        () async => customEnumErrorPanicTwinSyncSse(),
        'TwinSyncSse',
        messageOnNative: 'deliberate panic',
      );
    });
    ...
    test('call funcReturnErrorTwinSyncSse', () async {
      var matcher = isA<CustomEnumErrorTwinSyncSse>().having(
        (x) => x.message,
        'message',
        startsWith('deliberate error'),
      );
      ...
      await expectLater(
        () async => customEnumErrorReturnErrorTwinSyncSse(),
        throwsA(matcher),
      );
    });
  ...
  group('example-based tests', () {
    group('custom errors', () {
      ...
      test('Throw CustomError', timeout: Timeout.factor(5), () {
        expect(
          () async => returnErrCustomErrorTwinSyncSse(),
      ...
      test('Throw CustomStructError', () async {
        await expectLater(
          () async => returnCustomStructErrorTwinSyncSse(),
      ...
      test('Throw CustomNestedError1', () async {
        await expectLater(
          ...
          throwsA(
            CustomNestedError1TwinSyncSse.errorNested(
      ...
      test('Throw CustomNestedError2', () async {
        await expectLater(
          () async => returnCustomNestedError2TwinSyncSse(),
      ...
      test('Throw CustomError variant 0', () async {
        await expectLater(
          () async => returnErrorVariantTwinSyncSse(variant: 0),
          throwsA(isA<CustomErrorTwinSyncSse>()),
        );
      });
      ...
      test('Throw CustomError variant 1', () async {
        await expectLater(
          () async => returnErrorVariantTwinSyncSse(variant: 1),
          throwsA(isA<CustomErrorTwinSyncSse>()),
        );
      });
      ...
      test('Function with custom result panics', () async {
        await expectRustPanicRaw(
          () async => panicWithCustomResultTwinSyncSse(),
          'TwinSyncSse',
          throwsA(isA<FrbException>()),
        );
      });
