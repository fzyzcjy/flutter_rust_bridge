...
import 'package:frb_example_pure_dart/src/rust/api/pseudo_manual/misc_example_twin_rust_async.dart';
...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  void testComplexStruct(
    MyTreeNodeTwinRustAsync complexStructResp, {
    required int arrLen,
  }) {
  ...
  test('test abc', () async {
    ...
    final output4 = await testAbcEnumTwinRustAsync(
      abc: AbcTwinRustAsync.justInt(1),
    );
  ...
  addTestsIdentityFunctionCall(handleCharTwinRustAsync, <String>[
    'a',
    '\0',
    '\u{10FFFF}',
  ]);
