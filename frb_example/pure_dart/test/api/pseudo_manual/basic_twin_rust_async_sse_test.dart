...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  group('basic', () {
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeI8TwinRustAsyncSse,
      <int>[0, -128, 127, 79, -79],
    );
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeI16TwinRustAsyncSse,
      <int>[0, -32768, 32767, 12345, -12345],
    );
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeI32TwinRustAsyncSse,
      <int>[0, -2147483648, 2147483647, 1234567890, -1234567890],
    );
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeI64TwinRustAsyncSse,
      <PlatformInt64>[
    ...
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeI128TwinRustAsyncSse,
      <BigInt>[
        BigInt.parse("0"),
    ...
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeU8TwinRustAsyncSse,
      <int>[0, 255, 123],
    );
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeU16TwinRustAsyncSse,
      <int>[0, 65535, 12345],
    );
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeU32TwinRustAsyncSse,
      <int>[0, 4294967295, 2468013579],
    );
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeU64TwinRustAsyncSse,
      <BigInt>[
        BigInt.parse("0"),
        BigInt.parse("9007199254740992"),
        BigInt.parse("9223372036854775807"),
    ...
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeU128TwinRustAsyncSse,
      <BigInt>[
        BigInt.parse("0"),
        BigInt.parse("9007199254740992"),
        BigInt.parse("9223372036854775807"),
    ...
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeIsizeTwinRustAsyncSse,
      <PlatformInt64>[
        PlatformInt64.parse("0"),
    ...
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeUsizeTwinRustAsyncSse,
      <BigInt>[
        BigInt.parse("0"),
    ...
    addTestsIdentityFunctionCall(exampleBasicTypeF32TwinRustAsyncSse, <double>[
      0,
      -42.5,
      123456,
    ]);
    addTestsIdentityFunctionCall(exampleBasicTypeF64TwinRustAsyncSse, <double>[
      0,
      -42.5,
      123456,
    ]);
    addTestsIdentityFunctionCall(exampleBasicTypeBoolTwinRustAsyncSse, <bool>[
      false,
      true,
    ]);
    addTestsIdentityFunctionCall(
      exampleBasicTypeStringTwinRustAsyncSse,
      <String>["", "hello", "😂"],
    );
    addTestsIdentityFunctionCall(
      exampleBasicTypeBytesTwinRustAsyncSse,
      <Uint8List>[
        Uint8List.fromList([]),
