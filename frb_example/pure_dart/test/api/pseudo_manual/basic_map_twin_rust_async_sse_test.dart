...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  group('basic_map', () {
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeI8TwinRustAsyncSse,
      <Map<int, int>>[
        {},
        {42: 0},
        {42: -128},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeI128TwinRustAsyncSse,
      <Map<int, BigInt>>[
        {},
        {42: BigInt.parse("0")},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeU8TwinRustAsyncSse,
      <Map<int, int>>[
        {},
        {42: 0},
        {42: 255},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeU16TwinRustAsyncSse,
      <Map<int, int>>[
        {},
        {42: 0},
        {42: 65535},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeU32TwinRustAsyncSse,
      <Map<int, int>>[
        {},
        {42: 0},
        {42: 4294967295},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeU64TwinRustAsyncSse,
      <Map<int, BigInt>>[
        {},
        {42: BigInt.parse("0")},
        {42: BigInt.parse("9007199254740992")},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeU128TwinRustAsyncSse,
      <Map<int, BigInt>>[
        {},
        {42: BigInt.parse("0")},
        {42: BigInt.parse("9007199254740992")},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeIsizeTwinRustAsyncSse,
      <Map<int, PlatformInt64>>[
        {},
        {42: PlatformInt64.parse("0")},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeUsizeTwinRustAsyncSse,
      <Map<int, BigInt>>[
        {},
        {42: BigInt.parse("0")},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeF32TwinRustAsyncSse,
      <Map<int, double>>[
        {},
        {42: 0},
        {42: -42.5},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeF64TwinRustAsyncSse,
      <Map<int, double>>[
        {},
        {42: 0},
        {42: -42.5},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeBoolTwinRustAsyncSse,
      <Map<int, bool>>[
        {},
        {42: false},
        {42: true},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeStringTwinRustAsyncSse,
      <Map<int, String>>[
        {},
        {42: ""},
        {42: "hello"},
