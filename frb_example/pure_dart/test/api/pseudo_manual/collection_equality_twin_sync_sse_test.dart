...
import 'package:frb_example_pure_dart/src/rust/api/collection_equality.dart';// FRB_INTERNAL_GENERATOR: {"addCode": "import 'package:frb_example_pure_dart/src/rust/api/pseudo_manual/collection_equality_twin_sync_sse.dart';"}

import 'dart:typed_data';

import 'package:frb_example_pure_dart/src/rust/api/pseudo_manual/collection_equality_twin_sync_sse.dart';
...
StructWithDeepCollectionEqualityTwinSyncSse _makeDeepCollectionStruct({
  List<String>? list,
...
StructWithShallowCollectionEqualityTwinSyncSse _makeShallowCollectionStruct() =>
