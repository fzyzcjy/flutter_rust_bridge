...
import 'package:frb_example_pure_dart/src/rust/api/pseudo_manual/futures_twin_rust_async_sse.dart';
...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  group('functions returning futures', () {
    test('dart call `impl Future` adder', () async {
      expect(await implFutureAdderTwinRustAsyncSse(a: 100, b: 200), 300);
    });

    test('dart call `DartFnFuture` adder', () async {
      expect(
          await dartfnFutureAdderTwinRustAsyncSse(a: 100, b: 200, c: 300), 600);
    });
    ...
    test('dart call `impl Future` adder returning `Result::Ok`', () async {
      expect(await implFutureAdderResultTwinRustAsyncSse(a: 100, b: 200, true),
          300);
    });
    ...
    test('dart call `impl Future` adder returning `Result::Err`', () async {
      expect(await expectLater(
          () async =>
              implFutureAdderResultTwinRustAsyncSse(a: 100, b: 200, false),
          throwsA(isA<CustomErrTwinRustAsyncSse>())));
    });

    test('dart call `DartFnFuture` adder returning `Result::Ok`', () async {
      expect(
          await dartfnFutureAdderResultTwinRustAsyncSse(
    ...
    test('dart call `DartFnFuture` adder returning `Result::Err`', () async {
      expect(await expectLater(
          () async => dartfnFutureAdderResultTwinRustAsyncSse(
    ...
    test('dart call `BoxFuture` adder returning `Result::Ok`', () async {
      expect(
          await boxFutureAdderTwinRustAsyncSse(
    ...
    test('dart call `BoxFuture` adder returning `Result::Err`', () async {
      expect(await expectLater(
          () async => boxFutureAdderTwinRustAsyncSse(
