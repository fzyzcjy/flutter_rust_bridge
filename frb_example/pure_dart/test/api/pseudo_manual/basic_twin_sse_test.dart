...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  group('basic', () {
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeI8TwinSse, <int>[
      0,
      -128,
      127,
      79,
    ...
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeI16TwinSse, <int>[
      0,
      -32768,
      32767,
      12345,
    ...
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeI32TwinSse, <int>[
      0,
      -2147483648,
      2147483647,
      1234567890,
    ...
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeU8TwinSse, <int>[
      0,
      255,
      123,
    ]);
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeU16TwinSse, <int>[
      0,
      65535,
      12345,
    ]);
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeU32TwinSse, <int>[
      0,
      4294967295,
      2468013579,
    ]);
    ...
    addTestsIdentityFunctionCall(exampleBasicTypeF32TwinSse, <double>[
      0,
      -42.5,
      123456,
    ]);
    addTestsIdentityFunctionCall(exampleBasicTypeF64TwinSse, <double>[
      0,
      -42.5,
      123456,
    ]);
    addTestsIdentityFunctionCall(exampleBasicTypeBoolTwinSse, <bool>[
      false,
      true,
    ]);
    addTestsIdentityFunctionCall(exampleBasicTypeStringTwinSse, <String>[
      "",
      "hello",
      "😂",
    ]);
