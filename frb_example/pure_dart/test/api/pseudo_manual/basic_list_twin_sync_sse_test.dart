...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  group('basic_list', () {
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeI16TwinSyncSse,
      <Int16List>[
        Int16List(0),
        Int16List(1)..[0] = 0,
        Int16List(1)..[0] = -32768,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeI32TwinSyncSse,
      <Int32List>[
        Int32List(0),
        Int32List(1)..[0] = 0,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeI64TwinSyncSse,
      <Int64List>[
        Int64List(0),
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeU16TwinSyncSse,
      <Uint16List>[
        Uint16List(0),
        Uint16List(1)..[0] = 0,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeU32TwinSyncSse,
      <Uint32List>[
        Uint32List(0),
        Uint32List(1)..[0] = 0,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeU64TwinSyncSse,
      <Uint64List>[
        Uint64List(0),
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeF32TwinSyncSse,
      <Float32List>[
        Float32List(0),
        Float32List(1)..[0] = 0,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeF64TwinSyncSse,
      <Float64List>[
        Float64List(0),
        Float64List(1)..[0] = 0,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeBoolTwinSyncSse,
      <List<bool>>[
        <bool>[],
        <bool>[false],
        <bool>[true],
    ...
    addTestsIdentityFunctionCall(
      exampleBasicListTypeStringTwinSyncSse,
      <List<String>>[
        [],
        [""],
        ["hello"],
