...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  void testComplexStruct(
    MyTreeNodeTwinRustAsyncSse complexStructResp, {
    required int arrLen,
  }) {
  ...
  addTestsIdentityFunctionCall(handleCharTwinRustAsyncSse, <String>[
    'a',
    '\0',
    '\u{10FFFF}',
  ]);
  ...
  test('dart call handleVecU8', () async {
    final len = 100000;
    expect(
      await handleVecU8TwinRustAsyncSse(v: Uint8List.fromList(List.filled(len, 127))),
