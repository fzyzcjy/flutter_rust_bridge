...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  test('rust_stream_sink_stream_replay_true_late_listener', () async {
    ...
    await streamSinkInsideVecTwinRustAsyncSse(arg: [sink]);
  ...
  test('rust_stream_sink_stream_replay_true_large_data', () async {
    final values =
        await streamSinkEmitManyTwinRustAsyncSse(count: 2000).toList();
  ...
  test('rust_stream_sink_stream_listener_can_cancel_while_sender_active',
    ...
    final stream = streamSinkEmitRangeThenHoldTwinRustAsyncSse(
      count: 5000,
  ...
  test('stored_stream_sink_no_listener_retains_history', skip: kIsWeb,
      () async {
    await clearStoredStreamSinkTwinRustAsyncSse();
    final stream = storeStreamSinkTwinRustAsyncSse();
    addTearDown(clearStoredStreamSinkTwinRustAsyncSse);

    await storedStreamSinkEmitManyTwinRustAsyncSse(count: 1024);
  ...
  test('stored_stream_sink_no_listener_and_clear', skip: kIsWeb, () async {
    ...
    await storedStreamSinkEmitManyTwinRustAsyncSse(count: 128);
    await clearStoredStreamSinkTwinRustAsyncSse();
  ...
  test('stored_stream_sink_multi_listener_receive_massive_data', skip: kIsWeb,
    ...
    await storedStreamSinkEmitManyTwinRustAsyncSse(count: 512);
  ...
  test('stored_stream_sink_sender_alive_listener_cancel_then_clear',
    ...
    await storedStreamSinkStartSpamTwinRustAsyncSse(
      total: 2000,
  ...
  test('stored_stream_sink_error_single_listener', skip: kIsWeb, () async {
    ...
    await storedStreamSinkEmitManyTwinRustAsyncSse(count: 2);
    await storedStreamSinkEmitErrorTwinRustAsyncSse(
