...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  void testComplexStruct(
    MyTreeNodeTwinSyncSse complexStructResp, {
    required int arrLen,
  }) {
  ...
  test('test abc', () async {
    ...
    final output2 = await testAbcEnumTwinSyncSse(
      abc: AbcTwinSyncSse.b(BTwinSyncSse(b: 1)),
    );
  ...
  addTestsIdentityFunctionCall(handleCharTwinSyncSse, <String>[
    'a',
    '\0',
    '\u{10FFFF}',
  ]);
  ...
  test('dart call handleVecU8', () async {
    final len = 100000;
    expect(
      await handleVecU8TwinSyncSse(v: Uint8List.fromList(List.filled(len, 127))),
