...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  addTestsIdentityFunctionCall(funcEnumWithFreezedOverrideTwinRustAsyncSse, [
    const EnumWithFreezedOverrideTwinRustAsyncSse.empty(),
    const EnumWithFreezedOverrideTwinRustAsyncSse.named(count: 42),
    const EnumWithFreezedOverrideTwinRustAsyncSse.named(),
  ]);

  group('example-based tests', () {
    test('dart call handleReturnEnum', () async {
      expect(
        await handleReturnEnumTwinRustAsyncSse(input: "Tuesday"),
    ...
    test('dart call multiplyByTen()', () async {
      ...
      expect(
        (SpeedTwinRustAsyncSse_GPS).toString(),
        'SpeedTwinRustAsyncSse_GPS',
        skip: skipMinified,
      );
      expect(
        (DistanceTwinRustAsyncSse_Unknown).toString(),
        'DistanceTwinRustAsyncSse_Unknown',
        skip: skipMinified,
      );
      expect(
        (DistanceTwinRustAsyncSse_Map).toString(),
