...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  group('basic_optional', () {
    ...
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeI16TwinRustAsyncSse,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeI128TwinRustAsyncSse,
      <BigInt?>[
        null,
        BigInt.parse("0"),
    ...
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeU8TwinRustAsyncSse,
      <int?>[null, 0, 255, 123],
    );
    addTestsIdentityFunctionCall(
    ...
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeU32TwinRustAsyncSse,
      <int?>[null, 0, 4294967295, 2468013579],
    );
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeU64TwinRustAsyncSse,
      <BigInt?>[
        null,
        BigInt.parse("0"),
        BigInt.parse("9007199254740992"),
    ...
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeU128TwinRustAsyncSse,
      <BigInt?>[
        null,
        BigInt.parse("0"),
        BigInt.parse("9007199254740992"),
    ...
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeIsizeTwinRustAsyncSse,
      <PlatformInt64?>[
        null,
        PlatformInt64.parse("0"),
    ...
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeUsizeTwinRustAsyncSse,
      <BigInt?>[
        null,
        BigInt.parse("0"),
    ...
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeF64TwinRustAsyncSse,
      <double?>[null, 0, -42.5, 123456],
    );
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeBoolTwinRustAsyncSse,
      <bool?>[null, false, true],
    );
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeStringTwinRustAsyncSse,
      <String?>[null, "", "hello", "😂"],
    );
    addTestsIdentityFunctionCall(
