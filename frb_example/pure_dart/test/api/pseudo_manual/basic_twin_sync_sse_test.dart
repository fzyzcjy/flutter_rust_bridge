...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  group('basic', () {
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeI8TwinSyncSse, <int>[
      0,
      -128,
      127,
      79,
    ...
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeI16TwinSyncSse,
    ...
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeI64TwinSyncSse,
      <PlatformInt64>[
    ...
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeI128TwinSyncSse,
      <BigInt>[
        BigInt.parse("0"),
    ...
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeU8TwinSyncSse, <int>[
      0,
      255,
      123,
    ]);
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeU16TwinSyncSse,
      <int>[0, 65535, 12345],
    );
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeU32TwinSyncSse,
      <int>[0, 4294967295, 2468013579],
    );
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeU64TwinSyncSse,
      <BigInt>[
        BigInt.parse("0"),
        BigInt.parse("9007199254740992"),
        BigInt.parse("9223372036854775807"),
    ...
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeU128TwinSyncSse,
      <BigInt>[
        BigInt.parse("0"),
        BigInt.parse("9007199254740992"),
        BigInt.parse("9223372036854775807"),
    ...
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeIsizeTwinSyncSse,
      <PlatformInt64>[
        PlatformInt64.parse("0"),
    ...
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeUsizeTwinSyncSse,
      <BigInt>[
        BigInt.parse("0"),
    ...
    addTestsIdentityFunctionCall(exampleBasicTypeF32TwinSyncSse, <double>[
      0,
      -42.5,
      123456,
    ]);
    addTestsIdentityFunctionCall(exampleBasicTypeF64TwinSyncSse, <double>[
      0,
      -42.5,
      123456,
    ]);
    addTestsIdentityFunctionCall(exampleBasicTypeBoolTwinSyncSse, <bool>[
      false,
      true,
    ]);
    addTestsIdentityFunctionCall(exampleBasicTypeStringTwinSyncSse, <String>[
      "",
      "hello",
      "😂",
    ]);
