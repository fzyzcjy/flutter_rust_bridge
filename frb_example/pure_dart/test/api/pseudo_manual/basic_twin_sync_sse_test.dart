...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  group('basic', () {
    addTestsIdentityFunctionCall(
        exampleBasicTypeI8TwinSyncSse, <int>[0, -128, 127, 79, -79]);
    addTestsIdentityFunctionCall(
        exampleBasicTypeI16TwinSyncSse, <int>[0, -32768, 32767, 12345, -12345]);
    addTestsIdentityFunctionCall(exampleBasicTypeI32TwinSyncSse,
        <int>[0, -2147483648, 2147483647, 1234567890, -1234567890]);
    addTestsIdentityFunctionCall(
        exampleBasicTypeI64TwinSyncSse, <PlatformInt64>[
    ...
    addTestsIdentityFunctionCall(exampleBasicTypeI128TwinSyncSse, <BigInt>[
      BigInt.parse("0"),
    ...
    addTestsIdentityFunctionCall(
        exampleBasicTypeU8TwinSyncSse, <int>[0, 255, 123]);
    addTestsIdentityFunctionCall(
        exampleBasicTypeU16TwinSyncSse, <int>[0, 65535, 12345]);
    addTestsIdentityFunctionCall(
        exampleBasicTypeU32TwinSyncSse, <int>[0, 4294967295, 2468013579]);
    addTestsIdentityFunctionCall(exampleBasicTypeU64TwinSyncSse, <BigInt>[
      BigInt.parse("0"),
      BigInt.parse("9007199254740992"),
      BigInt.parse("9223372036854775807"),
    ...
    addTestsIdentityFunctionCall(exampleBasicTypeU128TwinSyncSse, <BigInt>[
      BigInt.parse("0"),
      BigInt.parse("9007199254740992"),
      BigInt.parse("18446744073709551615"),
    ...
    addTestsIdentityFunctionCall(
        exampleBasicTypeIsizeTwinSyncSse, <PlatformInt64>[
      PlatformInt64.parse("0"),
    ...
    addTestsIdentityFunctionCall(exampleBasicTypeUsizeTwinSyncSse, <BigInt>[
      BigInt.parse("0"),
