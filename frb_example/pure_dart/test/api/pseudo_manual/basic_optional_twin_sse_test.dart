...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  group('basic_optional', () {
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeI8TwinSse, <int?>[
      null,
      0,
      -128,
      127,
    ...
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeI16TwinSse, <int?>[
      null,
      0,
      -32768,
      32767,
    ...
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeI32TwinSse, <int?>[
      null,
      0,
      -2147483648,
      2147483647,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeI64TwinSse,
      <PlatformInt64?>[
        null,
    ...
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeU8TwinSse, <int?>[
      null,
      0,
      255,
      123,
    ]);
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeU16TwinSse, <int?>[
      null,
      0,
      65535,
      12345,
    ]);
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeU32TwinSse, <int?>[
      null,
      0,
      4294967295,
      2468013579,
    ...
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeF32TwinSse, <double?>[
      null,
      0,
      -42.5,
      123456,
    ]);
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeF64TwinSse, <double?>[
      null,
      0,
      -42.5,
      123456,
    ]);
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeBoolTwinSse, <bool?>[
      null,
      false,
      true,
    ]);
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeStringTwinSse,
      <String?>[null, "", "hello", "😂"],
    );
    addTestsIdentityFunctionCall(
