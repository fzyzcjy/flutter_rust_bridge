...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  group('basic', () {
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeI8TwinSync, <int>[
      0,
      -128,
      127,
      79,
    ...
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeI16TwinSync, <int>[
      0,
      -32768,
      32767,
      12345,
    ...
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeI32TwinSync, <int>[
      0,
      -2147483648,
      2147483647,
      1234567890,
    ...
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeU8TwinSync, <int>[
      0,
      255,
      123,
    ]);
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeU16TwinSync, <int>[
      0,
      65535,
      12345,
    ]);
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeU32TwinSync, <int>[
      0,
      4294967295,
      2468013579,
    ]);
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeU64TwinSync,
      <BigInt>[
        BigInt.parse("0"),
        BigInt.parse("9007199254740992"),
        BigInt.parse("9223372036854775807"),
    ...
    addTestsIdentityFunctionCall(exampleBasicTypeF32TwinSync, <double>[
      0,
      -42.5,
      123456,
    ]);
    addTestsIdentityFunctionCall(exampleBasicTypeF64TwinSync, <double>[
      0,
      -42.5,
      123456,
    ]);
    addTestsIdentityFunctionCall(exampleBasicTypeBoolTwinSync, <bool>[
      false,
      true,
    ]);
    addTestsIdentityFunctionCall(exampleBasicTypeStringTwinSync, <String>[
      "",
      "hello",
      "😂",
    ]);
    ...
    addTestsIdentityFunctionCall(
      exampleBasicTypeBasicStructTwinSyncTwinSync,
      <BasicStructTwinSync>[
