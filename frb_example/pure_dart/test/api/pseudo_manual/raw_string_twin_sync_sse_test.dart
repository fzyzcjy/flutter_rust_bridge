...
import 'package:frb_example_pure_dart/src/rust/api/pseudo_manual/raw_string_twin_sync_sse.dart';
...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  test('test dart raw string in struct', () async {
    final output = await testRawStringItemStructTwinSyncSse();
    expect(output, isA<RawStringItemStructTwinSyncSse>());
  ...
  test('test dart test more than just one raw string struct', () async {
    final output = await testMoreThanJustOneRawStringStructTwinSyncSse();
