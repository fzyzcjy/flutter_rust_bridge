...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  test('call after dispose', () async {
    ...
    data.dispose();
    await expectLater(
      () => runOpaqueTwinRustAsyncMoi(opaque: data),
  ...
  test('create array of opaque type', () async {
    ...
    for (var v in data) {
      ...
      v.dispose();
      await expectLater(
        () => runOpaqueTwinRustAsyncMoi(opaque: v),
        throwsA(isA<DroppableDisposedException>()),
      );
    }
  });
  ...
  test('create enums of opaque type', () async {
    ...
    await expectLater(
      () => runEnumOpaqueTwinRustAsyncMoi(opaque: data[4]),
      throwsA(isA<DroppableDisposedException>()),
    );
  });
  ...
  test('opaque field', () async {
    ...
    await futurizeVoidTwinRustAsyncMoi(runNestedOpaqueTwinRustAsyncMoi(opaque: data));
    ...
    data.first.dispose();
    await expectLater(
      () => runOpaqueTwinRustAsyncMoi(opaque: data.first),
      throwsA(isA<DroppableDisposedException>()),
    );
    await expectLater(
  ...
  test('array', () async {
    var data = await opaqueArrayTwinRustAsyncMoi();
    await futurizeVoidTwinRustAsyncMoi(opaqueArrayRunTwinRustAsyncMoi(data: data));
    data[0].dispose();
  ...
  test('vec', () async {
    ...
    await futurizeVoidTwinRustAsyncMoi(opaqueVecRunTwinRustAsyncMoi(data: data));
    data[0].dispose();
