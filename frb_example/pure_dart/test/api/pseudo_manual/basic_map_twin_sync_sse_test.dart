...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  group('basic_map', () {
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeI8TwinSyncSse,
      <Map<int, int>>[
        {},
        {42: 0},
        {42: -128},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeI16TwinSyncSse,
      <Map<int, int>>[
        {},
        {42: 0},
        {42: -32768},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeI32TwinSyncSse,
      <Map<int, int>>[
        {},
        {42: 0},
        {42: -2147483648},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeI64TwinSyncSse,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeI128TwinSyncSse,
      <Map<int, BigInt>>[
        {},
        {42: BigInt.parse("0")},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeU8TwinSyncSse,
      <Map<int, int>>[
        {},
        {42: 0},
        {42: 255},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeU16TwinSyncSse,
      <Map<int, int>>[
        {},
        {42: 0},
        {42: 65535},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeU32TwinSyncSse,
      <Map<int, int>>[
        {},
        {42: 0},
        {42: 4294967295},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeU64TwinSyncSse,
      <Map<int, BigInt>>[
        {},
        {42: BigInt.parse("0")},
        {42: BigInt.parse("9007199254740992")},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeU128TwinSyncSse,
      <Map<int, BigInt>>[
        {},
        {42: BigInt.parse("0")},
        {42: BigInt.parse("9007199254740992")},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeIsizeTwinSyncSse,
      <Map<int, PlatformInt64>>[
        {},
        {42: PlatformInt64.parse("0")},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeUsizeTwinSyncSse,
      <Map<int, BigInt>>[
        {},
        {42: BigInt.parse("0")},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeF64TwinSyncSse,
      <Map<int, double>>[
        {},
        {42: 0},
        {42: -42.5},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeBoolTwinSyncSse,
      <Map<int, bool>>[
        {},
        {42: false},
        {42: true},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeStringTwinSyncSse,
      <Map<int, String>>[
        {},
        {42: ""},
        {42: "hello"},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeBytesTwinSyncSse,
      <Map<int, Uint8List>>[
        {},
