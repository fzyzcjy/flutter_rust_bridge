...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  test('rustCallDartOptionalTwinRustAsyncSse', () async {
    final callbackCalls = <String>[];

    await rustCallDartOptionalTwinRustAsyncSse(callback: callbackCalls.add);
    await rustCallDartOptionalTwinRustAsyncSse(callback: null);
  ...
  test('rustCallDartReturnTwinRustAsyncSse', () async {
    var callCount = 0;
    await rustCallDartReturnTwinRustAsyncSse(
      callback: () {
        callCount++;
        return 'a';
      },
  ...
  test('rustCallDartLoopbackTwinRustAsyncSse', () async {
    var callCount = 0;
    await rustCallDartLoopbackTwinRustAsyncSse(
      callback: (arg) {
        callCount++;
        return arg;
      },
  ...
  test('rustCallDartUsingIpv4AddrTwinRustAsyncSse', skip: kIsWeb, () async {
    InternetAddress? addr;
    await rustCallDartUsingIpv4AddrTwinRustAsyncSse(
      callback: (rustAddr) {
        addr = rustAddr;
