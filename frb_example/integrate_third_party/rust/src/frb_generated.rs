...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1818098574;
...
let decode_indices_ = flutter_rust_bridge::for_generated::rust_auto_opaque_decode_compute_order(vec![flutter_rust_bridge::for_generated::rust_auto_opaque_lock_order_info(&api_that, 0, false)]);
 ...
 crate::api::override_web_audio_api::AudioContext::frb_override_decode_audio_data_sync(&api_that, api_input_path)
                    })())
                } })
}
...
let decode_indices_ = flutter_rust_bridge::for_generated::rust_auto_opaque_decode_compute_order(vec![flutter_rust_bridge::for_generated::rust_auto_opaque_lock_order_info(&api_that, 0, false)]);
        ...
        let api_that = api_that_decoded.unwrap();
 Result::<_,()>::Ok(crate::api::override_web_audio_api::AudioContext::frb_override_output_latency(&api_that))
                    })())
                } })
}
