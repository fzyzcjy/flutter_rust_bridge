...
// These functions are ignored because they are not marked as `pub`: `check_ring_buffer_up_down_mix`, `complex`, `cone_gain`, `count_mode`, `count`, `dist_gain`, `downsample_x2`, `downsample_x4`, `from_raw_parts`, `generate_custom`, `generate_sample`, `generate_sawtooth`, `generate_sine`, `generate_square`, `generate_triangle`, `get_playback_infos`, `handle_control_message`, `inner`, `interpretation`, `into_channel_config`, `inverse`, `new`, `new`, `new`, `new`, `new`, `new`, `new`, `new`, `new`, `poly_blep`, `precomputed_sine_table`, `process`, `process`, `process`, `process`, `real`, `samples_out_mut`, `samples_out`, `set_count_mode`, `set_count`, `set_interpretation`, `tail_time_samples`, `tail`, `unroll_phase`, `upsample_x2`, `upsample_x4`
// These functions are ignored because they have generic arguments: `connect_from_output_to_input`, `connect_from_output_to_input`, `connect_from_output_to_input`, `connect`, `connect`, `new`, `new`, `new`, `new`, `new`, `new`, `new`, `new`, `new`, `new`, `new`, `new`, `new`, `new`, `new`, `new`, `new`, `new`, `new`, `new`, `set_onaudioprocess`, `set_onended`, `set_onended`, `set_onended`, `set_onended`
...
// These functions are ignored: `attack`, `buffer`, `buffer`, `channel_config`, `channel_count_mode`, `channel_count`, `channel_interpretation`, `clear_onended`, `clear_onprocessorerror`, `context`, `curve`, `delay_time`, `detune`, `detune`, `detune`, `disconnect_dest_from_output_to_input`, `disconnect_dest_from_output_to_input`, `disconnect_dest_from_output`, `disconnect_dest_from_output`, `disconnect_dest`, `disconnect_dest`, `disconnect_output`, `disconnect`, `frequency`, `frequency`, `gain`, `gain`, `get_byte_frequency_data`, `get_byte_time_domain_data`, `get_float_frequency_data`, `get_float_time_domain_data`, `get_frequency_response`, `get_frequency_response`, `knee`, `number_of_inputs`, `number_of_outputs`, `offset`, `orientation_x`, `orientation_y`, `orientation_z`, `pan`, `playback_rate`, `position_x`, `position_y`, `position_z`, `q`, `ratio`, `registration`, `release`, `set_channel_count_mode`, `set_channel_count`, `set_channel_interpretation`, `set_onprocessorerror`, `start_at`, `start`, `stop_at`, `stop`, `threshold`
