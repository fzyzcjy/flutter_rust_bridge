...
void crateAppRustStateAutoAccessorSetFilter({required RustState that , required Filter filter });

void crateAppRustStateAutoAccessorSetInputText({required RustState that , required String inputText });
...
@override void crateAppRustStateAdd({required RustState that })  { return handler.executeSync(SyncTask(
            callFfi: () {
...
@override Filter crateAppRustStateAutoAccessorGetFilter({required RustState that })  { return handler.executeSync(SyncTask(
            callFfi: () {
        ...
        TaskConstMeta get kCrateAppRustStateAutoAccessorGetFilterConstMeta => const TaskConstMeta(
            debugName: "RustState_auto_accessor_get_filter",
            argNames: ["that"],
        );
        

@override String crateAppRustStateAutoAccessorGetInputText({required RustState that })  { return handler.executeSync(SyncTask(
            callFfi: () {
        ...
        TaskConstMeta get kCrateAppRustStateAutoAccessorGetInputTextConstMeta => const TaskConstMeta(
            debugName: "RustState_auto_accessor_get_input_text",
            argNames: ["that"],
        );
        

@override void crateAppRustStateAutoAccessorSetFilter({required RustState that , required Filter filter })  { return handler.executeSync(SyncTask(
            callFfi: () {
...
sse_encode_filter(filter, serializer);
        ...
        TaskConstMeta get kCrateAppRustStateAutoAccessorSetFilterConstMeta => const TaskConstMeta(
            debugName: "RustState_auto_accessor_set_filter",
            argNames: ["that", "filter"],
        );
        

@override void crateAppRustStateAutoAccessorSetInputText({required RustState that , required String inputText })  { return handler.executeSync(SyncTask(
            callFfi: () {
...
sse_encode_String(inputText, serializer);
        ...
        TaskConstMeta get kCrateAppRustStateAutoAccessorSetInputTextConstMeta => const TaskConstMeta(
            debugName: "RustState_auto_accessor_set_input_text",
            argNames: ["that", "inputText"],
        );
        

@override List<Item> crateAppRustStateFilteredItems({required RustState that })  { return handler.executeSync(SyncTask(
            callFfi: () {
        ...
        TaskConstMeta get kCrateAppRustStateFilteredItemsConstMeta => const TaskConstMeta(
...
@override void crateAppRustStateRemove({required RustState that , required int id })  { return handler.executeSync(SyncTask(
            callFfi: () {
...
@override void crateAppRustStateToggle({required RustState that , required int id })  { return handler.executeSync(SyncTask(
            callFfi: () {
...
@protected Filter dco_decode_filter(dynamic raw){ // Codec=Dco (DartCObject based), see doc to use other codecs
...
final arr = raw as List<dynamic>;
                ...
                return Item(id: dco_decode_i_32(arr[0]),
...
@protected Filter sse_decode_filter(SseDeserializer deserializer){ // Codec=Sse (Serialization based), see doc to use other codecs
...
@protected void sse_encode_filter(Filter self, SseSerializer serializer){ // Codec=Sse (Serialization based), see doc to use other codecs
...
static BaseRustState  empty()=>RustLib.instance.api.crateFrbGeneratedBaseRustStateEmpty();
        ...
        return object;
            ...
            @sealed class RustStateImpl extends RustOpaque implements RustState {
                ...
                static final _kStaticData = RustArcStaticData(
                 ...
                 void  add()=>RustLib.instance.api.crateAppRustStateAdd(that: this, );


 Filter get filter=>RustLib.instance.api.crateAppRustStateAutoAccessorGetFilter(that: this, );


 String get inputText=>RustLib.instance.api.crateAppRustStateAutoAccessorGetInputText(that: this, );


  set filter(Filter filter)=>RustLib.instance.api.crateAppRustStateAutoAccessorSetFilter(that: this, filter: filter);


  set inputText(String inputText)=>RustLib.instance.api.crateAppRustStateAutoAccessorSetInputText(that: this, inputText: inputText);


 List<Item>  filteredItems()=>RustLib.instance.api.crateAppRustStateFilteredItems(that: this, );


 void  remove({required int id })=>RustLib.instance.api.crateAppRustStateRemove(that: this, id: id);
 ...
 void  toggle({required int id })=>RustLib.instance.api.crateAppRustStateToggle(that: this, id: id);
