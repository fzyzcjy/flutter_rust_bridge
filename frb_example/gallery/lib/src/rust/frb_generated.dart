...
import 'package:flutter_rust_bridge/flutter_rust_bridge_for_generated.dart';
                ...
                abstract class RustLibApi extends BaseApi {
                  Future<Uint8List> crateApiMandelbrotDrawMandelbrot({required Size imageSize , required Point zoomPoint , required double scale , required int numThreads });
                ...
                class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
                  ...
                  @override Future<Uint8List> crateApiMandelbrotDrawMandelbrot({required Size imageSize , required Point zoomPoint , required double scale , required int numThreads })  { return handler.executeNormal(NormalTask(
            callFfi: (port_) {
              
            final serializer = SseSerializer(generalizedFrbRustBinding);sse_encode_box_autoadd_size(imageSize, serializer);
...
sse_encode_i_32(numThreads, serializer);
        ...
        TaskConstMeta get kCrateApiMandelbrotDrawMandelbrotConstMeta => const TaskConstMeta(
...
final arr = raw as List<dynamic>;
                ...
                return Point(x: dco_decode_f_64(arr[0]),
