...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1009360757;
...
fn wire_point_clone_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_that = <crate::api::mandelbrot::Point>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse((move || {
                    Result::<_, ()>::Ok(crate::api::mandelbrot::Point::clone(&api_that))
                })())
            }
        },
    )
}
fn wire_point_fmt_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_that = <crate::api::mandelbrot::Point>::sse_decode(&mut deserializer);
            let api_f = <RustOpaqueMoi<
                flutter_rust_bridge::for_generated::rust_async::RwLock<::core::fmt::Formatter>,
            >>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse((move || {
                    let mut api_f = api_f.rust_auto_opaque_decode_ref_mut();
                    Result::<_, ()>::Ok(crate::api::mandelbrot::Point::fmt(&api_that, &mut api_f))
                })())
            }
        },
    )
}
fn wire_size_clone_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_that = <crate::api::mandelbrot::Size>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse((move || {
                    Result::<_, ()>::Ok(crate::api::mandelbrot::Size::clone(&api_that))
                })())
            }
        },
    )
}
fn wire_size_fmt_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse((move || {
                    let mut api_f = api_f.rust_auto_opaque_decode_ref_mut();
                    Result::<_, ()>::Ok(crate::api::mandelbrot::Size::fmt(&api_that, &mut api_f))
                })())
            }
        },
    )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        5 => wire_point_clone_impl(port, ptr, rust_vec_len, data_len),
        4 => wire_point_fmt_impl(port, ptr, rust_vec_len, data_len),
        3 => wire_size_clone_impl(port, ptr, rust_vec_len, data_len),
        2 => wire_size_fmt_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
