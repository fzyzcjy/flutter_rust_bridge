...
class FlutterRustBridgeExampleWire implements FlutterRustBridgeWireBase {
  ...
  late final _drop_box_autoadd_point_0Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<wire_Point>)>>(
          'drop_box_autoadd_point_0');
  late final _drop_box_autoadd_point_0 = _drop_box_autoadd_point_0Ptr
      .asFunction<void Function(ffi.Pointer<wire_Point>)>();
  ...
  late final _drop_box_autoadd_size_0Ptr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<wire_Size>)>>(
          'drop_box_autoadd_size_0');
  late final _drop_box_autoadd_size_0 = _drop_box_autoadd_size_0Ptr
      .asFunction<void Function(ffi.Pointer<wire_Size>)>();
  ...
  late final _drop_box_autoadd_tree_node_0Ptr = _lookup<
          ffi.NativeFunction<ffi.Void Function(ffi.Pointer<wire_TreeNode>)>>(
      'drop_box_autoadd_tree_node_0');
  late final _drop_box_autoadd_tree_node_0 = _drop_box_autoadd_tree_node_0Ptr
      .asFunction<void Function(ffi.Pointer<wire_TreeNode>)>();
