...
abstract class ExampleApi extends DartRustBridgeBase<ExampleApiWire> {
  factory ExampleApi(ffi.DynamicLibrary dylib) => _ExampleApiImpl.raw(ExampleApiWire(dylib));

  ExampleApi.raw(ExampleApiWire inner) : super(inner);
...
class _ExampleApiImpl extends ExampleApi {
  _ExampleApiImpl.raw(ExampleApiWire inner) : super.raw(inner);
...
/// generated by flutter_rust_bridge
class ExampleApiWire implements DartRustBridgeWireBase {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  ExampleApiWire(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  ExampleApiWire.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup)
      : _lookup = lookup;
