...
fn wire_draw_mandelbrot_impl(
	port_: MessagePort, image_size: impl Wire2Api<Size>+UnwindSafe, zoom_point: impl Wire2Api<Point>+UnwindSafe,
	scale: impl Wire2Api<f64>+UnwindSafe, num_threads: impl Wire2Api<i32>+UnwindSafe,
) {
...
fn wire_passing_complex_structs_impl(port_: MessagePort, root: impl Wire2Api<TreeNode>+UnwindSafe) {
...
fn wire_off_topic_memory_test_input_array_impl(port_: MessagePort, input: impl Wire2Api<Vec<u8>>+UnwindSafe) {
...
fn wire_off_topic_memory_test_output_zero_copy_buffer_impl(port_: MessagePort, len: impl Wire2Api<i32>+UnwindSafe) {
	FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ZeroCopyBuffer<Vec<u8>>>(
		WrapInfo {
...
fn wire_off_topic_memory_test_output_vec_u8_impl(port_: MessagePort, len: impl Wire2Api<i32>+UnwindSafe) {
...
fn wire_off_topic_memory_test_input_vec_of_object_impl(port_: MessagePort, input: impl Wire2Api<Vec<Size>>+UnwindSafe) {
	FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, i32>(
		WrapInfo {
...
fn wire_off_topic_memory_test_output_vec_of_object_impl(port_: MessagePort, len: impl Wire2Api<i32>+UnwindSafe) {
...
fn wire_off_topic_memory_test_input_complex_struct_impl(port_: MessagePort, input: impl Wire2Api<TreeNode>+UnwindSafe) {
	FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, i32>(
		WrapInfo {
...
fn wire_off_topic_memory_test_output_complex_struct_impl(port_: MessagePort, len: impl Wire2Api<i32>+UnwindSafe) {
...
fn wire_test_method__method__BoxedPoint_impl(port_: MessagePort, that: impl Wire2Api<BoxedPoint>+UnwindSafe) {
...
fn wire_sum_static__static_method__SumWith_impl(
	port_: MessagePort, x: impl Wire2Api<u32>+UnwindSafe, y: impl Wire2Api<u32>+UnwindSafe,
) {
	FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, u32>(
		WrapInfo {
