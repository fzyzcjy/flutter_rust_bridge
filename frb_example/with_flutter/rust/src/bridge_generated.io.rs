...
pub extern "C" fn wire_draw_mandelbrot(
	port_: i64, image_size: *mut wire_Size, zoom_point: *mut wire_Point, scale: f64, num_threads: i32,
) {
...
#[no_mangle]
pub extern "C" fn wire_off_topic_memory_test_input_vec_of_object(port_: i64, input: *mut wire_list_size) {
...
#[no_mangle]
pub extern "C" fn wire_off_topic_memory_test_input_complex_struct(port_: i64, input: *mut wire_TreeNode) {
