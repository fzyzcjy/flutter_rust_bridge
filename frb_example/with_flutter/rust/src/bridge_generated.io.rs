...
pub extern "C" fn P7C55DD6B_wire_draw_mandelbrot(
    port_: i64,
    image_size: *mut P7C55DD6B_wire_Size,
    zoom_point: *mut P7C55DD6B_wire_Point,
    scale: f64,
    num_threads: i32,
) {
...
#[no_mangle]
pub extern "C" fn P7C55DD6B_wire_passing_complex_structs(
    port_: i64,
    root: *mut P7C55DD6B_wire_TreeNode,
) {
...
pub extern "C" fn P7C55DD6B_wire_off_topic_memory_test_input_vec_of_object(
    port_: i64,
    input: *mut P7C55DD6B_wire_list_size,
) {
...
pub extern "C" fn P7C55DD6B_wire_off_topic_memory_test_input_complex_struct(
    port_: i64,
    input: *mut P7C55DD6B_wire_TreeNode,
) {
...
#[no_mangle]
pub extern "C" fn new_box_autoadd_point_0() -> *mut P7C55DD6B_wire_Point {
    support::new_leak_box_ptr(P7C55DD6B_wire_Point::new_with_null_ptr())
}

#[no_mangle]
pub extern "C" fn new_box_autoadd_size_0() -> *mut P7C55DD6B_wire_Size {
    support::new_leak_box_ptr(P7C55DD6B_wire_Size::new_with_null_ptr())
}

#[no_mangle]
pub extern "C" fn new_box_autoadd_tree_node_0() -> *mut P7C55DD6B_wire_TreeNode {
    support::new_leak_box_ptr(P7C55DD6B_wire_TreeNode::new_with_null_ptr())
}

#[no_mangle]
pub extern "C" fn new_list_size_0(len: i32) -> *mut P7C55DD6B_wire_list_size {
    let wrap = P7C55DD6B_wire_list_size {
        ptr: support::new_leak_vec_ptr(<P7C55DD6B_wire_Size>::new_with_null_ptr(), len),
        len,
    };
...
#[no_mangle]
pub extern "C" fn new_list_tree_node_0(len: i32) -> *mut P7C55DD6B_wire_list_tree_node {
    let wrap = P7C55DD6B_wire_list_tree_node {
        ptr: support::new_leak_vec_ptr(<P7C55DD6B_wire_TreeNode>::new_with_null_ptr(), len),
        len,
    };
    support::new_leak_box_ptr(wrap)
}
...
impl Wire2Api<Point> for *mut P7C55DD6B_wire_Point {
    fn wire2api(self) -> Point {
        let wrap = unsafe { support::box_from_leak_ptr(self) };
        Wire2Api::<Point>::wire2api(*wrap).into()
    }
}
impl Wire2Api<Size> for *mut P7C55DD6B_wire_Size {
    fn wire2api(self) -> Size {
        let wrap = unsafe { support::box_from_leak_ptr(self) };
        Wire2Api::<Size>::wire2api(*wrap).into()
    }
}
impl Wire2Api<TreeNode> for *mut P7C55DD6B_wire_TreeNode {
...
impl Wire2Api<Vec<Size>> for *mut P7C55DD6B_wire_list_size {
...
impl Wire2Api<Vec<TreeNode>> for *mut P7C55DD6B_wire_list_tree_node {
...
impl Wire2Api<Point> for P7C55DD6B_wire_Point {
    fn wire2api(self) -> Point {
        Point {
            x: self.x.wire2api(),
            y: self.y.wire2api(),
...
impl Wire2Api<Size> for P7C55DD6B_wire_Size {
    fn wire2api(self) -> Size {
        Size {
...
impl Wire2Api<TreeNode> for P7C55DD6B_wire_TreeNode {
    fn wire2api(self) -> TreeNode {
        TreeNode {
...
#[repr(C)]
#[derive(Clone)]
pub struct P7C55DD6B_wire_list_size {
    ptr: *mut P7C55DD6B_wire_Size,
    len: i32,
}

#[repr(C)]
#[derive(Clone)]
pub struct P7C55DD6B_wire_list_tree_node {
    ptr: *mut P7C55DD6B_wire_TreeNode,
    len: i32,
}

#[repr(C)]
#[derive(Clone)]
pub struct P7C55DD6B_wire_Point {
    x: f64,
    y: f64,
}
...
#[repr(C)]
#[derive(Clone)]
pub struct P7C55DD6B_wire_Size {
    width: i32,
    height: i32,
}
...
#[repr(C)]
#[derive(Clone)]
pub struct P7C55DD6B_wire_TreeNode {
    name: *mut P7C55DD6B_wire_uint_8_list,
    children: *mut P7C55DD6B_wire_list_tree_node,
}
...
impl NewWithNullPtr for P7C55DD6B_wire_Point {
    fn new_with_null_ptr() -> Self {
        Self {
            x: Default::default(),
            y: Default::default(),
...
impl Default for P7C55DD6B_wire_Point {
    fn default() -> Self {
        Self::new_with_null_ptr()
    }
}

impl NewWithNullPtr for P7C55DD6B_wire_Size {
    fn new_with_null_ptr() -> Self {
        Self {
...
impl Default for P7C55DD6B_wire_Size {
    fn default() -> Self {
        Self::new_with_null_ptr()
    }
}

impl NewWithNullPtr for P7C55DD6B_wire_TreeNode {
    fn new_with_null_ptr() -> Self {
        Self {
...
impl Default for P7C55DD6B_wire_TreeNode {
    fn default() -> Self {
        Self::new_with_null_ptr()
    }
}
