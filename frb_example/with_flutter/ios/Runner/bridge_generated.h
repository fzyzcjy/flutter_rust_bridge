...
typedef struct P7C55DD6B_wire_Size {
  int32_t width;
  int32_t height;
} P7C55DD6B_wire_Size;

typedef struct P7C55DD6B_wire_Point {
  double x;
  double y;
} P7C55DD6B_wire_Point;
...
typedef struct P7C55DD6B_wire_list_tree_node {
  struct P7C55DD6B_wire_TreeNode *ptr;
  int32_t len;
} P7C55DD6B_wire_list_tree_node;

typedef struct P7C55DD6B_wire_TreeNode {
  struct P7C55DD6B_wire_uint_8_list *name;
  struct P7C55DD6B_wire_list_tree_node *children;
} P7C55DD6B_wire_TreeNode;

typedef struct P7C55DD6B_wire_list_size {
  struct P7C55DD6B_wire_Size *ptr;
  int32_t len;
} P7C55DD6B_wire_list_size;
...
void P7C55DD6B_wire_draw_mandelbrot(int64_t port_,
                                    struct P7C55DD6B_wire_Size *image_size,
                                    struct P7C55DD6B_wire_Point *zoom_point,
                                    double scale,
                                    int32_t num_threads);

void P7C55DD6B_wire_passing_complex_structs(int64_t port_, struct P7C55DD6B_wire_TreeNode *root);
...
void P7C55DD6B_wire_off_topic_memory_test_input_array(int64_t port_,
                                                      struct P7C55DD6B_wire_uint_8_list *input);
...
void P7C55DD6B_wire_off_topic_memory_test_input_vec_of_object(int64_t port_,
                                                              struct P7C55DD6B_wire_list_size *input);
...
void P7C55DD6B_wire_off_topic_memory_test_input_complex_struct(int64_t port_,
                                                               struct P7C55DD6B_wire_TreeNode *input);
...
struct P7C55DD6B_wire_Point *new_box_autoadd_point_0(void);

struct P7C55DD6B_wire_Size *new_box_autoadd_size_0(void);

struct P7C55DD6B_wire_TreeNode *new_box_autoadd_tree_node_0(void);

struct P7C55DD6B_wire_list_size *new_list_size_0(int32_t len);

struct P7C55DD6B_wire_list_tree_node *new_list_tree_node_0(int32_t len);
