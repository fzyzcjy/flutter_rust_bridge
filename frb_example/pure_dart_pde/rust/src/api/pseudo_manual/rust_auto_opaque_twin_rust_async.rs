...
#[derive(Debug)]
struct PrivateOpaqueFieldInnerTwinRustAsync {
    value: String,
}

#[derive(Debug)]
pub(super) struct RestrictedOpaqueFieldInnerTwinRustAsync {
    value: String,
}

mod private_opaque_field_module_twin_rust_async {
    #[derive(Debug)]
...
use private_opaque_field_module_twin_rust_async as private_module_alias_twin_rust_async;
...
mod private_opaque_field_alias_module_twin_rust_async {
    use super::private_opaque_field_module_twin_rust_async::PrivateModuleOpaqueFieldInnerTwinRustAsync;

    pub type ImportedTargetAliasTwinRustAsync = PrivateModuleOpaqueFieldInnerTwinRustAsync;
}

use private_opaque_field_alias_module_twin_rust_async::ImportedTargetAliasTwinRustAsync;

mod private_opaque_field_base_alias_module_twin_rust_async {
    use super::private_opaque_field_module_twin_rust_async::PrivateModuleOpaqueFieldInnerTwinRustAsync;

    pub type BaseAliasTwinRustAsync = PrivateModuleOpaqueFieldInnerTwinRustAsync;
}

mod private_opaque_field_chained_alias_module_twin_rust_async {
    use super::private_opaque_field_base_alias_module_twin_rust_async::BaseAliasTwinRustAsync;

    pub type ChainedAliasTwinRustAsync = BaseAliasTwinRustAsync;
}

use private_opaque_field_chained_alias_module_twin_rust_async::ChainedAliasTwinRustAsync;
...
#[derive(Clone, Debug)]
#[frb(opaque)]
pub struct OpaqueWithPrivateFieldTwinRustAsync {
    pub field: Arc<RwLock<PrivateOpaqueFieldInnerTwinRustAsync>>,
    pub restricted_field: Arc<RwLock<RestrictedOpaqueFieldInnerTwinRustAsync>>,
    pub private_module_field: Arc<
        RwLock<
            private_opaque_field_module_twin_rust_async::PrivateModuleOpaqueFieldInnerTwinRustAsync,
        >,
    >,
    ...
    pub module_alias_field: Arc<
        RwLock<private_module_alias_twin_rust_async::PrivateModuleOpaqueFieldInnerTwinRustAsync>,
    >,
    pub imported_target_alias_field: Arc<RwLock<ImportedTargetAliasTwinRustAsync>>,
    pub chained_alias_field: Arc<RwLock<ChainedAliasTwinRustAsync>>,
    pub alias_field: Arc<RwLock<PrivateOpaqueFieldAliasTwinRustAsync>>,
}

impl OpaqueWithPrivateFieldTwinRustAsync {
    pub async fn new_twin_rust_async(value: String) -> Self {
        Self {
            field: Arc::new(RwLock::new(PrivateOpaqueFieldInnerTwinRustAsync {
                value: value.clone(),
            })),
            restricted_field: Arc::new(RwLock::new(RestrictedOpaqueFieldInnerTwinRustAsync {
                value: value.clone(),
            })),
            ...
            module_alias_field: Arc::new(RwLock::new(
                private_module_alias_twin_rust_async::PrivateModuleOpaqueFieldInnerTwinRustAsync {
                    value: value.clone(),
                },
            )),
            ...
            chained_alias_field: Arc::new(RwLock::new(PrivateModuleOpaqueFieldInnerTwinRustAsync {
                value: value.clone(),
            })),
