...
pub async fn reproduce_moi_arc_release_contention_twin_rust_async() {
    contention_repro_twin_rust_async::release_while_pool_is_read_locked();
}

pub async fn moi_arc_contention_value_drop_count_twin_rust_async() -> u32 {
    contention_repro_twin_rust_async::drop_count()
}

#[flutter_rust_bridge::frb(ignore)]
mod contention_repro_twin_rust_async {
