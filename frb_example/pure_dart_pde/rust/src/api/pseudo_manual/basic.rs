...
pub fn example_basic_type_i8_twin_normal(arg: i8, expect: String) -> i8 {
    assert_eq!(arg, expect.parse::<i8>().unwrap());
    arg
}

pub fn example_basic_type_i16_twin_normal(arg: i16, expect: String) -> i16 {
    assert_eq!(arg, expect.parse::<i16>().unwrap());
    arg
}

pub fn example_basic_type_i32_twin_normal(arg: i32, expect: String) -> i32 {
...
pub fn example_basic_type_i128_twin_normal(arg: i128, expect: String) -> i128 {
    assert_eq!(arg, expect.parse::<i128>().unwrap());
    arg
}

pub fn example_basic_type_u8_twin_normal(arg: u8, expect: String) -> u8 {
    assert_eq!(arg, expect.parse::<u8>().unwrap());
    arg
}

pub fn example_basic_type_u16_twin_normal(arg: u16, expect: String) -> u16 {
    assert_eq!(arg, expect.parse::<u16>().unwrap());
    arg
}

pub fn example_basic_type_u32_twin_normal(arg: u32, expect: String) -> u32 {
...
pub fn example_basic_type_u128_twin_normal(arg: u128, expect: String) -> u128 {
    assert_eq!(arg, expect.parse::<u128>().unwrap());
    arg
}

pub fn example_basic_type_isize_twin_normal(arg: isize, expect: String) -> isize {
