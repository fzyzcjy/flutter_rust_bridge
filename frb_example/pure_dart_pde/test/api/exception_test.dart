  ...
  group('example-based tests', () {
    group('custom errors', () {
      ...
      test('Throw CustomError', timeout: Timeout.factor(5), () {
        expect(
          () async => returnErrCustomErrorTwinNormal(),
      ...
      test('Throw CustomStructError', () async {
        await expectLater(
          () async => returnCustomStructErrorTwinNormal(),
      ...
      test('Throw CustomStructError static method', () async {
        await expectLater(
          () async =>
              CustomStructTwinNormal.staticReturnCustomStructErrorTwinNormal(),
          throwsA(isA<CustomStructErrorAnotherTwinNormal>()),
        );
      });
      ...
      test('Throw CustomNestedError1', () async {
        await expectLater(
          ...
          throwsA(
            CustomNestedError1TwinNormal.errorNested(
      ...
      test('Throw CustomNestedError2', () async {
        await expectLater(
          () async => returnCustomNestedError2TwinNormal(),
      ...
      test('Throw CustomError variant 0', () async {
        await expectLater(
          () async => returnErrorVariantTwinNormal(variant: 0),
          throwsA(isA<CustomErrorTwinNormal>()),
        );
      });
      ...
      test('Throw CustomError variant 1', () async {
        await expectLater(
          () async => returnErrorVariantTwinNormal(variant: 1),
          throwsA(isA<CustomErrorTwinNormal>()),
        );
      });
      ...
      test('Do not throw CustomError static method', () async {
        expect(
          await SomeStructTwinNormal.staticReturnOkCustomErrorTwinNormal(),
          3,
        );
      });
