...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  group('basic_map', () {
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeI16TwinSync,
      <Map<int, int>>[
        {},
        {42: 0},
        {42: -32768},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeI32TwinSync,
      <Map<int, int>>[
        {},
        {42: 0},
        {42: -2147483648},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeI64TwinSync,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeI128TwinSync,
      <Map<int, BigInt>>[
        {},
        {42: BigInt.parse("0")},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeU16TwinSync,
      <Map<int, int>>[
        {},
        {42: 0},
        {42: 65535},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeU32TwinSync,
      <Map<int, int>>[
        {},
        {42: 0},
        {42: 4294967295},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeU64TwinSync,
      <Map<int, BigInt>>[
        {},
        {42: BigInt.parse("0")},
        {42: BigInt.parse("9007199254740992")},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeU128TwinSync,
      <Map<int, BigInt>>[
        {},
        {42: BigInt.parse("0")},
        {42: BigInt.parse("9007199254740992")},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeIsizeTwinSync,
      <Map<int, PlatformInt64>>[
        {},
        {42: PlatformInt64.parse("0")},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeUsizeTwinSync,
      <Map<int, BigInt>>[
        {},
        {42: BigInt.parse("0")},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeF32TwinSync,
      <Map<int, double>>[
        {},
        {42: 0},
        {42: -42.5},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeF64TwinSync,
      <Map<int, double>>[
        {},
        {42: 0},
        {42: -42.5},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeBoolTwinSync,
      <Map<int, bool>>[
        {},
        {42: false},
        {42: true},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeStringTwinSync,
      <Map<int, String>>[
        {},
        {42: ""},
        {42: "hello"},
    ...
    addTestsIdentityFunctionCall(
      exampleBasicMapTypeBytesTwinSync,
      <Map<int, Uint8List>>[
        {},
