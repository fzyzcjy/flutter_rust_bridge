...
// FRB_INTERNAL_GENERATOR: {"removeCode":["import 'package:frb_example_pure_dart_pde/src/rust/api/pseudo_manual/mirror_twin_sync_sse_twin_rust_async_sse_twin_sync.dart';\n","import 'package:frb_example_pure_dart_pde/src/rust/api/pseudo_manual/mirror_twin_sync_sse_twin_rust_async_twin_sync.dart';\n","import 'package:frb_example_pure_dart_pde/src/rust/api/pseudo_manual/mirror_twin_sync_sse_twin_sse_twin_sync.dart';\n","import 'package:frb_example_pure_dart_pde/src/rust/api/pseudo_manual/mirror_twin_sync_sse_twin_sync_sse_twin_sync.dart';\n","import 'package:frb_example_pure_dart_pde/src/rust/api/pseudo_manual/mirror_twin_sync_sse_twin_sync_twin_sync.dart';\n"],"addCode":"import 'package:frb_example_pure_dart_pde/src/rust/api/pseudo_manual/mirror_twin_sync_sse_twin_sync.dart';"}
...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  test('dart call app_settings_stream', () async {
    final settings = await appSettingsStreamTwinSync().first;
    _testAppSettings(settings);
  });

  test('dart call app_settings_vec_stream', () async {
    final settings = await appSettingsVecStreamTwinSync().first;
  ...
  test('dart call mirror_tuple_stream', () async {
    final (settings, rawStringEnum) = await mirrorTupleStreamTwinSync().first;
    _testAppSettings(settings);
