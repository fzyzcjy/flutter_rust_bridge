...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  addTestsIdentityFunctionCall(funcEnumWithItemTupleTwinRustAsync, [
    ...
    EnumWithItemTupleTwinRustAsync.b(200),
  ]);
  ...
  addTestsIdentityFunctionCall(funcEnumWithFreezedOverrideTwinRustAsync, [
    const EnumWithFreezedOverrideTwinRustAsync.empty(),
    const EnumWithFreezedOverrideTwinRustAsync.named(count: 42),
    const EnumWithFreezedOverrideTwinRustAsync.named(),
  ]);
