...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  group('basic_optional', () {
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeI8TwinSync, <int?>[
      null,
      0,
      -128,
      127,
    ...
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeI16TwinSync, <int?>[
      null,
      0,
      -32768,
      32767,
    ...
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeI32TwinSync, <int?>[
      null,
      0,
      -2147483648,
      2147483647,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeI64TwinSync,
      <PlatformInt64?>[
        null,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeI128TwinSync,
      <BigInt?>[
        null,
        BigInt.parse("0"),
    ...
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeU8TwinSync, <int?>[
      null,
      0,
      255,
      123,
    ]);
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeU16TwinSync, <int?>[
      null,
      0,
      65535,
      12345,
    ]);
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeU32TwinSync, <int?>[
      null,
      0,
      4294967295,
      2468013579,
    ...
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeU128TwinSync,
      <BigInt?>[
        null,
        BigInt.parse("0"),
        BigInt.parse("9007199254740992"),
    ...
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeIsizeTwinSync,
      <PlatformInt64?>[
        null,
        PlatformInt64.parse("0"),
    ...
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeUsizeTwinSync,
      <BigInt?>[
        null,
        BigInt.parse("0"),
    ...
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeF32TwinSync, <double?>[
      null,
      0,
      -42.5,
      123456,
    ]);
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeF64TwinSync, <double?>[
      null,
      0,
      -42.5,
      123456,
    ]);
    addTestsIdentityFunctionCall(exampleBasicOptionalTypeBoolTwinSync, <bool?>[
      null,
      false,
      true,
    ]);
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeStringTwinSync,
      <String?>[null, "", "hello", "😂"],
    );
    addTestsIdentityFunctionCall(
      exampleBasicOptionalTypeBytesTwinSync,
      <Uint8List?>[
        null,
        Uint8List.fromList([]),
