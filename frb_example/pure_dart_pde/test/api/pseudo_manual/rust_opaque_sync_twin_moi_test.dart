...
import 'package:frb_example_pure_dart_pde/src/rust/api/pseudo_manual/rust_opaque_twin_moi.dart';
import 'package:frb_example_pure_dart_pde/src/rust/api/pseudo_manual/rust_opaque_sync_twin_moi.dart';
...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  test('check generator', () {
    expect(
        frbSyncGeneratorTestTwinMoi().runtimeType == FrbOpaqueSyncReturnTwinMoi,
        isTrue);
  });
}
