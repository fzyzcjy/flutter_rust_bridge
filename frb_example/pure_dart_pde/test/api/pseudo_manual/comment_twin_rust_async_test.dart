...
import 'package:frb_example_pure_dart_pde/src/rust/api/pseudo_manual/comment_twin_rust_async.dart';
...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  test('can call the functions', () async {
    await futurizeVoidTwinRustAsync(functionWithCommentsSlashStarStarTwinRustAsync());
