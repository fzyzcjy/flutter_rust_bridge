...
import 'package:frb_example_pure_dart_pde/src/rust/api/pseudo_manual/attribute_twin_rust_async.dart';
...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  test('dart call next_user_id to test metadata annotations', () async {
    ...
    expect(
      await nextUserIdTwinRustAsync(userId: userId),
      UserIdTwinRustAsync(value: 12),
    );
  });

  test('init_dart_code runs during RustLib.init', () {
    expect(getInitDartCodeMessagesTwinRustAsync(), ['first', 'second']);
  });
}
