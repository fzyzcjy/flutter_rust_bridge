...
import 'package:frb_example_pure_dart_pde/src/rust/api/pseudo_manual/raw_string_twin_rust_async.dart';
...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  test('test dart raw string in struct', () async {
    final output = await testRawStringItemStructTwinRustAsync();
    expect(output, isA<RawStringItemStructTwinRustAsync>());
  ...
  test('test dart test more than just one raw string struct', () async {
    final output = await testMoreThanJustOneRawStringStructTwinRustAsync();
