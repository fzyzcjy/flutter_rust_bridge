...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  group('basic', () {
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeI8TwinNormal, <int>[
      0,
      -128,
      127,
      79,
    ...
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeI16TwinNormal, <int>[
      0,
      -32768,
      32767,
      12345,
    ...
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeI32TwinNormal, <int>[
      0,
      -2147483648,
      2147483647,
      1234567890,
    ...
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeI128TwinNormal,
      <BigInt>[
        BigInt.parse("0"),
    ...
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeU8TwinNormal, <int>[
      0,
      255,
      123,
    ]);
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeU16TwinNormal, <int>[
      0,
      65535,
      12345,
    ]);
    addTestsIdentityWithExpectFunctionCall(exampleBasicTypeU32TwinNormal, <int>[
      0,
      4294967295,
      2468013579,
    ]);
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeU64TwinNormal,
      <BigInt>[
        BigInt.parse("0"),
        BigInt.parse("9007199254740992"),
        BigInt.parse("9223372036854775807"),
    ...
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeU128TwinNormal,
      <BigInt>[
        BigInt.parse("0"),
        BigInt.parse("9007199254740992"),
        BigInt.parse("9223372036854775807"),
    ...
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeIsizeTwinNormal,
      <PlatformInt64>[
        PlatformInt64.parse("0"),
    ...
    addTestsIdentityWithExpectFunctionCall(
      exampleBasicTypeUsizeTwinNormal,
      <BigInt>[
        BigInt.parse("0"),
    ...
    addTestsIdentityFunctionCall(exampleBasicTypeF32TwinNormal, <double>[
      0,
      -42.5,
      123456,
    ]);
    addTestsIdentityFunctionCall(exampleBasicTypeF64TwinNormal, <double>[
      0,
      -42.5,
      123456,
    ]);
    addTestsIdentityFunctionCall(exampleBasicTypeBoolTwinNormal, <bool>[
      false,
      true,
    ]);
    addTestsIdentityFunctionCall(exampleBasicTypeStringTwinNormal, <String>[
      "",
      "hello",
      "😂",
    ]);
