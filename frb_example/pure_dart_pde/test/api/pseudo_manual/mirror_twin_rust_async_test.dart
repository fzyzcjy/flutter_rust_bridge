...
// FRB_INTERNAL_GENERATOR: {"addCode":"import 'package:frb_example_pure_dart_pde/src/rust/api/pseudo_manual/mirror_twin_rust_async.dart';"}
...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  test('dart call repeatNumber()', () async {
    var numbers = await repeatNumberTwinRustAsync(num: 1, times: BigInt.from(10));
    expect(
  ...
  test('dart call repeatSequence()', () async {
    var sequences = await repeatSequenceTwinRustAsync(
      seq: 1,
