...
Future<void> main({bool skipRustLibInit = false}) async {
  ...
  void testComplexStruct(
    MyTreeNodeTwinNormal complexStructResp, {
    required int arrLen,
  }) {
  ...
  test('test abc', () async {
    ...
    final output2 = await testAbcEnumTwinNormal(
      abc: AbcTwinNormal.b(BTwinNormal(b: 1)),
    );
  ...
  addTestsIdentityFunctionCall(handleCharTwinNormal, <String>[
    'a',
    '\0',
    '\u{10FFFF}',
  ]);
  ...
  test('dart call handleVecU8', () async {
    final len = 100000;
    expect(
      await handleVecU8TwinNormal(v: Uint8List.fromList(List.filled(len, 127))),
