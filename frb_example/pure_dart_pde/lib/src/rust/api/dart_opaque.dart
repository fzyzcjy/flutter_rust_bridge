...
Future<Object?> loopBackOptionTwinNormal({required Object opaque}) => RustLib
    .instance
    .api
...
Future<ObjectArray1> loopBackArrayTwinNormal({required Object opaque}) =>
    RustLib.instance.api.crateApiDartOpaqueLoopBackArrayTwinNormal(
      opaque: opaque,
    );

Future<List<Object>> loopBackVecTwinNormal({required Object opaque}) => RustLib
    .instance
    .api
    .crateApiDartOpaqueLoopBackVecTwinNormal(opaque: opaque);

Future<void> loopBackOptionGetTwinNormal({Object? opaque}) => RustLib
    .instance
    .api
...
Future<void> loopBackVecGetTwinNormal({required List<Object> opaque}) => RustLib
    .instance
    .api
...
Future<void> dropStaticDartOpaqueTwinNormal({required int id}) => RustLib
    .instance
    .api
...
class ObjectArray1 extends NonGrowableListView<Object> {
  ...
  ObjectArray1(this._inner) : assert(_inner.length == arraySize), super(_inner);
...
sealed class EnumDartOpaqueTwinNormal with _$EnumDartOpaqueTwinNormal {
  ...
  const factory EnumDartOpaqueTwinNormal.primitive(int field0) =
      EnumDartOpaqueTwinNormal_Primitive;
  const factory EnumDartOpaqueTwinNormal.opaque(Object field0) =
