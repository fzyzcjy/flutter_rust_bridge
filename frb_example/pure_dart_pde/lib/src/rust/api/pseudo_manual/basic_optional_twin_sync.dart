...
PlatformInt64? exampleBasicOptionalTypeI64TwinSync({
  PlatformInt64? arg,
}) =>
...
BigInt? exampleBasicOptionalTypeI128TwinSync({BigInt? arg}) =>
    RustLib.instance.api
...
BigInt? exampleBasicOptionalTypeU64TwinSync({BigInt? arg}) =>
    RustLib.instance.api
        .crateApiPseudoManualBasicOptionalTwinSyncExampleBasicOptionalTypeU64TwinSync(
      arg: arg,
    );

BigInt? exampleBasicOptionalTypeU128TwinSync({BigInt? arg}) =>
    RustLib.instance.api
        .crateApiPseudoManualBasicOptionalTwinSyncExampleBasicOptionalTypeU128TwinSync(
      arg: arg,
    );

PlatformInt64? exampleBasicOptionalTypeIsizeTwinSync({
  PlatformInt64? arg,
}) =>
    RustLib.instance.api
...
BigInt? exampleBasicOptionalTypeUsizeTwinSync({BigInt? arg}) =>
    RustLib.instance.api
        .crateApiPseudoManualBasicOptionalTwinSyncExampleBasicOptionalTypeUsizeTwinSync(
      arg: arg,
    );

double? exampleBasicOptionalTypeF32TwinSync({double? arg}) =>
    RustLib.instance.api
        .crateApiPseudoManualBasicOptionalTwinSyncExampleBasicOptionalTypeF32TwinSync(
      arg: arg,
    );

double? exampleBasicOptionalTypeF64TwinSync({double? arg}) =>
    RustLib.instance.api
...
String? exampleBasicOptionalTypeStringTwinSync({String? arg}) =>
    RustLib.instance.api
        .crateApiPseudoManualBasicOptionalTwinSyncExampleBasicOptionalTypeStringTwinSync(
      arg: arg,
    );

Uint8List? exampleBasicOptionalTypeBytesTwinSync({Uint8List? arg}) =>
    RustLib.instance.api
