...
// The type `SimpleEnumWithCommentsTwinRustAsync` is exported as `pub` but never used by any `pub` functions, thus it is ignored.
// The type `ComplexEnumWithCommentsTwinRustAsync` is exported as `pub` but never used by any `pub` functions, thus it is ignored.
