...
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `PrivateOpaqueFieldInnerTwinSync`, `RestrictedOpaqueFieldInnerTwinSync`
...
// Rust type: RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<OpaqueWithPrivateFieldTwinSync>>
abstract class OpaqueWithPrivateFieldTwinSync implements RustOpaqueInterface {
  static OpaqueWithPrivateFieldTwinSync newTwinSync({required String value}) =>
      RustLib.instance.api
