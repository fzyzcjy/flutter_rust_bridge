...
Map<int, int> funcHashMapI32I32TwinSync(
    ...
    RustLib.instance.api
        .crateApiPseudoManualMapAndSetTwinSyncFuncHashMapI32I32TwinSync(
            arg: arg, hint: hint);

Set<int> funcHashSetI32TwinSync({required Set<int> arg, dynamic hint}) =>
    RustLib.instance.api
        .crateApiPseudoManualMapAndSetTwinSyncFuncHashSetI32TwinSync(
            arg: arg, hint: hint);
...
Set<String> funcHashSetStringTwinSync(
    ...
    RustLib.instance.api
        .crateApiPseudoManualMapAndSetTwinSyncFuncHashSetStringTwinSync(
            arg: arg, hint: hint);
