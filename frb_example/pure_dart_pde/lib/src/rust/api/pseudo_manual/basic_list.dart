...
Future<Uint16List> exampleBasicListTypeU16TwinNormal({
  required List<int> arg,
    ...
    .crateApiPseudoManualBasicListExampleBasicListTypeU16TwinNormal(arg: arg);

Future<Uint32List> exampleBasicListTypeU32TwinNormal({
  required List<int> arg,
}) => RustLib.instance.api
    .crateApiPseudoManualBasicListExampleBasicListTypeU32TwinNormal(arg: arg);

Future<Uint64List> exampleBasicListTypeU64TwinNormal({
  required Uint64List arg,
}) => RustLib.instance.api
    .crateApiPseudoManualBasicListExampleBasicListTypeU64TwinNormal(arg: arg);

Future<Float32List> exampleBasicListTypeF32TwinNormal({
  required List<double> arg,
}) => RustLib.instance.api
    .crateApiPseudoManualBasicListExampleBasicListTypeF32TwinNormal(arg: arg);

Future<Float64List> exampleBasicListTypeF64TwinNormal({
  required List<double> arg,
}) => RustLib.instance.api
    .crateApiPseudoManualBasicListExampleBasicListTypeF64TwinNormal(arg: arg);

Future<List<bool>> exampleBasicListTypeBoolTwinNormal({
  required List<bool> arg,
}) => RustLib.instance.api
    .crateApiPseudoManualBasicListExampleBasicListTypeBoolTwinNormal(arg: arg);
...
Future<List<Uint8List>> exampleBasicListTypeBytesTwinNormal({
  required List<Uint8List> arg,
    ...
    .crateApiPseudoManualBasicListExampleBasicListTypeBytesTwinNormal(arg: arg);
