...
class ConcatenateWithTwinRustAsync {
  ...
  Stream<int> handleSomeStreamSinkAt1TwinRustAsync({dynamic hint}) => RustLib
      .instance.api
...
class SimpleStructTwinRustAsync {
  ...
  Future<String> receiverBorrowTwinRustAsync({dynamic hint}) => RustLib
      .instance.api
      .crateApiPseudoManualMethodTwinRustAsyncSimpleStructTwinRustAsyncReceiverBorrowTwinRustAsync(
          that: this, hint: hint);

  Future<String> receiverOwnTwinRustAsync({dynamic hint}) => RustLib
      .instance.api
