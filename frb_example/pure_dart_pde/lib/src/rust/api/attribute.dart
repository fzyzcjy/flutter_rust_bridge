...
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `IgnoredStructTwinNormal`, `StructWithOnlyIgnoredMethodTwinNormal`
