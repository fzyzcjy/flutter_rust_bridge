...
import 'rust_builder_bindings_generated.dart';
...
const String _libName = 'rust_builder';

/// The dynamic library in which the symbols for [RustBuilderBindings] can be found.
...
final RustBuilderBindings _bindings = RustBuilderBindings(_dylib);
