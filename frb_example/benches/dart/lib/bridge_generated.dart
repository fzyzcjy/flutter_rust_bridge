...
extension BenchHandleUuidExtension
    on FlutterRustBridgeExampleBenchmarkSuiteImpl {
  Future<UuidValue> benchHandleUuid(
      {required UuidValue id, String? timelineTaskName}) async {
    return wireBenchHandleUuid(this, timelineTaskName, id: id);
  }
}

extension BenchHandleUuidsExtension
    on FlutterRustBridgeExampleBenchmarkSuiteImpl {
  Future<List<UuidValue>> benchHandleUuids(
      {required List<UuidValue> ids, String? timelineTaskName}) async {
    return wireBenchHandleUuids(this, timelineTaskName, ids: ids);
  }
}

extension BenchHandleUuidsConvertToStringsExtension
    on FlutterRustBridgeExampleBenchmarkSuiteImpl {
  Future<List<String>> benchHandleUuidsConvertToStrings(
      {required List<UuidValue> ids, String? timelineTaskName}) async {
    return wireBenchHandleUuidsConvertToStrings(this, timelineTaskName,
        ids: ids);
  }
}

extension BenchHandleNestedUuidsExtension
    on FlutterRustBridgeExampleBenchmarkSuiteImpl {
  Future<FeatureUuid> benchHandleNestedUuids(
      {required FeatureUuid ids, String? timelineTaskName}) async {
    return wireBenchHandleNestedUuids(this, timelineTaskName, ids: ids);
  }
}

extension BenchHandleStringsExtension
    on FlutterRustBridgeExampleBenchmarkSuiteImpl {
  Future<List<String>> benchHandleStrings(
      {required List<String> strings, String? timelineTaskName}) async {
    return wireBenchHandleStrings(this, timelineTaskName, strings: strings);
  }
}

extension BenchSendI64Extension on FlutterRustBridgeExampleBenchmarkSuiteImpl {
  Future<int> benchSendI64(
      {required int value, String? timelineTaskName}) async {
