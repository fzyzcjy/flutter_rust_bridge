...
/// This function should never be called manually.
#[no_mangle]
pub unsafe extern "C" fn free_wire_sync_return_dco(value: WireSyncRust2DartDco) {
...
/// This function should never be called manually.
#[no_mangle]
pub unsafe extern "C" fn free_wire_sync_return_sse(value: WireSyncRust2DartSse) {
