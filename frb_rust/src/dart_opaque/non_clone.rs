...
use crate::platform_types::{handle_to_message_port, SerializedDartNativeSendPort};
#[cfg(wasm)]
...
pub(super) struct DartOpaqueNonClone {
    ...
    dart_handler_port: SerializedDartNativeSendPort,
}
...
impl DartOpaqueNonClone {
    ...
    pub(crate) fn dart_handler_port(&self) -> &SerializedDartNativeSendPort {
