...
macro_rules! frb_generated_io_extern_func {
    ...
    (
                    frb_pde_ffi_dispatcher_primary = $frb_pde_ffi_dispatcher_primary_link_name:literal,
frb_pde_ffi_dispatcher_sync = $frb_pde_ffi_dispatcher_sync_link_name:literal,
frb_dart_fn_deliver_output = $frb_dart_fn_deliver_output_link_name:literal,
                ) => {
        #[unsafe(export_name = $frb_pde_ffi_dispatcher_primary_link_name)]
        pub extern "C" fn frb_pde_ffi_dispatcher_primary(
            func_id: i32,
            port_: i64,
            ptr_: *mut u8,
        ...
        #[unsafe(export_name = $frb_pde_ffi_dispatcher_sync_link_name)]
        pub extern "C" fn frb_pde_ffi_dispatcher_sync(
            func_id: i32,
            ptr_: *mut u8,
            rust_vec_len_: i32,
        ...
        #[unsafe(export_name = $frb_dart_fn_deliver_output_link_name)]
        pub extern "C" fn frb_dart_fn_deliver_output(
            call_id: i32,
            ptr_: *mut u8,
            rust_vec_len_: i32,
