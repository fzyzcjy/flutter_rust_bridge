...
pub fn rust_arc_increment_strong_count_moi<T: 'static>(raw: usize) {
    <MoiRustOpaqueCodec as BaseRustOpaqueCodec>::Arc::<T>::increment_strong_count_safe(raw);
}

pub fn rust_arc_decrement_strong_count_moi<T: 'static>(raw: usize) {
    <MoiRustOpaqueCodec as BaseRustOpaqueCodec>::Arc::<T>::decrement_strong_count_safe(raw);
}
