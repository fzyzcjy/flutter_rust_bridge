...
[<img id="flutter_favorite" src="flutter_favorite.png" width="200" />](https://flutter.dev/docs/development/packages-and-plugins/favorites)

<!-- I'm using this id in custom.css -->
<img id="flutter_rust_bridge_logo"/>
