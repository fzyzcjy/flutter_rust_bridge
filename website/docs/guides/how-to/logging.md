...
First you need to add a dependency on the logging crate in your Cargo.toml file with `cargo add log` or by putting `log = "^0"` in your Cargo.toml file under the `[dependencies]` section.
