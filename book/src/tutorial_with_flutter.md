...
As soon as you make any modification to `api.rs`, you need to run codegen again : more informations about requirements for code generation in the [Installing dependencies](integrate/deps.md) section.
