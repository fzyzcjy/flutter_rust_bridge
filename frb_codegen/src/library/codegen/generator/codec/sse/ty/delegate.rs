    ...
    fn generate_encode(&self, lang: &Lang) -> Option<String> {
        let inner_expr = match lang {
            Lang::DartLang(_) => match &self.ir {
                ...
                IrTypeDelegate::BigPrimitive(_) => "self.toString()",
            },
            Lang::RustLang(_) => match &self.ir {
                ...
                IrTypeDelegate::BigPrimitive(_) => "self.to_string()",
            },
        };
    ...
    fn generate_decode(&self, lang: &Lang) -> Option<String> {
        let wrapper_expr = match lang {
            Lang::DartLang(_) => match &self.ir {
                ...
                IrTypeDelegate::BigPrimitive(_) => "BigInt.parse(inner)",
            },
            Lang::RustLang(_) => match &self.ir {
                IrTypeDelegate::Array(_) => {
                ...
                IrTypeDelegate::BigPrimitive(_) => "inner.parse().unwrap()",
            },
        };
