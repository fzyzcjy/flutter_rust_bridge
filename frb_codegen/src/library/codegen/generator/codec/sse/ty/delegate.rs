    ...
    fn generate_encode(&self, lang: &Lang) -> Option<String> {
        let inner_expr = match lang {
            Lang::DartLang(_) => match &self.ir {
                ...
                IrTypeDelegate::RustAutoOpaqueExplicit(ir) => "self".to_owned(),
            },
            Lang::RustLang(_) => match &self.ir {
                ...
                IrTypeDelegate::RustAutoOpaqueExplicit(ir) => "rust_auto_opaque_explicit_encode(inner)".to_owned(),
            },
        };
    ...
    fn generate_decode(&self, lang: &Lang) -> Option<String> {
        let wrapper_expr = match lang {
            Lang::DartLang(_) => match &self.ir {
                ...
                IrTypeDelegate::RustAutoOpaqueExplicit(ir) => "inner".to_owned(),
            },
            Lang::RustLang(_) => match &self.ir {
                IrTypeDelegate::Array(_) => {
                ...
                IrTypeDelegate::RustAutoOpaqueExplicit(ir) => "rust_auto_opaque_explicit_decode(inner)".to_owned(),
            },
        };
