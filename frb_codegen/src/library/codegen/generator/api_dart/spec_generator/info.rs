    ...
    pub fn test_rust_type_to_dart_type() {
        ...
        assert_eq!(
            &rust_type_to_dart_type(
                "flutter_rust_bridge::for_generated::tokio::sync::RwLock<crate::api::simple::AnotherOpaqueType>",
                true
            ),
            "AnotherOpaqueType"
        );
        assert_eq!(&rust_type_to_dart_type("flutter_rust_bridge::for_generated::tokio::sync::RwLock<(crate::api::simple::MyOpaqueType,crate::api::simple::AnotherOpaqueType,)>", true), "MyOpaqueTypeAnotherOpaqueType");
    }
}
