...
pub(crate) fn replace_file_content(content: &[u8], replacements: &HashMap<&str, String>) -> Vec<u8> {
...
pub(crate) fn replace_string_content(content: &str, replacements: &HashMap<&str, String>) -> String {
