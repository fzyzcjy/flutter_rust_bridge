...
impl Generator {
    ...
    fn generate(&mut self, ir_file: &IrFile, rust_wire_mod: &str) -> String {
        ...
        lines.push(r#"#![allow(non_camel_case_types, unused, clippy::redundant_closure, clippy::useless_conversion, clippy::unit_arg, clippy::double-parens, non_snake_case)]"#.to_string());
